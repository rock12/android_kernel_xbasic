 ...
 * Revision 1.2  2013/11/08 06:34:38  dongxiaocheng
 * Editor:dongxiaocheng
 * Inspector:dongxiaocheng
 * Reason:13F43-E700WD¡ì1?¨®??¡¥
 * Reference:none
 *
 * Revision 1.1  2013/09/04 07:14:58  pengyajun
 * E700S
 *
 ...
 * Editor:sujian
 * Inspector:lanqilong
 * Reason:12Y36_H8 main camera D¡ì1?¨®??¡¥¨ª¨º3¨¦
 * Reference:none
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x0b , 0x00);//
	...
	*/
	...
	GC2035_write_cmos_sensor(0xfe, 0x00); 
	GC2035_write_cmos_sensor(0x03, 0x02);//
	GC2035_write_cmos_sensor(0x04, 0x48);//
	GC2035_write_cmos_sensor(0x05, 0x01);//
	GC2035_write_cmos_sensor(0x06, 0x05);  
	GC2035_write_cmos_sensor(0x07, 0x00);//
	GC2035_write_cmos_sensor(0x08, 0x72);  
	...
	GC2035_write_cmos_sensor(0x2b, 0x05);//
	GC2035_write_cmos_sensor(0x2c, 0xb4);  
	GC2035_write_cmos_sensor(0x2d, 0x06);//5b4 betty
	...
	GC2035_write_cmos_sensor(0x87 , 0xb0); //[7]middle gamma 
	...
	GC2035_write_cmos_sensor(0xc3 , 0x15);
	GC2035_write_cmos_sensor(0xc4 , 0x10);
	GC2035_write_cmos_sensor(0xc8 , 0x12); // down_b2 of R  27
	GC2035_write_cmos_sensor(0xc9 , 0x14); // down_b2 of G
	GC2035_write_cmos_sensor(0xca , 0x10); // down_b2 of B
	GC2035_write_cmos_sensor(0xbc , 0x42);
	GC2035_write_cmos_sensor(0xbd , 0x24);
	GC2035_write_cmos_sensor(0xbe , 0x1a);
	GC2035_write_cmos_sensor(0xb6 , 0x38);
	...
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x0c);  // down_b4 of R
	GC2035_write_cmos_sensor(0xcc , 0x00);  // down_b4 of G
	GC2035_write_cmos_sensor(0xcd , 0x00);  // down_b4 of B
	GC2035_write_cmos_sensor(0xbf , 0x16);
	GC2035_write_cmos_sensor(0xc0 , 0x00);
	GC2035_write_cmos_sensor(0xc1 , 0x00);
	GC2035_write_cmos_sensor(0xb9 , 0x0c);
	...
	GC2035_write_cmos_sensor(0xae , 0x04);
	GC2035_write_cmos_sensor(0xaf , 0x07);
	GC2035_write_cmos_sensor(0xb0 , 0x00); // Q3_b1 of R  09
	GC2035_write_cmos_sensor(0xb1 , 0x0b); // Q3_b1 of g  
	GC2035_write_cmos_sensor(0xb2 , 0x0f); // Q3_b1 of b  
	GC2035_write_cmos_sensor(0xb3 , 0x02); // Q4_b1 of R 03
	GC2035_write_cmos_sensor(0xb4 , 0x0b); // Q4_b1 of G
	GC2035_write_cmos_sensor(0xb5 , 0x0f); // Q4_b1 of B
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x00);
	GC2035_write_cmos_sensor(0xd8 , 0x00);
	...
	GC2035_write_cmos_sensor(0xd7 , 0x00);
	GC2035_write_cmos_sensor(0xa4 , 0x00);
	GC2035_write_cmos_sensor(0xa5 , 0x04); //[6]Q3_b1 of R sign [5]Q3_b1 of G sign [4]Q3_b1 of B sign  [2]Q4_b1 of R sign [1]Q4_b1 of G sign [0]Q4_b1 of B sign  00
	GC2035_write_cmos_sensor(0xa6 , 0x77);
	GC2035_write_cmos_sensor(0xa7 , 0x77);
	GC2035_write_cmos_sensor(0xa8 , 0x00);
	GC2035_write_cmos_sensor(0xa9 , 0x00);
	...
	GC2035_write_cmos_sensor(0xc1 , 0x42); //Green_cc for d
	...
	GC2035_write_cmos_sensor(0xa6 , 0x70); //dd_th  80
	GC2035_write_cmos_sensor(0xa7 , 0x70); //ot_th  80
	...
	GC2035_write_cmos_sensor(0x38 , 0x0a); // 0f
	...
	GC2035_write_cmos_sensor(0x97 , 0x66);// edge effect
	////==============RGB Gamma 
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 3; //2
