...
////////////////add ratio///////
	GC2035_write_cmos_sensor(0xad, 0x84);  
	GC2035_write_cmos_sensor(0xae, 0x82);  
	GC2035_write_cmos_sensor(0xaf, 0x7e);  
	...
	//abs
	GC2035_write_cmos_sensor(0x9c , 0x02);
	...
	GC2035_write_cmos_sensor(0xc5, 0x48);  //0x44
	...
	GC2035_write_cmos_sensor(0xd3 , 0x3c);//contrast ?42	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xf8);//luma_offset  0xf8
	...
	GC2035_write_cmos_sensor(0x97 , 0x78);// edge effect//45
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x82);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
