...
#define GT2005_write_cmos_sensor_2(addr, para, bytes) iWriteReg((u16) addr , (u32) para ,bytes,GT2005_WRITE_ID, true)
...
kal_uint16 GT2005_write_cmos_sensor(kal_uint32 Addr, kal_uint32 Para)
{
  char pSendCmd[2] = {(char)(Addr & 0xFF) ,(char)(Para & 0xFF)};
  
  //SENSORDB("[HI342]HI342WriteCmosSensor,Addr:%x;Para:%x \n",Addr,Para);
  iWriteRegI2C(pSendCmd , 2,GT2005_WRITE_ID);
}
...
kal_uint16 GT2005_read_cmos_sensor(kal_uint32 Addr)
{
  ...
  iReadRegI2C(&pSendCmd , 1, &pGetByte,1,GT2005_WRITE_ID);
  return pGetByte;
}
*/
/*******************************************************************************
...
//static kal_uint32 GT2005_sensor.pv_shutter = 0;
//static kal_uint32 GT2005_sensor.pv_extra_shutter = 0;

UINT8 GT2005_PixelClockDivider=0;

//SENSOR_REG_STRUCT GT2005SensorCCT[FACTORY_END_ADDR]=CAMERA_SENSOR_CCT_DEFAULT_VALUE;
//SENSOR_REG_STRUCT GT2005SensorReg[ENGINEER_END]=CAMERA_SENSOR_REG_DEFAULT_VALUE;
...
UINT32 GT2005Open(void)
{
	...
	zoom_factor = 0; 
	//GT2005_write_cmos_sensor(0x3012,0x80);// Reset sensor
    Sleep(10);
    ...
    GT2005_write_cmos_sensor(0x0116, 0x01); 
    GT2005_write_cmos_sensor(0x0117, 0x00); 
    GT2005_write_cmos_sensor(0x0118, 0x20); 
    ...
    GT2005_write_cmos_sensor(0x0200, 0x00); //20 betty 
    GT2005_write_cmos_sensor(0x0201, 0x06); //2b betty 0x00 seaser
    GT2005_write_cmos_sensor(0x0202, 0x40); //40 betty saturation
    ...
    GT2005_write_cmos_sensor(0x020B, 0x2f); //0x28 seaser white side
    GT2005_write_cmos_sensor(0x020C, 0x4a); //0x44 seaser black side
    GT2005_write_cmos_sensor(0x020D, 0xC8); 
    GT2005_write_cmos_sensor(0x020E, 0xBC); 
    GT2005_write_cmos_sensor(0x020F, 0x08); 
    GT2005_write_cmos_sensor(0x0210, 0xd6); //0x16 seaser
    ...
    GT2005_write_cmos_sensor(0x0313, 0x35); //1d betty
    GT2005_write_cmos_sensor(0x0314, 0xA4); 
    ...
    GT2005_write_cmos_sensor(0x040A, 0x00); 
    GT2005_write_cmos_sensor(0x040B, 0x11); //f6 betty 33 seaser
    ...
    GT2005_write_cmos_sensor(0x0441, 0x5C); 
    GT2005_write_cmos_sensor(0x0442, 0x00); 
    GT2005_write_cmos_sensor(0x0443, 0x00); 
    GT2005_write_cmos_sensor(0x0444, 0x17); 
    ...
    GT2005_write_cmos_sensor(0x0466, 0x25); 
    GT2005_write_cmos_sensor(0x0467, 0x25); 
    GT2005_write_cmos_sensor(0x0468, 0x40); 
    GT2005_write_cmos_sensor(0x0469, 0x30); 
    GT2005_write_cmos_sensor(0x046A, 0x28); 
    GT2005_write_cmos_sensor(0x046B, 0x45); 
    GT2005_write_cmos_sensor(0x046C, 0x3A); 
    GT2005_write_cmos_sensor(0x046D, 0x33); 
    GT2005_write_cmos_sensor(0x046E, 0x2F); 
    GT2005_write_cmos_sensor(0x046F, 0x49); 
    GT2005_write_cmos_sensor(0x0470, 0x46); 
    GT2005_write_cmos_sensor(0x0471, 0x3D); 
    GT2005_write_cmos_sensor(0x0472, 0x30); 
    GT2005_write_cmos_sensor(0x0473, 0x3E); 
    GT2005_write_cmos_sensor(0x0474, 0x3D); 
    GT2005_write_cmos_sensor(0x0475, 0x32); 
    GT2005_write_cmos_sensor(0x0476, 0x34); 
    GT2005_write_cmos_sensor(0x0477, 0x40); 
...
UINT32 GT2005GetSensorID(UINT32 *sensorID) 
{
	volatile signed char i;
	kal_uint16 sensor_id=0;
	SENSORDB("xieyang GT2005GetSensorID ");
...
*/
		...
		GT2005_write_cmos_sensor(0x0315, 0x56);                  			
			GT2005_write_cmos_sensor(0x0313, 0x37); 
			GT2005_write_cmos_sensor(0x0314, 0x0d);
            break;
...
BOOL GT2005_set_param_exposure(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AE_EV_COMP_00:
			GT2005_write_cmos_sensor(0x0201, 0x10);//00 betty 0x00 seaser
            break;
