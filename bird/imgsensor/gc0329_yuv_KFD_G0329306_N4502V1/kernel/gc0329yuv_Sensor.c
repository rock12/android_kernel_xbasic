 ...
 *------------------------------------------------------------------------------
 * $Log: gc0329yuv_Sensor.c,v $
 * Revision 1.1  2013/09/23 10:42:43  wangqiang
 * add for 13E45_306, by liuxd.
 *
 * Revision 1.4  2013/07/17 12:20:24  huangmaohua
 * no message
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x78, 0x48);//4d
	...
	GC0329_write_cmos_sensor(0x1f, 0xb0);
	GC0329_write_cmos_sensor(0x20, 0x50);
	...
	GC0329_write_cmos_sensor(0x83, 0x01);  // add by lanking 20120423
	...
	GC0329_write_cmos_sensor(0xb3, 0x3a);
	GC0329_write_cmos_sensor(0xb4, 0xf0);//fd betty
	GC0329_write_cmos_sensor(0xb5, 0x07);//02 betty
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x44);
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x32);
	GC0329_write_cmos_sensor(0xd2, 0x32);
	...
	GC0329_write_cmos_sensor(0x13, 0x56);
	...
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0x03, 0x01); 	
	GC0329_write_cmos_sensor(0x04, 0x2c);
	GC0329_write_cmos_sensor(0x05, 0x00); 	
	GC0329_write_cmos_sensor(0x06, 0x6a); 
	GC0329_write_cmos_sensor(0x07, 0x00);
	GC0329_write_cmos_sensor(0x08, 0x25);
	GC0329_SET_PAGE1;
  GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	...
	GC0329_write_cmos_sensor(0x30, 0x1a); 
	GC0329_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
	GC0329_write_cmos_sensor(0x32, 0xdc); 
	GC0329_SET_PAGE0;
	...
	GC0329_write_cmos_sensor(0x5d, 0x13);
	...
	GC0329_write_cmos_sensor(0x67, 0x6c);//70
	GC0329_write_cmos_sensor(0x68, 0x54);//58
	...
	GC0329_write_cmos_sensor(0x7b, 0x7a);
	GC0329_write_cmos_sensor(0x7c, 0x80);//hyper add
	////////////////////asde ///////////////////
	//GC0329_write_cmos_sensor(0xa0, 0xaf);
	//GC0329_write_cmos_sensor(0xa2, 0xff);
	mdelay(400);
...
UINT32 GC0329GetSensorID(UINT32 *sensorID)
{
    ...
    do
    {
        	...
        	for(i = 0; i < 3; i++)
		{
	            	...
	            	printk("MYCAT GC0329 Sensor id = %x\n", sensor_id);
    ...
    if(sensor_id != GC0329_SENSOR_ID)
    {
        printk("MYCAT GC0329 Sensor id read failed, ID = %x\n", sensor_id);
        return ERROR_SENSOR_CONNECT_FAIL;
    }

    *sensorID = sensor_id;
	printk("MYCAT GC0329 Sensor id read OK, ID = %x\n", sensor_id);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x5d,0x16);																																																																									
	GC0329_write_cmos_sensor(0x67,0x6c);	//70																																																																								
	GC0329_write_cmos_sensor(0x68,0x54);	//58																																																																								
	GC0329_write_cmos_sensor(0x69,0x80);																																																																									
	...
	GC0329_write_cmos_sensor(0xd1,0x26);																																																																									
	GC0329_write_cmos_sensor(0xd2,0x26);																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(3);//0:use default
...
BOOL GC0329_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			GC0329_write_cmos_sensor(0x77, 0x7c); //WB_manual_gain 
			GC0329_write_cmos_sensor(0x78, 0x58);
	...
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			*/
			GC0329_write_cmos_sensor(0x05, 0x00); 	
			GC0329_write_cmos_sensor(0x06, 0x6a); 
			GC0329_write_cmos_sensor(0x07, 0x02);
			GC0329_write_cmos_sensor(0x08, 0x32);
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x96);   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x04);   //exp level 0  14.28fps
			GC0329_write_cmos_sensor(0x2c, 0x1a); 
			GC0329_write_cmos_sensor(0x2d, 0x05);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0xdc); 
			GC0329_write_cmos_sensor(0x2f, 0x08);   //exp level 2  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x34); 
			GC0329_write_cmos_sensor(0x31, 0x0b);   //exp level 3  7.14fps
			GC0329_write_cmos_sensor(0x32, 0xb8); 
			GC0329_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			/*
			GC0329_write_cmos_sensor(0x05, 0x00); 	
			GC0329_write_cmos_sensor(0x06, 0xc7); 
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x10);
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x38);   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0329_write_cmos_sensor(0x2c, 0x30); 
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0xa0); 
			...
			*/
			GC0329_write_cmos_sensor(0x05, 0x00); 	
			GC0329_write_cmos_sensor(0x06, 0xa8); 
			GC0329_write_cmos_sensor(0x07, 0x02);
			GC0329_write_cmos_sensor(0x08, 0x2c);
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x74);   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x04);   //exp level 0  15.00fps
			GC0329_write_cmos_sensor(0x2c, 0x14); 
			GC0329_write_cmos_sensor(0x2d, 0x05);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0x70); 
			GC0329_write_cmos_sensor(0x2f, 0x08);   //exp level 0  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x28); 
			GC0329_write_cmos_sensor(0x31, 0x0a);   //exp level 0  7.05fps
			GC0329_write_cmos_sensor(0x32, 0xe0); 
			GC0329_SET_PAGE0;
		break;
		default:
		return FALSE;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0xf8);
	value_Y = (GC0329_NIGHT_MODE?0x68:0x58);
