 ...
 * Revision 1.1  2013/09/12 10:04:58  wangqiang
 * add for 13E45_Z317, by liuxd.
 *
 * Revision 1.1  2013/09/04 07:11:27  pengyajun
 * E700S
 *
...
////AWB//
  ...
  GC0328_write_cmos_sensor(0x44 , 0x00);//0x hyper
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x2d);//32
	GC0328_write_cmos_sensor(0xd2 , 0x2d);//32
	GC0328_write_cmos_sensor(0xd3 , 0x46);//32
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0x08);
			GC0328_write_cmos_sensor(0xfe, 0x01);
