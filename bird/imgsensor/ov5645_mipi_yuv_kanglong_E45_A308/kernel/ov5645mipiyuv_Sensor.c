...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x4300, 0x31);
  ...
  OV5645MIPI_write_cmos_sensor(0x518a, 0x60);
  ...
  OV5645MIPI_write_cmos_sensor(0x5800, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x5801, 0x20);
  OV5645MIPI_write_cmos_sensor(0x5802, 0x18);
  OV5645MIPI_write_cmos_sensor(0x5803, 0x18);
  OV5645MIPI_write_cmos_sensor(0x5804, 0x20);
  OV5645MIPI_write_cmos_sensor(0x5805, 0x3f);
  OV5645MIPI_write_cmos_sensor(0x5806, 0x11);
  OV5645MIPI_write_cmos_sensor(0x5807, 0x0a);
  OV5645MIPI_write_cmos_sensor(0x5808, 0x08);
  OV5645MIPI_write_cmos_sensor(0x5809, 0x09);
  OV5645MIPI_write_cmos_sensor(0x580a, 0x0c);
  OV5645MIPI_write_cmos_sensor(0x580b, 0x18);
  ...
  OV5645MIPI_write_cmos_sensor(0x5817, 0x0f);
  ...
  OV5645MIPI_write_cmos_sensor(0x581d, 0x16);
  OV5645MIPI_write_cmos_sensor(0x581e, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x581f, 0x1a);
  OV5645MIPI_write_cmos_sensor(0x5820, 0x15);
  OV5645MIPI_write_cmos_sensor(0x5821, 0x16);
  OV5645MIPI_write_cmos_sensor(0x5822, 0x22);
  OV5645MIPI_write_cmos_sensor(0x5823, 0x3d);
  OV5645MIPI_write_cmos_sensor(0x5824, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x5825, 0x0c);
  OV5645MIPI_write_cmos_sensor(0x5826, 0x0e);
  OV5645MIPI_write_cmos_sensor(0x5827, 0x0c);
  ...
  OV5645MIPI_write_cmos_sensor(0x582d, 0x2a);
  ...
  OV5645MIPI_write_cmos_sensor(0x5833, 0x2c);
  ...
  OV5645MIPI_write_cmos_sensor(0x5838, 0x48);
  OV5645MIPI_write_cmos_sensor(0x5839, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x583a, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x583b, 0x2c);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5306, 0x0c);
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x0c);
	OV5645MIPI_write_cmos_sensor(0x5306, 0x0a);
	OV5645MIPI_write_cmos_sensor(0x5307, 0x1a);
  ...
  OV5645MIPI_write_cmos_sensor(0x460c, 0x20); 
	OV5645MIPI_write_cmos_sensor(0x4837, 0x0b);	
	OV5645MIPI_write_cmos_sensor(0x3824, 0x01); 
	OV5645MIPI_write_cmos_sensor(0x5001, 0x83);
