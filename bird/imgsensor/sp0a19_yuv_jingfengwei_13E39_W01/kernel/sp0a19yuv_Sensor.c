 ...
 * Revision 1.5  2013/09/23 03:14:50  lanqilong
 * lanqilong 优化进入前摄颜色发红问题和切换速度慢问题
 *
 * Revision 1.4  2013/09/12 12:29:02  maliejun
 * sp0a19 漏电 8mA
 *
 * Revision 1.3  2013/08/07 07:06:14  birdlibo
 * [96199]
 *
 * Revision 1.2  2013/08/07 06:50:19  birdlibo
 * [96199]
 *
 * Revision 1.1  2013/06/27 09:08:25  maliejun
 * 13E39-W01 锦峰威CAM调试
 *
...
void SP0A19NightMode(kal_bool bEnable)
{
    ...
    else    // daylight mode
    {
        ...
        else
        {
            ...
            {
								#if 1//lj_test
								//ae setting 10-15FPS 50HZ
								SP0A19_write_cmos_sensor(0xfd,0x00);
								SP0A19_write_cmos_sensor(0x03,0x00);
								SP0A19_write_cmos_sensor(0x04,0xe7);
								SP0A19_write_cmos_sensor(0x06,0x00);
								SP0A19_write_cmos_sensor(0x09,0x02);
								...
								SP0A19_write_cmos_sensor(0x9b,0x00);
								SP0A19_write_cmos_sensor(0xfd,0x01);
								SP0A19_write_cmos_sensor(0xce,0x02);
								SP0A19_write_cmos_sensor(0xcf,0x03);
								SP0A19_write_cmos_sensor(0xd0,0x02);
            ...
            else if (sp0a19_isBanding== 1)
            {
								...
								#if 1//lj_test 
								//ae setting 10-15 60HZ
								SP0A19_write_cmos_sensor(0xfd,0x00);
								SP0A19_write_cmos_sensor(0x03,0x00);
								SP0A19_write_cmos_sensor(0x04,0xc3);
								SP0A19_write_cmos_sensor(0x06,0x00);
								SP0A19_write_cmos_sensor(0x09,0x02);
								SP0A19_write_cmos_sensor(0x0a,0xb0);
								SP0A19_write_cmos_sensor(0xf0,0x41);
								SP0A19_write_cmos_sensor(0xf1,0x00);
								SP0A19_write_cmos_sensor(0xfd,0x01);
								SP0A19_write_cmos_sensor(0x90,0x0c);
								SP0A19_write_cmos_sensor(0x92,0x01);
								SP0A19_write_cmos_sensor(0x98,0x41);
								SP0A19_write_cmos_sensor(0x99,0x00);
								SP0A19_write_cmos_sensor(0x9a,0x01);
								SP0A19_write_cmos_sensor(0x9b,0x00);
								SP0A19_write_cmos_sensor(0xfd,0x01);
...
//SP0A19 ini
    ...
    SP0A19_write_cmos_sensor(0xfd,0x01);
    SP0A19_write_cmos_sensor(0xa0,0x66);  //0x80  //zouyu 20121009
    SP0A19_write_cmos_sensor(0xa1,0x00);
    SP0A19_write_cmos_sensor(0xa2,0x19);
    ...
    SP0A19_write_cmos_sensor(0xa7,0xe6);   // 0xda    SP0A19_write_cmos_sensor(0xa5,0x00);  // 0xf2
