 ...
 * Revision 1.5  2013/09/12 07:24:41  zhoushaohong
 * 1.3传错，恢复成之前1.2版本
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	GC2035_write_cmos_sensor(0x8d , 0x6b); //awb gain limit R//70 
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x30);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x30);//saturation_Cr
