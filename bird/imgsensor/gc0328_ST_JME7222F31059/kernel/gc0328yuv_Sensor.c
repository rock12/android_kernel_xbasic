 ...
 * Revision 1.1  2013/10/15 13:01:56  xialeijie
 * no message
 *
...
void GC0328NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0328_write_cmos_sensor(0xfe, 0x00);
		GC0328GammaSelect(GC0328_RGB_Gamma_m5);
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x73 , 0x20); //30 inter  
...
/*
	...
	*/
	...
	GC0328_write_cmos_sensor(0xfe , 0x00);     //page0//hyper
	...
	GC0328_write_cmos_sensor(0x56 , 0x02);  //06 
	GC0328_write_cmos_sensor(0x5b , 0x02);  
	GC0328_write_cmos_sensor(0x5e , 0xa4);  //06 
	...
	GC0328_write_cmos_sensor(0x4f , 0x00);   
	GC0328_write_cmos_sensor(0x4f , 0x00);   //wait clr finish   
	GC0328_write_cmos_sensor(0x4d , 0x32);     ////////////40  
	//GC0328_write_cmos_sensor(0x4e , 0x02);     //SPL D65 
	GC0328_write_cmos_sensor(0x4e , 0x04);     //SPL D65 
	GC0328_write_cmos_sensor(0x4d , 0x41);     ////////////40
	GC0328_write_cmos_sensor(0x4e , 0x04);
	...
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x53);     /////////////50
	GC0328_write_cmos_sensor(0x4e , 0x00);    //SPL CWF
	GC0328_write_cmos_sensor(0x4e , 0x04);      //DNP
	GC0328_write_cmos_sensor(0x4e , 0x04);   //04//pink      //DNP
	//GC0328_write_cmos_sensor(0x4d , 0x63);     /////////////60
	//GC0328_write_cmos_sensor(0x4e , 0x08);  	//TL84
	//GC0328_write_cmos_sensor(0x4e , 0x08);  	//TL84
	GC0328_write_cmos_sensor(0x4d , 0x73);     //////////////80
	...
	GC0328_write_cmos_sensor(0x4d , 0x83);     //////////////80
	GC0328_write_cmos_sensor(0x4e , 0x20);    //SPL   A
	GC0328_write_cmos_sensor(0x4d , 0x93);     //////////////80
	GC0328_write_cmos_sensor(0x4e , 0x20);    //SPL   A
	GC0328_write_cmos_sensor(0x4f , 0x01);      
	...
	GC0328_write_cmos_sensor(0xde , 0x34); //hyper
#endif	
	////////////////////////////////////////////////
	////////////     BLK      //////////////////////
	////////////////////////////////////////////////
	...
	GC0328_write_cmos_sensor(0xfe , 0x00);  
	GC0328_write_cmos_sensor(0x03 , 0x02);  
	GC0328_write_cmos_sensor(0x04 , 0x40); 
	...
	GC0328_write_cmos_sensor(0x30, 0xe0); //3c0 hyper
	GC0328_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
	GC0328_write_cmos_sensor(0x32, 0x40);  //hyper
	...
	*/
    ...
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror 14
#else		
	GC0328_write_cmos_sensor(0x17 , 0x17);    //mirror
#endif		
	...
	GC0328_write_cmos_sensor(0x44 , 0x00);//02   
#else
  GC0328_write_cmos_sensor(0x44 , 0x02);
	...
	GC0328_write_cmos_sensor(0x90 , 0x00); //0xac hyper   
	GC0328_write_cmos_sensor(0x92 , 0x02);    
	GC0328_write_cmos_sensor(0x94 , 0x02);    
	GC0328_write_cmos_sensor(0x95 , 0x24); //0x54   
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x28);//0x38
	GC0328_write_cmos_sensor(0xd2 , 0x24);//0x38
	...
	//////////////////////////////////////////////
	GC0328_write_cmos_sensor(0xfe , 0x01);   
	GC0328_write_cmos_sensor(0x9c , 0x00);  //0x02 hyper abs 
	GC0328_write_cmos_sensor(0x08 , 0xa0);   
	GC0328_write_cmos_sensor(0x09 , 0xe8);   
	
	GC0328_write_cmos_sensor(0x10 , 0x08); //before gamma 0x00 
	GC0328_write_cmos_sensor(0x11 , 0x11);   
	GC0328_write_cmos_sensor(0x12 , 0x40);   //0x10 center weight
	...
	///cct       
	GC0328_write_cmos_sensor(0xB1 , 0x08);// 0x04  seaser
	GC0328_write_cmos_sensor(0xB2 , 0xf0);//0xfd   
	GC0328_write_cmos_sensor(0xB3 , 0x00);  //0xfc 
	GC0328_write_cmos_sensor(0xB4 , 0xf0);   
	GC0328_write_cmos_sensor(0xB5 , 0xf6);//   0x05
	...
	GC0328_write_cmos_sensor(0x70 , 0xf5); 
	GC0328_write_cmos_sensor(0x71 , 0x0a); 
	GC0328_write_cmos_sensor(0x72 , 0x28);// 0x18
...
UINT32 GC0328GetSensorID(UINT32 *sensorID)
{
    ...
    do
    {
        	...
        	for(i = 0; i < 3; i++)
		{
	            	*sensorID = GC0328_read_cmos_sensor(0xf0);
	            	printk("GC0328 Sensor id = %x\n", *sensorID);
	            	if (*sensorID == GC0328_SENSOR_ID)
			{
	               	break;
	            	}
        	}
...
{
    GC0328GammaSelect(GC0328_RGB_Gamma_m5);//0:use default
}
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2f, 0x04);   //exp level 0  10.00fps
			GC0328_write_cmos_sensor(0x30, 0xe0); //3a8 hyper
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n13:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x30);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xf8);
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x5c);//56
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
