...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x17, 0x17);  // 14
	...
	GC2145_write_cmos_sensor(0x86, 0x02);//06
	...
	GC2145_write_cmos_sensor(0x97, 0x64);
	...
	GC2145_write_cmos_sensor(0x82, 0x08);
	GC2145_write_cmos_sensor(0x83, 0x05);
	...
	*/
	...
	GC2145_write_cmos_sensor(0xd2, 0x30);
	GC2145_write_cmos_sensor(0xd3, 0x45);
	...
	///////////////////////////////////////////////
	///////////////// 2145 LSC SET 0.8  2014-05-10////////////////
	///////////////////////////////////////////////
	GC2145_write_cmos_sensor(0xfe ,0x01);
	GC2145_write_cmos_sensor(0xa1 ,0x80);  // center_row
	GC2145_write_cmos_sensor(0xa2 ,0x80);  // center_col
	GC2145_write_cmos_sensor(0xa4 ,0x00);  // sign of b1
	GC2145_write_cmos_sensor(0xa5 ,0x01);  // sign of b1
	GC2145_write_cmos_sensor(0xa6 ,0x30);  // sign of b4
	GC2145_write_cmos_sensor(0xa7 ,0x07);  // sign of b4
	GC2145_write_cmos_sensor(0xa8 ,0x77);  // sign of b22
	GC2145_write_cmos_sensor(0xa9 ,0x07);  // sign of b22
	GC2145_write_cmos_sensor(0xaa ,0x40);  // Q1_b1 of R
	GC2145_write_cmos_sensor(0xab ,0x29);  // Q1_b1 of G
	GC2145_write_cmos_sensor(0xac ,0x19);  // Q1_b1 of B
	GC2145_write_cmos_sensor(0xad ,0x40);  // Q2_b1 of R
	GC2145_write_cmos_sensor(0xae ,0x34);  // Q2_b1 of G
	GC2145_write_cmos_sensor(0xaf ,0x3a);  // Q2_b1 of B
	GC2145_write_cmos_sensor(0xb0 ,0x09);  // Q3_b1 of R
	GC2145_write_cmos_sensor(0xb1 ,0x14);  // Q3_b1 of G
	GC2145_write_cmos_sensor(0xb2 ,0x0f);  // Q3_b1 of B
	GC2145_write_cmos_sensor(0xb3 ,0x10);  // Q4_b1 of R
	GC2145_write_cmos_sensor(0xb4 ,0x03);  // Q4_b1 of G
	GC2145_write_cmos_sensor(0xb5 ,0x02);  // Q4_b1 of B
	GC2145_write_cmos_sensor(0xb6 ,0x46);//40  // right_b2 of R
	GC2145_write_cmos_sensor(0xb7 ,0x3c);  // right_b2 of G
	GC2145_write_cmos_sensor(0xb8 ,0x3c);//40  // right_b2 of B
	GC2145_write_cmos_sensor(0xb9 ,0x2b);  // right_b4 of R
	GC2145_write_cmos_sensor(0xba ,0x00);  // right_b4 of G
	GC2145_write_cmos_sensor(0xbb ,0x00);  // right_b4 of B
	GC2145_write_cmos_sensor(0xbc ,0x1f);  // left_b2 of R
	GC2145_write_cmos_sensor(0xbd ,0x0e);  // left_b2 of G
	GC2145_write_cmos_sensor(0xbe ,0x0c);  // left_b2 of B
	GC2145_write_cmos_sensor(0xbf ,0x40);  // left_b4 of R
	GC2145_write_cmos_sensor(0xc0 ,0x40);  // left_b4 of G
	GC2145_write_cmos_sensor(0xc1 ,0x40);  // left_b4 of B
	GC2145_write_cmos_sensor(0xc2 ,0x25);  // up_b2 of R
	GC2145_write_cmos_sensor(0xc3 ,0x1a);  // up_b2 of G
	GC2145_write_cmos_sensor(0xc4 ,0x16);  // up_b2 of B
	GC2145_write_cmos_sensor(0xc5 ,0x35);  // up_b4 of R
	GC2145_write_cmos_sensor(0xc6 ,0x35);  // up_b4 of G
	GC2145_write_cmos_sensor(0xc7 ,0x40);  // up_b4 of B
	GC2145_write_cmos_sensor(0xc8 ,0x3c);  // down_b2 of R
	GC2145_write_cmos_sensor(0xc9 ,0x22);  // down_b2 of G
	GC2145_write_cmos_sensor(0xca ,0x2b);  // down_b2 of B
	GC2145_write_cmos_sensor(0xcb ,0x29);  // down_b4 of R
	GC2145_write_cmos_sensor(0xcc ,0x06);  // down_b4 of G
	GC2145_write_cmos_sensor(0xcd ,0x20);  // down_b4 of B
	GC2145_write_cmos_sensor(0xd0 ,0x3f);  // right_up_b22 of R
	GC2145_write_cmos_sensor(0xd1 ,0x3f);  // right_up_b22 of G
	GC2145_write_cmos_sensor(0xd2 ,0x2f);  // right_up_b22 of B
	GC2145_write_cmos_sensor(0xd3 ,0x3f);  // right_down_b22 of R
	GC2145_write_cmos_sensor(0xd4 ,0x2e);  // right_down_b22 of G
	GC2145_write_cmos_sensor(0xd5 ,0x20);  // right_down_b22 of B
	GC2145_write_cmos_sensor(0xd6 ,0x40);  // left_up_b22 of R
	GC2145_write_cmos_sensor(0xd7 ,0x40);  // left_up_b22 of G
	GC2145_write_cmos_sensor(0xd8 ,0x40);  // left_up_b22 of B
	GC2145_write_cmos_sensor(0xd9 ,0x35);  // left_down_b22 of R
	GC2145_write_cmos_sensor(0xda ,0x3f);  // left_down_b22 of G
	GC2145_write_cmos_sensor(0xdb ,0x3f);  // left_down_b22 of B
	GC2145_write_cmos_sensor(0xfe ,0x00);
	...
	GC2145_write_cmos_sensor(0x28, 0xe2);
	GC2145_write_cmos_sensor(0x29, 0x05);
	GC2145_write_cmos_sensor(0x2a, 0xdc);
	GC2145_write_cmos_sensor(0x2b, 0x06);
	GC2145_write_cmos_sensor(0x2c, 0xd6);
	GC2145_write_cmos_sensor(0x2d, 0x0b);
	GC2145_write_cmos_sensor(0x2e, 0xb8);
	GC2145_write_cmos_sensor(0xfe, 0x00);
}
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_YUYV;//SENSOR_OUTPUT_FORMAT_YUYV SENSOR_OUTPUT_FORMAT_YVYU SENSOR_OUTPUT_FORMAT_VYUY SENSOR_OUTPUT_FORMAT_UYVY
...
BOOL GC2145_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145_write_cmos_sensor(0x27, 0x04);
		GC2145_write_cmos_sensor(0x28, 0xf8); //30fps 00
		GC2145_write_cmos_sensor(0x29, 0x08);
		GC2145_write_cmos_sensor(0x2a, 0x48); // 20fps 01
		GC2145_write_cmos_sensor(0x2b, 0x0b);
		GC2145_write_cmos_sensor(0x2c, 0x98); //15fps  10
		GC2145_write_cmos_sensor(0x2d, 0x0f);
		GC2145_write_cmos_sensor(0x2e, 0xbc); //10fps 11
		GC2145_write_cmos_sensor(0xfe, 0x00);
            break;
...
BOOL GC2145_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0x30);
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2145_SET_PAGE1;
