...
HM5065MIPI_write_cmos_sensor(0x00B2,0x50);// 4e->50 by jink 20131202       // set PLL output 713MHz
HM5065MIPI_write_cmos_sensor(0x00B3,0x80);// ca->80 by jink 20131202
HM5065MIPI_write_cmos_sensor(0x00B4,0x01);//         // E_div
HM5065MIPI_write_cmos_sensor(0x00B5,0x02);//01=>02 by jink 20131202         // PLL3_div 2
...
HM5065MIPI_write_cmos_sensor(0x019D,0x20);// c0->20 by jink 20131202
...
// SetPeakingControl
HM5065MIPI_write_cmos_sensor(0x004C,0x0a);//  PipeSetupBank0 fPeakingGain 08->0a by jink 20131202
...
HM5065MIPI_write_cmos_sensor(0x004A,0x0e);//  PipeSetupBank0 bGammaInterpolationGain 0d->0e by jink 20131202
HM5065MIPI_write_cmos_sensor(0x0069,0x14);//  PipeSetupBank1 bGammaGain 
HM5065MIPI_write_cmos_sensor(0x006A,0x0e);//  PipeSetupBank1 bGammaInterpolationGain 0d->0e by jink 20131202
...
HM5065MIPI_write_cmos_sensor(0x0098,0x01);//   // GammaGainDamperControl fDisable {CompiledExposureTime} 00->01 by jink 20131202
...
HM5065MIPI_write_cmos_sensor(0x00A8,0x01);//  GammaInterpolationDamperControl fDisable {CompiledExposureTime} 00->01 by jink 20131202
...
UINT32 HM5065MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			pSensorInfo->SensorClockFreq=26;//24->26 by jink 20131202
...
void HM5065MIPI_set_iso(UINT16 para)
{
	...
	HM5065MIPI_write_cmos_sensor(0x02C3, 0x80);
			...
			case AE_ISO_AUTO:
				 //ISO Auto
	HM5065MIPI_write_cmos_sensor(0x015C, 0x3e);//40->3e by jink 20131202
	HM5065MIPI_write_cmos_sensor(0x015D, 0x00);
	HM5065MIPI_write_cmos_sensor(0x015E, 0x40);
	HM5065MIPI_write_cmos_sensor(0x015F, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C0, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C1, 0x00);//c0->00 by jink 20131202
	HM5065MIPI_write_cmos_sensor(0x02C2, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C3, 0xC0);
				 break; 
		}	
