 ...
 * Revision 1.1  2013/09/04 07:12:56  pengyajun
 * E700S
 *
...
void GC0329_Write_More_Registers(void)
{
	...
	///////////////////////////////////////////////
       ...
       GC0329_write_cmos_sensor(0xfe,0x00);																																																																									
	GC0329_write_cmos_sensor(0x7a,0x84);		//r ratio																																																																							
	GC0329_write_cmos_sensor(0x7b,0x7c);
	GC0329_write_cmos_sensor(0x7c,0x7a);
}
