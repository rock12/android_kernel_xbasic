...
////AWB//
	...
	GC0328_write_cmos_sensor(0x23 , 0x04);//06    
	//GC0328_write_cmos_sensor(0x24 , 0x11);//pclk 4ma
	GC0328_write_cmos_sensor(0x24 , 0x17);//pclk 10ma//data 4ma modified 0701    
  ...
  GC0328_write_cmos_sensor(0x44 , 0x02);
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x28);//0x2d
	GC0328_write_cmos_sensor(0xd2 , 0x28);
	GC0328_write_cmos_sensor(0xd3 , 0x3a);//0x3c
	...
	///cct       
	GC0328_write_cmos_sensor(0xB1 , 0x00);  //0x00 
	GC0328_write_cmos_sensor(0xB2 , 0xfd);   
	GC0328_write_cmos_sensor(0xB3 , 0x08); //0x07  
...
BOOL GC0328_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			//GC0328_write_cmos_sensor(0x24 , 0x17);//pclk 10ma//data 4ma
		break;
		...
		case AWB_MODE_DAYLIGHT: //sunny
			...
			GC0328_write_cmos_sensor(0x79, 0x40);
			//GC0328_write_cmos_sensor(0x24 , 0x13);//pclk 10ma			
		break;
		...
		case AWB_MODE_INCANDESCENT: //office
			...
			//GC0328_write_cmos_sensor(0x24 , 0x12);//pclk 8ma//data 4ma
		break;
		...
		case AWB_MODE_FLUORESCENT:
			...
			//GC0328_write_cmos_sensor(0x24 , 0x16);//pclk 8ma//data 10ma
		break;
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x31, 0x04);   //exp level 3  7.14fps
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2e, 0xee); 
