 ...
 * Revision 1.1  2013/09/23 10:41:37  wangqiang
...
#else		
	GC0328_write_cmos_sensor(0x17 , 0x14);    //mirror
#endif		
...
#else
  GC0328_write_cmos_sensor(0x44 , 0x00);
#endif
	...
	GC0328_write_cmos_sensor(0x81 , 0x16);    
	...
	GC0328_write_cmos_sensor(0xd3 , 0x42);
	...
	GC0328_write_cmos_sensor(0xB3 , 0xfe); //0xfc  
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x2f, 0x05);   //exp level 2  10.00fps
			GC0328_write_cmos_sensor(0x30, 0x40); //3c0
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x32, 0x50); //hyper
			GC0328_SET_PAGE0;
		break;
		default:
		return FALSE;
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_03:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x8b);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
