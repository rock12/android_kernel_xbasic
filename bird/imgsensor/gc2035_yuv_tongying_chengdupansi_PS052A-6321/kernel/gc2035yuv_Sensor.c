...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x1f , 0xb0);//max_post_gain c0 betty
	GC2035_write_cmos_sensor(0x20 , 0x50);//max_pre_gain 60 betty
	...
	GC2035_write_cmos_sensor(0x87 , 0xb0); //[7]middle gamma 90 betty
...
GC2035_write_cmos_sensor(0xb1 , 0x1c);
GC2035_write_cmos_sensor(0xb2 , 0x1b);
GC2035_write_cmos_sensor(0xb3 , 0x1d);
...
GC2035_write_cmos_sensor(0xa6 , 0x40);
...
GC2035_write_cmos_sensor(0x4e , 0x04);  //d65 
GC2035_write_cmos_sensor(0x4e , 0x00);   
GC2035_write_cmos_sensor(0x4e , 0x00);
GC2035_write_cmos_sensor(0x4e , 0x00);
GC2035_write_cmos_sensor(0x4e , 0x00);
...
GC2035_write_cmos_sensor(0x4e , 0x00);  
GC2035_write_cmos_sensor(0x4e , 0x00);  
GC2035_write_cmos_sensor(0x4e , 0x10);  //tl84 ok
...
GC2035_write_cmos_sensor(0x4e , 0x40);  //h
...
GC2035_write_cmos_sensor(0x4f , 0x01);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x40);//saturation_cb
...
static void GC2035_Sensor_SVGA(void)
{
	...
	GC2035_write_cmos_sensor(0x9a,0x06); // 07
