...
S5K4ECGX_MIPI_AE_Dump_WeightTbl(void)
{
    ...
    {
        SENSORDB("[4EC] AETbl SW_Tbl[%d~%d]: %x, %x, %x, %x\n", offset, offset+3,
    ...
    unsigned int prevH)
{
    ...
    SENSORDB("[4EC] AE_Set_Window 3AWin: (%d,%d)~(%d,%d), (%d,%d)\n",x0, y0, x1, y1, srcW, srcH);
    ...
    S5K4ECGX_Driver.apAEWindows[5] = srcW;
    S5K4ECGX_Driver.apAEWindows[6] = srcH;
    spin_unlock(&s5k4ecgx_mipi_drv_lock);


    if ((srcW == 0) || (srcW > prevW))
    {
        srcW = 320;
    }

    if ((srcH == 0)||(srcH > prevH))
    {
         srcH = 240;
    }    
    ...
    unsigned int prevH)
{
    ...
    unsigned int caf_same_win_size = 0; 
    ...
    if ((x1 < x0) || (y1 < y0))
    {
       return S5K4ECGX_AAA_AF_STATUS_BAD_PARA;   
    }
    ...
    else if (S5K4ECGX_AF_MODE_CONTINUOUS == S5K4ECGX_Driver.afMode)
    {
       //check if the window size is the same? 
       //if the window is not a point, it means UI is at Face AF state.
       //We need to achieve that DON' DO AF if the face is at the same depth.        
       //Thus we check the Face window size to detect if the face is at the same depth or not.
       width  = x1 - x0;
       height = y1 - y0;
       if ((S5K4ECGX_Driver.prevAfWinWidth == width) &&
           (S5K4ECGX_Driver.prevAfWinHeight == height))
       {
          caf_same_win_size = 1;
       }
    }
    S5K4ECGX_Driver.prevAfWinWidth = width;
    S5K4ECGX_Driver.prevAfWinHeight = height;
    spin_unlock(&s5k4ecgx_mipi_drv_lock);

    SENSORDB("[4EC] AF_Set_Window AP's setting: (%d,%d)~(%d,%d) FaceWinSize:(%d,%d).size:(%d,%d)\n",x0, y0, x1, y1,width, height, FD_XS, FD_YS);

    if (caf_same_win_size == 1)
    {
        SENSORDB("[4EC] AF_Set_Window: caf_same_win_size:True*******\n");
        return S5K4ECGX_AAA_AF_STATUS_OK;
    }
...
S5K4ECGX_MIPI_AF_Start(S5K4ECGX_AF_MODE_ENUM mode)
{
    ...
    if (mode == S5K4ECGX_AF_MODE_SINGLE)
    {
        ...
        S5K4ECGX_Driver.prevAfWinWidth = 0;
        S5K4ECGX_Driver.prevAfWinHeight = 0;
    }
    else
    {
...
static void S5K4ECGX_MIPI_Init_Setting(void)
{
    ...
    //==================================================================================
             0x002A,  0x0734,
             0x0F12,  0x0001,   //0000  //saRR_usDualGammaLutRGBIndoor[0][0]
             0x0F12,  0x0007,   //000A  //saRR_usDualGammaLutRGBIndoor[0][1]
             0x0F12,  0x0010,   //0016  //saRR_usDualGammaLutRGBIndoor[0][2]
             0x0F12,  0x0028,   //0030  //saRR_usDualGammaLutRGBIndoor[0][3]
             0x0F12,  0x0062,   //0066  //saRR_usDualGammaLutRGBIndoor[0][4]
             0x0F12,  0x00D3,   //00D5  //saRR_usDualGammaLutRGBIndoor[0][5]
             0x0F12,  0x0130,   //0138  //saRR_usDualGammaLutRGBIndoor[0][6]
             0x0F12,  0x0158,   //0163  //saRR_usDualGammaLutRGBIndoor[0][7]
             0x0F12,  0x017D,   //0189  //saRR_usDualGammaLutRGBIndoor[0][8]
             0x0F12,  0x01BE,   //01C6  //saRR_usDualGammaLutRGBIndoor[0][9]
             0x0F12,  0x01E2,   //01F8  //saRR_usDualGammaLutRGBIndoor[0][10]
             0x0F12,  0x020D,   //0222  //saRR_usDualGammaLutRGBIndoor[0][11]
             0x0F12,  0x023D,   //0247  //saRR_usDualGammaLutRGBIndoor[0][12]
             0x0F12,  0x0279,   //0282  //saRR_usDualGammaLutRGBIndoor[0][13]
             0x0F12,  0x02C1,   //02B5  //saRR_usDualGammaLutRGBIndoor[0][14]
             0x0F12,  0x0320,   //030F  //saRR_usDualGammaLutRGBIndoor[0][15]
             0x0F12,  0x0378,   //035F  //saRR_usDualGammaLutRGBIndoor[0][16]
             0x0F12,  0x03C6,   //03A2  //saRR_usDualGammaLutRGBIndoor[0][17]
             0x0F12,  0x03E9,   //03D8  //saRR_usDualGammaLutRGBIndoor[0][18]
             0x0F12,  0x03F9,   //03FF  //saRR_usDualGammaLutRGBIndoor[0][19]
             0x0F12,  0x0001,   //0000  //saRR_usDualGammaLutRGBIndoor[1][0]
             0x0F12,  0x0007,   //000A  //saRR_usDualGammaLutRGBIndoor[1][1]
             0x0F12,  0x0010,   //0016  //saRR_usDualGammaLutRGBIndoor[1][2]
             0x0F12,  0x0028,   //0030  //saRR_usDualGammaLutRGBIndoor[1][3]
             0x0F12,  0x0062,   //0066  //saRR_usDualGammaLutRGBIndoor[1][4]
             0x0F12,  0x00D3,   //00D5  //saRR_usDualGammaLutRGBIndoor[1][5]
             0x0F12,  0x0130,   //0138  //saRR_usDualGammaLutRGBIndoor[1][6]
             0x0F12,  0x0158,   //0163  //saRR_usDualGammaLutRGBIndoor[1][7]
             0x0F12,  0x017D,   //0189  //saRR_usDualGammaLutRGBIndoor[1][8]
             0x0F12,  0x01BE,   //01C6  //saRR_usDualGammaLutRGBIndoor[1][9]
             0x0F12,  0x01F8,   //01F8  //saRR_usDualGammaLutRGBIndoor[1][10]
             0x0F12,  0x022C,   //0222  //saRR_usDualGammaLutRGBIndoor[1][11]
             0x0F12,  0x025B,   //0247  //saRR_usDualGammaLutRGBIndoor[1][12]
             0x0F12,  0x02AA,   //0282  //saRR_usDualGammaLutRGBIndoor[1][13]
             0x0F12,  0x02EC,   //02B5  //saRR_usDualGammaLutRGBIndoor[1][14]
             0x0F12,  0x034E,   //030F  //saRR_usDualGammaLutRGBIndoor[1][15]
             0x0F12,  0x0396,   //035F  //saRR_usDualGammaLutRGBIndoor[1][16]
             0x0F12,  0x03C6,   //03A2  //saRR_usDualGammaLutRGBIndoor[1][17]
             0x0F12,  0x03E9,   //03D8  //saRR_usDualGammaLutRGBIndoor[1][18]
             0x0F12,  0x03F9,   //03FF  //saRR_usDualGammaLutRGBIndoor[1][19]
             0x0F12,  0x0001,   //0000  //saRR_usDualGammaLutRGBIndoor[2][0]
             0x0F12,  0x0007,   //000A  //saRR_usDualGammaLutRGBIndoor[2][1]
             0x0F12,  0x0010,   //0016  //saRR_usDualGammaLutRGBIndoor[2][2]
             0x0F12,  0x0028,   //0030  //saRR_usDualGammaLutRGBIndoor[2][3]
             0x0F12,  0x0062,   //0066  //saRR_usDualGammaLutRGBIndoor[2][4]
             0x0F12,  0x00D3,   //00D5  //saRR_usDualGammaLutRGBIndoor[2][5]
             0x0F12,  0x0130,   //0138  //saRR_usDualGammaLutRGBIndoor[2][6]
             0x0F12,  0x0158,   //0163  //saRR_usDualGammaLutRGBIndoor[2][7]
             0x0F12,  0x017D,   //0189  //saRR_usDualGammaLutRGBIndoor[2][8]
             0x0F12,  0x01BE,   //01C6  //saRR_usDualGammaLutRGBIndoor[2][9]
             0x0F12,  0x01F8,   //01F8  //saRR_usDualGammaLutRGBIndoor[2][10]
             0x0F12,  0x022C,   //0222  //saRR_usDualGammaLutRGBIndoor[2][11]
             0x0F12,  0x025B,   //0247  //saRR_usDualGammaLutRGBIndoor[2][12]
             0x0F12,  0x02AA,   //0282  //saRR_usDualGammaLutRGBIndoor[2][13]
             0x0F12,  0x02EC,   //02B5  //saRR_usDualGammaLutRGBIndoor[2][14]
             0x0F12,  0x0334,   //030F  //saRR_usDualGammaLutRGBIndoor[2][15]
             0x0F12,  0x036C,   //035F  //saRR_usDualGammaLutRGBIndoor[2][16]
             0x0F12,  0x039C,   //03A2  //saRR_usDualGammaLutRGBIndoor[2][17]
             0x0F12,  0x03C8,   //03D8  //saRR_usDualGammaLutRGBIndoor[2][18]
             0x0F12,  0x03F9,   //03FF  //saRR_usDualGammaLutRGBIndoor[2][19]
    ...
    //==================================================================================
             ...
             0x0F12, 0xFFF0, //70000990//AFIT16_SATURATION 0x0000
             ...
             0x0F12, 0x1018, //70000A26//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
             0x0F12, 0xa040, //70000A28//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
             0x0F12, 0x2028, //70000A2A//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
             ...
             0x0F12, 0x0805, //70000ADC//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
             0x0F12, 0xa040, //70000ADE//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
             ...
             0x0F12, 0x4628, //70000B4E//AFIT8_ee_iSmoothEdgeThres   [7:0] AFIT8_ee_iMSharpen
             0x0F12, 0x043C, //70000B50//AFIT8_ee_iWSharpen [7:0] AFIT8_ee_iMShThresh
             ...
             0x0F12, 0x0808, //70000B92//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
             0x0F12, 0xc060, //70000B94//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
             0x0F12, 0x0808, //70000B96//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
             ...
             0x0F12, 0x5A28, //70000C04//AFIT8_ee_iSmoothEdgeThres   [7:0] AFIT8_ee_iMSharpen
             0x0F12, 0x044E, //70000C06//AFIT8_ee_iWSharpen [7:0] AFIT8_ee_iMShThresh
             ...
             0x0F12, 0x0505, //70000C48//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
             0x0F12, 0xc060, //70000C4A//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
             0x0F12, 0x0505, //70000C4C//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
             ...
             0x0F12, 0x6428, //70000CBA//AFIT8_ee_iSmoothEdgeThres   [7:0] AFIT8_ee_iMSharpen
             0x0F12, 0x0450, //70000CBC//AFIT8_ee_iWSharpen [7:0] AFIT8_ee_iMShThresh
             ...
             0x0F12, 0x0404, //70000CFE//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
             0x0F12, 0xc060, //70000D00//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
             0x0F12, 0x0404, //70000D02//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
...
//    S5K4ECGX_MIPI_HVMirror(IMAGE_HV_MIRROR);
    return;
}
...
*/
        S5K4ECGX_write_cmos_sensor(0x002E,0x0230);//id register
       brightness = S5K4ECGX_read_cmos_sensor(0x0F12);
...
void S5K4ECGX_MIPI_set_saturation(UINT16 para)
{
    ...
    S5K4ECGX_write_cmos_sensor(0x002A ,0x0234);
     S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0000);  //REG_TC_UserSaturation//40
/*
    S5K4ECGX_write_cmos_sensor(0x002A ,0x0230);    //brightness
    S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0000);
    
    S5K4ECGX_write_cmos_sensor(0x002A ,0x0236);    //sharpness
    S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0000);

    S5K4ECGX_write_cmos_sensor(0x002A ,0x0238);    //glamour
    S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0000);
*/
	/*
    switch (para)
