...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	GC2035_write_cmos_sensor(0x81 , 0x24);//38 , 0x//skin_Y 8c_debug
	...
	GC2035_write_cmos_sensor(0xc3 , 0x08);//0d
	...
	GC2035_write_cmos_sensor(0xbc , 0x14);//0c
	GC2035_write_cmos_sensor(0xbd , 0x19);//1f
	GC2035_write_cmos_sensor(0xbe , 0x24);//11
	GC2035_write_cmos_sensor(0xb6 , 0x16);//2e
	GC2035_write_cmos_sensor(0xb7 , 0x0b);
	GC2035_write_cmos_sensor(0xb8 , 0x08);//14
	...
	GC2035_write_cmos_sensor(0xbf , 0x14);//1e
	GC2035_write_cmos_sensor(0xc0 , 0x00);//05
	GC2035_write_cmos_sensor(0xc1 , 0x08);//00
	GC2035_write_cmos_sensor(0xb9 , 0x10);//1d
	GC2035_write_cmos_sensor(0xba , 0x00);//09
	GC2035_write_cmos_sensor(0xbb , 0x00);//07
	GC2035_write_cmos_sensor(0xaa , 0x04);
	GC2035_write_cmos_sensor(0xab , 0x05);//00
	...
	GC2035_write_cmos_sensor(0xb4 , 0x05);//00
	GC2035_write_cmos_sensor(0xb5 , 0x09);
	GC2035_write_cmos_sensor(0xd0 , 0x0b);
	GC2035_write_cmos_sensor(0xd2 , 0x04);//00
	...
	GC2035_write_cmos_sensor(0xd6 , 0x04);//00
	...
	GC2035_write_cmos_sensor(0xfe , 0x00);
	GC2035_write_cmos_sensor(0x81 , 0x24);//0x26 hyper
	GC2035_write_cmos_sensor(0xfe , 0x02);
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x87 , 0x20);
	GC2035_write_cmos_sensor(0x88 , 0x16);//dn_b_base 0x1f
	...
	GC2035_write_cmos_sensor(0x97 , 0x45);// edge effect 45 betty
	////==============RGB Gamma 
#if 0
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x7a);//80
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
