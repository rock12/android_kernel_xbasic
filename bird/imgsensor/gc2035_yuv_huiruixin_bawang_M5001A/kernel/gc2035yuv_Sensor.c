 ...
 * Revision 1.2  2013/11/08 02:16:41  lijunchao
 * no message
 *
 * Revision 1.1  2013/10/17 07:56:31  lijunchao
 * no message
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf7 , 0x15); //pll enable
  	GC2035_write_cmos_sensor(0xf8 , 0x83);//84 20131211 laidian ganrao seaser
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x24 , 0x17); //pad drive  16 changxian laidian ganrao 20131211 seaser
	...
	*/
	...
	GC2035_write_cmos_sensor(0xd3 , 0x3b);//contrast \D3
	...
	GC2035_write_cmos_sensor(0x97 , 0x45);// edge effect 45 betty//54
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	#ifdef BIRD_13C43_S100
		pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_4MA;
	#else
		pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;//ISP_DRIVING_4MA 201311211 seaser
	#endif
