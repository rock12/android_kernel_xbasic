...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0xb3, 0x3d);///////44
	...
	GC0329_write_cmos_sensor(0x66, 0xea);//fa
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x5d,0x12);																																																																									
	GC0329_write_cmos_sensor(0x67,0x70);//80																																																																									
	...
	GC0329_write_cmos_sensor(0xd1,0x2d);	//34																																																																								
	GC0329_write_cmos_sensor(0xd2,0x2d);		//34																																																																						
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
...
*/
			...
			GC0329_write_cmos_sensor(0x2f, 0x05);   //exp level 2  10.00fps/////3c0
			GC0329_write_cmos_sensor(0x30, 0x40); 
			GC0329_write_cmos_sensor(0x31, 0x07);   //exp level 3  7.14fps  ////540
