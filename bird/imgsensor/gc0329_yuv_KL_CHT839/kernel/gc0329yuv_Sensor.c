 ...
 * Revision 1.2  2013/10/22 09:25:27  xialeijie
 * no message
 *
 * Revision 1.1  2013/09/23 12:42:06  wangdong
 * no message
 *
 * Revision 1.2  2013/07/18 03:37:22  wangqiang
 * 编译错误
 *
 * Revision 1.1  2013/07/17 10:12:45  wangqiang
 * no message
 *
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m4);// m1
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x1f, 0xc8);//c0
	...
	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x95, 0x33);
	...
	GC0329_write_cmos_sensor(0xb3, 0x44);//44//40
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x37);	//34																																																																								
	GC0329_write_cmos_sensor(0xd2,0x37);	//34
...
////analog//
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0x1e, 0x08);  //08//08
	GC0329_write_cmos_sensor(0x20, 0x00); //00//08
////blk///
	GC0329_write_cmos_sensor(0x29, 0x80); 
	GC0329_write_cmos_sensor(0x33, 0x20);
	GC0329_write_cmos_sensor(0x34, 0x20);
	...
	GC0329_write_cmos_sensor(0x36, 0x20);
///////dndd//// 
	GC0329_write_cmos_sensor(0x82, 0x55);   ///0e//  55//10
	GC0329_write_cmos_sensor(0x83, 0x03);  // add by lanking 20120423//00
////intpee//
  GC0329_write_cmos_sensor(0x95, 0x33);  //   54 /74
  GC0329_write_cmos_sensor(0x96, 0x75);  //   88
///aec//////
	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x12, 0x17);  //17// 07 
	GC0329_write_cmos_sensor(0x15, 0xf2);  /// f2
	GC0329_write_cmos_sensor(0x21, 0xe8);  
	GC0329_write_cmos_sensor(0x22, 0x4a);   /// 48
	GC0329_write_cmos_sensor(0x3c, 0xe0);  /// 95
	GC0329_write_cmos_sensor(0x3d, 0x60);  /// 50
	GC0329_write_cmos_sensor(0x3e, 0x60);  /// 48
	////////////////////ABS////////////////////
	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x9c, 0x00);   ////  02 /01//02
	GC0329_write_cmos_sensor(0x9d, 0x10);
//色彩，肤色
///////cc/////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xb3, 0x46);  ///  44   
	GC0329_write_cmos_sensor(0xb4, 0xfe);  // fd4
	GC0329_write_cmos_sensor(0xb5, 0x00);   /// 02
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x42);  /// 48
...
//////awb//////
	...
	GC0329_write_cmos_sensor(0x51, 0x18);  // 28   10/////////  0e
	GC0329_write_cmos_sensor(0x52, 0x10);  /// 0b   10
	GC0329_write_cmos_sensor(0x53, 0x20);  /// 38/////////  3c
	GC0329_write_cmos_sensor(0x54, 0x40);  /// 48//////////////  4a
	...
	GC0329_write_cmos_sensor(0x68, 0x58);  ///// 58
	GC0329_write_cmos_sensor(0x69, 0x80);  // 85
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0xee); 
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps  465
			GC0329_write_cmos_sensor(0x30, 0xcf); 
			GC0329_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
			GC0329_write_cmos_sensor(0x32, 0xdc); 
			GC0329_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x30, 0xa0); 
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x78:0x58);// 50
