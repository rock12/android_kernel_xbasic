 ...
 * Revision 1.3  2013/08/15 12:56:55  wangqiang
 * 13C43_45C
 * 0328优化效果
 *
 * Revision 1.1  2013/07/16 01:15:56  lijunchao
 * commit gc0328 yuv jinlangxin for T56A
 *
 * Revision 1.5  2013/07/11 00:38:06  birdlibo
 * no message
 *
 * Revision 1.4  2013/06/28 08:27:21  lanqilong
 * Editor: lanqilong
 * Inspector:lanqilong
 * Reason:13E35_X5 camera 预览暗，夜景模式不明显已改好
 * Reference:none
 *
 * Revision 1.3  2013/06/25 07:28:45  maliejun
 * 刚进入时绿屏问题
 *
 * Revision 1.2  2013/06/21 06:33:01  shenruxuan
 * no message
 *
 * Revision 1.1  2013/06/03 11:27:53  maliejun
 * 13E35_X5 Driver
 *
 * Revision 1.1  2013/05/23 03:38:13  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.3  2013/04/03 04:30:04  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 i9
 * Author:Huangwenjian
 *
 * Revision 1.2  2013/04/02 13:24:15  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 i9
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/04/02 03:03:50  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 i9
 * Author:Huangwenjian
 *
 * Revision 1.2  2013/04/02 02:50:58  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 i9
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/03/28 12:54:51  huangwenjian
 * Bug[none]
 *
 * Reason:12y36 i9
 * Author:Huangwenjian
...
void GC0328NightMode(kal_bool bEnable)
{
	...
	{	
		...
		GC0328_write_cmos_sensor(0x22 , 0x90);	
		GC0328_write_cmos_sensor(0xfe, 0x00);		
...
void GC0328_Sensor_Init(void)
	{
		...
		GC0328_write_cmos_sensor(0x76 , 0x00);   //move mode en,Move mode TH
		GC0328_write_cmos_sensor(0x79 , 0x20);    //use old
	...
	*/
    ...
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror
...
#else		
		GC0328_write_cmos_sensor(0x17 , 0x14);//17
#endif	
		...
		GC0328_write_cmos_sensor(0x24 , 0x17);
		...
		GC0328_write_cmos_sensor(0x44 , 0x00); //YUV format
		...
		GC0328_write_cmos_sensor(0x82 , 0x15);//85 8f
		...
		GC0328_write_cmos_sensor(0x95 , 0x63);//43 44
		
		
		///////YCP
		GC0328_write_cmos_sensor(0xd1 , 0x28);//38 30
		GC0328_write_cmos_sensor(0xd2 , 0x28);
		GC0328_write_cmos_sensor(0xd3 , 0x3c);// 40
		...
		///////////////////////////////////////
		GC0328_write_cmos_sensor(0xfe , 0x01);
		GC0328_write_cmos_sensor(0x9c , 0x02);//02 03
		...
		GC0328_write_cmos_sensor(0x13 , 0x45);
		...
		//GC0328_write_cmos_sensor(0x28 , 0x0a);
			...
			GC0328_write_cmos_sensor(0x2b, 0x03);   //exp level 0  14.28fps
			GC0328_write_cmos_sensor(0x2c, 0xc0); 
			GC0328_write_cmos_sensor(0x2d, 0x04);   //exp level 1  12.50fps
			GC0328_write_cmos_sensor(0x2e , 0x20); //2c 600
			GC0328_write_cmos_sensor(0x2f , 0x05); //1650
			GC0328_write_cmos_sensor(0x30 , 0x40);
			GC0328_write_cmos_sensor(0x31 , 0x07); // 1800
			GC0328_write_cmos_sensor(0x32 , 0xe0);
		...
		GC0328_write_cmos_sensor(0xfe , 0x00);
	    GC0328_write_cmos_sensor(0x70 , 0x45);  //global gain tim
...
{
	GC0328_write_cmos_sensor(0xfe , 0x00);//ratio
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x06, 0x2c); 
			GC0328_write_cmos_sensor(0x07, 0x00);
			GC0328_write_cmos_sensor(0x08, 0x98);
			
			GC0328_SET_PAGE1;
			GC0328_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0328_write_cmos_sensor(0x2a, 0x50);   //anti-flicker step [7:0]
			
			GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0328_write_cmos_sensor(0x2c, 0x80); 
			...
			GC0328_write_cmos_sensor(0x30, 0xb0); 
			GC0328_write_cmos_sensor(0x31, 0x07);   //exp level 0  7.05fps
			GC0328_write_cmos_sensor(0x32, 0x50); 
			GC0328_SET_PAGE0;
		break;
		default:
		return FALSE;
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, value_luma - 0x0f);//04
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, value_Y- 0x06);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
