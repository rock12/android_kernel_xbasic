 ...
 * Revision 1.1  2013/09/18 04:18:08  zhoushaohong
 * 13C43_C806
 *
 * Revision 1.1  2013/09/12 07:38:49  zhoushaohong
 * S100A
 *
 * Revision 1.3  2013/08/16 01:55:12  xialeijie
 * Editor: xialeijie
 * Inspector: xialeijie
 * Reaseon:
 * Reference:
 *
 * Revision 1.2  2013/08/16 01:48:38  xialeijie
 * no message
 *
 * Revision 1.1  2013/07/19 02:54:56  zhoushaohong
 * 13C43-BT45B
 *
...
static void GC2035_Sensor_Init(void)
{
  ...
  GC2035_write_cmos_sensor(0xf8 , 0x84);
	...
	//GC2035_write_cmos_sensor(0xad , 0x7e);
	//GC2035_write_cmos_sensor(0xae , 0x80);
	//GC2035_write_cmos_sensor(0xaf , 0x82);
	GC2035_write_cmos_sensor(0x03 , 0x02);
	GC2035_write_cmos_sensor(0x04 , 0x48);//2da
	...
	GC2035_write_cmos_sensor(0x20 , 0x50);//max_pre_gain
	...
	*/
	GC2035_write_cmos_sensor(0xfe, 0x00);  
		...
		GC2035_write_cmos_sensor(0x2e, 0xfc);  
	...
	GC2035_write_cmos_sensor(0xd5 , 0xf8);//luma_offset //00 betty
	...
	GC2035_write_cmos_sensor(0x97 , 0x54);// edge effect 45 betty//54
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
static void GC2035_Sensor_SVGA(void)
{
	...
	GC2035_write_cmos_sensor(0x9a,0x07);//07 betty
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x88);//84 betty
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x9c);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_07:
			GC2035_SET_PAGE1;
