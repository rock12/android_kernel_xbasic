...
void HM5065InitialSetting(void)
{
	...
	HM5065_write_cmos_sensor(0x0080,0x70);
...
HM5065_write_cmos_sensor(0x03E4 ,0xBC);
HM5065_write_cmos_sensor(0x03E5 ,0x70);
HM5065_write_cmos_sensor(0x03E6 ,0xBC);
HM5065_write_cmos_sensor(0x03E7 ,0x18);
HM5065_write_cmos_sensor(0x03E8 ,0xBB);
HM5065_write_cmos_sensor(0x03E9 ,0xD7);
HM5065_write_cmos_sensor(0x03EA ,0xBE);
HM5065_write_cmos_sensor(0x03EB ,0x0A);
HM5065_write_cmos_sensor(0x03F0 ,0xBA);
HM5065_write_cmos_sensor(0x03F1 ,0x7B);
HM5065_write_cmos_sensor(0x03F2 ,0xBA);
HM5065_write_cmos_sensor(0x03F3 ,0x83);
HM5065_write_cmos_sensor(0x03F4 ,0xBD);
HM5065_write_cmos_sensor(0x03F5 ,0x11);
HM5065_write_cmos_sensor(0x03F6 ,0xBC);
HM5065_write_cmos_sensor(0x03F7 ,0x7F);
HM5065_write_cmos_sensor(0x03F8 ,0xBB);
HM5065_write_cmos_sensor(0x03F9 ,0x23);
HM5065_write_cmos_sensor(0x03FA ,0xBD);
HM5065_write_cmos_sensor(0x03FB ,0xAC);
HM5065_write_cmos_sensor(0x0400 ,0xBA);
HM5065_write_cmos_sensor(0x0401 ,0xCD);
HM5065_write_cmos_sensor(0x0402 ,0xBA);
HM5065_write_cmos_sensor(0x0403 ,0x3D);
HM5065_write_cmos_sensor(0x0404 ,0xBE);
HM5065_write_cmos_sensor(0x0405 ,0x00);
HM5065_write_cmos_sensor(0x0406 ,0xBD);
HM5065_write_cmos_sensor(0x0407 ,0x33);
HM5065_write_cmos_sensor(0x0408 ,0xB8);
HM5065_write_cmos_sensor(0x0409 ,0x7B);
HM5065_write_cmos_sensor(0x040A ,0xBC);
HM5065_write_cmos_sensor(0x040B ,0xA4);
HM5065_write_cmos_sensor(0x0410 ,0xBB);
HM5065_write_cmos_sensor(0x0411 ,0x3E);
HM5065_write_cmos_sensor(0x0412 ,0xBA);
HM5065_write_cmos_sensor(0x0413 ,0x14);
HM5065_write_cmos_sensor(0x0414 ,0xBD);
HM5065_write_cmos_sensor(0x0415 ,0x9C);
HM5065_write_cmos_sensor(0x0416 ,0xBD);
HM5065_write_cmos_sensor(0x0417 ,0x38);
HM5065_write_cmos_sensor(0x0418 ,0xB7);
HM5065_write_cmos_sensor(0x0419 ,0x5C);
HM5065_write_cmos_sensor(0x041A ,0xBB);
HM5065_write_cmos_sensor(0x041B ,0x3A);
...
HM5065_write_cmos_sensor(0x04A0,0xFF);
HM5065_write_cmos_sensor(0x04A1,0x82);
HM5065_write_cmos_sensor(0x04A2,0x00);
HM5065_write_cmos_sensor(0x04A3,0x87);
HM5065_write_cmos_sensor(0x04A4,0x00);
HM5065_write_cmos_sensor(0x04A5,0xA0);
HM5065_write_cmos_sensor(0x04A6,0x00);
HM5065_write_cmos_sensor(0x04A7,0xAD);
HM5065_write_cmos_sensor(0x04A8,0xFE);
HM5065_write_cmos_sensor(0x04A9,0x6C);
HM5065_write_cmos_sensor(0x04AA,0x01);
HM5065_write_cmos_sensor(0x04AB,0x0B);
HM5065_write_cmos_sensor(0x04AC,0x00);
HM5065_write_cmos_sensor(0x04AD,0x46);
...
HM5065_write_cmos_sensor(0x04B3,0x1C);
HM5065_write_cmos_sensor(0x04B4,0x00);
HM5065_write_cmos_sensor(0x04B5,0xC0);
HM5065_write_cmos_sensor(0x04B6,0x00);
HM5065_write_cmos_sensor(0x04B7,0xD4);
HM5065_write_cmos_sensor(0x04B8,0xFF);
HM5065_write_cmos_sensor(0x04B9,0xE4);
HM5065_write_cmos_sensor(0x04BA,0x00);
HM5065_write_cmos_sensor(0x04BB,0x9D);
...
HM5065_write_cmos_sensor(0x04BF,0x19);
HM5065_write_cmos_sensor(0x04C0,0xFF);
HM5065_write_cmos_sensor(0x04C1,0x82);
HM5065_write_cmos_sensor(0x04C2,0x00);
HM5065_write_cmos_sensor(0x04C3,0x87);
HM5065_write_cmos_sensor(0x04C4,0x00);
HM5065_write_cmos_sensor(0x04C5,0xA0);
HM5065_write_cmos_sensor(0x04C6,0x00);
HM5065_write_cmos_sensor(0x04C7,0xAD);
HM5065_write_cmos_sensor(0x04C8,0xFE);
HM5065_write_cmos_sensor(0x04C9,0x6C);
HM5065_write_cmos_sensor(0x04CA,0x00);
HM5065_write_cmos_sensor(0x04CB,0x97);
HM5065_write_cmos_sensor(0x04CC,0xFF);
HM5065_write_cmos_sensor(0x04CD,0x5F);
...
HM5065_write_cmos_sensor(0x04CF,0x02);
HM5065_write_cmos_sensor(0x04D0,0xFF);
HM5065_write_cmos_sensor(0x04D1,0xAB);
HM5065_write_cmos_sensor(0x04D2,0x00);
HM5065_write_cmos_sensor(0x04D3,0x1E);
HM5065_write_cmos_sensor(0x04D4,0x00);
HM5065_write_cmos_sensor(0x04D5,0x77);
HM5065_write_cmos_sensor(0x04D6,0x00);
HM5065_write_cmos_sensor(0x04D7,0x7A);
HM5065_write_cmos_sensor(0x04D8,0xFF);
HM5065_write_cmos_sensor(0x04D9,0x84);
HM5065_write_cmos_sensor(0x04DA,0x00);
HM5065_write_cmos_sensor(0x04DB,0x02);
...
HM5065_write_cmos_sensor(0x04E0,0xFF);
HM5065_write_cmos_sensor(0x04E1,0xAD);
HM5065_write_cmos_sensor(0x04E2,0x00);
HM5065_write_cmos_sensor(0x04E3,0x1F);
HM5065_write_cmos_sensor(0x04E4,0x00);
HM5065_write_cmos_sensor(0x04E5,0x83);
HM5065_write_cmos_sensor(0x04E6,0x00);
HM5065_write_cmos_sensor(0x04E7,0x93);
HM5065_write_cmos_sensor(0x04E8,0xFC);
HM5065_write_cmos_sensor(0x04E9,0x04);
HM5065_write_cmos_sensor(0x04EA,0x00);
HM5065_write_cmos_sensor(0x04EB,0x39);
HM5065_write_cmos_sensor(0x04EC,0xFF);
HM5065_write_cmos_sensor(0x04ED,0x07);
HM5065_write_cmos_sensor(0x04EE,0x00);
HM5065_write_cmos_sensor(0x04EF,0x71);
HM5065_write_cmos_sensor(0x04F0,0xFF);
HM5065_write_cmos_sensor(0x04F1,0xBC);
HM5065_write_cmos_sensor(0x04F2,0xFF);
HM5065_write_cmos_sensor(0x04F3,0xB2);
HM5065_write_cmos_sensor(0x04F4,0x00);
HM5065_write_cmos_sensor(0x04F5,0xA4);
HM5065_write_cmos_sensor(0x04F6,0x00);
HM5065_write_cmos_sensor(0x04F7,0xB8);
HM5065_write_cmos_sensor(0x04F8,0xFC);
HM5065_write_cmos_sensor(0x04F9,0xEB);
HM5065_write_cmos_sensor(0x04FA,0xFF);
HM5065_write_cmos_sensor(0x04FB,0x2C);
HM5065_write_cmos_sensor(0x04FC,0xFD);
HM5065_write_cmos_sensor(0x04FD,0xF8);
HM5065_write_cmos_sensor(0x04FE,0x00);
HM5065_write_cmos_sensor(0x04FF,0x3A);
HM5065_write_cmos_sensor(0x0500,0xFF);
HM5065_write_cmos_sensor(0x0501,0xAD);
HM5065_write_cmos_sensor(0x0502,0x00);
HM5065_write_cmos_sensor(0x0503,0x1F);
HM5065_write_cmos_sensor(0x0504,0x00);
HM5065_write_cmos_sensor(0x0505,0x83);
HM5065_write_cmos_sensor(0x0506,0x00);
HM5065_write_cmos_sensor(0x0507,0x93);
HM5065_write_cmos_sensor(0x0508,0xFC);
HM5065_write_cmos_sensor(0x0509,0x04);
HM5065_write_cmos_sensor(0x050A,0x00);
HM5065_write_cmos_sensor(0x050B,0x33);
HM5065_write_cmos_sensor(0x050C,0xFE);
HM5065_write_cmos_sensor(0x050D,0xFC);
HM5065_write_cmos_sensor(0x050E,0x00);
HM5065_write_cmos_sensor(0x050F,0x6F);
HM5065_write_cmos_sensor(0x0510,0xFF);
HM5065_write_cmos_sensor(0x0511,0xF6);
HM5065_write_cmos_sensor(0x0512,0xFF);
HM5065_write_cmos_sensor(0x0513,0xBE);
HM5065_write_cmos_sensor(0x0514,0x00);
HM5065_write_cmos_sensor(0x0515,0x66);
HM5065_write_cmos_sensor(0x0516,0x00);
HM5065_write_cmos_sensor(0x0517,0x73);
HM5065_write_cmos_sensor(0x0518,0xFD);
HM5065_write_cmos_sensor(0x0519,0xD2);
HM5065_write_cmos_sensor(0x051A,0xFF);
HM5065_write_cmos_sensor(0x051B,0x1B);
HM5065_write_cmos_sensor(0x051C,0xFE);
HM5065_write_cmos_sensor(0x051D,0x6D);
HM5065_write_cmos_sensor(0x051E,0x00);
HM5065_write_cmos_sensor(0x051F,0x9D);
...
HM5065_write_cmos_sensor(0x06CE,0xFB);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefMacro LSB
HM5065_write_cmos_sensor(0x06CF,0x00);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefInfinity MSB = 127
HM5065_write_cmos_sensor(0x06D0,0x56);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefInfinity LSB
...
HM5065_write_cmos_sensor(0x0734,0x03);  // FocusRangeConstants->wFullRange_LensRecoveryPosition MSB = 753
HM5065_write_cmos_sensor(0x0735,0x2C);  // FocusRangeConstants->wFullRange_LensRecoveryPosition LSB
...
HM5065_write_cmos_sensor(0x0770,0xD9);  // AutoFocusConstants->bCoarseStep = 120
HM5065_write_cmos_sensor(0x0771,0x24);  // AutoFocusConstants->bFineStep = 20
...
void HM5065_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_MIDDLE:
        default:
             HM5065_write_cmos_sensor(0x0081 ,0x58); //54->60
             break; 
    }	
...
//#define OV5640YUV_FLASH_BV_THRESHOLD 0x25     //打闪阈值
static void HM5065_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int Flashlight_state;

    Flashlight_state = HM5065_read_cmos_sensor(0x02d1);//当前曝光时间(0x184)和曝光时间阈值(0x145)比较的结果
    printk("wqcat OV5640YUV_FlashTriggerCheck Flashlight_state=%d\n",Flashlight_state);
    if (Flashlight_state){
...
UINT32 HM5065FeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId,UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
        ...
        case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
						HM5065_FlashTriggerCheck(pFeatureData32);
						HM5065SENSORDB("F_GET_TRIGGER_FLASHLIGHT_INFO: %d\n", pFeatureData32);
						break;
		default:
