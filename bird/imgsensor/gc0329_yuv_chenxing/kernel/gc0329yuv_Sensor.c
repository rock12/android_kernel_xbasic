 ...
 * Revision 1.1  2013/05/23 03:38:14  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 ...
 * no message
 *
 * Revision 1.1  2012/12/10 00:47:27  zhuyaozhong
...
static void GC0329_write_cmos_sensor(addr, para)
{
...
kal_uint8 GC0329_read_cmos_sensor(kal_uint32 addr)
{
...
void GC0329_Sensor_Init(void)
{
...
#if defined(BIRD_GC0329_HV_MIRROR)
	...
	GC0329_write_cmos_sensor(0x83, 0x03);
	...
	////////////////////YCP////////////////////
	GC0329_write_cmos_sensor(0xfe, 0x00);
	GC0329_write_cmos_sensor(0xd1, 0x32); //34
	...
	GC0329_write_cmos_sensor(0x53, 0x1d);
	GC0329_write_cmos_sensor(0x54, 0x16);
	GC0329_write_cmos_sensor(0x55, 0x20);
	GC0329_write_cmos_sensor(0x56, 0x60);
	...
	GC0329_write_cmos_sensor(0x6c, 0x40);
	GC0329_write_cmos_sensor(0x6d, 0x80);
	GC0329_write_cmos_sensor(0x6e, 0x41);
	GC0329_write_cmos_sensor(0x70, 0x50);
	...
	GC0329_write_cmos_sensor(0x80, 0x4a);
	GC0329_write_cmos_sensor(0x81, 0x43);
	GC0329_write_cmos_sensor(0x82, 0x43);
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2b, 0x03);   //exp level 0  12.5fps
			GC0329_write_cmos_sensor(0x2c, 0x3c); 
			GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 0  10fps
			GC0329_write_cmos_sensor(0x2e, 0xf4); 
