...
void GC0329_Sensor_Init(void)
{
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x40);//26
	GC0329_write_cmos_sensor(0xd2, 0x40);//26
	GC0329_write_cmos_sensor(0xd3, 0x44);
  ...
  GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	...
	GC0329_write_cmos_sensor(0x30, 0x1a);   //41a
