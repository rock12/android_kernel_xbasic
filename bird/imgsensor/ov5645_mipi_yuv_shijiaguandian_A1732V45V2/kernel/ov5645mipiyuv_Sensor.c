...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x2c);//	; sharpen MT off1
	OV5645MIPI_write_cmos_sensor(0x5303, 0x1c);//	; sharpen MT off2
	OV5645MIPI_write_cmos_sensor(0x5304, 0x08);//	; DNS th1
	OV5645MIPI_write_cmos_sensor(0x5305, 0x30);//	; DNS th2
	OV5645MIPI_write_cmos_sensor(0x5306, 0x1c);//	; DNS off1
	OV5645MIPI_write_cmos_sensor(0x5307, 0x2c);//	; DNS off2
	...
	OV5645MIPI_write_cmos_sensor(0x5800, 0x22);//lsc
	OV5645MIPI_write_cmos_sensor(0x5801, 0xe );//
	OV5645MIPI_write_cmos_sensor(0x5802, 0xc );//
	OV5645MIPI_write_cmos_sensor(0x5803, 0xc );//
	OV5645MIPI_write_cmos_sensor(0x5804, 0xc );//
	OV5645MIPI_write_cmos_sensor(0x5805, 0x1b);//
	OV5645MIPI_write_cmos_sensor(0x5806, 0xa );//
	...
	OV5645MIPI_write_cmos_sensor(0x580b, 0x8 );//
	...
	OV5645MIPI_write_cmos_sensor(0x5810, 0x1 );//
	OV5645MIPI_write_cmos_sensor(0x5811, 0x6 );//
	...
	OV5645MIPI_write_cmos_sensor(0x5816, 0x2 );//
	OV5645MIPI_write_cmos_sensor(0x5817, 0x7 );//
	OV5645MIPI_write_cmos_sensor(0x5818, 0xd );//
	...
	OV5645MIPI_write_cmos_sensor(0x5835, 0x2 );//
	...
	OV5645MIPI_write_cmos_sensor(0x3a0f, 0x2C);//	; AEC in H
	OV5645MIPI_write_cmos_sensor(0x3a10, 0x24);//	; AEC in L
	OV5645MIPI_write_cmos_sensor(0x3a1b, 0x59);//	; AEC out H
	OV5645MIPI_write_cmos_sensor(0x3a1e, 0x2C);//	; AEC out L
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x24);//	; control zone H
...
static void OV5645WBcalibattion(kal_uint32 color_r_gain,kal_uint32 color_b_gain)
{
	...
	if(color_r_gain>0x600)//d65   66b 5a7 4a7 449   //°ì¹«ÊÒ
	{
	     if (temp>=0x70)
	     {
	...
	}else if(color_r_gain>0x540)//cwf  //Ž°»§Íâ
	{
	if (temp>=0x70)
	{
	     color_r_gain_w=color_r_gain *97/100;                                                                                                                                                                                                                                                                                                                                                                                                                                      
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	switch(CurrentScenarioId)
	{
		...
		default:
			   ...
			   zsdshutter=0;
			   //OV5645MIPIWriteExpShutter(OV5645MIPISensor.PreviewShutter);
			   OV5645MIPISENSORDB("[OV5645MIPI]enter normal OV5645MIPIPreview function:OV5645MIPISensor.PreviewShutter=%d\n",OV5645MIPISensor.PreviewShutter);
			   break;
	}
	mDELAY(100);	
...
void OV5645MIPI_scene_mode_night()
{
	...
	if(OV5645MIPISensor.VideoMode)
		OV5645MIPI_write_cmos_sensor(0x3A00,0x38); //video modeÏÂ fps=30 ¹Ì¶šÖ¡ÂÊ
	else
    ...
    {	
       case AE_EV_COMP_20:	                   
		...
		case AE_EV_COMP_10:	                   
			  ...
			  break;
		case AE_EV_COMP_00:
				OV5645MIPI_write_cmos_sensor(0x3a0f, 0x2C);//	; AEC in H          30
				OV5645MIPI_write_cmos_sensor(0x3a10, 0x24);//	; AEC in L          28
				OV5645MIPI_write_cmos_sensor(0x3a11, 0x59);//	; AEC out H         60
				OV5645MIPI_write_cmos_sensor(0x3a1b, 0x2C);//	; AEC out L         30
				OV5645MIPI_write_cmos_sensor(0x3a1e, 0x24);//	; control zone H    28
				OV5645MIPI_write_cmos_sensor(0x3a1f, 0x12);//	; control zone L    14
			  break;
   		 case AE_EV_COMP_n10:
