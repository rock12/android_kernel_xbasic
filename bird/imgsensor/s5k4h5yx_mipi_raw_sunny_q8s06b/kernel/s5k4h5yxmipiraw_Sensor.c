...
kal_uint16 S5K4H5YX_check_otp_wb(kal_uint16 index)
{
...
void S5K4H5YX_write_shutter(kal_uint32 shutter)
{
  ...
  else if(s5k4h5yx.sensorMode==SENSOR_MODE_VIDEO)
  {
  	S5K4H5YXDB("[S5K4H5YX] [S5K4H5YX_write_shutter] SENSOR_MODE_VIDEO \n");
  	   frame_length = S5K4H5YX_FeatureControl_PERIOD_LineNum;
...
else if( SENSOR_MODE_VIDEO == s5k4h5yx.sensorMode )		
{
	...
	frame_length = s5k4h5yx_video_frame_length + iLines;
	S5K4H5YX_FeatureControl_PERIOD_LineNum = frame_length;
}
else
{
...
void S5K4H5YXPreviewSetting(void)
{
   S5K4H5YXDB("[S5K4H5YX] [S5K4H5YXPreviewSetting]\n");
	...
	S5K4H5YX_write_cmos_sensor(0x3091, 0x03); //
	S5K4H5YX_write_cmos_sensor(0x3092, 0x03); //
   ...
   //write otp start
	/*
   S5K4H5YX_write_cmos_sensor(0x3b1b, 0x00);
   S5K4H5YX_write_cmos_sensor(0x3b31, 0x01);
   S5K4H5YX_write_cmos_sensor(0x3b26, 0x01);
   S5K4H5YX_write_cmos_sensor(0x3b1d, 0x68);
   S5K4H5YX_write_cmos_sensor(0x3a02, 0x00);
   S5K4H5YX_write_cmos_sensor(0x3a00, 0x03);
   S5K4H5YX_write_cmos_sensor(0x3b26, 0x00);
   S5K4H5YX_write_cmos_sensor(0x3a08, 0x02);
   mdelay(35);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	spin_unlock(&s5k4h5yxmipiraw_drv_lock);
   		...
   		pSensorInfo->SensorOutputDataFormat= SENSOR_OUTPUT_FORMAT_RAW_B; //Gb r
    ...
    switch (ScenarioId)
    {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            ...
            pSensorInfo->SensorGrabStartY = S5K4H5YX_PV_Y_START+1;
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            ...
            pSensorInfo->SensorGrabStartY = S5K4H5YX_VIDEO_Y_START+1;
		...
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
            ...
            pSensorInfo->SensorGrabStartY = S5K4H5YX_FULL_Y_START+1;	//2*S5K4H5YX_IMAGE_SENSOR_PV_STARTY;
			#elif defined(Capture8M)
			pSensorInfo->SensorGrabStartX = 0;	//2*S5K4H5YX_IMAGE_SENSOR_PV_STARTX;
            pSensorInfo->SensorGrabStartY = 1+1;	//2*S5K4H5YX_IMAGE_SENSOR_PV_STARTY;
			#else
            pSensorInfo->SensorGrabStartX = S5K4H5YX_FULL_X_START;	//2*S5K4H5YX_IMAGE_SENSOR_PV_STARTX;
            pSensorInfo->SensorGrabStartY = S5K4H5YX_FULL_Y_START+1;	//2*S5K4H5YX_IMAGE_SENSOR_PV_STARTY;
			#endif
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_ENG_INFO:
            ...
            pSensorEngInfo->SensorType = CMOS_SENSOR;
   					...
   					pSensorEngInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_RAW_B; //gb r
