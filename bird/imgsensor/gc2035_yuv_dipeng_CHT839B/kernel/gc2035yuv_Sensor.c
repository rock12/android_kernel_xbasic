...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xad , 0x81);
	GC2035_write_cmos_sensor(0xae , 0x7e);
	...
	GC2035_write_cmos_sensor(0x13 , 0x78);//y_target 0x75 jon
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	*/
	...
	GC2035_write_cmos_sensor(0x87 , 0xb0); //[7]middle gamma  0x90 jon
	...
	///////////////////////////////////////////////
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x1d);
	...
	GC2035_write_cmos_sensor(0xb6 , 0x23);
	GC2035_write_cmos_sensor(0xb7 , 0x1d);
	GC2035_write_cmos_sensor(0xb8 , 0x0a);
	...
	GC2035_write_cmos_sensor(0xbb , 0x0b);
	GC2035_write_cmos_sensor(0xaa , 0x0a);
	GC2035_write_cmos_sensor(0xab , 0x0c);
	GC2035_write_cmos_sensor(0xac , 0x05);
	GC2035_write_cmos_sensor(0xad , 0x0c);
	GC2035_write_cmos_sensor(0xae , 0x0d);
	GC2035_write_cmos_sensor(0xaf , 0x0c);
	GC2035_write_cmos_sensor(0xb0 , 0x0e);
	GC2035_write_cmos_sensor(0xb1 , 0x04);
	GC2035_write_cmos_sensor(0xb2 , 0x04);
	GC2035_write_cmos_sensor(0xb3 , 0x09);
	GC2035_write_cmos_sensor(0xb4 , 0x0a);
	GC2035_write_cmos_sensor(0xb5 , 0x00);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x09);
	GC2035_write_cmos_sensor(0xd3 , 0x1b);
	GC2035_write_cmos_sensor(0xd8 , 0x00);
	GC2035_write_cmos_sensor(0xda , 0x08);
	GC2035_write_cmos_sensor(0xdb , 0x0e);
	GC2035_write_cmos_sensor(0xdc , 0x00);
	GC2035_write_cmos_sensor(0xde , 0x19);
	GC2035_write_cmos_sensor(0xdf , 0x0f);
	GC2035_write_cmos_sensor(0xd4 , 0x01);
	GC2035_write_cmos_sensor(0xd6 , 0x00);
	GC2035_write_cmos_sensor(0xd7 , 0x12);
	GC2035_write_cmos_sensor(0xa4 , 0x00);
	GC2035_write_cmos_sensor(0xa5 , 0x00);
	GC2035_write_cmos_sensor(0xa6 , 0x00);
	GC2035_write_cmos_sensor(0xa7 , 0x00);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x38);//saturation_cb//32 betty //0x40 jon
	GC2035_write_cmos_sensor(0xd2 , 0x38);//saturation_Cr //0x40 jon
	GC2035_write_cmos_sensor(0xd3 , 0x44);//contrast \D3 //0x3a jon
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xf0);//luma_offset // 0x00	0626 //0xfc jon
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x18);//dn_b_base //0x1f jon
	...
	GC2035_write_cmos_sensor(0x97 , 0x64);// edge effect 45 betty// 0x54	0626//44 //0x65 jon
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
#if 0///def 	BIRD_GC2035_HV_MIRROR  // 1
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n10:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x60);//0x60
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n07:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x68);//0x70 
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x70);//0x78
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x78);//88 jon
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x90);//0xa0
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_07:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0xa0);//0xb0
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_10:
			GC2035_SET_PAGE1;
