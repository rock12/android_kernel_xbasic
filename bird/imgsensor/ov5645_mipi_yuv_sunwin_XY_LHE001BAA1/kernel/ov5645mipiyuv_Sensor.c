...
OV5645Status OV5645CurrentStatus;
//add zhuyawen 20130605 end
...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3036, 0x38);//	; PLL 70
	...
	OV5645MIPI_write_cmos_sensor(0x3a19, 0x60);//	; gain ceiling 0x60 f8
  ...
  OV5645MIPI_write_cmos_sensor(0x5384, 0x05);
  ...
  OV5645MIPI_write_cmos_sensor(0x5490, 0x15);
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x20);//	; sharpen MT off1//18
	OV5645MIPI_write_cmos_sensor(0x5303, 0x10);//	; sharpen MT off2
	OV5645MIPI_write_cmos_sensor(0x5304, 0x08);//	; DNS th1
	OV5645MIPI_write_cmos_sensor(0x5305, 0x30);//	; DNS th2
	OV5645MIPI_write_cmos_sensor(0x5306, 0x0e);//	; DNS off1
	OV5645MIPI_write_cmos_sensor(0x5307, 0x1e);//	; DNS off2
  ...
  OV5645MIPI_write_cmos_sensor(0x5584, 0x20);//10
  ...
  OV5645MIPI_write_cmos_sensor(0x558b, 0xf8);
	...
	OV5645MIPI_write_cmos_sensor(0x5800, 0x2d);
	...
	OV5645MIPI_write_cmos_sensor(0x5805, 0x2f);
	OV5645MIPI_write_cmos_sensor(0x5806, 0x0d);
	...
	OV5645MIPI_write_cmos_sensor(0x580b, 0x0e);
	...
	OV5645MIPI_write_cmos_sensor(0x5817, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5818, 0x0c);
	OV5645MIPI_write_cmos_sensor(0x5819, 0x09);
	OV5645MIPI_write_cmos_sensor(0x581a, 0x05);
	OV5645MIPI_write_cmos_sensor(0x581b, 0x05);
	...
	OV5645MIPI_write_cmos_sensor(0x5833, 0x0a);
	...
	OV5645MIPI_write_cmos_sensor(0x583a, 0x08);
  ...
  OV5645MIPI_write_cmos_sensor(0x568f, 0x11);
	...
	OV5645MIPI_write_cmos_sensor(0x3a00, 0x3c);//	; ae mode	//38
...
static void OV5645_FOCUS_OVT_AFC_Init(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x8e99,0x05);//08
...
*************************************************************************/ 
static UINT32 OV5645_FOCUS_Move_to(UINT32 a_u2MovePosition)//??how many bits for ??
{
}
/*************************************************************************
* FUNCTION
...
UINT32 OV5645MIPIMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) 
	{
		...
		switch (scenarioId) {
			case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
				...
				spin_unlock(&ov5645mipi_drv_lock);
				//(OV5645MIPISensor.PreviewDummyPixels, dummyLine);			
				break;			
			case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
				pclk = 56000000;
			...
			case MSDK_SCENARIO_ID_CAMERA_ZSD:			
				...
				OV5645MIPISensor.SensorMode= SENSOR_MODE_CAPTURE;
				spin_unlock(&ov5645mipi_drv_lock);
				//(OV5645MIPISensor.CaptureDummyPixels, dummyLine);			
				break;		
...
{
	OV5645MIPISENSORDB("[OV5645MIPI]enter OV5645_MIPI_GetExifInfo function:\n ");
