...
static void GC2035_Sensor_Init(void)
{
  ...
  /////////awb end /////////////
	...
	GC2035_write_cmos_sensor(0x13 , 0x78);//y_target
	...
	GC2035_write_cmos_sensor(0xc1 , 0x3d);  
	GC2035_write_cmos_sensor(0xc2 , 0xfc);  
	GC2035_write_cmos_sensor(0xc3 , 0x07);  
	GC2035_write_cmos_sensor(0xc4 , 0xec);  
	GC2035_write_cmos_sensor(0xc5 , 0x40);  
	...
	GC2035_write_cmos_sensor(0xd1 , 0x26);  
	GC2035_write_cmos_sensor(0xd2 , 0x26);  
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1d);//dn_b_base
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2c, 0x20);  
