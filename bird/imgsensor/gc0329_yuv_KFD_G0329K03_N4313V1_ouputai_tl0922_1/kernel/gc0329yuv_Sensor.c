 ...
 * Revision 1.1  2013/09/30 05:39:26  zhoushaohong
 * T28
 *
...
//	GC0329_write_cmos_sensor(0x7b, 0x80);
 // GC0329_write_cmos_sensor(0x7c, 0x78);
	...
	GC0329_write_cmos_sensor(0xb3, 0x3e);//40
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x2b);//26_ifrank
	GC0329_write_cmos_sensor(0xd2, 0x2f);//26
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x2b);	//26																																																																								
	GC0329_write_cmos_sensor(0xd2,0x2f);	//26																																																																								
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
...
BOOL GC0329_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_AUTO:
			GC0329_write_cmos_sensor(0x77, 0x57);//57
			GC0329_write_cmos_sensor(0x78, 0x4d);//4d
			GC0329_write_cmos_sensor(0x79, 0x40);//45
