 ...
 * Revision 1.7  2013/08/20 08:46:02  wangqiang
 * 13C43_3275
 * 2035效果优化。
 *
 * Revision 1.6  2013/08/17 12:43:07  wangqiang
 * 13C43_3275
 * 2035红绿线问题
 *
 * Revision 1.5  2013/08/16 08:25:31  zhoushaohong
 * 优化效果
 *
 * Revision 1.4  2013/08/13 09:05:23  zhoushaohong
 * no message
 *
 * Revision 1.3  2013/08/13 08:32:43  zhoushaohong
 * 优化效果
 *
 * Revision 1.2  2013/07/29 04:25:22  wangqiang
 * 13C43_3275
 * 2035优化
 *
 * Revision 1.1  2013/07/24 06:50:15  lijunchao
 * Commit for 3275
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0x0c);

	GC2035_write_cmos_sensor(0xad , 0x80);
	GC2035_write_cmos_sensor(0xae , 0x7d);
	...
	GC2035_write_cmos_sensor(0x1f , 0xc8);//max_post_gain  c0
	GC2035_write_cmos_sensor(0x20 , 0x58);//max_pre_gain  60  0813
	GC2035_write_cmos_sensor(0x47 , 0x40);//AEC_outdoor_th 30  0813
	GC2035_write_cmos_sensor(0x0b , 0x10);//
	GC2035_write_cmos_sensor(0x13 , 0x84);//y_target //70_hms
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	*/
	...
	GC2035_write_cmos_sensor(0x29, 0x05);//48e
	GC2035_write_cmos_sensor(0x2a, 0x62);  
	GC2035_write_cmos_sensor(0x2b, 0x05);//
	GC2035_write_cmos_sensor(0x2c, 0xcc);  
	GC2035_write_cmos_sensor(0x2d, 0x05);//
	GC2035_write_cmos_sensor(0x2e, 0xcc);  
	GC2035_write_cmos_sensor(0x2f, 0x07);//
	GC2035_write_cmos_sensor(0x30, 0x0a);  
	GC2035_write_cmos_sensor(0xfe, 0x00);  
#else
	GC2035_write_cmos_sensor(0xfe, 0x00);  
		GC2035_write_cmos_sensor(0x05, 0x01);//
		...
		GC2035_write_cmos_sensor(0x2d, 0x05);//5b4 betty
		GC2035_write_cmos_sensor(0x2e, 0xa1);  
	...
	GC2035_write_cmos_sensor(0x81 , 0x24);//38 , 0x//skin_Y 8c_debug //26_hms
	...
	GC2035_write_cmos_sensor(0xb0 , 0xa6); //globle gain  90 0813
	GC2035_write_cmos_sensor(0xc0 , 0x40);//Yuv bypass

	//////lsc/////////////paisi052a -6321
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x17);
	GC2035_write_cmos_sensor(0xc3 , 0x12);
	GC2035_write_cmos_sensor(0xc4 , 0x0e);
	GC2035_write_cmos_sensor(0xc8 , 0x12);
	GC2035_write_cmos_sensor(0xc9 , 0x10);
	GC2035_write_cmos_sensor(0xca , 0x06);
	GC2035_write_cmos_sensor(0xbc , 0x28);
	GC2035_write_cmos_sensor(0xbd , 0x20);
	GC2035_write_cmos_sensor(0xbe , 0x1e);
	GC2035_write_cmos_sensor(0xb6 , 0x2c);
	GC2035_write_cmos_sensor(0xb7 , 0x1f);
	GC2035_write_cmos_sensor(0xb8 , 0x0d);
	...
	GC2035_write_cmos_sensor(0xac , 0x16);
	GC2035_write_cmos_sensor(0xad , 0x13);
	GC2035_write_cmos_sensor(0xae , 0x14);
	GC2035_write_cmos_sensor(0xaf , 0x1c);
	GC2035_write_cmos_sensor(0xb0 , 0x1f);
	GC2035_write_cmos_sensor(0xb1 , 0x17);
	GC2035_write_cmos_sensor(0xb2 , 0x1b);
	GC2035_write_cmos_sensor(0xb3 , 0x1b);
	GC2035_write_cmos_sensor(0xb4 , 0x1a);
	GC2035_write_cmos_sensor(0xb5 , 0x18);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x0c);
	GC2035_write_cmos_sensor(0xd8 , 0x18);
	GC2035_write_cmos_sensor(0xda , 0x00);
	GC2035_write_cmos_sensor(0xdb , 0x00);
	GC2035_write_cmos_sensor(0xdc , 0x03);
	...
	GC2035_write_cmos_sensor(0xc1 , 0x3e); //Green_cc for d//40//red
	GC2035_write_cmos_sensor(0xc2 , 0x00);//fc
	GC2035_write_cmos_sensor(0xc3 , 0x05);
	GC2035_write_cmos_sensor(0xc4 , 0xec);
	GC2035_write_cmos_sensor(0xc5 , 0x42);//green
	...
	GC2035_write_cmos_sensor(0xfe , 0x00);
	GC2035_write_cmos_sensor(0x81 , 0x24); // 26_hms
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x83 , 0x00);//
	GC2035_write_cmos_sensor(0x84 , 0x45);//
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x36);//saturation_cb//32 betty//32//40
	GC2035_write_cmos_sensor(0xd2 , 0x36);//saturation_Cr//32//36//40
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast \D3//3b  //40_hms
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0x04);//luma_offset 
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1c);//dn_b_base //1f_hms
	...
	GC2035_write_cmos_sensor(0x97 , 0x55);// edge effect 45 betty _67_hms
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	/*GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x15 , 0x02);
	GC2035_write_cmos_sensor(0x16 , 0x04);
	GC2035_write_cmos_sensor(0x17 , 0x06);
	GC2035_write_cmos_sensor(0x18 , 0x08);
	GC2035_write_cmos_sensor(0x19 , 0x0c);
	GC2035_write_cmos_sensor(0x1a , 0x10);
	GC2035_write_cmos_sensor(0x1b , 0x14);
	GC2035_write_cmos_sensor(0x1c , 0x18);
	GC2035_write_cmos_sensor(0x1d , 0x20);
	GC2035_write_cmos_sensor(0x1e , 0x28);
	GC2035_write_cmos_sensor(0x1f , 0x30);
	GC2035_write_cmos_sensor(0x20 , 0x38);
	GC2035_write_cmos_sensor(0x21 , 0x40);
	GC2035_write_cmos_sensor(0x22 , 0x50);
	GC2035_write_cmos_sensor(0x23 , 0x60);
	GC2035_write_cmos_sensor(0x24 , 0x70);
	GC2035_write_cmos_sensor(0x25 , 0x80);
	GC2035_write_cmos_sensor(0x26 , 0xa0);
	GC2035_write_cmos_sensor(0x27 , 0xc0);
	GC2035_write_cmos_sensor(0x28 , 0xe0);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2b, 0x05);//
		GC2035_write_cmos_sensor(0x2c, 0xcc);  
		GC2035_write_cmos_sensor(0x2d, 0x05);//562
		GC2035_write_cmos_sensor(0x2e, 0xcc);  
		GC2035_write_cmos_sensor(0x2f, 0x07);//
		GC2035_write_cmos_sensor(0x30, 0x0a);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
		...
		GC2035_write_cmos_sensor(0x2b, 0x05);//
		GC2035_write_cmos_sensor(0x2c, 0xb0);  
		GC2035_write_cmos_sensor(0x2d, 0x05);//
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n10:    //  -1
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x50);//50
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n07:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x60); //60
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n03:
			GC2035_SET_PAGE1;
			...
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_00:    //  0
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x84); //70_hms
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
