 ...
 * Revision 1.1  2013/10/24 11:20:39  wangtinglong
 * 13C43/F43 S26E/S36E/S25E/S32E
 *
 * Revision 1.4  2013/10/24 11:06:10  lijunchao
 * proformance tuning
 *
 * Revision 1.3  2013/09/11 10:13:26  lijunchao
 * Tuning noise and resolution
 *
 * Revision 1.2  2013/09/06 04:33:26  wangtinglong
 * 13C43 S25E
 *
 * Revision 1.1  2013/08/13 05:35:30  chenchuanbao
 * Editor: chenchuanbao
...
void GC0329_Sensor_Init(void)
{
	...
	//GC0329_write_cmos_sensor(0x42, 0xfc);
       GC0329_write_cmos_sensor(0x7a, 0x80);//add rgb ratio
	...
	GC0329_write_cmos_sensor(0x67, 0x70);//70//6c
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x67,0x70);	//70	//6c																																																																							
	GC0329_write_cmos_sensor(0x68,0x52);	//58	//54																																																																							
	GC0329_write_cmos_sensor(0x69,0x84);//80																																																																									
	...
	GC0329_write_cmos_sensor(0xd1,0x2a);//26																																																																									
	GC0329_write_cmos_sensor(0xd2,0x2a);//26
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x70);
	  	//GC0329_write_cmos_sensor(0x17, 0x15);//MIRROR		
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x00);//10
	value_Y = (GC0329_NIGHT_MODE?0x68:0x60);
