 ...
 * Revision 1.1  2013/09/24 09:40:33  huangmaohua
 * *** empty log message ***
 *
 *
 * [GC2035YUV V1.0.0]
...
static void GC2035_Sensor_Init(void)
{
	...
	//AEC
	GC2035_write_cmos_sensor(0xfe , 0x01); 
	GC2035_write_cmos_sensor(0x0c , 0x11); 
	...
	//abs
	GC2035_write_cmos_sensor(0x9c , 0x00); //02_hms
	...
	GC2035_write_cmos_sensor(0x30, 0x8e);  
	GC2035_write_cmos_sensor(0x3e, 0x40);//
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	...
	GC2035_write_cmos_sensor(0xc1, 0x3d); //40 
	GC2035_write_cmos_sensor(0xc2, 0xfc);  
	GC2035_write_cmos_sensor(0xc3, 0x07); //05 
	GC2035_write_cmos_sensor(0xc4, 0xec);  
	GC2035_write_cmos_sensor(0xc5, 0x40);  //0x44 48 //42_hms
	...
	GC2035_write_cmos_sensor(0xd1 , 0x38);  //38_hms
	GC2035_write_cmos_sensor(0xd2 , 0x38);  //38_hms
	GC2035_write_cmos_sensor(0xd3 , 0x3b);//contrast ?	 //42_hms
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfd);//luma_offset  //f8_hms
	...
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x16);//dn_b_base
	...
	GC2035_write_cmos_sensor(0x97 , 0x67);// edge effect//45
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x15 , 0x0e);//0a_hms
	GC2035_write_cmos_sensor(0x16 , 0x16);//12_hms
	GC2035_write_cmos_sensor(0x17 , 0x1c);//19_hms
	GC2035_write_cmos_sensor(0x18 , 0x23);//1f_hms
	GC2035_write_cmos_sensor(0x19 , 0x2f);//2c_hms
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2c, 0xb4);  
		GC2035_write_cmos_sensor(0x2d, 0x07);//
		GC2035_write_cmos_sensor(0x2e, 0xfc);  //5b4//6d8//76a
		GC2035_write_cmos_sensor(0x2f, 0x08);//
		GC2035_write_cmos_sensor(0x30, 0x8e);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x7b); //82_hms
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
