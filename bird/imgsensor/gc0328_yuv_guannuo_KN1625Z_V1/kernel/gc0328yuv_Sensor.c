...
void GC0328_Sensor_Init(void)
    ...
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror
		...
		///////YCP
		GC0328_write_cmos_sensor(0xd1 , 0x40);//////38
		GC0328_write_cmos_sensor(0xd2 , 0x40);//////38
		...
		GC0328_write_cmos_sensor(0xaa , 0x30);//////40
		...
		GC0328_write_cmos_sensor(0x21 , 0xc0);////c0
		GC0328_write_cmos_sensor(0x22 , 0x60);////60
		...
		///cct
		GC0328_write_cmos_sensor(0xB1 , 0x07);//02 betty
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x2f, 0x05);   //exp level 2  10.00fps/////3c0
			GC0328_write_cmos_sensor(0x30, 0x40); 
