...
void HM5065InitialSetting(void)
{
	...
	HM5065_write_cmos_sensor(0xA44D,0x80);
	...
	HM5065_write_cmos_sensor(0xA453,0x44);
	...
	HM5065_write_cmos_sensor(0xA45B,0x80);
	...
	HM5065_write_cmos_sensor(0xA461,0x44);
	...
	HM5065_write_cmos_sensor(0xA469,0x80);
	...
	HM5065_write_cmos_sensor(0xA46F,0x44);
	...
	HM5065_write_cmos_sensor(0x0083,0x00);//01
	HM5065_write_cmos_sensor(0x0084,0x00);//01
	...
	HM5065_write_cmos_sensor(0x0130,0x00);//00->fe->f9
	...
	HM5065_write_cmos_sensor(0x0357,0x19); //19
	...
	HM5065_write_cmos_sensor(0x04b1,0xe0);
	...
	HM5065_write_cmos_sensor(0x04e1,0x6d);
	...
	HM5065_write_cmos_sensor(0x04e8,0xff);
	HM5065_write_cmos_sensor(0x04e9,0xc0);
	...
	HM5065_write_cmos_sensor(0x04f1,0xe0);
	HM5065_write_cmos_sensor(0x04f2,0xff);
	HM5065_write_cmos_sensor(0x04f3,0x95);
	HM5065_write_cmos_sensor(0x04f4,0x00);
	HM5065_write_cmos_sensor(0x04f5,0xa7);
	HM5065_write_cmos_sensor(0x04f6,0x00);
	HM5065_write_cmos_sensor(0x04f7,0xc8);
	...
	HM5065_write_cmos_sensor(0x04ff,0x10);
	...
	HM5065_write_cmos_sensor(0x0508,0xff);
	HM5065_write_cmos_sensor(0x0509,0xc0);
	...
	HM5065_write_cmos_sensor(0x0081,0x50); //6E
...
HM5065_write_cmos_sensor(0x0420,0x00);  //C0_GreenRed_X 72
HM5065_write_cmos_sensor(0x0421,0x48);  //C0_GreenRed_X LSB
HM5065_write_cmos_sensor(0x0422,0x00);  //C0_GreenRed_Y 63
HM5065_write_cmos_sensor(0x0423,0x3f);  //C0_GreenRed_Y LSB
HM5065_write_cmos_sensor(0x0424,0x00);  //C0_GreenRed_X2 142
HM5065_write_cmos_sensor(0x0425,0x8e);  //C0_GreenRed_X2 LSB
HM5065_write_cmos_sensor(0x0426,0x00);  //C0_GreenRed_Y2 170
HM5065_write_cmos_sensor(0x0427,0xaa);  //C0_GreenRed_Y2 LSB
HM5065_write_cmos_sensor(0x0428,0x00);  //C0_GreenRed_XY 51
HM5065_write_cmos_sensor(0x0429,0x33);  //C0_GreenRed_XY LSB
HM5065_write_cmos_sensor(0x042a,0xff);  //C0_GreenRed_X2Y -23
HM5065_write_cmos_sensor(0x042b,0xe9);  //C0_GreenRed_X2Y LSB
HM5065_write_cmos_sensor(0x042c,0x00);  //C0_GreenRed_XY2 118
HM5065_write_cmos_sensor(0x042d,0x76);  //C0_GreenRed_XY2 LSB
HM5065_write_cmos_sensor(0x042e,0xff);  //C0_GreenRed_X2Y2 -87
HM5065_write_cmos_sensor(0x042f,0xa9);  //C0_GreenRed_X2Y2 LSB
HM5065_write_cmos_sensor(0x0430,0x00);  //C0_Red_X 15
HM5065_write_cmos_sensor(0x0431,0x0f);  //C0_Red_X LSB
HM5065_write_cmos_sensor(0x0432,0x00);  //C0_Red_Y 50
HM5065_write_cmos_sensor(0x0433,0x32);  //C0_Red_Y LSB
HM5065_write_cmos_sensor(0x0434,0x00);  //C0_Red_X2 242
HM5065_write_cmos_sensor(0x0435,0xf2);  //C0_Red_X2 LSB
HM5065_write_cmos_sensor(0x0436,0x01);  //C0_Red_Y2 275
HM5065_write_cmos_sensor(0x0437,0x13);  //C0_Red_Y2 LSB
HM5065_write_cmos_sensor(0x0438,0xff);  //C0_Red_XY -89
HM5065_write_cmos_sensor(0x0439,0xa7);  //C0_Red_XY LSB
HM5065_write_cmos_sensor(0x043a,0x00);  //C0_Red_X2Y 0
HM5065_write_cmos_sensor(0x043b,0x00);  //C0_Red_X2Y LSB
HM5065_write_cmos_sensor(0x043c,0x00);  //C0_Red_XY2 120
HM5065_write_cmos_sensor(0x043d,0x78);  //C0_Red_XY2 LSB
HM5065_write_cmos_sensor(0x043e,0xff);  //C0_Red_X2Y2 -178
HM5065_write_cmos_sensor(0x043f,0x4e);  //C0_Red_X2Y2 LSB
HM5065_write_cmos_sensor(0x0450,0x00);  //C0_Blue_X 86
HM5065_write_cmos_sensor(0x0451,0x56);  //C0_Blue_X LSB
HM5065_write_cmos_sensor(0x0452,0x00);  //C0_Blue_Y 14
HM5065_write_cmos_sensor(0x0453,0x0e);  //C0_Blue_Y LSB
HM5065_write_cmos_sensor(0x0454,0x00);  //C0_Blue_X2 117
HM5065_write_cmos_sensor(0x0455,0x75);  //C0_Blue_X2 LSB
HM5065_write_cmos_sensor(0x0456,0x00);  //C0_Blue_Y2 153
HM5065_write_cmos_sensor(0x0457,0x99);  //C0_Blue_Y2 LSB
HM5065_write_cmos_sensor(0x0458,0xff);  //C0_Blue_XY -67
HM5065_write_cmos_sensor(0x0459,0xbd);  //C0_Blue_XY LSB
HM5065_write_cmos_sensor(0x045a,0x00);  //C0_Blue_X2Y 95
HM5065_write_cmos_sensor(0x045b,0x5f);  //C0_Blue_X2Y LSB
HM5065_write_cmos_sensor(0x045c,0xff);  //C0_Blue_XY2 -158
HM5065_write_cmos_sensor(0x045d,0x62);  //C0_Blue_XY2 LSB
HM5065_write_cmos_sensor(0x045e,0x00);  //C0_Blue_X2Y2 7
HM5065_write_cmos_sensor(0x045f,0x07);  //C0_Blue_X2Y2 LSB
HM5065_write_cmos_sensor(0x0440,0x00);  //C0_GreenBlue_X 73
HM5065_write_cmos_sensor(0x0441,0x49);  //C0_GreenBlue_X LSB
HM5065_write_cmos_sensor(0x0442,0x00);  //C0_GreenBlue_Y 67
HM5065_write_cmos_sensor(0x0443,0x43);  //C0_GreenBlue_Y LSB
HM5065_write_cmos_sensor(0x0444,0x00);  //C0_GreenBlue_X2 142
HM5065_write_cmos_sensor(0x0445,0x8e);  //C0_GreenBlue_X2 LSB
HM5065_write_cmos_sensor(0x0446,0x00);  //C0_GreenBlue_Y2 170
HM5065_write_cmos_sensor(0x0447,0xaa);  //C0_GreenBlue_Y2 LSB
HM5065_write_cmos_sensor(0x0448,0x00);  //C0_GreenBlue_XY 55
HM5065_write_cmos_sensor(0x0449,0x37);  //C0_GreenBlue_XY LSB
HM5065_write_cmos_sensor(0x044a,0xff);  //C0_GreenBlue_X2Y -37
HM5065_write_cmos_sensor(0x044b,0xdb);  //C0_GreenBlue_X2Y LSB
HM5065_write_cmos_sensor(0x044c,0x00);  //C0_GreenBlue_XY2 118
HM5065_write_cmos_sensor(0x044d,0x76);  //C0_GreenBlue_XY2 LSB
HM5065_write_cmos_sensor(0x044e,0xff);  //C0_GreenBlue_X2Y2 -85
HM5065_write_cmos_sensor(0x044f,0xab);  //C0_GreenBlue_X2Y2 LSB
HM5065_write_cmos_sensor(0x0460,0x00);  //C1_GreenRed_X 66
HM5065_write_cmos_sensor(0x0461,0x42);  //C1_GreenRed_X LSB
HM5065_write_cmos_sensor(0x0462,0x00);  //C1_GreenRed_Y 63
HM5065_write_cmos_sensor(0x0463,0x3f);  //C1_GreenRed_Y LSB
HM5065_write_cmos_sensor(0x0464,0x00);  //C1_GreenRed_X2 140
HM5065_write_cmos_sensor(0x0465,0x8c);  //C1_GreenRed_X2 LSB
HM5065_write_cmos_sensor(0x0466,0x00);  //C1_GreenRed_Y2 166
HM5065_write_cmos_sensor(0x0467,0xa6);  //C1_GreenRed_Y2 LSB
HM5065_write_cmos_sensor(0x0468,0x00);  //C1_GreenRed_XY 59
HM5065_write_cmos_sensor(0x0469,0x3b);  //C1_GreenRed_XY LSB
HM5065_write_cmos_sensor(0x046a,0xff);  //C1_GreenRed_X2Y -26
HM5065_write_cmos_sensor(0x046b,0xe6);  //C1_GreenRed_X2Y LSB
HM5065_write_cmos_sensor(0x046c,0x00);  //C1_GreenRed_XY2 117
HM5065_write_cmos_sensor(0x046d,0x75);  //C1_GreenRed_XY2 LSB
HM5065_write_cmos_sensor(0x046e,0xff);  //C1_GreenRed_X2Y2 -74
HM5065_write_cmos_sensor(0x046f,0xb6);  //C1_GreenRed_X2Y2 LSB
HM5065_write_cmos_sensor(0x0470,0x00);  //C1_Red_X 19
HM5065_write_cmos_sensor(0x0471,0x13);  //C1_Red_X LSB
HM5065_write_cmos_sensor(0x0472,0x00);  //C1_Red_Y 46
HM5065_write_cmos_sensor(0x0473,0x2e);  //C1_Red_Y LSB
HM5065_write_cmos_sensor(0x0474,0x00);  //C1_Red_X2 232
HM5065_write_cmos_sensor(0x0475,0xe8);  //C1_Red_X2 LSB
HM5065_write_cmos_sensor(0x0476,0x01);  //C1_Red_Y2 264
HM5065_write_cmos_sensor(0x0477,0x08);  //C1_Red_Y2 LSB
HM5065_write_cmos_sensor(0x0478,0xff);  //C1_Red_XY -80
HM5065_write_cmos_sensor(0x0479,0xb0);  //C1_Red_XY LSB
HM5065_write_cmos_sensor(0x047a,0x00);  //C1_Red_X2Y 9
HM5065_write_cmos_sensor(0x047b,0x09);  //C1_Red_X2Y LSB
HM5065_write_cmos_sensor(0x047c,0x00);  //C1_Red_XY2 124
HM5065_write_cmos_sensor(0x047d,0x7c);  //C1_Red_XY2 LSB
HM5065_write_cmos_sensor(0x047e,0xff);  //C1_Red_X2Y2 -162
HM5065_write_cmos_sensor(0x047f,0x5e);  //C1_Red_X2Y2 LSB
HM5065_write_cmos_sensor(0x0490,0x00);  //C1_Blue_X 77
HM5065_write_cmos_sensor(0x0491,0x4d);  //C1_Blue_X LSB
HM5065_write_cmos_sensor(0x0492,0x00);  //C1_Blue_Y 15
HM5065_write_cmos_sensor(0x0493,0x0f);  //C1_Blue_Y LSB
HM5065_write_cmos_sensor(0x0494,0x00);  //C1_Blue_X2 113
HM5065_write_cmos_sensor(0x0495,0x71);  //C1_Blue_X2 LSB
HM5065_write_cmos_sensor(0x0496,0x00);  //C1_Blue_Y2 147
HM5065_write_cmos_sensor(0x0497,0x93);  //C1_Blue_Y2 LSB
HM5065_write_cmos_sensor(0x0498,0xff);  //C1_Blue_XY -58
HM5065_write_cmos_sensor(0x0499,0xc6);  //C1_Blue_XY LSB
HM5065_write_cmos_sensor(0x049a,0x00);  //C1_Blue_X2Y 52
HM5065_write_cmos_sensor(0x049b,0x34);  //C1_Blue_X2Y LSB
HM5065_write_cmos_sensor(0x049c,0xff);  //C1_Blue_XY2 -135
HM5065_write_cmos_sensor(0x049d,0x79);  //C1_Blue_XY2 LSB
HM5065_write_cmos_sensor(0x049e,0xff);  //C1_Blue_X2Y2 -18
HM5065_write_cmos_sensor(0x049f,0xee);  //C1_Blue_X2Y2 LSB
HM5065_write_cmos_sensor(0x0480,0x00);  //C1_GreenBlue_X 69
HM5065_write_cmos_sensor(0x0481,0x45);  //C1_GreenBlue_X LSB
HM5065_write_cmos_sensor(0x0482,0x00);  //C1_GreenBlue_Y 66
HM5065_write_cmos_sensor(0x0483,0x42);  //C1_GreenBlue_Y LSB
HM5065_write_cmos_sensor(0x0484,0x00);  //C1_GreenBlue_X2 140
HM5065_write_cmos_sensor(0x0485,0x8c);  //C1_GreenBlue_X2 LSB
HM5065_write_cmos_sensor(0x0486,0x00);  //C1_GreenBlue_Y2 166
HM5065_write_cmos_sensor(0x0487,0xa6);  //C1_GreenBlue_Y2 LSB
HM5065_write_cmos_sensor(0x0488,0x00);  //C1_GreenBlue_XY 62
HM5065_write_cmos_sensor(0x0489,0x3e);  //C1_GreenBlue_XY LSB
HM5065_write_cmos_sensor(0x048a,0xff);  //C1_GreenBlue_X2Y -33
HM5065_write_cmos_sensor(0x048b,0xdf);  //C1_GreenBlue_X2Y LSB
HM5065_write_cmos_sensor(0x048c,0x00);  //C1_GreenBlue_XY2 117
HM5065_write_cmos_sensor(0x048d,0x75);  //C1_GreenBlue_XY2 LSB
HM5065_write_cmos_sensor(0x048e,0xff);  //C1_GreenBlue_X2Y2 -73
HM5065_write_cmos_sensor(0x048f,0xb7);  //C1_GreenBlue_X2Y2 LSB
HM5065_write_cmos_sensor(0x04a0,0x00);  //C2_GreenRed_X 70
HM5065_write_cmos_sensor(0x04a1,0x46);  //C2_GreenRed_X LSB
HM5065_write_cmos_sensor(0x04a2,0x00);  //C2_GreenRed_Y 66
HM5065_write_cmos_sensor(0x04a3,0x42);  //C2_GreenRed_Y LSB
HM5065_write_cmos_sensor(0x04a4,0x00);  //C2_GreenRed_X2 131
HM5065_write_cmos_sensor(0x04a5,0x83);  //C2_GreenRed_X2 LSB
HM5065_write_cmos_sensor(0x04a6,0x00);  //C2_GreenRed_Y2 153
HM5065_write_cmos_sensor(0x04a7,0x99);  //C2_GreenRed_Y2 LSB
HM5065_write_cmos_sensor(0x04a8,0x00);  //C2_GreenRed_XY 64
HM5065_write_cmos_sensor(0x04a9,0x40);  //C2_GreenRed_XY LSB
HM5065_write_cmos_sensor(0x04aa,0xff);  //C2_GreenRed_X2Y -35
HM5065_write_cmos_sensor(0x04ab,0xdd);  //C2_GreenRed_X2Y LSB
HM5065_write_cmos_sensor(0x04ac,0x00);  //C2_GreenRed_XY2 124
HM5065_write_cmos_sensor(0x04ad,0x7c);  //C2_GreenRed_XY2 LSB
HM5065_write_cmos_sensor(0x04ae,0xff);  //C2_GreenRed_X2Y2 -54
HM5065_write_cmos_sensor(0x04af,0xca);  //C2_GreenRed_X2Y2 LSB
HM5065_write_cmos_sensor(0x04b0,0x00);  //C2_Red_X 33
HM5065_write_cmos_sensor(0x04b1,0x21);  //C2_Red_X LSB
HM5065_write_cmos_sensor(0x04b2,0x00);  //C2_Red_Y 20
HM5065_write_cmos_sensor(0x04b3,0x14);  //C2_Red_Y LSB
HM5065_write_cmos_sensor(0x04b4,0x00);  //C2_Red_X2 165
HM5065_write_cmos_sensor(0x04b5,0xa5);  //C2_Red_X2 LSB
HM5065_write_cmos_sensor(0x04b6,0x00);  //C2_Red_Y2 193
HM5065_write_cmos_sensor(0x04b7,0xc1);  //C2_Red_Y2 LSB
HM5065_write_cmos_sensor(0x04b8,0xff);  //C2_Red_XY -67
HM5065_write_cmos_sensor(0x04b9,0xbd);  //C2_Red_XY LSB
HM5065_write_cmos_sensor(0x04ba,0xff);  //C2_Red_X2Y -13
HM5065_write_cmos_sensor(0x04bb,0xf3);  //C2_Red_X2Y LSB
HM5065_write_cmos_sensor(0x04bc,0x00);  //C2_Red_XY2 53
HM5065_write_cmos_sensor(0x04bd,0x35);  //C2_Red_XY2 LSB
HM5065_write_cmos_sensor(0x04be,0xff);  //C2_Red_X2Y2 -57
HM5065_write_cmos_sensor(0x04bf,0xc7);  //C2_Red_X2Y2 LSB
HM5065_write_cmos_sensor(0x04d0,0x00);  //C2_Blue_X 65
HM5065_write_cmos_sensor(0x04d1,0x41);  //C2_Blue_X LSB
HM5065_write_cmos_sensor(0x04d2,0x00);  //C2_Blue_Y 12
HM5065_write_cmos_sensor(0x04d3,0x0c);  //C2_Blue_Y LSB
HM5065_write_cmos_sensor(0x04d4,0x00);  //C2_Blue_X2 102
HM5065_write_cmos_sensor(0x04d5,0x66);  //C2_Blue_X2 LSB
HM5065_write_cmos_sensor(0x04d6,0x00);  //C2_Blue_Y2 131
HM5065_write_cmos_sensor(0x04d7,0x83);  //C2_Blue_Y2 LSB
HM5065_write_cmos_sensor(0x04d8,0xff);  //C2_Blue_XY -64
HM5065_write_cmos_sensor(0x04d9,0xc0);  //C2_Blue_XY LSB
HM5065_write_cmos_sensor(0x04da,0xff);  //C2_Blue_X2Y -2
HM5065_write_cmos_sensor(0x04db,0xfe);  //C2_Blue_X2Y LSB
HM5065_write_cmos_sensor(0x04dc,0xff);  //C2_Blue_XY2 -29
HM5065_write_cmos_sensor(0x04dd,0xe3);  //C2_Blue_XY2 LSB
HM5065_write_cmos_sensor(0x04de,0xff);  //C2_Blue_X2Y2 -1
HM5065_write_cmos_sensor(0x04df,0xff);  //C2_Blue_X2Y2 LSB
HM5065_write_cmos_sensor(0x04c0,0x00);  //C2_GreenBlue_X 72
HM5065_write_cmos_sensor(0x04c1,0x48);  //C2_GreenBlue_X LSB
HM5065_write_cmos_sensor(0x04c2,0x00);  //C2_GreenBlue_Y 69
HM5065_write_cmos_sensor(0x04c3,0x45);  //C2_GreenBlue_Y LSB
HM5065_write_cmos_sensor(0x04c4,0x00);  //C2_GreenBlue_X2 131
HM5065_write_cmos_sensor(0x04c5,0x83);  //C2_GreenBlue_X2 LSB
HM5065_write_cmos_sensor(0x04c6,0x00);  //C2_GreenBlue_Y2 153
HM5065_write_cmos_sensor(0x04c7,0x99);  //C2_GreenBlue_Y2 LSB
HM5065_write_cmos_sensor(0x04c8,0x00);  //C2_GreenBlue_XY 66
HM5065_write_cmos_sensor(0x04c9,0x42);  //C2_GreenBlue_XY LSB
HM5065_write_cmos_sensor(0x04ca,0xff);  //C2_GreenBlue_X2Y -36
HM5065_write_cmos_sensor(0x04cb,0xdc);  //C2_GreenBlue_X2Y LSB
HM5065_write_cmos_sensor(0x04cc,0x00);  //C2_GreenBlue_XY2 125
HM5065_write_cmos_sensor(0x04cd,0x7d);  //C2_GreenBlue_XY2 LSB
HM5065_write_cmos_sensor(0x04ce,0xff);  //C2_GreenBlue_X2Y2 -54
HM5065_write_cmos_sensor(0x04cf,0xca);  //C2_GreenBlue_X2Y2 LSB
HM5065_write_cmos_sensor(0x04e0,0x00);  //C3_GreenRed_X 63
HM5065_write_cmos_sensor(0x04e1,0x3f);  //C3_GreenRed_X LSB
HM5065_write_cmos_sensor(0x04e2,0x00);  //C3_GreenRed_Y 52
HM5065_write_cmos_sensor(0x04e3,0x34);  //C3_GreenRed_Y LSB
HM5065_write_cmos_sensor(0x04e4,0x00);  //C3_GreenRed_X2 129
HM5065_write_cmos_sensor(0x04e5,0x81);  //C3_GreenRed_X2 LSB
HM5065_write_cmos_sensor(0x04e6,0x00);  //C3_GreenRed_Y2 153
HM5065_write_cmos_sensor(0x04e7,0x99);  //C3_GreenRed_Y2 LSB
HM5065_write_cmos_sensor(0x04e8,0x00);  //C3_GreenRed_XY 76
HM5065_write_cmos_sensor(0x04e9,0x4c);  //C3_GreenRed_XY LSB
HM5065_write_cmos_sensor(0x04ea,0xff);  //C3_GreenRed_X2Y -56
HM5065_write_cmos_sensor(0x04eb,0xc8);  //C3_GreenRed_X2Y LSB
HM5065_write_cmos_sensor(0x04ec,0x00);  //C3_GreenRed_XY2 101
HM5065_write_cmos_sensor(0x04ed,0x65);  //C3_GreenRed_XY2 LSB
HM5065_write_cmos_sensor(0x04ee,0xff);  //C3_GreenRed_X2Y2 -58
HM5065_write_cmos_sensor(0x04ef,0xc6);  //C3_GreenRed_X2Y2 LSB
HM5065_write_cmos_sensor(0x04f0,0x00);  //C3_Red_X 61
HM5065_write_cmos_sensor(0x04f1,0x3d);  //C3_Red_X LSB
HM5065_write_cmos_sensor(0x04f2,0x00);  //C3_Red_Y 26
HM5065_write_cmos_sensor(0x04f3,0x1a);  //C3_Red_Y LSB
HM5065_write_cmos_sensor(0x04f4,0x00);  //C3_Red_X2 186
HM5065_write_cmos_sensor(0x04f5,0xba);  //C3_Red_X2 LSB
HM5065_write_cmos_sensor(0x04f6,0x00);  //C3_Red_Y2 223
HM5065_write_cmos_sensor(0x04f7,0xdf);  //C3_Red_Y2 LSB
HM5065_write_cmos_sensor(0x04f8,0xff);  //C3_Red_XY -67
HM5065_write_cmos_sensor(0x04f9,0xbd);  //C3_Red_XY LSB
HM5065_write_cmos_sensor(0x04fa,0xff);  //C3_Red_X2Y -43
HM5065_write_cmos_sensor(0x04fb,0xd5);  //C3_Red_X2Y LSB
HM5065_write_cmos_sensor(0x04fc,0x00);  //C3_Red_XY2 41
HM5065_write_cmos_sensor(0x04fd,0x29);  //C3_Red_XY2 LSB
HM5065_write_cmos_sensor(0x04fe,0xff);  //C3_Red_X2Y2 -103
HM5065_write_cmos_sensor(0x04ff,0x99);  //C3_Red_X2Y2 LSB
HM5065_write_cmos_sensor(0x0510,0x00);  //C3_Blue_X 33
HM5065_write_cmos_sensor(0x0511,0x21);  //C3_Blue_X LSB
HM5065_write_cmos_sensor(0x0512,0x00);  //C3_Blue_Y 0
HM5065_write_cmos_sensor(0x0513,0x00);  //C3_Blue_Y LSB
HM5065_write_cmos_sensor(0x0514,0x00);  //C3_Blue_X2 105
HM5065_write_cmos_sensor(0x0515,0x69);  //C3_Blue_X2 LSB
HM5065_write_cmos_sensor(0x0516,0x00);  //C3_Blue_Y2 130
HM5065_write_cmos_sensor(0x0517,0x82);  //C3_Blue_Y2 LSB
HM5065_write_cmos_sensor(0x0518,0xff);  //C3_Blue_XY -67
HM5065_write_cmos_sensor(0x0519,0xbd);  //C3_Blue_XY LSB
HM5065_write_cmos_sensor(0x051a,0xff);  //C3_Blue_X2Y -40
HM5065_write_cmos_sensor(0x051b,0xd8);  //C3_Blue_X2Y LSB
HM5065_write_cmos_sensor(0x051c,0x00);  //C3_Blue_XY2 42
HM5065_write_cmos_sensor(0x051d,0x2a);  //C3_Blue_XY2 LSB
HM5065_write_cmos_sensor(0x051e,0xff);  //C3_Blue_X2Y2 -28
HM5065_write_cmos_sensor(0x051f,0xe4);  //C3_Blue_X2Y2 LSB
HM5065_write_cmos_sensor(0x0500,0x00);  //C3_GreenBlue_X 64
HM5065_write_cmos_sensor(0x0501,0x40);  //C3_GreenBlue_X LSB
HM5065_write_cmos_sensor(0x0502,0x00);  //C3_GreenBlue_Y 54
HM5065_write_cmos_sensor(0x0503,0x36);  //C3_GreenBlue_Y LSB
HM5065_write_cmos_sensor(0x0504,0x00);  //C3_GreenBlue_X2 129
HM5065_write_cmos_sensor(0x0505,0x81);  //C3_GreenBlue_X2 LSB
HM5065_write_cmos_sensor(0x0506,0x00);  //C3_GreenBlue_Y2 153
HM5065_write_cmos_sensor(0x0507,0x99);  //C3_GreenBlue_Y2 LSB
HM5065_write_cmos_sensor(0x0508,0x00);  //C3_GreenBlue_XY 79
HM5065_write_cmos_sensor(0x0509,0x4f);  //C3_GreenBlue_XY LSB
HM5065_write_cmos_sensor(0x050a,0xff);  //C3_GreenBlue_X2Y -53
HM5065_write_cmos_sensor(0x050b,0xcb);  //C3_GreenBlue_X2Y LSB
HM5065_write_cmos_sensor(0x050c,0x00);  //C3_GreenBlue_XY2 101
HM5065_write_cmos_sensor(0x050d,0x65);  //C3_GreenBlue_XY2 LSB
HM5065_write_cmos_sensor(0x050e,0xff);  //C3_GreenBlue_X2Y2 -57
HM5065_write_cmos_sensor(0x050f,0xc7);  //C3_GreenBlue_X2Y2 LSB
HM5065_write_cmos_sensor(0x0561,0x01);  //0 Unity
HM5065_write_cmos_sensor(0x0562,0x01);  //1 Unity
HM5065_write_cmos_sensor(0x0563,0x00);  //2 Unity
HM5065_write_cmos_sensor(0x0564,0x00);  //3 Unity
HM5065_write_cmos_sensor(0x0324,0x38);  //
HM5065_write_cmos_sensor(0x0325,0xF6);  //
HM5065_write_cmos_sensor(0x0326,0x39);  //
HM5065_write_cmos_sensor(0x0327,0x8D);  //
HM5065_write_cmos_sensor(0x0328,0x3A);  //
HM5065_write_cmos_sensor(0x0329,0x93);  //
HM5065_write_cmos_sensor(0x032A,0x3B);  //
HM5065_write_cmos_sensor(0x032B,0x37);  //

#if 1
HM5065_write_cmos_sensor(0x065A,0x00);  // AFStatsControls->bWindowsSystem = 7 zone AF system 
HM5065_write_cmos_sensor(0x06C9,0x01);  // FLADriverLowLevelParameters->AutoSkipNextFrame = ENABLED
HM5065_write_cmos_sensor(0x06CD,0x01);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefMacro MSB = 450
HM5065_write_cmos_sensor(0x06CE,0xA5);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefMacro LSB
HM5065_write_cmos_sensor(0x06CF,0x00);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefInfinity MSB = 127
HM5065_write_cmos_sensor(0x06D0,0x61);  // FLADriverLowLevelParameters->AF_OTP_uwHostDefInfinity LSB
HM5065_write_cmos_sensor(0x06D1,0x02);  // FLADriverLowLevelParameters->AF_OTP_bStepsMultiStepDriver = 2 step driver
HM5065_write_cmos_sensor(0x06D2,0x30);  // FLADriverLowLevelParameters->AF_OTP_uwMultiStepTimeDelay MSB = 12.5ms
HM5065_write_cmos_sensor(0x06D3,0xD4);  // FLADriverLowLevelParameters->AF_OTP_uwMultiStepTimeDelay LSB
HM5065_write_cmos_sensor(0x06D4,0x01);  // FLADriverLowLevelParameters->AF_OTP_fHostEnableOTPRead (1 = disabled)
HM5065_write_cmos_sensor(0x06DB,0x59);  // FLADriverLowLevelParameters->fpActuatorResponseTime MSB 12.5ms (FP900)
HM5065_write_cmos_sensor(0x06DC,0x0D);  // FLADriverLowLevelParameters->fpActuatorResponseTime LSB
HM5065_write_cmos_sensor(0x0730,0x00);  // FocusRangeConstants->wFullRange_LensMinPosition MSB = 0
HM5065_write_cmos_sensor(0x0731,0x00);  // FocusRangeConstants->wFullRange_LensMinPosition LSB
HM5065_write_cmos_sensor(0x0732,0x03);  // FocusRangeConstants->wFullRange_LensMaxPosition MSB = 1023
HM5065_write_cmos_sensor(0x0733,0xFF);  // FocusRangeConstants->wFullRange_LensMaxPosition LSB
HM5065_write_cmos_sensor(0x0734,0x02);  // FocusRangeConstants->wFullRange_LensRecoveryPosition MSB = 753
HM5065_write_cmos_sensor(0x0735,0xCA);  // FocusRangeConstants->wFullRange_LensRecoveryPosition LSB
HM5065_write_cmos_sensor(0x0755,0x01);  // AutoFocusControls->fEnableSimpleCoarseThEvaluation = ENABLED
HM5065_write_cmos_sensor(0x0756,0x00);  // AutoFocusControls->bSelectedMultizoneBehavior = REGIONSELECTIONMETHOD_AVERAGE
HM5065_write_cmos_sensor(0x075B,0x00);  // AutoFocusControls->fEnableTrackingThresholdEvaluation = DISABLED
HM5065_write_cmos_sensor(0x075E,0x00);  // AutoFocusControls->fFineToCoarseAutoTransitionEnable = DISABLED
HM5065_write_cmos_sensor(0x0764,0x01);  // AutoFocusControls->fResetHCSPos = TRUE = Start from Recovery Position for every HCS
HM5065_write_cmos_sensor(0x0766,0x00);  // AutoFocusControls->fEnablePrioritiesMacro = FALSE = Do not prioritise Macro
HM5065_write_cmos_sensor(0x0768,0x01);  // AutoFocusControls->fEnableInterpolationAfterFineSearch = TRUE
HM5065_write_cmos_sensor(0x076A,0x01);  // AutoFocusControls->fReducedZoneSetup = TRUE
HM5065_write_cmos_sensor(0x0758,0x01);  // AutoFocusControls->bWeighedFunctionSelected = TRAPEZIUM
HM5065_write_cmos_sensor(0x075C,0x01);  // AutoFocusControls->fEnableHeuristicMethod = FALSE
HM5065_write_cmos_sensor(0x0770,0xC6);  // AutoFocusConstants->bCoarseStep = 120
HM5065_write_cmos_sensor(0x0771,0x21);  // AutoFocusConstants->bFineStep = 20
HM5065_write_cmos_sensor(0x0772,0x1B);  // AutoFocusConstants->bFullSearchStep = 27
HM5065_write_cmos_sensor(0x0774,0x01);  // AutoFocusConstants->uwFineThreshold MSB = 330
HM5065_write_cmos_sensor(0x0775,0x4A);  // AutoFocusConstants->uwFineThreshold LSB
HM5065_write_cmos_sensor(0x0777,0x00);  // AutoFocusConstants->uwBacklightThreshold MSB = 69
HM5065_write_cmos_sensor(0x0778,0x45);  // AutoFocusConstants->uwBacklightThreshold LSB 
HM5065_write_cmos_sensor(0x0779,0x00);  // AutoFocusConstants->uwMotionBlurInRatio MSB = 2
HM5065_write_cmos_sensor(0x077A,0x02);  // AutoFocusConstants->uwMotionBlurInRatio LSB
HM5065_write_cmos_sensor(0x077D,0x01);  // AutoFocusConstants->bMaxNumberContinuouslyInstableTime = 1
HM5065_write_cmos_sensor(0x077E,0x03);  // AutoFocusConstants->bMaxNumberContinuouslyStableFrame = 3
HM5065_write_cmos_sensor(0x0783,0x10);  // AutoFocusConstants->bLightGap = 16
HM5065_write_cmos_sensor(0x0785,0x14);  // AutoFocusConstants->uwDeltaValue = 20
HM5065_write_cmos_sensor(0x0846,0x06);  // AutoFocusHeuristicConstants->bHighToMaxFMShiftFactor = 6
HM5065_write_cmos_sensor(0x0847,0x05);  // AutoFocusHeuristicConstants->bLowToHighFMShiftFactor = 5
#else

//**********************************************
// AF and VCM settings - 29Aug2012
//**********************************************
HM5065_write_cmos_sensor(0x0659,0x01);//     // AFStatsControls->bCoringValue = 1 Coring Value  Midified by HP 2013/01/08 
HM5065_write_cmos_sensor(0x065A,0x00);//     // AFStatsControls->bWindowsSystem = 7 zone AF system 

HM5065_write_cmos_sensor(0x06C9,0x01);//     // FLADriverLowLevelParameters->AutoSkipNextFrame = ENABLED
HM5065_write_cmos_sensor(0x06CD,0x01);//     // FLADriverLowLevelParameters->AF_OTP_uwHostDefMacro MSB = 445
HM5065_write_cmos_sensor(0x06CE,0xBD);//     // FLADriverLowLevelParameters->AF_OTP_uwHostDefMacro LSB
HM5065_write_cmos_sensor(0x06CF,0x00);//     // FLADriverLowLevelParameters->AF_OTP_uwHostDefInfinity MSB = 147
HM5065_write_cmos_sensor(0x06D0,0x93);//     // FLADriverLowLevelParameters->AF_OTP_uwHostDefInfinity LSB
HM5065_write_cmos_sensor(0x06D1,0x02);//     // FLADriverLowLevelParameters->AF_OTP_bStepsMultiStepDriver = 2 step driver
HM5065_write_cmos_sensor(0x06D2,0x30);//     // FLADriverLowLevelParameters->AF_OTP_uwMultiStepTimeDelay MSB = 12.5ms
HM5065_write_cmos_sensor(0x06D3,0xD4);//     // FLADriverLowLevelParameters->AF_OTP_uwMultiStepTimeDelay LSB
HM5065_write_cmos_sensor(0x06D4,0x01);//     // FLADriverLowLevelParameters->AF_OTP_fHostEnableOTPRead (1 = disabled);
...
HM5065_write_cmos_sensor(0x0732,0x03);//     // FocusRangeConstants->wFullRange_LensMaxPosition MSB = 1023
HM5065_write_cmos_sensor(0x0733,0xFF);//     // FocusRangeConstants->wFullRange_LensMaxPosition LSB
HM5065_write_cmos_sensor(0x0734,0x03);//     // FocusRangeConstants->wFullRange_LensRecoveryPosition MSB = 880
HM5065_write_cmos_sensor(0x0735,0x70);//     // FocusRangeConstants->wFullRange_LensRecoveryPosition LSB

HM5065_write_cmos_sensor(0x0755,0x01);//     // AutoFocusControls->fEnableSimpleCoarseThEvaluation = ENABLED
HM5065_write_cmos_sensor(0x0756,0x00);//     // AutoFocusControls->bSelectedMultizoneBehavior = REGIONSELECTIONMETHOD_AVERAGE Modified by HP
HM5065_write_cmos_sensor(0x075A,0x00);//     // AutoFocusControls-fLightVariationEnable = FALSE = do not enable with bugs Modified by HP
HM5065_write_cmos_sensor(0x075B,0x01);//     // AutoFocusControls->fEnableTrackingThresholdEvaluation = DISABLED MK change to 0x1
HM5065_write_cmos_sensor(0x075E,0x00);//     // AutoFocusControls->fFineToCoarseAutoTransitionEnable = DISABLED
//HM5065_write_cmos_sensor(0x075F,0x00);//     // AutoFocusControls-fEnableTimedFineExecution = FALSE  Disable   Modified by HP
HM5065_write_cmos_sensor(0x0764,0x01);//     // AutoFocusControls->fResetHCSPos = TRUE = Start from Recovery Position for every HCS
HM5065_write_cmos_sensor(0x0766,0x01);//     // AutoFocusControls->fEnablePrioritiesMacro = FALSE = Do not prioritise Macro mk change to 0x01
HM5065_write_cmos_sensor(0x0768,0x01);//     // AutoFocusControls->fEnableInterpolationAfterFineSearch = TRUE
HM5065_write_cmos_sensor(0x076A,0x00);//     // AutoFocusControls->fReducedZoneSetup = TRUE mk change to 0x0


HM5065_write_cmos_sensor(0x0758,0x01);//     // AutoFocusControls->bWeighedFunctionSelected = TRAPEZIUM
HM5065_write_cmos_sensor(0x075C,0x01);//     // AutoFocusControls->fEnableHeuristicMethod = FALSE

HM5065_write_cmos_sensor(0x0770,0x98);//     // AutoFocusConstants->bCoarseStep = 95
HM5065_write_cmos_sensor(0x0771,0x19);//     // AutoFocusConstants->bFineStep = 16
HM5065_write_cmos_sensor(0x0772,0x1B);//     // AutoFocusConstants->bFullSearchStep = 27
HM5065_write_cmos_sensor(0x0774,0x01);//     // AutoFocusConstants->uwFineThreshold MSB = 330 
HM5065_write_cmos_sensor(0x0775,0x4a);//     // AutoFocusConstants->uwFineThreshold LSB 
HM5065_write_cmos_sensor(0x0777,0x00);//     // AutoFocusConstants->uwBacklightThreshold MSB = 69
...
HM5065_write_cmos_sensor(0x077D,0x01);//     // AutoFocusConstants->bMaxNumberContinuouslyInstableTime = 1
HM5065_write_cmos_sensor(0x077E,0x03);//     // AutoFocusConstants->bMaxNumberContinuouslyStableFrame = 3
HM5065_write_cmos_sensor(0x0783,0x10);//     // AutoFocusConstants->bLightGap = 10 
HM5065_write_cmos_sensor(0x0785,0x14);//     // AutoFocusConstants->uwDeltaValue = 20
HM5065_write_cmos_sensor(0x0788,0x04);//     // AutoFocusConstants->bMinNumberMacroRegion = 4 mk add
...
HM5065_write_cmos_sensor(0x056c,0x42);
HM5065_write_cmos_sensor(0x056d,0x00);
HM5065_write_cmos_sensor(0x056e,0x41);
HM5065_write_cmos_sensor(0x056f,0xc0);
HM5065_write_cmos_sensor(0x0570,0x41);
HM5065_write_cmos_sensor(0x0571,0xc0);
HM5065_write_cmos_sensor(0x0572,0x42);
HM5065_write_cmos_sensor(0x0573,0x00);
#endif
...
HM5065_table_write_cmos_sensor(addr_data_pair, sizeof(addr_data_pair)/sizeof(kal_uint8));	
mdelay(200);
static const kal_uint8 addr_data_pair1[] =
{
	0x0009,0x17,
	0x0012,0x00,
	0x0013,0x00,
...
HM5065_table_write_cmos_sensor(addr_data_pair1, sizeof(addr_data_pair1)/sizeof(kal_uint8));
...
void HM5065_set_brightness(UINT16 para)
{
    HM5065SENSORDB("[HM5065]CONTROLFLOW enter HM5065_set_brightness function:\n ");
		...
		{
			case ISP_BRIGHT_LOW:
				  HM5065_write_cmos_sensor(0x0130,0xfb);
				 break; 
			case ISP_BRIGHT_HIGH:  
				  HM5065_write_cmos_sensor(0x0130,0x02);
				 break; 
			case ISP_BRIGHT_MIDDLE:
				  HM5065_write_cmos_sensor(0x0130,0x00);//00->fe
			default:	
				 break; 
		}
...
void HM5065_set_saturation(UINT16 para)
{
    ...
    {
        case ISP_SAT_HIGH:
             HM5065_write_cmos_sensor(0x0081 ,0x78);
        ...
        case ISP_SAT_MIDDLE:
        default:
             HM5065_write_cmos_sensor(0x0081 ,0x50); //54->60
             break; 
    }	
