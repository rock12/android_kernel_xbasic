...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x24 , 0x12); //pad drive 13 16 17 1f  //libo 0x17 0x16 -> 15 0707 11 10 00 12
	...
	*/
	...
	GC2035_write_cmos_sensor(0x87 , 0xb0); //[7]middle gamma  90 jon
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x2f);//dn_b_base //0x1f jon
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;//ISP_DRIVING_8MA
...
{ 
	...
	GC2035_write_cmos_sensor(0xfe,0x00);
	//shutter = (GC2035_read_cmos_sensor(0x03) << 8)|GC2035_read_cmos_sensor(0x04); 
	dg_pre = GC2035_read_cmos_sensor(0xb1);
	dg_post = GC2035_read_cmos_sensor(0xb2);
	//GC2035_SET_PAGE1;
	//shutter_limit = (GC2035_read_cmos_sensor(0x2d) << 8)|GC2035_read_cmos_sensor(0x2e); 
	//GC2035_SET_PAGE0;
	if((dg_pre >= 0x48)&&(dg_post >= 0x60))//(shutter <= shutter_limit)&&
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		break;
		case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO: //auto flashlight pyj
