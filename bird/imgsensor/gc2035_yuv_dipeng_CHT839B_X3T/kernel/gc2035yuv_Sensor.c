...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xad , 0x7a);
	GC2035_write_cmos_sensor(0xae , 0x7a);
	GC2035_write_cmos_sensor(0xaf , 0x7d);
	...
	*/
	...
	#else
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x20);//21
	GC2035_write_cmos_sensor(0xc3 , 0x19);
	GC2035_write_cmos_sensor(0xc4 , 0x11);
	GC2035_write_cmos_sensor(0xc8 , 0x16);//24
	GC2035_write_cmos_sensor(0xc9 , 0x17);
	GC2035_write_cmos_sensor(0xca , 0x12);
	GC2035_write_cmos_sensor(0xbc , 0x40);//41
	GC2035_write_cmos_sensor(0xbd , 0x41);
	GC2035_write_cmos_sensor(0xbe , 0x23);
	GC2035_write_cmos_sensor(0xb6 , 0x28);//48
	GC2035_write_cmos_sensor(0xb7 , 0x2a);
	GC2035_write_cmos_sensor(0xb8 , 0x18);//22
	GC2035_write_cmos_sensor(0xc5 , 0x0d);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x40);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x40);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3a);//contrast \D3
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfc);//luma_offset // 0x00	0626
