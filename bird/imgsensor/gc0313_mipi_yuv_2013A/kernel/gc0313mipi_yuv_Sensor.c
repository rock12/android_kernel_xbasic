 ...
 *------------------------------------------------------------------------------
 * $Log: gc0313mipi_yuv_Sensor.c,v $
 * Revision 1.2  2013/09/17 08:03:38  huangwenjian
 * Bug[none]
 *
 * Reason:for I9 sub imgsensor
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/09/16 06:32:39  huangwenjian
 * Bug[none]
 *
 * Reason:for I9 sub imgsensor
 * Author:Huangwenjian
...
kal_uint16 GC0313MIPI_write_cmos_sensor(kal_uint8 addr, kal_uint8 para)
{
	...
	iWriteRegI2C(puSendCmd , 2, GC0313MIPI_WRITE_ID);
...
static kal_uint32 GC0313MIPI_g_fPV_PCLK = 24;//26
	...
	else 
	{
		...
		if(GC0313MIPI_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0313MIPI_write_cmos_sensor(0x33, 0x20);
           	       GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
			GC0313MIPIGammaSelect(GC0313MIPI_RGB_Gamma_m2); // GC0313MIPI_RGB_Gamma_m4  hms
...
void GC0313MIPI_Sensor_Init(void)
{
	...
	GC0313MIPI_write_cmos_sensor(0x77 , 0x6f); 
	GC0313MIPI_write_cmos_sensor(0x78 , 0x40); 
	GC0313MIPI_write_cmos_sensor(0x79 , 0x54); 
	...
	GC0313MIPI_write_cmos_sensor(0x03 , 0x01);
	GC0313MIPI_write_cmos_sensor(0x04 , 0x2c);
	GC0313MIPI_write_cmos_sensor(0x05 , 0x00);
	GC0313MIPI_write_cmos_sensor(0x06 , 0x6a);
	GC0313MIPI_write_cmos_sensor(0x07 , 0x00);
	GC0313MIPI_write_cmos_sensor(0x08 , 0x25);
	...
	////////////////////////////////////////////////////	
		GC0313MIPI_write_cmos_sensor(0xfe , 0x00);
		GC0313MIPI_write_cmos_sensor(0x05 , 0x01); //HB
		GC0313MIPI_write_cmos_sensor(0x06 , 0xb6); 
		GC0313MIPI_write_cmos_sensor(0x07 , 0x00); //VB
		GC0313MIPI_write_cmos_sensor(0x08 , 0x2a); 
			
	    GC0313MIPI_write_cmos_sensor(0xfe , 0x01);
		GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
		GC0313MIPI_write_cmos_sensor(0x2a , 0x35); //step
		GC0313MIPI_write_cmos_sensor(0x2b , 0x02); //14fps
		GC0313MIPI_write_cmos_sensor(0x2c , 0x12);
		GC0313MIPI_write_cmos_sensor(0x2d , 0x02); //11fps
		GC0313MIPI_write_cmos_sensor(0x2e , 0x7c);
		GC0313MIPI_write_cmos_sensor(0x2f , 0x02); //8fps
		GC0313MIPI_write_cmos_sensor(0x30 , 0xe6);
		GC0313MIPI_write_cmos_sensor(0x31 , 0x04); //4fps
		GC0313MIPI_write_cmos_sensor(0x32 , 0x24); 
	    GC0313MIPI_write_cmos_sensor(0xfe , 0x00);
	////////////////////////////////////////////////////
	//////////////////// Y Gamma ///////////////////////
	////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////
	#if 1
	GC0313MIPI_write_cmos_sensor(0xb0 , 0x1f);
	GC0313MIPI_write_cmos_sensor(0xb1 , 0x25);//27
	GC0313MIPI_write_cmos_sensor(0xb2 , 0xfc);//07
	GC0313MIPI_write_cmos_sensor(0xb3 , 0xf7);
	GC0313MIPI_write_cmos_sensor(0xb4 , 0xed);
	GC0313MIPI_write_cmos_sensor(0xb5 , 0x1c);
	GC0313MIPI_write_cmos_sensor(0xb6 , 0x19);
	GC0313MIPI_write_cmos_sensor(0xb7 , 0xe2);
	GC0313MIPI_write_cmos_sensor(0xb8 , 0x05);
	#else
	GC0313MIPI_write_cmos_sensor(0xb0 , 0x14);
	GC0313MIPI_write_cmos_sensor(0xb1 , 0x27);//27
	GC0313MIPI_write_cmos_sensor(0xb2 , 0x07);//07
	...
	GC0313MIPI_write_cmos_sensor(0x82 , 0x6c);//78 hms
	...
	GC0313MIPI_write_cmos_sensor(0x95 , 0x44); //86 //54_hms
	...
	GC0313MIPI_write_cmos_sensor(0x9c , 0x00);
	GC0313MIPI_write_cmos_sensor(0xfe , 0x00);
	...
	GC0313MIPI_write_cmos_sensor(0x13 , 0x88);
	...
	GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
	GC0313MIPI_write_cmos_sensor(0x2a , 0x4b);
	GC0313MIPI_write_cmos_sensor(0x2b , 0x02);
	GC0313MIPI_write_cmos_sensor(0x2c , 0x30);
	GC0313MIPI_write_cmos_sensor(0x2d , 0x02);
	GC0313MIPI_write_cmos_sensor(0x2e , 0xa0);
	GC0313MIPI_write_cmos_sensor(0x2f , 0x03);
	GC0313MIPI_write_cmos_sensor(0x30 , 0x80);
	GC0313MIPI_write_cmos_sensor(0x31 , 0x05);
	...
	GC0313MIPI_write_cmos_sensor(0xd1 , 0x28);//38
	GC0313MIPI_write_cmos_sensor(0xd2 , 0x24);//38
	GC0313MIPI_write_cmos_sensor(0xd3 , 0x41);//40
	GC0313MIPI_write_cmos_sensor(0xd5 , 0x04);//luma offset 
	...
	GC0313MIPI_write_cmos_sensor(0x52 , 0x18); //20_hms
	GC0313MIPI_write_cmos_sensor(0x53 , 0x08);
	GC0313MIPI_write_cmos_sensor(0x54 , 0x15); //10_hms
	GC0313MIPI_write_cmos_sensor(0x55 , 0x25); //20_hms
	...
	GC0313MIPI_write_cmos_sensor(0x74 , 0x1b);                                       
	...
	GC0313MIPI_write_cmos_sensor(0x82 , 0x60); //60
	GC0313MIPI_write_cmos_sensor(0x83 , 0xb0); 
...
{
    	GC0313MIPIGammaSelect(GC0313MIPI_RGB_Gamma_m2);//0:use default//0 // GC0313MIPI_RGB_Gamma_m4 hms
}
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    default:
        pSensorInfo->SensorClockFreq=12;//26
...
BOOL GC0313MIPI_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_SEPIABLUE:
			GC0313MIPI_write_cmos_sensor(0x43 , 0x02);
			GC0313MIPI_write_cmos_sensor(0xda , 0x50);
			GC0313MIPI_write_cmos_sensor(0xdb , 0xe0);
		break;
...
BOOL GC0313MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			/*
			GC0313MIPI_write_cmos_sensor(0x05 , 0x00); //HB
			GC0313MIPI_write_cmos_sensor(0x06 , 0x6a); 
			GC0313MIPI_write_cmos_sensor(0x07 , 0x00); //VB
			GC0313MIPI_write_cmos_sensor(0x08 , 0x25); 
			...
			GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
			GC0313MIPI_write_cmos_sensor(0x2a , 0x4b); //step
			GC0313MIPI_write_cmos_sensor(0x2b , 0x02); //14fps
			GC0313MIPI_write_cmos_sensor(0x2c , 0x58);
			GC0313MIPI_write_cmos_sensor(0x2d , 0x02); //11fps
			GC0313MIPI_write_cmos_sensor(0x2e , 0xee);
			GC0313MIPI_write_cmos_sensor(0x2f , 0x03); //8fps
			GC0313MIPI_write_cmos_sensor(0x30 , 0x84);
			GC0313MIPI_write_cmos_sensor(0x31 , 0x05); //4fps
			GC0313MIPI_write_cmos_sensor(0x32 , 0xdc); 
			GC0313MIPI_SET_PAGE0;
			*/
			/*
			GC0313MIPI_write_cmos_sensor(0x05 , 0x01); //HB
			GC0313MIPI_write_cmos_sensor(0x06 , 0xb6); 
			GC0313MIPI_write_cmos_sensor(0x07 , 0x01); //VB
			GC0313MIPI_write_cmos_sensor(0x08 , 0x68); 
			
			GC0313MIPI_SET_PAGE1;
			GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
			GC0313MIPI_write_cmos_sensor(0x2a , 0x6a); //step
			//GC0313MIPI_write_cmos_sensor(0x2b , 0x03); //14fps
			//GC0313MIPI_write_cmos_sensor(0x2c , 0x50);
			//GC0313MIPI_write_cmos_sensor(0x2d , 0x04); //11fps
			//GC0313MIPI_write_cmos_sensor(0x2e , 0xf8);
			//GC0313MIPI_write_cmos_sensor(0x2f , 0x06); //8fps
			//GC0313MIPI_write_cmos_sensor(0x30 , 0x36);
			//GC0313MIPI_write_cmos_sensor(0x31 , 0x08); //4fps
			//GC0313MIPI_write_cmos_sensor(0x32 , 0x48); 
			GC0313MIPI_write_cmos_sensor(0x2b , 0x06); //14fps
			GC0313MIPI_write_cmos_sensor(0x2c , 0x36);
			GC0313MIPI_write_cmos_sensor(0x2d , 0x06); //11fps
			GC0313MIPI_write_cmos_sensor(0x2e , 0x36);
			GC0313MIPI_write_cmos_sensor(0x2f , 0x08); //8fps
			GC0313MIPI_write_cmos_sensor(0x30 , 0x48);
			GC0313MIPI_write_cmos_sensor(0x31 , 0x08); //4fps
			GC0313MIPI_write_cmos_sensor(0x32 , 0x48); 
			GC0313MIPI_SET_PAGE0;			
			*/
		...
		case AE_FLICKER_MODE_60HZ:
			/*
			GC0313MIPI_write_cmos_sensor(0x05 , 0x00); //HB
			GC0313MIPI_write_cmos_sensor(0x06 , 0xc7); 
			GC0313MIPI_write_cmos_sensor(0x07 , 0x00); //VB
			GC0313MIPI_write_cmos_sensor(0x08 , 0x10); 
			
			GC0313MIPI_SET_PAGE1;
			GC0313MIPI_write_cmos_sensor(0x29, 0x00);
			GC0313MIPI_write_cmos_sensor(0x2a , 0x38); //step
			GC0313MIPI_write_cmos_sensor(0x2b , 0x02); //14fps
			GC0313MIPI_write_cmos_sensor(0x2c , 0x30);
			GC0313MIPI_write_cmos_sensor(0x2d , 0x02); //11fps
			GC0313MIPI_write_cmos_sensor(0x2e , 0xa0);
			...
			*/
			/*
			GC0313MIPI_write_cmos_sensor(0x05 , 0x01); //HB
			GC0313MIPI_write_cmos_sensor(0x06 , 0xa1); 
			GC0313MIPI_write_cmos_sensor(0x07 , 0x01); //VB
			GC0313MIPI_write_cmos_sensor(0x08 , 0x9c); 
			
			GC0313MIPI_SET_PAGE1;
			GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
			GC0313MIPI_write_cmos_sensor(0x2a , 0x5a); //step
			//GC0313MIPI_write_cmos_sensor(0x2b , 0x02); //14fps
			//GC0313MIPI_write_cmos_sensor(0x2c , 0xd0);
			//GC0313MIPI_write_cmos_sensor(0x2d , 0x04); //11fps
			//GC0313MIPI_write_cmos_sensor(0x2e , 0xec);
			//GC0313MIPI_write_cmos_sensor(0x2f , 0x06); //8fps
			//GC0313MIPI_write_cmos_sensor(0x30 , 0x54);
			//GC0313MIPI_write_cmos_sensor(0x31 , 0x08); //4fps
			//GC0313MIPI_write_cmos_sensor(0x32 , 0x70); 
			GC0313MIPI_write_cmos_sensor(0x2b , 0x06); //14fps
			GC0313MIPI_write_cmos_sensor(0x2c , 0x54);
			GC0313MIPI_write_cmos_sensor(0x2d , 0x06); //11fps
			GC0313MIPI_write_cmos_sensor(0x2e , 0x54);
			GC0313MIPI_write_cmos_sensor(0x2f , 0x08); //8fps
			GC0313MIPI_write_cmos_sensor(0x30 , 0x70);
			GC0313MIPI_write_cmos_sensor(0x31 , 0x08); //4fps
			GC0313MIPI_write_cmos_sensor(0x32 , 0x70); 			
			GC0313MIPI_SET_PAGE0;		
			*/
			GC0313MIPI_write_cmos_sensor(0x05 , 0x01); //HB
			GC0313MIPI_write_cmos_sensor(0x06 , 0x89); 
			GC0313MIPI_write_cmos_sensor(0x07 , 0x00); //VB
			GC0313MIPI_write_cmos_sensor(0x08 , 0x40); 
			
			GC0313MIPI_SET_PAGE1;
			GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
			GC0313MIPI_write_cmos_sensor(0x2a , 0x2e); //step
			GC0313MIPI_write_cmos_sensor(0x2b , 0x02); //14fps
			GC0313MIPI_write_cmos_sensor(0x2c , 0x28);
			GC0313MIPI_write_cmos_sensor(0x2d , 0x02); //11fps
			GC0313MIPI_write_cmos_sensor(0x2e , 0x84);
			GC0313MIPI_write_cmos_sensor(0x2f , 0x03); //8fps
			GC0313MIPI_write_cmos_sensor(0x30 , 0x0e);
			GC0313MIPI_write_cmos_sensor(0x31 , 0x04); //4fps
			GC0313MIPI_write_cmos_sensor(0x32 , 0x50); 
			GC0313MIPI_SET_PAGE0;			
		break;
		default:
		return FALSE;
...
BOOL GC0313MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:		
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x75);//45
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
			GC0313MIPI_write_cmos_sensor(0xd5, 0x04); //00_hms
		break;

		case AE_EV_COMP_03:
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x80);
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
		...
		case AE_EV_COMP_10:			
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x90);
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
		...
		case AE_EV_COMP_13:
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x98);
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
