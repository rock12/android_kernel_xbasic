...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x24 , 0x1f); //pad drive  16     0x17->0x1f  20131218
	...
	GC2035_write_cmos_sensor(0xad , 0x40);
	GC2035_write_cmos_sensor(0xae , 0x28);
	GC2035_write_cmos_sensor(0xaf , 0x28);
	GC2035_write_cmos_sensor(0xb0 , 0x40);
	...
	GC2035_write_cmos_sensor(0xc0 , 0x36);
	GC2035_write_cmos_sensor(0xc1 , 0x3c);
	GC2035_write_cmos_sensor(0xc2 , 0x2c);
	GC2035_write_cmos_sensor(0xc3 , 0x23);
	...
	GC2035_write_cmos_sensor(0xc8 , 0x40);
	...
	GC2035_write_cmos_sensor(0xd8 , 0x12);
	GC2035_write_cmos_sensor(0xda , 0x3f);
	GC2035_write_cmos_sensor(0xdb , 0x3f);
	GC2035_write_cmos_sensor(0xdc , 0x40);
