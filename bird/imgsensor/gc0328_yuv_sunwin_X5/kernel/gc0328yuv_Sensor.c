 ...
 * Revision 1.6  2013/07/24 11:50:18  wangqiang
 * 13E35_X5
 * 0328效果优化
 *
...
void GC0328NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0328_write_cmos_sensor(0xfe, 0x01);
		GC0328_write_cmos_sensor(0x21 , 0xc8);///////c0
...
void GC0328_Sensor_Init(void)
	...
	*/
    ...
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror
		...
		GC0328_write_cmos_sensor(0x95 , 0x43);
		...
		GC0328_write_cmos_sensor(0xa3 , 0x83);////45
		
		GC0328_write_cmos_sensor(0xa4 , 0x10);
		
		GC0328_write_cmos_sensor(0xa7 , 0x90);/////60
		
		
		GC0328_write_cmos_sensor(0xa8 , 0xB0);
		GC0328_write_cmos_sensor(0xaa , 0xa0);//////40
		...
		///////////////////////////////////////
		GC0328_write_cmos_sensor(0xfe , 0x01);
		GC0328_write_cmos_sensor(0x9c , 0x00);/////02
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x2c, 0x00); 
			GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps
			GC0328_write_cmos_sensor(0x2e , 0xc0); //2c 600
			GC0328_write_cmos_sensor(0x2f , 0x06); //1650////////540
