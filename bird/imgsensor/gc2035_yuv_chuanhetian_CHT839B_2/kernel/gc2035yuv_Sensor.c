 ...
 * Revision 1.1  2013/10/14 10:14:04  wangdong
 * no message
 *
 * Revision 1.2  2013/08/27 09:00:11  wangdong
 * 优化shading
 *
 * Revision 1.3  2013/08/26 13:09:37  wangdong
 * no message
 *
 * Revision 1.2  2013/08/12 07:20:23  wangqiang
 * 13C35_9500B
 * 量产摄像头不一致，部分预览偏红
 *
 * Revision 1.1  2013/07/02 12:34:05  wangqiang
 * cam效果优化
 *
...
//#define GC2035ISP_DEBUG   	  //LSC&AWB tools
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0x8f);
	...
	GC2035_write_cmos_sensor(0xad , 0x80);//0x84
	GC2035_write_cmos_sensor(0xae , 0x7d);//0x7c
	GC2035_write_cmos_sensor(0xaf , 0x80);//0x7d
	...
	*/
	...
	GC2035_write_cmos_sensor(0x08,  0xe1);  
	GC2035_write_cmos_sensor(0xfe,  0x01);  
	GC2035_write_cmos_sensor(0x27,  0x00);//step
	GC2035_write_cmos_sensor(0x28,  0x83);  
	GC2035_write_cmos_sensor(0x29,  0x05);//9fps
	GC2035_write_cmos_sensor(0x2a,  0xa1);  
	GC2035_write_cmos_sensor(0x2b,  0x06);//8.33fps
	GC2035_write_cmos_sensor(0x2c,  0x24);  
	GC2035_write_cmos_sensor(0x2d,  0x06);//7.69fps
	GC2035_write_cmos_sensor(0x2e,  0xa7);  
	GC2035_write_cmos_sensor(0x2f,  0x0a);//5fps
	GC2035_write_cmos_sensor(0x30,  0x3c); 
	GC2035_write_cmos_sensor(0xfe , 0x00);  //
	...
	GC2035_write_cmos_sensor(0xb0 , 0x80); //globle gain  80 90
	GC2035_write_cmos_sensor(0xc0 , 0x40);//Yuv bypass

	//////lsc/////////////
	#if 1
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xa1 , 0x7a);
	GC2035_write_cmos_sensor(0xa2 , 0x7f);
	GC2035_write_cmos_sensor(0xa4 , 0x73);
	GC2035_write_cmos_sensor(0xa5 , 0x77);
	GC2035_write_cmos_sensor(0xa6 , 0x73);
	GC2035_write_cmos_sensor(0xa7 , 0x77);
	GC2035_write_cmos_sensor(0xa8 , 0x00);
	GC2035_write_cmos_sensor(0xa9 , 0x40);
	GC2035_write_cmos_sensor(0xaa , 0x08);
	GC2035_write_cmos_sensor(0xab , 0x1b);
	GC2035_write_cmos_sensor(0xac , 0x1e);
	GC2035_write_cmos_sensor(0xad , 0x05);
	GC2035_write_cmos_sensor(0xae , 0x17);
	GC2035_write_cmos_sensor(0xaf , 0x14);
	GC2035_write_cmos_sensor(0xb0 , 0x06);
	GC2035_write_cmos_sensor(0xb1 , 0x17);
	GC2035_write_cmos_sensor(0xb2 , 0x12);
	GC2035_write_cmos_sensor(0xb3 , 0x03);
	GC2035_write_cmos_sensor(0xb4 , 0x12);
	GC2035_write_cmos_sensor(0xb5 , 0x15);
	GC2035_write_cmos_sensor(0xb6 , 0x5e);
	GC2035_write_cmos_sensor(0xb7 , 0x48);
	GC2035_write_cmos_sensor(0xb8 , 0x36);
	GC2035_write_cmos_sensor(0xb9 , 0x05);
	GC2035_write_cmos_sensor(0xba , 0x13);
	GC2035_write_cmos_sensor(0xbb , 0x14);
	GC2035_write_cmos_sensor(0xbc , 0x59);
	GC2035_write_cmos_sensor(0xbd , 0x43);
	GC2035_write_cmos_sensor(0xbe , 0x35);
	GC2035_write_cmos_sensor(0xbf , 0x09);
	GC2035_write_cmos_sensor(0xc0 , 0x11);
	GC2035_write_cmos_sensor(0xc1 , 0x06);
	GC2035_write_cmos_sensor(0xc2 , 0x3a);
	GC2035_write_cmos_sensor(0xc3 , 0x32);
	GC2035_write_cmos_sensor(0xc4 , 0x27);
	GC2035_write_cmos_sensor(0xc5 , 0x08);
	GC2035_write_cmos_sensor(0xc6 , 0x2b);
	GC2035_write_cmos_sensor(0xc7 , 0x1e);
	GC2035_write_cmos_sensor(0xc8 , 0x31);
	GC2035_write_cmos_sensor(0xc9 , 0x36);
	GC2035_write_cmos_sensor(0xca , 0x2b);
	GC2035_write_cmos_sensor(0xcb , 0x0d);
	GC2035_write_cmos_sensor(0xcc , 0x35);
	GC2035_write_cmos_sensor(0xcd , 0x27);
	GC2035_write_cmos_sensor(0xd0 , 0x23);
	GC2035_write_cmos_sensor(0xd2 , 0x2b);
	GC2035_write_cmos_sensor(0xd3 , 0x46);
	GC2035_write_cmos_sensor(0xd4 , 0x21);
	GC2035_write_cmos_sensor(0xd6 , 0x2d);
	GC2035_write_cmos_sensor(0xd7 , 0x49);
	GC2035_write_cmos_sensor(0xd8 , 0x02);
	GC2035_write_cmos_sensor(0xda , 0x1e);
	GC2035_write_cmos_sensor(0xdb , 0x18);
	GC2035_write_cmos_sensor(0xdc , 0x3a);
	GC2035_write_cmos_sensor(0xde , 0x38);
	GC2035_write_cmos_sensor(0xdf , 0x2b);
        #else  //shun tai 959A
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xa1 , 0x85);
	GC2035_write_cmos_sensor(0xa2 , 0x80);
	GC2035_write_cmos_sensor(0xa4 , 0x77);
	GC2035_write_cmos_sensor(0xa5 , 0x77);
	GC2035_write_cmos_sensor(0xa6 , 0x67);
	GC2035_write_cmos_sensor(0xa7 , 0x77);
	GC2035_write_cmos_sensor(0xa8 , 0x04);
	GC2035_write_cmos_sensor(0xa9 , 0x00);
	GC2035_write_cmos_sensor(0xaa , 0x10);
	GC2035_write_cmos_sensor(0xab , 0x0e);
	GC2035_write_cmos_sensor(0xac , 0x0b);
	GC2035_write_cmos_sensor(0xad , 0x0e);
	GC2035_write_cmos_sensor(0xae , 0x09);
	GC2035_write_cmos_sensor(0xaf , 0x0e);
	GC2035_write_cmos_sensor(0xb0 , 0x14);
	GC2035_write_cmos_sensor(0xb1 , 0x12);
	GC2035_write_cmos_sensor(0xb2 , 0x15);
	GC2035_write_cmos_sensor(0xb3 , 0x03);
	GC2035_write_cmos_sensor(0xb4 , 0x0e);
	GC2035_write_cmos_sensor(0xb5 , 0x0d);
	GC2035_write_cmos_sensor(0xb6 , 0x69);
	GC2035_write_cmos_sensor(0xb7 , 0x3a);
	GC2035_write_cmos_sensor(0xb8 , 0x2d);
	GC2035_write_cmos_sensor(0xb9 , 0x07);
	GC2035_write_cmos_sensor(0xba , 0x07);
	GC2035_write_cmos_sensor(0xbb , 0x01);
	GC2035_write_cmos_sensor(0xbc , 0x6a);
	GC2035_write_cmos_sensor(0xbd , 0x3c);
	GC2035_write_cmos_sensor(0xbe , 0x2b);
	GC2035_write_cmos_sensor(0xbf , 0x11);
	GC2035_write_cmos_sensor(0xc0 , 0x05);
	GC2035_write_cmos_sensor(0xc1 , 0x08);
	GC2035_write_cmos_sensor(0xc2 , 0x3b);
	GC2035_write_cmos_sensor(0xc3 , 0x2c);
	GC2035_write_cmos_sensor(0xc4 , 0x22);
	GC2035_write_cmos_sensor(0xc5 , 0x1f);
	GC2035_write_cmos_sensor(0xc6 , 0x20);
	GC2035_write_cmos_sensor(0xc7 , 0x15);
	GC2035_write_cmos_sensor(0xc8 , 0x48);
	GC2035_write_cmos_sensor(0xc9 , 0x2a);
	GC2035_write_cmos_sensor(0xca , 0x20);
	GC2035_write_cmos_sensor(0xcb , 0x25);
	GC2035_write_cmos_sensor(0xcc , 0x1a);
	GC2035_write_cmos_sensor(0xcd , 0x10);
	GC2035_write_cmos_sensor(0xd0 , 0x42);
	GC2035_write_cmos_sensor(0xd2 , 0x34);
	GC2035_write_cmos_sensor(0xd3 , 0x27);
	GC2035_write_cmos_sensor(0xd4 , 0x01);
	GC2035_write_cmos_sensor(0xd6 , 0x18);
	GC2035_write_cmos_sensor(0xd7 , 0x13);
	GC2035_write_cmos_sensor(0xd8 , 0x29);
	GC2035_write_cmos_sensor(0xda , 0x27);
	GC2035_write_cmos_sensor(0xdb , 0x42);
	GC2035_write_cmos_sensor(0xdc , 0x2d);
	GC2035_write_cmos_sensor(0xde , 0x25);
...
#if 1//Lens_of_PS350A
	GC2035_write_cmos_sensor(0x4f , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0x25);
	...
	GC2035_write_cmos_sensor(0x4e , 0x20);
	GC2035_write_cmos_sensor(0x4d , 0x82);						
	GC2035_write_cmos_sensor(0x4e , 0x00);     
	...
	GC2035_write_cmos_sensor(0x56 , 0x22);
	GC2035_write_cmos_sensor(0x57 , 0x20); 
	GC2035_write_cmos_sensor(0x58 , 0x01); 
	GC2035_write_cmos_sensor(0x5b , 0x04); 
	...
	GC2035_write_cmos_sensor(0x8d , 0x80); //awb gain limit R 
	...
	GC2035_write_cmos_sensor(0xde , 0xb5);  //
	GC2035_write_cmos_sensor(0x38 , 0x08); // 
	...
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast \D3 //40 betty
   ...
   //// small  RGB gamma////
	...
	GC2035_write_cmos_sensor(0x17 , 0x10);//10
...
#ifdef GC2035ISP_DEBUG	
	GC2035_write_cmos_sensor(0xfe, 0x00);								   
	GC2035_write_cmos_sensor(0x80, 0x08);// 09 if tunning AWB
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2c,0x24);
		GC2035_write_cmos_sensor(0x2d,0x08);//6e8//level3//6a7
		GC2035_write_cmos_sensor(0x2e,0x30);
		GC2035_write_cmos_sensor(0x2f,0x0d);//level4
		GC2035_write_cmos_sensor(0x30,0x25);
		GC2035_SET_PAGE0; 
            break;
