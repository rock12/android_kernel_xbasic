...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x72);//add 0611
  OV5645MIPI_write_cmos_sensor(0x518a, 0x72);
  ...
  OV5645MIPI_write_cmos_sensor(0x5387, 0x88);
  OV5645MIPI_write_cmos_sensor(0x5388, 0x7d);
  OV5645MIPI_write_cmos_sensor(0x5389, 0x0b);
  ...
  */
  ...
  OV5645MIPI_write_cmos_sensor(0x3a0f, 0x2c);
	OV5645MIPI_write_cmos_sensor(0x3a10, 0x24);
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x51);
	OV5645MIPI_write_cmos_sensor(0x3a1b, 0x2c);
	OV5645MIPI_write_cmos_sensor(0x3a1e, 0x24);
