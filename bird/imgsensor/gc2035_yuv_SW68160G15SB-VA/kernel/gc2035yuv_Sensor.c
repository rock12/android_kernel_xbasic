 ...
 * Revision 1.1  2013/08/29 15:09:11  pengyajun
 * GXQ T3
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0x0c);// 0x02da	0626//28f
	...
	GC2035_write_cmos_sensor(0x1f , 0xa0);//
	GC2035_write_cmos_sensor(0x20 , 0x50);//
	...
	GC2035_write_cmos_sensor(0x2f,  0x0a);//
	...
	GC2035_write_cmos_sensor(0xa6 , 0x90); //80 betty
	...
	GC2035_write_cmos_sensor(0xde , 0xb4); 
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x36);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x36);//saturation_Cr
	...
	GC2035_write_cmos_sensor(0xd5 , 0xfb);//luma_offset  00 betty
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1c);//dn_b_base
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x00); //dn_c_weight
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
	...
	GC2035_write_cmos_sensor(0x2d,  0x06);
	GC2035_write_cmos_sensor(0x2e,  0xa7);  
	GC2035_write_cmos_sensor(0x2f,  0x07);//70a
	GC2035_write_cmos_sensor(0x30,  0xad);  
	GC2035_write_cmos_sensor(0xfe , 0x00);   
            break;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x8c);//80 betty
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
