 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: hi704yuv_Sensor.c,v $
 * Revision 1.1  2013/05/23 03:38:27  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.1  2013/02/23 02:34:21  zhuyaozhong
 * Create 6589 12U25 project
 *
 * Revision 1.1  2012/12/12 07:14:30  birdlibo
 * no message
 *
 * Revision 1.2  2012/12/10 00:40:56  zhuyaozhong
 * merged from BIRD75_ICS_V2
 *
 * Revision 1.9  2012/11/20 06:28:23  maliejun
 * [87906] [CAM]前后置camera选择夜景模式快速浏览所拍照片时点击返回手机报错
 *
 * Revision 1.8  2012/09/21 09:35:02  bianhuannan
 * no message
 *
 * Revision 1.7  2012/08/29 09:17:19  huangwenjian
 * Bug[none]
 *
 * Reason:[T7C_H12]
 * Author:Huangwenjian
 *
 * Revision 1.6  2012/08/22 07:07:27  maliejun
 * [85131] [Camera]拍照模式选择"自动场景检测", 按HOME键退出，再次进入相机会提示“很抱歉，相机已停止运行
 *
 * Revision 1.5  2012/08/06 06:45:25  birdlibo
 * mirror
 *
 * Revision 1.4  2012/07/18 11:11:42  maliejun
 * Editor: maliejun
 * Inspector:maliejun
 * Reason:[bug-null] green line
 * Reference:none
 *
 * Revision 1.3  2012/07/18 01:58:55  zhoushaohong
 * 解决夜景模式，反复进入几次camera有时会出现进不去的现象
 *
 * Revision 1.2  2012/07/17 13:00:44  zhoushaohong
 * 解决夜景模式，反复进入几次camera有时会出现进不去的问题
 *
 * Revision 1.1  2012/06/06 11:07:56  zhuyaozhong
 * create 6628 project
 *
 * Revision 1.2  2012/05/23 03:28:54  yanwangjun
 * add  t15 hi704 mirror config
 *
 * Revision 1.1  2012/05/04 03:24:23  zhuyaozhong
 * no message
 *
 * Revision 1.3  2012/04/06 09:38:15  wuyiping
 * Editor:wuyiping
 * Inspector:wuyiping
 * Reason:update for MQ430
 * Reference:none
 *
 * Revision 1.2  2012/03/15 00:27:24  yanwangjun
 * update for T8 project
 *
...
static void HI704_Set_Mirror_Flip(kal_uint8 image_mirror)
{
  /********************************************************
    ...
    *********************************************************/    
    ...
    {
        case IMAGE_NORMAL:
#if defined(BIRD_HI704_HV_MIRROR)
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_YUYV;//SENSOR_OUTPUT_FORMAT_YVYU add by zhuyaozhong 20120203 for 11HX4 project
		...
		case AWB_MODE_AUTO:
			{
		        ...
		        HI704_write_cmos_sensor(0x84, 0x12);
	            HI704_write_cmos_sensor(0x85, 0x5e);
		        HI704_write_cmos_sensor(0x86, 0x1e);				
            }                
		    break;
