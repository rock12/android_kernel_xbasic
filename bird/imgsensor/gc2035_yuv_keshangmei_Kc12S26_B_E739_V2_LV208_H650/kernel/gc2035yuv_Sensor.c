 ...
 * $Revision: 1.3 $
 * $Modtime:$
 * $Log: gc2035yuv_Sensor.c,v $
 * Revision 1.3  2013/10/24 11:23:07  wangtinglong
 * 13C43/F43 S26E/S36E/S25E/S32E
 *
 * Revision 1.2  2013/10/24 11:06:48  lijunchao
 * proformance tuning
 *
 * Revision 1.1  2013/09/27 07:33:46  zhoushaohong
 * 13C43_S25E
 *
 * Revision 1.6  2013/08/03 06:43:05  wangqiang
 * AC充电有红绿线问题
 *
 * Revision 1.5  2013/07/24 13:12:18  wangqiang
 * 拍照绿屏修复，帧率设为12fps
 *
 * Revision 1.4  2013/07/24 09:00:28  wangqiang
 * 13E43_H82
 * 优化效果
 * 预览12fps
 *
 * Revision 1.3  2013/07/17 10:15:01  wangqiang
 * 13E43_H82 cam优化
 *
 * Revision 1.2  2013/07/08 02:49:47  wangqiang
 * 效果优化
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf7 , 0x15); //pll enable
  	GC2035_write_cmos_sensor(0xf8 , 0x84);////84
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x04 , 0xdc);// 0x02da	0626//28f
	...
	GC2035_write_cmos_sensor(0xad , 0x84);//81
	GC2035_write_cmos_sensor(0xae , 0x82);//7e
	GC2035_write_cmos_sensor(0xaf , 0x7d);//hyper 0x80
	...
	GC2035_write_cmos_sensor(0x24 , 0x17); //pad drive 13 16 17 1f  //libo

	//AEC
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x11 , 0x20);//AEC_out_slope , 0x
	GC2035_write_cmos_sensor(0x1f , 0xa0);//max_post_gain
	...
	*/
		...
		GC2035_write_cmos_sensor(0x29, 0x05);//
		GC2035_write_cmos_sensor(0x2a, 0x22);  
		GC2035_write_cmos_sensor(0x2b, 0x05);//   624//6a7
		GC2035_write_cmos_sensor(0x2c, 0x22);  
		GC2035_write_cmos_sensor(0x2d, 0x05);//5b4 betty   72a
		GC2035_write_cmos_sensor(0x2e, 0x22);  
		GC2035_write_cmos_sensor(0x2f, 0x05);//76a betty
		GC2035_write_cmos_sensor(0x30, 0x22);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
	...
	GC2035_write_cmos_sensor(0x86 , 0x06); //02 06 //sync plority
...
GC2035_write_cmos_sensor(0xa5 , 0x77); 
...
GC2035_write_cmos_sensor(0xaa , 0x17); 
GC2035_write_cmos_sensor(0xab , 0x1b); 
GC2035_write_cmos_sensor(0xac , 0x10); 
GC2035_write_cmos_sensor(0xad , 0x17); 
GC2035_write_cmos_sensor(0xae , 0x18); 
GC2035_write_cmos_sensor(0xaf , 0x0e); 
GC2035_write_cmos_sensor(0xb0 , 0x0d); 
GC2035_write_cmos_sensor(0xb1 , 0x10); 
GC2035_write_cmos_sensor(0xb2 , 0x0d); 
GC2035_write_cmos_sensor(0xb3 , 0x0e); 
GC2035_write_cmos_sensor(0xb4 , 0x12); 
GC2035_write_cmos_sensor(0xb5 , 0x0d); 
GC2035_write_cmos_sensor(0xb6 , 0x00); 
GC2035_write_cmos_sensor(0xb7 , 0x00); 
GC2035_write_cmos_sensor(0xb8 , 0x09); 
GC2035_write_cmos_sensor(0xb9 , 0x0c); 
GC2035_write_cmos_sensor(0xba , 0x0f); 
GC2035_write_cmos_sensor(0xbb , 0x16); 
GC2035_write_cmos_sensor(0xbc , 0x00); 
GC2035_write_cmos_sensor(0xbd , 0x00); 
GC2035_write_cmos_sensor(0xbe , 0x06); 
GC2035_write_cmos_sensor(0xbf , 0x0b); 
GC2035_write_cmos_sensor(0xc0 , 0x0d); 
GC2035_write_cmos_sensor(0xc1 , 0x13); 
GC2035_write_cmos_sensor(0xc2 , 0x00); 
GC2035_write_cmos_sensor(0xc3 , 0x00); 
GC2035_write_cmos_sensor(0xc4 , 0x06); 
GC2035_write_cmos_sensor(0xc5 , 0x0c); 
GC2035_write_cmos_sensor(0xc6 , 0x0f); 
GC2035_write_cmos_sensor(0xc7 , 0x17); 
GC2035_write_cmos_sensor(0xc8 , 0x02); 
GC2035_write_cmos_sensor(0xc9 , 0x01); 
GC2035_write_cmos_sensor(0xca , 0x0d); 
GC2035_write_cmos_sensor(0xcb , 0x09); 
GC2035_write_cmos_sensor(0xcc , 0x08); 
GC2035_write_cmos_sensor(0xcd , 0x26); 
GC2035_write_cmos_sensor(0xd0 , 0x37); 
GC2035_write_cmos_sensor(0xd2 , 0x42); 
GC2035_write_cmos_sensor(0xd3 , 0x10); 
GC2035_write_cmos_sensor(0xd4 , 0x22); 
GC2035_write_cmos_sensor(0xd6 , 0x2b); 
GC2035_write_cmos_sensor(0xd7 , 0x06); 
GC2035_write_cmos_sensor(0xd8 , 0x38); 
GC2035_write_cmos_sensor(0xda , 0x3b); 
GC2035_write_cmos_sensor(0xdb , 0x0b); 
GC2035_write_cmos_sensor(0xdc , 0x20); 
GC2035_write_cmos_sensor(0xde , 0x24); 
GC2035_write_cmos_sensor(0xdf , 0x07); 
*/
///////////////////////keshangmei_tuning_1219//////////
GC2035_write_cmos_sensor(0xfe,0x01);
GC2035_write_cmos_sensor(0xa1,0x80);
GC2035_write_cmos_sensor(0xa2,0x80);
GC2035_write_cmos_sensor(0xa4,0x10);
GC2035_write_cmos_sensor(0xa5,0x07);
GC2035_write_cmos_sensor(0xa6,0x30);
GC2035_write_cmos_sensor(0xa7,0x36);
GC2035_write_cmos_sensor(0xa8,0x66);
GC2035_write_cmos_sensor(0xa9,0x77);
GC2035_write_cmos_sensor(0xaa,0x0d);
GC2035_write_cmos_sensor(0xab,0x02);
GC2035_write_cmos_sensor(0xac,0x15);
GC2035_write_cmos_sensor(0xad,0x34);
GC2035_write_cmos_sensor(0xae,0x18);
GC2035_write_cmos_sensor(0xaf,0x17);
GC2035_write_cmos_sensor(0xb0,0x1c);
GC2035_write_cmos_sensor(0xb1,0x0d);
GC2035_write_cmos_sensor(0xb2,0x0f);
GC2035_write_cmos_sensor(0xb3,0x0d);
GC2035_write_cmos_sensor(0xb4,0x03);
GC2035_write_cmos_sensor(0xb5,0x12);
GC2035_write_cmos_sensor(0xb6,0x40);
GC2035_write_cmos_sensor(0xb7,0x40);
GC2035_write_cmos_sensor(0xb8,0x34);
GC2035_write_cmos_sensor(0xb9,0x08);
GC2035_write_cmos_sensor(0xba,0x07);
GC2035_write_cmos_sensor(0xbb,0x06);
GC2035_write_cmos_sensor(0xbc,0x40);
GC2035_write_cmos_sensor(0xbd,0x40);
GC2035_write_cmos_sensor(0xbe,0x40);
GC2035_write_cmos_sensor(0xbf,0x3c);
GC2035_write_cmos_sensor(0xc0,0x07);
GC2035_write_cmos_sensor(0xc1,0x05);
GC2035_write_cmos_sensor(0xc2,0x40);
GC2035_write_cmos_sensor(0xc3,0x37);
GC2035_write_cmos_sensor(0xc4,0x32);
GC2035_write_cmos_sensor(0xc5,0x00);
GC2035_write_cmos_sensor(0xc6,0x1f);
GC2035_write_cmos_sensor(0xc7,0x21);
GC2035_write_cmos_sensor(0xc8,0x32);
GC2035_write_cmos_sensor(0xc9,0x2e);
GC2035_write_cmos_sensor(0xca,0x1e);
GC2035_write_cmos_sensor(0xcb,0x0f);
GC2035_write_cmos_sensor(0xcc,0x1d);
GC2035_write_cmos_sensor(0xcd,0x0f);
GC2035_write_cmos_sensor(0xd0,0x3e);
GC2035_write_cmos_sensor(0xd2,0x2e);
GC2035_write_cmos_sensor(0xd3,0x0f);
GC2035_write_cmos_sensor(0xd4,0x0d);
GC2035_write_cmos_sensor(0xd6,0x2d);
GC2035_write_cmos_sensor(0xd7,0x05);
GC2035_write_cmos_sensor(0xd8,0x3f);
GC2035_write_cmos_sensor(0xda,0x31);
GC2035_write_cmos_sensor(0xdb,0x3f);
GC2035_write_cmos_sensor(0xdc,0x3f);
GC2035_write_cmos_sensor(0xde,0x3f);
GC2035_write_cmos_sensor(0xdf,0x3f);
GC2035_write_cmos_sensor(0xfe,0x00);
/////////////////////////////////////////////////////
	#else
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x21);
	GC2035_write_cmos_sensor(0xc3 , 0x19);
	GC2035_write_cmos_sensor(0xc4 , 0x11);
	GC2035_write_cmos_sensor(0xc8 , 0x24);
	GC2035_write_cmos_sensor(0xc9 , 0x17);
	GC2035_write_cmos_sensor(0xca , 0x12);
	GC2035_write_cmos_sensor(0xbc , 0x41);
	GC2035_write_cmos_sensor(0xbd , 0x41);
	GC2035_write_cmos_sensor(0xbe , 0x23);
	GC2035_write_cmos_sensor(0xb6 , 0x48);
	GC2035_write_cmos_sensor(0xb7 , 0x28);
	GC2035_write_cmos_sensor(0xb8 , 0x22);
	GC2035_write_cmos_sensor(0xc5 , 0x0f);
	GC2035_write_cmos_sensor(0xc6 , 0x07);
	...
	GC2035_write_cmos_sensor(0xbf , 0x07);
	GC2035_write_cmos_sensor(0xc0 , 0x22);
	GC2035_write_cmos_sensor(0xc1 , 0x01);
	GC2035_write_cmos_sensor(0xb9 , 0x12);
	GC2035_write_cmos_sensor(0xba , 0x10);
	GC2035_write_cmos_sensor(0xbb , 0x04);
	GC2035_write_cmos_sensor(0xaa , 0x00);
	GC2035_write_cmos_sensor(0xab , 0x00);
	GC2035_write_cmos_sensor(0xac , 0x00);
	GC2035_write_cmos_sensor(0xad , 0x04);
	...
	GC2035_write_cmos_sensor(0xb3 , 0x03);
	GC2035_write_cmos_sensor(0xb4 , 0x07);
	GC2035_write_cmos_sensor(0xb5 , 0x0e);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x07);
	...
	GC2035_write_cmos_sensor(0xb3 , 0x50); //saturation dec slope  80
	GC2035_write_cmos_sensor(0xde , 0xb6);  //
	GC2035_write_cmos_sensor(0x38 , 0x08); // 0f
	GC2035_write_cmos_sensor(0x39 , 0x50); // 60
	GC2035_write_cmos_sensor(0xfe , 0x00);
	GC2035_write_cmos_sensor(0x81 , 0x24);// 26
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x83 , 0x00);//
	GC2035_write_cmos_sensor(0x84 , 0x45);//
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x38);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x38);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3d);//contrast \D3 //36
	GC2035_write_cmos_sensor(0xd4 , 0x60);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfe);//luma_offset // 0x00	0626 0xf8 seaser 20131211
	...
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight // 0x02  01
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x46);// edge effect 45 betty// 0x54	0626//44//65 hyper 0x45
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 4; // 4	0626
	pSensorInfo->VideoDelayFrame = 4; 
	pSensorInfo->YUVAwbDelayFrame = 2;  // add by lanking // 2	0626
	pSensorInfo->YUVEffectDelayFrame = 2;  // add by lanking // 2	0626
	pSensorInfo->SensorMasterClockSwitch = 0; 
	pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;//ISP_DRIVING_4MA   ISP_DRIVING_8MA	0626
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2b, 0x05);//   624//6a7
		GC2035_write_cmos_sensor(0x2c, 0xb4);  
		GC2035_write_cmos_sensor(0x2d, 0x06);//5b4 betty   72a
		GC2035_write_cmos_sensor(0x2e, 0x46);  
		GC2035_write_cmos_sensor(0x2f, 0x07);//76a betty
		GC2035_write_cmos_sensor(0x30, 0xfc);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
		...
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x90);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x70);  
		GC2035_write_cmos_sensor(0x29, 0x05);//
		GC2035_write_cmos_sensor(0x2a, 0x40);  
		GC2035_write_cmos_sensor(0x2b, 0x06);//
		GC2035_write_cmos_sensor(0x2c, 0x90);  
		GC2035_write_cmos_sensor(0x2d, 0x07);//
		GC2035_write_cmos_sensor(0x2e, 0x70);  
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n07:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x64);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n03:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x78);//0x80
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
