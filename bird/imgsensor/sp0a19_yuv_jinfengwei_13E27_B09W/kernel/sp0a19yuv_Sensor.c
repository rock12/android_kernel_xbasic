 ...
 * $Log: sp0a19yuv_Sensor.c,v $
 * Revision 1.4  2013/09/16 01:13:44  maliejun
 * no message
 *
 * Revision 1.3  2013/09/13 10:55:30  dinghongzhen
 * zhoushaohong modify
 *
 * Revision 1.2  2013/09/12 12:28:47  maliejun
 * sp0a19 ©�� 8mA
 *
 * Revision 1.1  2013/09/10 05:46:50  xialeijie
 * no message
 *
...
void SP0A19NightMode(kal_bool bEnable)
{
    ...
    if (bEnable)//night mode
    {
        ...
        if (SP0A19_MPEG4_encode_mode == KAL_TRUE)
        {
            ...
            {
                //SI13_SP0A19 24M 1\B7\D6Ƶ 50Hz 8.0392-8fps AE_Parameters_ maxgain 80
                printk("SP0A19_VID_NIGTHT_60HZ  \r\n");
                SP0A19_write_cmos_sensor(0xfd,0x00);
                SP0A19_write_cmos_sensor(0x03,0x00);
    ...
    else    // daylight mode
    {
		...
		//ae setting 8-12FPS 50HZ
		  ...
		  SP0A19_write_cmos_sensor(0x0a,0x3d);
		...
		//Status
		  ...
		  SP0A19_write_cmos_sensor(0xfd,0x00);
		  SP0A19_write_cmos_sensor(0x03,0x00); 
		  SP0A19_write_cmos_sensor(0x04,0x9c); 
		  SP0A19_write_cmos_sensor(0x06,0x00);
		  SP0A19_write_cmos_sensor(0x09,0x04);
		  SP0A19_write_cmos_sensor(0x0a,0x31);
		  SP0A19_write_cmos_sensor(0xf0,0x34);
		  SP0A19_write_cmos_sensor(0xf1,0x00);
		  SP0A19_write_cmos_sensor(0xfd,0x01);
		  SP0A19_write_cmos_sensor(0x90,0x0f);
		  SP0A19_write_cmos_sensor(0x92,0x01);
		  SP0A19_write_cmos_sensor(0x98,0x34);
		  SP0A19_write_cmos_sensor(0x99,0x00);
		  SP0A19_write_cmos_sensor(0x9a,0x01);
		  SP0A19_write_cmos_sensor(0x9b,0x00);
		//Status
		  SP0A19_write_cmos_sensor(0xfd,0x01);
		  SP0A19_write_cmos_sensor(0xce,0x0c);
		  SP0A19_write_cmos_sensor(0xcf,0x03);
		  SP0A19_write_cmos_sensor(0xd0,0x0c);
...
//SP0A19 ini
    ...
    SP0A19_write_cmos_sensor(0x58,0x0e); //raw_dif_thr_normal
    SP0A19_write_cmos_sensor(0x56,0x20); //raw_dif_thr_dummy
    SP0A19_write_cmos_sensor(0x59,0x20); //raw_dif_thr_lowlight
    //GrGb
    SP0A19_write_cmos_sensor(0x89,0x06); //raw_grgb_thr_outdoor
    SP0A19_write_cmos_sensor(0x8a,0x0e); //raw_grgb_thr_normal
    SP0A19_write_cmos_sensor(0x9c,0x20); //raw_grgb_thr_dummy
    SP0A19_write_cmos_sensor(0x9d,0x20); //raw_grgb_thr_lowlight
    //Gr\Gb
    SP0A19_write_cmos_sensor(0x81,0xe0); //raw_gflt_fac_outdoor
    SP0A19_write_cmos_sensor(0x82,0x80); //raw_gflt_fac_normal
    ...
    SP0A19_write_cmos_sensor(0x5c,0x60);  //raw_rb_fac_dummy
    SP0A19_write_cmos_sensor(0x5d,0x00);  //raw_rb_fac_lowlight
#else
    //
    SP0A19_write_cmos_sensor(0x57,0x06); //raw_dif_thr_outdoor
    SP0A19_write_cmos_sensor(0x58,0x0c);//0d //raw_dif_thr_normal
    SP0A19_write_cmos_sensor(0x56,0x10); //raw_dif_thr_dummy
    SP0A19_write_cmos_sensor(0x59,0x10); //raw_dif_thr_lowlight
    //GrGb
    SP0A19_write_cmos_sensor(0x89,0x06); //raw_grgb_thr_outdoor
    SP0A19_write_cmos_sensor(0x8a,0x0c);//0d //raw_grgb_thr_normal
    ...
    SP0A19_write_cmos_sensor(0xe7,0x07);//08 //rangek_neg_dummy   // 0x10
    SP0A19_write_cmos_sensor(0xd5,0x07); //08//rangek_pos_dummy   // 0x10
    SP0A19_write_cmos_sensor(0xd9,0x07);//08 //range_base_dummy    // 0x10
    ...
    SP0A19_write_cmos_sensor(0xea,0x15);  //sharp_fac_pos_dummy   // 0x30
    SP0A19_write_cmos_sensor(0xef,0x15);  //sharp_fac_neg_dummy   // 0x20
    SP0A19_write_cmos_sensor(0xeb,0x10);  //sharp_fac_pos_low
    SP0A19_write_cmos_sensor(0xf0,0x15);  //sharp_fac_neg_low
#else
    SP0A19_write_cmos_sensor(0xe8,0x22); //20 //sharp_fac_pos_outdoor  // 0x35
    SP0A19_write_cmos_sensor(0xec,0x38); //35 //sharp_fac_neg_outdoor
    SP0A19_write_cmos_sensor(0xe9,0x22); //20 //sharp_fac_pos_nr	  // 0x35
    SP0A19_write_cmos_sensor(0xed,0x38); //35 //sharp_fac_neg_nr
    SP0A19_write_cmos_sensor(0xea,0x20);  //sharp_fac_pos_dummy   // 0x30
    SP0A19_write_cmos_sensor(0xef,0x30); //30 //sharp_fac_neg_dummy   // 0x20
    SP0A19_write_cmos_sensor(0xeb,0x10);  //sharp_fac_pos_low
    SP0A19_write_cmos_sensor(0xf0,0x20);  //sharp_fac_neg_low
#endif
    //CCM
    #if 0 //lj_test decrease red
    SP0A19_write_cmos_sensor(0xfd,0x01);
    SP0A19_write_cmos_sensor(0xa0,0x80);  //0x80  //zouyu 20121009
    SP0A19_write_cmos_sensor(0xa1,0x02);
    SP0A19_write_cmos_sensor(0xa2,0xfe);
    ...
    SP0A19_write_cmos_sensor(0xa9,0x30);
    SP0A19_write_cmos_sensor(0xaa,0x03);  // 0x33
    SP0A19_write_cmos_sensor(0xab,0x0c);
    SP0A19_write_cmos_sensor(0xfd,0x00);
    #else
    SP0A19_write_cmos_sensor(0xfd,0x01);
    SP0A19_write_cmos_sensor(0xa0,0x7b);  //0x80  //zouyu 20121009
    SP0A19_write_cmos_sensor(0xa1,0x11);
    SP0A19_write_cmos_sensor(0xa2,0xf4);
    SP0A19_write_cmos_sensor(0xa3,0xf3);  // 0xf6
    SP0A19_write_cmos_sensor(0xa4,0x93);  // 0x99
    SP0A19_write_cmos_sensor(0xa5,0xfa);  // 0xf2
    SP0A19_write_cmos_sensor(0xa6,0x00);  // 0x0d
    SP0A19_write_cmos_sensor(0xa7,0xe6);   // 0xda
    SP0A19_write_cmos_sensor(0xa8,0x9a);//0xa0 0813  // 0x98
    SP0A19_write_cmos_sensor(0xa9,0x30);
    SP0A19_write_cmos_sensor(0xaa,0x33);  // 0x33
    SP0A19_write_cmos_sensor(0xab,0x0c);
    SP0A19_write_cmos_sensor(0xfd,0x00);
    /*SP0A19_write_cmos_sensor(0xfd,0x01);
    SP0A19_write_cmos_sensor(0xa0,0x80);  //0x80  //zouyu 20121009
    ...
    SP0A19_write_cmos_sensor(0x8c,0x14);  // 0f;C ;11
    SP0A19_write_cmos_sensor(0x8d,0x24);  // 1e;19;19
    SP0A19_write_cmos_sensor(0x8e,0x3a);  // 3d;2C;28
    SP0A19_write_cmos_sensor(0x8f,0x59);  // 6c;49;46
    SP0A19_write_cmos_sensor(0x90,0x70);  // 92;61;61
    SP0A19_write_cmos_sensor(0x91,0x85);  // aa;77;78
    SP0A19_write_cmos_sensor(0x92,0x96);  // b9;8A;8A
    SP0A19_write_cmos_sensor(0x93,0xa6);  // c4;9B;9B
    SP0A19_write_cmos_sensor(0x94,0xb3);  // cf;A9;A9
    SP0A19_write_cmos_sensor(0x95,0xBe);  // d4;B5;B5
    SP0A19_write_cmos_sensor(0x96,0xC9);  // da;C0;C0
    SP0A19_write_cmos_sensor(0x97,0xd2);  // e0;CA;CA
    SP0A19_write_cmos_sensor(0x98,0xDb);  // e4;D4;D4
    SP0A19_write_cmos_sensor(0x99,0xe3);  // e8;DD;DD
    SP0A19_write_cmos_sensor(0x9a,0xEb);  // ec;E6;E6
    SP0A19_write_cmos_sensor(0x9b,0xf2);  // f1;EF;EF
    SP0A19_write_cmos_sensor(0xfd,0x01);  // 01;01;01
    SP0A19_write_cmos_sensor(0x8d,0xF9);  // f7;F7;F7
    ...
    //ae target
    SP0A19_write_cmos_sensor(0xfd,0x00);
    SP0A19_write_cmos_sensor(0xed,0x8c+0x04); //80
    SP0A19_write_cmos_sensor(0xf7,0x88+0x04); //7c
    SP0A19_write_cmos_sensor(0xf8,0x80+0x04); //70
    SP0A19_write_cmos_sensor(0xec,0x7c+0x04); //6c

#if 0//lj_test
    SP0A19_write_cmos_sensor(0xef,0x78); //99
    SP0A19_write_cmos_sensor(0xf9,0x74); //90
    SP0A19_write_cmos_sensor(0xfa,0x6c); //80
    SP0A19_write_cmos_sensor(0xee,0x68); //78
#else
    SP0A19_write_cmos_sensor(0xef,0x74+0x04); //99
    SP0A19_write_cmos_sensor(0xf9,0x70+0x04); //90
    SP0A19_write_cmos_sensor(0xfa,0x68+0x04); //80
    SP0A19_write_cmos_sensor(0xee,0x64+0x04); //78
#endif
    ...
    SP0A19_write_cmos_sensor(0xb4,0x40);//30 //black_vt  // 0x20
    SP0A19_write_cmos_sensor(0xb5,0x60); //45//white_vt
...
BOOL SP0A19_set_param_wb(UINT16 para)
{
    ...
    {
        // SP0A19_reg_WB_auto  \B0\D7\CC\EC
    ...
    {
        // SP0A19_reg_WB_auto \B0׳\E3\B5\C6
    ...
    {
        //SP0A19_reg_WB_auto  ӫ\B9\E2\B5\C6
    ...
    {
        // SP0A19_reg_WB_auto \B0\D7\C8ȹ\E2
