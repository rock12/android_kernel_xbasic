...
#define IMAGE_SENSOR_DRVNAME SENSOR_DRVNAME_HM5065_YUV
...
*/
 ...
 #define SYSTEM_CLK                           (52*1000*1000)
  ...
  #define PIXEL_CLK							    (SYSTEM_CLK/8)		// 52/8 MHz
   ...
   #define HM5065_VIDEO_NORMALMODE_FRAME_RATE							30		// Limitation for MPEG4 Encode Only
   #define HM5065_VIDEO_NIGHTMODE_FRAME_RATE							15
	/* SENSOR PIXEL/LINE NUMBERS IN ONE PERIOD */
	#define VGA_PERIOD_PIXEL_NUMS					970
	#define VGA_PERIOD_LINE_NUMS					670

	/* SENSOR EXPOSURE LINE LIMITATION */
	#define VGA_EXPOSURE_LIMITATION					510

	/* SENSOR GLOBAL GAIN AT NIGHT MODE */
	#define HM5065_SENSOR_NIGHT_MODE_GAIN					0x08	// Please refer to OV7670 Implementation Guide
	...
	//#define IMAGE_SENSOR_FULL_WIDTH          (2592 - 96) 
    //#define IMAGE_SENSOR_FULL_HEIGHT         (1944 - 72) 

//#define IMAGE_SENSOR_FULL_WIDTH 		 (2592 - 64) 
//#define IMAGE_SENSOR_FULL_HEIGHT		 (1944 - 48) 
#define IMAGE_SENSOR_FULL_WIDTH 		(2592 - 32) 
#define IMAGE_SENSOR_FULL_HEIGHT		 (1944 - 24)  



    //#define IMAGE_SENSOR_PV_WIDTH   1280-24
   // #define IMAGE_SENSOR_PV_HEIGHT  960-18

    //#define IMAGE_SENSOR_PV_WIDTH   1280-72
    //#define IMAGE_SENSOR_PV_HEIGHT  960-54

    //#define IMAGE_SENSOR_PV_WIDTH   (1280-16)
    //#define IMAGE_SENSOR_PV_HEIGHT  (960-12)
    
    #define IMAGE_SENSOR_PV_WIDTH   (1296-16)
    #define IMAGE_SENSOR_PV_HEIGHT  (972-12)    
 ...
 //   #define IMAGE_SENSOR_PV_HEIGHT  (480-6) 	
	...
	#define IMAGE_SENSOR_VGA_INSERTED_PIXELS		4
	#define IMAGE_SENSOR_VGA_INSERTED_LINES		  4
	
	#define HM5065_WRITE_ID								0x3E
	#define HM5065_READ_ID								0x3F
	
    #define HM5065_SENSOR_ID    (0x039E)  
#define HM5065_IMAGE_SENSOR_PV_STARTX                         4
#define HM5065_IMAGE_SENSOR_PV_STARTY                         4
  typedef struct
  {
