...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x6e);
  OV5645MIPI_write_cmos_sensor(0x518a, 0x6e);
  ...
  //OV5645MIPI_write_cmos_sensor(0x5388, 0x4d);
  //OV5645MIPI_write_cmos_sensor(0x5389, 0x18);
  ...
  OV5645MIPI_write_cmos_sensor(0x5384, 0x0b);//0.8
  ...
  OV5645MIPI_write_cmos_sensor(0x5302, 0x24);
  ...
  OV5645MIPI_write_cmos_sensor(0x5584, 0x08);
  ...
  //OV5645MIPI_write_cmos_sensor(0x3a0f, 0x30);
	...
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x80);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x28);
	OV5645MIPI_write_cmos_sensor(0x5303, 0x10);
