...
//SP0A19 ini
...
#if 1//lj_test
    SP0A19_write_cmos_sensor(0x57,0x10); //raw_dif_thr_outdoor 06 20140213 LCG
    SP0A19_write_cmos_sensor(0x58,0x10); //raw_dif_thr_normal 0e
    SP0A19_write_cmos_sensor(0x56,0x2a); //raw_dif_thr_dummy 20
    SP0A19_write_cmos_sensor(0x59,0x2a); //raw_dif_thr_lowlight 20
    //GrGb
    ...
    SP0A19_write_cmos_sensor(0xd3,0xe8); //0x78 88 20140213 LCG
    SP0A19_write_cmos_sensor(0xd4,0x88); //0x78  //lj_test 0x88
    SP0A19_write_cmos_sensor(0xd6,0x88); //0x78 	   (0xd7,0x60); //0x78  //lj_test 0x70
