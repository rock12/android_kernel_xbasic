...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x82, 0x5c); //55
	GC0329_write_cmos_sensor(0x83, 0x01);  // add by lanking 20120423//03
	...
	GC0329_write_cmos_sensor(0xb3, 0x42);///////44
	GC0329_write_cmos_sensor(0xb4, 0xfd);
	GC0329_write_cmos_sensor(0xb5, 0x06);///////2
	GC0329_write_cmos_sensor(0xb6, 0xf8);///////fa
	GC0329_write_cmos_sensor(0xb7, 0x45);/////48
	...
	////////////////////AEC////////////////////
		...
		GC0329_write_cmos_sensor(0x05, 0x00); 	
			...
			GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps/////300
			GC0329_write_cmos_sensor(0x2e, 0x84); 
			GC0329_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps/////3c0//4b0
			GC0329_write_cmos_sensor(0x30, 0x1a); 
			GC0329_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps  ////540
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x69,0x80);	//90																																																																								
