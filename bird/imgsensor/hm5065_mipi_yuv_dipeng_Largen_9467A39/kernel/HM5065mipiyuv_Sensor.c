...
void HM5065MIPIInitialSetting(void)
{
	...
	HM5065MIPISENSORDB("[HM5065MIPI]enter HM5065MIPIInitialSetting function:\n ");
		...
		HM5065MIPI_write_cmos_sensor(0x0130,0x01);//00(0EV)->FF(-0.2EV)
		...
		HM5065MIPI_write_cmos_sensor(0x02C3,0xC0);//C0 By Zeroy
		...
		HM5065MIPI_write_cmos_sensor(0x004C,0x10);	//08
		...
		HM5065MIPI_write_cmos_sensor(0x0357,0x60);	//19
		...
		HM5065MIPI_write_cmos_sensor(0x0082,0x68); //	;Set Brightness
    ...
    HM5065MIPISENSORDB("[HM5065MIPI]CONTROLFLOW enter HM5065MIPI_set_brightness function:\n ");
		...
		switch (para)
		{
			...
			case ISP_BRIGHT_MIDDLE:
				  HM5065MIPI_write_cmos_sensor(0x0130,0x01);
			default:	
				 break; 
		}
...
void HM5065MIPI_set_iso(UINT16 para)
{
	...
	HM5065MIPI_write_cmos_sensor(0x015D, 0x00);
	HM5065MIPI_write_cmos_sensor(0x015E, 0x41);	//40
	HM5065MIPI_write_cmos_sensor(0x015F, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C0, 0x00);
