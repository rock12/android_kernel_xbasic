 ...
 * Revision 1.1  2013/10/21 15:19:17  pengyajun
 * no message
 *
 * Revision 1.2  2013/08/16 10:58:02  dinghongzhen
 * 已传宝离职，先上传
 *
 * Revision 1.1  2013/08/09 05:44:02  chenchuanbao
 * Editor: chenchuanbao
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	{	
		...
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			GC0329_write_cmos_sensor(0x33, 0x30);//0x00
		else
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x1d);
	...
	GC0329_write_cmos_sensor(0x13, 0x5a);
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		/*	GC0329_write_cmos_sensor(0x05, 0x02); 	
			...
			GC0329_write_cmos_sensor(0x31, 0x06);   //exp level 3  7.14fps
		...
		/*	GC0329_write_cmos_sensor(0x05, 0x02); 	
			...
			GC0329_write_cmos_sensor(0x2c, 0x0c); 
			GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0xa8); 
			...
			GC0329_write_cmos_sensor(0x32, 0x7c); 
			GC0329_SET_PAGE0;
		break;*/
	  	GC0329_write_cmos_sensor(0x05, 0x01); 	
			GC0329_write_cmos_sensor(0x06, 0x32); 
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x05);
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n07:
			GC0329_write_cmos_sensor(0xd5, value_luma - 0x15);
			GC0329_write_cmos_sensor(0xfe, 0x01);
		...
		case AE_EV_COMP_00:
			...
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y + 0x03);
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
