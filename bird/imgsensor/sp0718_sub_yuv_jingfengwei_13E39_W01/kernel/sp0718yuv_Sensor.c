 ...
 * $Log: sp0718yuv_Sensor.c,v $
 * Revision 1.3  2013/09/23 03:13:45  lanqilong
 * lanqilong 绿线优化
 *
 * Revision 1.2  2013/08/19 06:49:24  birdlibo
 * no message
 *
 * Revision 1.1  2013/06/27 09:07:57  maliejun
 * 13E39-W01 锦峰威CAM调试
 *
 ...
 * no message
 *
 * Revision 1.2  2013/05/31 01:12:26  birdlibo
 * no message
 *

 * Revision 1.1  2013/05/28 02:24:07  birdlibo
 * no message
 *
...
//AE target
#define  SP0718_P1_0xeb  0x7c //lj_test 0x78
#define  SP0718_P1_0xec  0x70 //lj_test 0x6c
//HEQ
...
void SP0718_Sensor_Init(void)
{
  ...
  SP0718_write_cmos_sensor(0x31,0x70);//00 60   shezhi PCLK
  SP0718_write_cmos_sensor(0x27,0xb3);//0xb3	//2x gain
  SP0718_write_cmos_sensor(0x1b,0x17);
  SP0718_write_cmos_sensor(0x26,0xa8);
...
//ae gain &status
SP0718_write_cmos_sensor(0xfd,0x01);
SP0718_write_cmos_sensor(0x04,0xa0);//rpc_max_indr //lj_test 0xe0
...
SP0718_write_cmos_sensor(0xd3,0x0b);
SP0718_write_cmos_sensor(0xd4,0x0b);
SP0718_write_cmos_sensor(0xd5,0x0b);
SP0718_write_cmos_sensor(0xd7,0x10);//10//2x根据增益判断轮廓阈值
...
SP0718_write_cmos_sensor(0xe8,0x50);//48//轮廓强度
...
SP0718_write_cmos_sensor(0x71,0x0d);//0d//弱平滑（非平坦）区域平滑阈值	
