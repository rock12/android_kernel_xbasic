...
static const kal_uint8 addr_data_pair22[218] =
{
	0x94,
	0xc0,
	0x83,
...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x60);//6a
  OV5645MIPI_write_cmos_sensor(0x518a, 0x60);//6a
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x14);
...
static void OV5645_FOCUS_OVT_AFC_Init(void)
{
	...
	iBurstWriteReg(addr_data_pair22 , 218, OV5645MIPI_WRITE_ID);
    ...
    {	
        case AE_EV_COMP_20:	                   
		    ...
		    case AE_EV_COMP_00:
			                     ...
			                     break;
   		  case AE_EV_COMP_n10:
				                   OV5645MIPI_write_cmos_sensor(0x3a0f, 0x28);
				                   OV5645MIPI_write_cmos_sensor(0x3a10, 0x20);
				                   OV5645MIPI_write_cmos_sensor(0x3a11, 0x51);
				                   OV5645MIPI_write_cmos_sensor(0x3a1b, 0x28);
				                   OV5645MIPI_write_cmos_sensor(0x3a1e, 0x20);
				                   OV5645MIPI_write_cmos_sensor(0x3a1f, 0x10); 
			                     break;
      	case AE_EV_COMP_n20: 
        	                 OV5645MIPI_write_cmos_sensor(0x3a0f, 0x20);
				                   OV5645MIPI_write_cmos_sensor(0x3a10, 0x18);
				                   OV5645MIPI_write_cmos_sensor(0x3a11, 0x30);
