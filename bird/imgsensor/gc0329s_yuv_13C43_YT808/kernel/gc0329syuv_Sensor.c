 ...
 * Revision 1.1  2013/07/31 13:02:17  chenchuanbao
 * Editor: chenchuanbao
 ...
 * Bug 86348:夜景模式，照相机进入退出几次后，会提示“很抱歉，相机已停止运行
 *
 ...
 * Editor: maliejun
 * Inspector:maliejun
 * Reason:[84290] [N803]驱动需要移到ICS_V2上
 * Reference:none
 *
...
void GC0329SNightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0329S_write_cmos_sensor(0xfe, 0x00);
		GC0329SGammaSelect(GC0329S_RGB_Gamma_m4);
...
void GC0329S_Sensor_Init(void)
{
	...
	GC0329S_write_cmos_sensor(0x78, 0x48);
...
#if defined(BIRD_12TX6_N803C)||defined(BIRD_12TX6_N804)||defined(BIRD_GC0329_HV_MIRROR)
	GC0329S_write_cmos_sensor(0x17, 0x17);
#else
	GC0329S_write_cmos_sensor(0x17, 0x14); // 14    mirror setting
#endif
	...
	GC0329S_write_cmos_sensor(0x1f, 0xb0);
	GC0329S_write_cmos_sensor(0x20, 0x50);
	GC0329S_write_cmos_sensor(0x21, 0x48);
	GC0329S_write_cmos_sensor(0x22, 0xba);
	GC0329S_write_cmos_sensor(0x23, 0x22);
	GC0329S_write_cmos_sensor(0x24, 0x3f);
	...
	GC0329S_write_cmos_sensor(0x82, 0x55);//55  
	...
	GC0329S_SET_PAGE0;
/*
	GC0329S_write_cmos_sensor(0xb3, 0x40);
	GC0329S_write_cmos_sensor(0xb4, 0xf0);
	GC0329S_write_cmos_sensor(0xb5, 0x05);
	GC0329S_write_cmos_sensor(0xb6, 0xfa);
	GC0329S_write_cmos_sensor(0xb7, 0x44);
	...
	*/
	...
	////////////////////YCP////////////////////
	GC0329S_SET_PAGE0;
	GC0329S_write_cmos_sensor(0xd1, 0x24);
	GC0329S_write_cmos_sensor(0xd2, 0x24);
	GC0329S_write_cmos_sensor(0xdd, 0x54);


    GC0329S_write_cmos_sensor(0x7a, 0x80);//add betty
	GC0329S_write_cmos_sensor(0x7b, 0x7d);
	GC0329S_write_cmos_sensor(0x7c, 0x80);
	////////////////////AEC////////////////////
	GC0329S_SET_PAGE1;
	GC0329S_write_cmos_sensor(0x10, 0x40);
	GC0329S_write_cmos_sensor(0x11, 0x21);
	GC0329S_write_cmos_sensor(0x12, 0x27);
	GC0329S_write_cmos_sensor(0x13, 0x55);//48
	...
	GC0329S_SET_PAGE0;
	GC0329S_write_cmos_sensor(0x03, 0x01); 	
	GC0329S_write_cmos_sensor(0x04, 0x2c);
	/*
	GC0329S_write_cmos_sensor(0x05, 0x00); 	
	GC0329S_write_cmos_sensor(0x06, 0x6a); 
	GC0329S_write_cmos_sensor(0x07, 0x00);
	GC0329S_write_cmos_sensor(0x08, 0x25);
	GC0329S_SET_PAGE1;
  	GC0329S_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0329S_write_cmos_sensor(0x2a, 0x4b);   //anti-flicker step [7:0]
			
	GC0329S_write_cmos_sensor(0x2b, 0x02);   //exp level 0  14.28fps
	GC0329S_write_cmos_sensor(0x2c, 0x58); 
	GC0329S_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
	GC0329S_write_cmos_sensor(0x2e, 0xee); 
	GC0329S_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps
	GC0329S_write_cmos_sensor(0x30, 0x1a); 
	GC0329S_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
	GC0329S_write_cmos_sensor(0x32, 0xdc); 
	GC0329S_SET_PAGE0;*/
	GC0329S_write_cmos_sensor(0x05, 0x01); 	
	GC0329S_write_cmos_sensor(0x06, 0x32); 
	GC0329S_write_cmos_sensor(0x07, 0x00);
	GC0329S_write_cmos_sensor(0x08, 0x70);
	GC0329S_SET_PAGE1;
	GC0329S_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0329S_write_cmos_sensor(0x2a, 0x3c);   //anti-flicker step [7:0]
	GC0329S_write_cmos_sensor(0x2b, 0x02);   //exp level 0  14.28fps
	GC0329S_write_cmos_sensor(0x2c, 0x58); 
	GC0329S_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
	GC0329S_write_cmos_sensor(0x2e, 0xd0); 
	GC0329S_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps
	GC0329S_write_cmos_sensor(0x30, 0xc0); 
	GC0329S_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
	GC0329S_write_cmos_sensor(0x32, 0x28); 
	GC0329S_SET_PAGE0;
	GC0329S_write_cmos_sensor(0x28, 0x7f); //hyper add
	...
	GC0329S_write_cmos_sensor(0x51, 0x28);//20 betty
	...
	GC0329S_write_cmos_sensor(0x67, 0x6c);//70//6c//80
	GC0329S_write_cmos_sensor(0x68, 0x60);//58//54
	...
	////////////////////ABS////////////////////
	GC0329S_write_cmos_sensor(0x9c, 0x00); 
...
void GC0329S_Write_More_Registers(void)
{
	...
	GC0329S_write_cmos_sensor(0x5d,0x16);																																																																									
	GC0329S_write_cmos_sensor(0x67,0x6c);																																																																									
	GC0329S_write_cmos_sensor(0x68,0x54);																																																																									
	GC0329S_write_cmos_sensor(0x69,0x80);																																																																									
	...
	GC0329S_write_cmos_sensor(0xd1,0x24);	//30																																																																								
	GC0329S_write_cmos_sensor(0xd2,0x24);
	GC0329S_write_cmos_sensor(0xd3,0x3c);
	GC0329S_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329SGammaSelect(4);//0:use default
...
/*
	...
	*/
    ...
    pSensorInfo->PreviewDelayFrame = 6;//4
...
BOOL GC0329S_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329S_SET_PAGE1;
			GC0329S_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329S_write_cmos_sensor(0x2a, 0x32);   //anti-flicker step [7:0]
			
			GC0329S_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0329S_write_cmos_sensor(0x2c, 0x58); 
			GC0329S_write_cmos_sensor(0x2d, 0x02);   //exp level 0  12.00fps
			GC0329S_write_cmos_sensor(0x2e, 0xee); 
			GC0329S_write_cmos_sensor(0x2f, 0x03);   //exp level 0  10.00fps
			GC0329S_write_cmos_sensor(0x30, 0x84); 
			GC0329S_write_cmos_sensor(0x31, 0x04);   //exp level 0  7.05fps
			GC0329S_write_cmos_sensor(0x32, 0xb0); 
			GC0329S_SET_PAGE0;
		break;
		default:
		return FALSE;
...
BOOL GC0329S_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329S_NIGHT_MODE?0x2b:0xfa);//00 
	value_Y = (GC0329S_NIGHT_MODE?0x68:0x55);
