 ...
 *------------------------------------------------------------------------------
 * $Log: gc0329syuv_Sensor.h,v $
 * Revision 1.1  2013/07/31 13:02:18  chenchuanbao
 * Editor: chenchuanbao
 ...
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/06/27 07:50:25  wangqiang
 * 13E43-H82
 * 效果优化；
 *
...
#ifndef __GC0329S_SENSOR_H
#define __GC0329S_SENSOR_H
...
#define GC0329S_WRITE_ID							0x62
#define GC0329S_READ_ID								0x63

typedef enum
{
	GC0329S_RGB_Gamma_m1 = 0,
	GC0329S_RGB_Gamma_m2,
	GC0329S_RGB_Gamma_m3,
	GC0329S_RGB_Gamma_m4,
	GC0329S_RGB_Gamma_m5,
	GC0329S_RGB_Gamma_m6,
	GC0329S_RGB_Gamma_night
}GC0329S_GAMMA_TAG;
...
UINT32 GC0329SControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 GC0329SFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
UINT32 GC0329SGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
