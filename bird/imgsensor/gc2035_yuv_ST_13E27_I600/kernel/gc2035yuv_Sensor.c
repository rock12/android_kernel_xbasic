 ...
 * Revision 1.5  2013/08/26 09:01:03  dinghongzhen
 * 深圳FAE调试，代上传
 *
 * Revision 1.4  2013/08/23 06:15:30  xialeijie
 * no message
 *
 * Revision 1.3  2013/08/20 05:52:36  xialeijie
 * Editor: xialeijie
 * Inspector: xialeijie
 * Reaseon: 优化
 * Reference:
 *
 * Revision 1.2  2013/08/16 10:59:44  dinghongzhen
 * 因传宝离职，先上传
 *
 * Revision 1.1  2013/08/09 05:44:57  chenchuanbao
 * Editor: chenchuanbao
 * Inspector:chenchuanbao
 * Reason:优化
 * Reference:none
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf7 , 0x15); //pll enable
  	GC2035_write_cmos_sensor(0xf8 , 0x84); //84---20130619

	GC2035_write_cmos_sensor(0xfe , 0x00);
GC2035_set_BLK_mode(KAL_FALSE);//peter
/*	GC2035_write_cmos_sensor(0x44 , 0x00);//g 7c
	GC2035_write_cmos_sensor(0x45 , 0x00);//g
	GC2035_write_cmos_sensor(0x4a , 0x60);
	GC2035_write_cmos_sensor(0x4b , 0x40);*/
	GC2035_write_cmos_sensor(0x54 , 0x58);//G	
	GC2035_write_cmos_sensor(0x55 , 0x58);
	GC2035_write_cmos_sensor(0x5a , 0x58);
	GC2035_write_cmos_sensor(0x5b , 0x58);		
	...
	GC2035_write_cmos_sensor(0x04 , 0x62);
#else
	...
	GC2035_write_cmos_sensor(0x22 , 0xf0); //[3:0]vref  20130403   d0---20130619
	...
	*/
	...
	GC2035_write_cmos_sensor(0x2f, 0x09);//
	GC2035_write_cmos_sensor(0x30, 0x36);  
	GC2035_write_cmos_sensor(0xfe, 0x00);  
#else
	GC2035_write_cmos_sensor(0xfe, 0x00); 
	GC2035_write_cmos_sensor(0x05, 0x01);//
	...
	GC2035_write_cmos_sensor(0x2b, 0x05);//
	GC2035_write_cmos_sensor(0x2c, 0xb4);  
	GC2035_write_cmos_sensor(0x2d, 0x07);//5b4 betty
	GC2035_write_cmos_sensor(0x2e, 0x6a);  
	GC2035_write_cmos_sensor(0x2f, 0x09);//76a betty
	GC2035_write_cmos_sensor(0x30, 0x20);  
#endif
	GC2035_write_cmos_sensor(0xfe , 0x00);  //
	...
	GC2035_write_cmos_sensor(0xb0 , 0x90); //globle gain
	GC2035_write_cmos_sensor(0xc0 , 0x40);//Yuv bypass

	//////lsc/////////////
	
	/*GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x18);
	GC2035_write_cmos_sensor(0xc3 , 0x0d);
	GC2035_write_cmos_sensor(0xc4 , 0x05);
	GC2035_write_cmos_sensor(0xc8 , 0x03);
	GC2035_write_cmos_sensor(0xc9 , 0x0c);
	GC2035_write_cmos_sensor(0xca , 0x08);
	GC2035_write_cmos_sensor(0xbc , 0x0c);
	GC2035_write_cmos_sensor(0xbd , 0x1f);
	GC2035_write_cmos_sensor(0xbe , 0x11);
	GC2035_write_cmos_sensor(0xb6 , 0x2e);
	GC2035_write_cmos_sensor(0xb7 , 0x0b);
	GC2035_write_cmos_sensor(0xb8 , 0x14);
	GC2035_write_cmos_sensor(0xc5 , 0x1a);
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x23);
	GC2035_write_cmos_sensor(0xcc , 0x00);
	GC2035_write_cmos_sensor(0xcd , 0x09);
	GC2035_write_cmos_sensor(0xbf , 0x1e);
	GC2035_write_cmos_sensor(0xc0 , 0x05);
	GC2035_write_cmos_sensor(0xc1 , 0x00);
	GC2035_write_cmos_sensor(0xb9 , 0x1d);
	GC2035_write_cmos_sensor(0xba , 0x09);
	GC2035_write_cmos_sensor(0xbb , 0x07);
	GC2035_write_cmos_sensor(0xaa , 0x04);
	GC2035_write_cmos_sensor(0xab , 0x00);
	GC2035_write_cmos_sensor(0xac , 0x00);
	GC2035_write_cmos_sensor(0xad , 0x0a);
	GC2035_write_cmos_sensor(0xae , 0x03);
	GC2035_write_cmos_sensor(0xaf , 0x06);
	GC2035_write_cmos_sensor(0xb0 , 0x0c);
	...
	GC2035_write_cmos_sensor(0xb5 , 0x09);
	GC2035_write_cmos_sensor(0xd0 , 0x0b);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x0a);
	GC2035_write_cmos_sensor(0xd8 , 0x08);
	GC2035_write_cmos_sensor(0xda , 0x00);
	GC2035_write_cmos_sensor(0xdb , 0x0c);
	GC2035_write_cmos_sensor(0xdc , 0x0f);
	GC2035_write_cmos_sensor(0xde , 0x00);
	GC2035_write_cmos_sensor(0xdf , 0x19);
	GC2035_write_cmos_sensor(0xd4 , 0x12);
	...
	GC2035_write_cmos_sensor(0xa6 , 0x52);
	GC2035_write_cmos_sensor(0xa7 , 0x43);
	...
	GC2035_write_cmos_sensor(0xfe ,0x01);
	GC2035_write_cmos_sensor(0xa1 ,0xa0); 
	GC2035_write_cmos_sensor(0xa2 ,0x88); 
	GC2035_write_cmos_sensor(0xa4 ,0x10); 
	GC2035_write_cmos_sensor(0xa5 ,0x11); 
	GC2035_write_cmos_sensor(0xa6 ,0x10); 
	GC2035_write_cmos_sensor(0xa7 ,0x00); 
	GC2035_write_cmos_sensor(0xa8 ,0x07); 
	GC2035_write_cmos_sensor(0xa9 ,0x07); 
	GC2035_write_cmos_sensor(0xaa ,0x26); 
	GC2035_write_cmos_sensor(0xab ,0x19); 
	GC2035_write_cmos_sensor(0xac ,0x02); 
	GC2035_write_cmos_sensor(0xad ,0x28); 
	GC2035_write_cmos_sensor(0xae ,0x2c); 
	GC2035_write_cmos_sensor(0xaf ,0x0f); 
	GC2035_write_cmos_sensor(0xb0 ,0x1a); 
	GC2035_write_cmos_sensor(0xb1 ,0x13); 
	GC2035_write_cmos_sensor(0xb2 ,0x0a); 
	GC2035_write_cmos_sensor(0xb3 ,0x19); 
	GC2035_write_cmos_sensor(0xb4 ,0x0b); 
	GC2035_write_cmos_sensor(0xb5 ,0x04); 
	GC2035_write_cmos_sensor(0xb6 ,0x41); 
	GC2035_write_cmos_sensor(0xb7 ,0x28); 
	GC2035_write_cmos_sensor(0xb8 ,0x38); 
	GC2035_write_cmos_sensor(0xb9 ,0x11); 
	GC2035_write_cmos_sensor(0xba ,0x0f); 
	GC2035_write_cmos_sensor(0xbb ,0x0f); 
	GC2035_write_cmos_sensor(0xbc ,0x2e); 
	GC2035_write_cmos_sensor(0xbd ,0x2e); 
	GC2035_write_cmos_sensor(0xbe ,0x2e); 
	GC2035_write_cmos_sensor(0xbf ,0x2d); 
	GC2035_write_cmos_sensor(0xc0 ,0x1b); 
	GC2035_write_cmos_sensor(0xc1 ,0x14); 
	GC2035_write_cmos_sensor(0xc2 ,0x1f); 
	GC2035_write_cmos_sensor(0xc3 ,0x1f); 
	GC2035_write_cmos_sensor(0xc4 ,0x30); 
	GC2035_write_cmos_sensor(0xc5 ,0x51); 
	GC2035_write_cmos_sensor(0xc6 ,0x42); 
	GC2035_write_cmos_sensor(0xc7 ,0x1a); 
	GC2035_write_cmos_sensor(0xc8 ,0x1a); 
	GC2035_write_cmos_sensor(0xc9 ,0x13); 
	GC2035_write_cmos_sensor(0xca ,0x20); 
	GC2035_write_cmos_sensor(0xcb ,0x53); 
	GC2035_write_cmos_sensor(0xcc ,0x44); 
	GC2035_write_cmos_sensor(0xcd ,0x14); 
	GC2035_write_cmos_sensor(0xd0 ,0x20); 
	GC2035_write_cmos_sensor(0xd2 ,0x00); 
	GC2035_write_cmos_sensor(0xd3 ,0x34); 
	GC2035_write_cmos_sensor(0xd4 ,0x6b); 
	GC2035_write_cmos_sensor(0xd6 ,0x51); 
	GC2035_write_cmos_sensor(0xd7 ,0x3e); 
	GC2035_write_cmos_sensor(0xd8 ,0x43); 
	GC2035_write_cmos_sensor(0xda ,0x0b); 
	GC2035_write_cmos_sensor(0xdb ,0x50); 
	GC2035_write_cmos_sensor(0xdc ,0x35); 
	GC2035_write_cmos_sensor(0xde ,0x41); 
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0x10);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0x50);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0x80);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0x90);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x40);
	GC2035_write_cmos_sensor(0x4e , 0x40);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0xa0);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0xb0);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0xc0);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0xd0);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0xe0);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0xf0);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x3a);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x3a);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3e);//contrast \D3
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);//peter
	GC2035_write_cmos_sensor(0x88 , 0x3f);//dn_b_base
	...
	GC2035_write_cmos_sensor(0x97 , 0x44);// edge effect 45 betty
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
#ifdef 	BIRD_GC2035_HV_MIRROR
	GC2035_set_mirror_flip(IMAGE_HV_MIRROR);
#else
	GC2035_set_mirror_flip(IMAGE_NORMAL);
#endif	
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	GC2035_set_BLK_mode(KAL_TRUE);//peter
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 8;//2 peter 
...
BOOL GC2035_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_TUNGSTEN: //home
			GC2035_set_AWB_mode(KAL_FALSE);  //a0 45  40
			GC2035_write_cmos_sensor(0xb3, 0x58);
			GC2035_write_cmos_sensor(0xb4, 0x40);
			GC2035_write_cmos_sensor(0xb5, 0x70);
		break;
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0xfe, 0x00);  
		GC2035_write_cmos_sensor(0x05, 0x01);//
		GC2035_write_cmos_sensor(0x06, 0x18);  
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x48);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x6a);  
		
		GC2035_write_cmos_sensor(0x29, 0x04);//
		GC2035_write_cmos_sensor(0x2a, 0x8e);  
		GC2035_write_cmos_sensor(0x2b, 0x05);//
		GC2035_write_cmos_sensor(0x2c, 0x62);  
		GC2035_write_cmos_sensor(0x2d, 0x05);//
		GC2035_write_cmos_sensor(0x2e, 0xcc);  
		GC2035_write_cmos_sensor(0x2f, 0x08);//
		GC2035_write_cmos_sensor(0x30, 0x48);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  							 												 
		break;
#else
		GC2035_write_cmos_sensor(0xfe, 0x00);  
	...
	/*GC2035_write_cmos_sensor(0xfe , 0x00); 
    GC2035_write_cmos_sensor(0x80 , 0x09); //only intp enabl9
					GC2035_write_cmos_sensor(0x81 , 0x00); //close all	   
					GC2035_write_cmos_sensor(0x82 , 0x00); //close all	   
					GC2035_write_cmos_sensor(0xb6 , 0x03); //AEC_dis 	   
					...
					GC2035_write_cmos_sensor(0xfe , 0x02); //			   
					GC2035_write_cmos_sensor(0xd0 , 0x40); // saturation    
					GC2035_write_cmos_sensor(0xd1 , 0x20); // saturation    
					GC2035_write_cmos_sensor(0xd2 , 0x20); // saturation    
					GC2035_write_cmos_sensor(0xd3 , 0x40); //			   
					GC2035_write_cmos_sensor(0xd5 , 0x00); //			   
					GC2035_write_cmos_sensor(0xdd , 0x00); //edge_sa 	   
					GC2035_write_cmos_sensor(0xee , 0x00);			   
					GC2035_write_cmos_sensor(0xfe , 0x00); //			   
					GC2035_write_cmos_sensor(0xfe , 0x01); //			   
		...
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x80);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		...
		GC2035_write_cmos_sensor(0x2e, 0x00);  
		GC2035_write_cmos_sensor(0x2f, 0x09);//
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x68);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x78);//80 peter
			GC2035_SET_PAGE0;
