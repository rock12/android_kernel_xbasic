 ...
 * Revision 1.1  2013/09/03 13:13:57  xialeijie
 * no message
 *
 * Revision 1.1  2013/08/12 03:56:32  wangqiang
 * no message
 *
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m4);//5
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x7a, 0x80);//add
	GC0329_write_cmos_sensor(0x7b, 0x7d);
	...
	GC0329_write_cmos_sensor(0x83, 0x00);  // add by lanking 20120423 //01
	GC0329_write_cmos_sensor(0x87, 0x4a);

	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x95, 0x33);//43
	...
	GC0329_write_cmos_sensor(0xb4, 0xfa);//fd betty//f0
	GC0329_write_cmos_sensor(0xb5, 0x02);//02 betty//05
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x40);//44
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x2a);
	GC0329_write_cmos_sensor(0xd2, 0x2a);
	GC0329_write_cmos_sensor(0xd3, 0x3b);//3d
  ...
  GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	...
	GC0329_write_cmos_sensor(0x51, 0x18);//20 betty//28
	GC0329_write_cmos_sensor(0x52, 0x0a);//10
	GC0329_write_cmos_sensor(0x53, 0x28);//20
	GC0329_write_cmos_sensor(0x54, 0x50);//40
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x51,0x10);	//28																																																																								
	GC0329_write_cmos_sensor(0x52,0x08);		//10																																																																							
	GC0329_write_cmos_sensor(0x53,0x38);	//20																																																																								
	GC0329_write_cmos_sensor(0x54,0x60);	//40																																																																						
	GC0329_write_cmos_sensor(0x55,0x16);																																																																									
	GC0329_write_cmos_sensor(0x56,0x30);																																																																									
	GC0329_write_cmos_sensor(0x58,0x4c);	//60																																																																								
	GC0329_write_cmos_sensor(0x59,0x08);																																																																									
	GC0329_write_cmos_sensor(0x5c,0x35);																																																																									
	GC0329_write_cmos_sensor(0x5d,0x34);	//16																																																																								
	GC0329_write_cmos_sensor(0x67,0x68);	//70																																																																								
	GC0329_write_cmos_sensor(0x68,0x50);	//58 54																																																																								
	GC0329_write_cmos_sensor(0x69,0xe0);	//80																																																																								
	GC0329_write_cmos_sensor(0x6c,0x50);	//30																																																																								
	GC0329_write_cmos_sensor(0x6d,0x70);			//60																																																																						
	GC0329_write_cmos_sensor(0x70,0x0a);//10	
	...
	GC0329_write_cmos_sensor(0xd1,0x20);//26																																																																									
	GC0329_write_cmos_sensor(0xd2,0x20);//26																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x58);//50
