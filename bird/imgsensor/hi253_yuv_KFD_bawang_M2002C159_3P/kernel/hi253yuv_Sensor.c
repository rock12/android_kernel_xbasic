 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: hi253yuv_Sensor.c,v $
 * Revision 1.1  2013/08/20 10:30:35  wangqiang
 * 13C43_A6M
 *
 * Revision 1.1  2013/06/15 05:48:14  birdlibo
 * no message
 *
 *
 *
...
void HI253InitSetting(void)
{
  ...
  //Dark BLC 
  HI253WriteCmosSensor(0xa0, 0x02); // BLCOFS DB
  HI253WriteCmosSensor(0xa2, 0x02); // BLCOFS DGb
  HI253WriteCmosSensor(0xa4, 0x02); // BLCOFS DR
  HI253WriteCmosSensor(0xa6, 0x02); // BLCOFS DGr
  ...
  HI253WriteCmosSensor(0x6d, 0x80); // VNEGSAT
  ...
  HI253WriteCmosSensor(0x4a, 0xa0); // DARK2RATIO
  ...
  //Indoor Edg 
  HI253WriteCmosSensor(0x5c, 0x1a);
  HI253WriteCmosSensor(0x5d, 0x2b);
  HI253WriteCmosSensor(0x5e, 0x1a);
  HI253WriteCmosSensor(0x5f, 0x18);
  HI253WriteCmosSensor(0x60, 0x29);
  HI253WriteCmosSensor(0x61, 0x18);

  //Dark1 Edge
  HI253WriteCmosSensor(0x62, 0x08);
  HI253WriteCmosSensor(0x63, 0x18);
  HI253WriteCmosSensor(0x64, 0x08);
  HI253WriteCmosSensor(0x65, 0x06);
  HI253WriteCmosSensor(0x66, 0x16);
  ...
  HI253WriteCmosSensor(0x22, 0x7e); // LENSRGAIN
  ...
  HI253WriteCmosSensor(0x40, 0x5c); // LENSRP0
  HI253WriteCmosSensor(0x50, 0x4a); // LENSGrP0
  HI253WriteCmosSensor(0x60, 0x46); // LENSBP0
  HI253WriteCmosSensor(0x70, 0x4a); // LENSGbP0
  ...
  HI253WriteCmosSensor(0x70, 0x1e); // BGMA0
  HI253WriteCmosSensor(0x71, 0x1e); // BGMA1
  HI253WriteCmosSensor(0x72, 0x23); // BGMA2
  HI253WriteCmosSensor(0x73, 0x2c); // BGMA3
  HI253WriteCmosSensor(0x74, 0x3f); // BGMA4
  HI253WriteCmosSensor(0x75, 0x56); // BGMA5
  HI253WriteCmosSensor(0x76, 0x6c); // BGMA6
  HI253WriteCmosSensor(0x77, 0x81); // BGMA7
  HI253WriteCmosSensor(0x78, 0x94); // BGMA8
  HI253WriteCmosSensor(0x79, 0xa5); // BGMA9
  HI253WriteCmosSensor(0x7a, 0xb3); // BGMA10
  HI253WriteCmosSensor(0x7b, 0xc4); // BGMA11
  HI253WriteCmosSensor(0x7c, 0xce); // BGMA12
  HI253WriteCmosSensor(0x7d, 0xd9); // BGMA13
  HI253WriteCmosSensor(0x7e, 0xe4); // BGMA14
  HI253WriteCmosSensor(0x7f, 0xec); // BGMA15
  HI253WriteCmosSensor(0x80, 0xf5); // BGMA16
  HI253WriteCmosSensor(0x81, 0xfc); // BGMA17
  ...
  HI253WriteCmosSensor(0x66, 0x6b); // AEWGT7
  HI253WriteCmosSensor(0x67, 0xe9); // AEWGT8
  ...
  HI253WriteCmosSensor(0x70, 0x48); // YLVL
  ...
  HI253SetPage(0x22); 
  HI253WriteCmosSensor(0x10, 0xe2); // AWBCTL1
  HI253WriteCmosSensor(0x11, 0x26); // AWBCTL2
  HI253WriteCmosSensor(0x19, 0x01); 
  HI253WriteCmosSensor(0x20, 0x30);
  HI253WriteCmosSensor(0x21, 0x40);
  ...
  HI253WriteCmosSensor(0x38, 0x12); // UVTH1
  HI253WriteCmosSensor(0x39, 0x33); // UVTH2
  HI253WriteCmosSensor(0x40, 0xf0); // YRANGE

  HI253WriteCmosSensor(0x41, 0x33); // CDIFF
  HI253WriteCmosSensor(0x42, 0x33); // CSUM2
  HI253WriteCmosSensor(0x43, 0xf3);
  HI253WriteCmosSensor(0x44, 0x55);
  HI253WriteCmosSensor(0x45, 0x44);
  HI253WriteCmosSensor(0x46, 0x02); // WHTPXLTH1  
  ...
  HI253WriteCmosSensor(0x8f, 0x63); // BGAINPARA1
  HI253WriteCmosSensor(0x90, 0x60); // BGAINPARA2
  HI253WriteCmosSensor(0x91, 0x5c); // BGAINPARA3
  HI253WriteCmosSensor(0x92, 0x56); // BGAINPARA4
  HI253WriteCmosSensor(0x93, 0x52); // BGAINPARA5
  HI253WriteCmosSensor(0x94, 0x4c); // BGAINPARA6
  HI253WriteCmosSensor(0x95, 0x36); // BGAINPARA7
  HI253WriteCmosSensor(0x96, 0x31); // BGAINPARA8
  HI253WriteCmosSensor(0x97, 0x2e); // BGAINPARA9
  HI253WriteCmosSensor(0x98, 0x2a); // BGAINPARA10
  HI253WriteCmosSensor(0x99, 0x29); // BGAINPARA11
  HI253WriteCmosSensor(0x9a, 0x26); // BGAINPARA12
...
void HI253NightMode(kal_bool Enable)
{
  ...
  //HI253WriteCmosSensor(0x83, 0x01); //(EXPTIME>>16)&(0xff)); // EXPTIMEH max fps
  //HI253WriteCmosSensor(0x84, 0x7c); //(EXPTIME>>8)&(0xff)); // EXPTIMEM
  //HI253WriteCmosSensor(0x85, 0xdc); //(EXPTIME>>0)&(0xff)); // EXPTIMEL
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
  ...
  pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_UYVY; // back for 16 SENSOR_OUTPUT_FORMAT_UYVY;
