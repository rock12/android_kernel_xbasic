...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x03 , 0x01);//2dc  
	GC2035_write_cmos_sensor(0x04 , 0xc0);
  ...
  /////////awb end /////////////
	...
	GC2035_write_cmos_sensor(0x13 , 0x7a);//y_target //0x75 jon 88
	...
	GC2035_write_cmos_sensor(0x2a , 0x9b);  
	GC2035_write_cmos_sensor(0x2b , 0x04);//  level 1 13.75
	GC2035_write_cmos_sensor(0x2c , 0x9b);  
	...
	GC2035_write_cmos_sensor(0x30 , 0x2a); 
	GC2035_write_cmos_sensor(0xfe , 0x00);*/
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	...
	//---------------------------------------
	GC2035_write_cmos_sensor(0xad , 0x7e); //add by jon 
	...
	GC2035_write_cmos_sensor(0xd1 , 0x30); //0x38 jon 
	GC2035_write_cmos_sensor(0xd2 , 0x30); //0x38 jon 
	GC2035_write_cmos_sensor(0xd3 , 0x3e);//contrast ? //0x40 jon	
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0x00);//luma_offset //0x00 jon
	GC2035_write_cmos_sensor(0xdc , 0x30);
	GC2035_write_cmos_sensor(0xdd , 0xb8);//edge_sa_g,b
	GC2035_write_cmos_sensor(0xfe , 0x00);
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x25);//dn_b_base //0x15 jon //1f
	...
	GC2035_write_cmos_sensor(0x97 , 0x43);// edge effect //0x45 jon
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x7a);//0x80jon
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
