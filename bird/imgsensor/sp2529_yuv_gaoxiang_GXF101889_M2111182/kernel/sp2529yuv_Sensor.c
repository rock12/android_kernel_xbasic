...
SP2529_write_cmos_sensor(0x29 , 0x00);  //lsc_dec_fac     进dummy态退shading 功能有问题，需关掉                  
SP2529_write_cmos_sensor(0x2a , 0x01);  //lsc_rpc_en lens 衰减自适应        
//LSC for CHT813                                            
SP2529_write_cmos_sensor(0xfd , 0x01);                                     
...
SP2529_write_cmos_sensor(0xcd , 0x10); //raw_sharp_range_base_dummy	
SP2529_write_cmos_sensor(0xce , 0x1a); //raw_sharp_range_base_low	
...
SP2529_write_cmos_sensor(0xdc , 0x04); //skin_sharp_sel肤色降锐化                       
SP2529_write_cmos_sensor(0x05 , 0x6f); //skin_num_th2排除肤色降锐化对分辨率卡引起的干扰 
...
SP2529_write_cmos_sensor(0x7a , 0x14);
SP2529_write_cmos_sensor(0x7b , 0x08);
...
SP2529_write_cmos_sensor(0x84 , 0x08);
                                   
SP2529_write_cmos_sensor(0xfd , 0x03);
SP2529_write_cmos_sensor(0x7e , 0x06); //raw_noise_base_outdoor                   
SP2529_write_cmos_sensor(0x7f , 0x0d); //raw_noise_base_normal                    
SP2529_write_cmos_sensor(0x80 , 0x10); //raw_noise_base_dummy                     
SP2529_write_cmos_sensor(0x81 , 0x16); //raw_noise_base_low                       
...
//sat u                            
SP2529_write_cmos_sensor(0xfd , 0x01);
SP2529_write_cmos_sensor(0xd3 , 0xa0);
SP2529_write_cmos_sensor(0xd4 , 0xa0);
SP2529_write_cmos_sensor(0xd5 , 0xa0);
SP2529_write_cmos_sensor(0xd6 , 0xa0);
//sat v                            
SP2529_write_cmos_sensor(0xd7 , 0xa0);
SP2529_write_cmos_sensor(0xd8 , 0xa0);
SP2529_write_cmos_sensor(0xd9 , 0xa0);
SP2529_write_cmos_sensor(0xda , 0xa0);
...
SP2529_write_cmos_sensor(0x7b , 0x40);
 //auto_sat                        
SP2529_write_cmos_sensor(0xfd , 0x01);
SP2529_write_cmos_sensor(0xc2 , 0xaa);  //u_v_th_outdoor白色物体表面有彩色噪声降低此值    
...
SP2529_write_cmos_sensor(0x03 , 0x68); //ctf_range_thr   可以排除灰板场景的阈值   
...
SP2529_write_cmos_sensor(0xfd , 0x00);        
SP2529_write_cmos_sensor(0x3f , 0x00); //mirror/flip    0x03 dxc 140507
SP2529_write_cmos_sensor(0xfd , 0x01);
