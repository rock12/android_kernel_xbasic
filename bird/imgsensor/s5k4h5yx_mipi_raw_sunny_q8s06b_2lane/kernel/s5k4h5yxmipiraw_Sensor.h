...
//20130426 add basic data
	...
	#define s5k4h5yx_video_frame_length 		1264
	#define s5k4h5yx_video_line_length 		 	3688
	#define s5k4h5yx_preview_frame_length 		1266
	...
	#define s5k4h5yx_capture_pclk_frequency		130
	...
	#define S5K4H5YX_IMAGE_SENSOR_VIDEO_WIDTH					(2200)//(1920)
	#define S5K4H5YX_IMAGE_SENSOR_VIDEO_HEIGHT				(1200)//(1080)
	...
	#define S5K4H5YX_FULL_Y_START						    		(2+1)

	#define S5K4H5YX_PV_X_START						    		(2)
	#define S5K4H5YX_PV_Y_START						    		(2+1)
	
	#define S5K4H5YX_VIDEO_X_START								(2)
	#define S5K4H5YX_VIDEO_Y_START								(2+1)
...
#define S5K4H5YXMIPI_WRITE_ID 	(0x6c)
#define S5K4H5YXMIPI_READ_ID	(0x6d)
