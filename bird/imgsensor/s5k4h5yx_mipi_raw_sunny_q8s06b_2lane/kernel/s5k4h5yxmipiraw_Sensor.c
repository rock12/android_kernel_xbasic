...
void S5K4H5YX_write_shutter(kal_uint32 shutter)
{
  ...
  if (s5k4h5yx.sensorMode == SENSOR_MODE_PREVIEW) 
  {
	  ...
	  S5K4H5YXDB("[S5K4H5YX] [S5K4H5YX_write_shutter] SENSOR_MODE_PREVIEW , shutter = %d, frame_length = %d\n",shutter, frame_length);
  }
...
void S5K4H5YXPreviewSetting(void)
{
	...
	S5K4H5YX_write_cmos_sensor(0x0341, 0xF2);
	...
	S5K4H5YX_write_cmos_sensor(0x0114, 0x01);
	...
	S5K4H5YX_write_cmos_sensor(0x030F, 0xA2);//20130426 a8->a2
	...
	S5K4H5YX_write_cmos_sensor(0x3C63, 0xA0);
...
S5K4H5YX_write_cmos_sensor(0x0201, 0xE8);
S5K4H5YX_write_cmos_sensor(0x0202, 0x04);
S5K4H5YX_write_cmos_sensor(0x0203, 0xE2);
S5K4H5YX_write_cmos_sensor(0x0340, 0x04);
S5K4H5YX_write_cmos_sensor(0x0341, 0xF0);
S5K4H5YX_write_cmos_sensor(0x0342, 0x0E);
S5K4H5YX_write_cmos_sensor(0x0343, 0x68);
S5K4H5YX_write_cmos_sensor(0x0344, 0x02);
S5K4H5YX_write_cmos_sensor(0x0345, 0x18);
S5K4H5YX_write_cmos_sensor(0x0346, 0x02);
S5K4H5YX_write_cmos_sensor(0x0347, 0x62);
S5K4H5YX_write_cmos_sensor(0x0348, 0x0A);
S5K4H5YX_write_cmos_sensor(0x0349, 0xB7);
S5K4H5YX_write_cmos_sensor(0x034A, 0x07);
S5K4H5YX_write_cmos_sensor(0x034B, 0x3B);
S5K4H5YX_write_cmos_sensor(0x034C, 0x08);
S5K4H5YX_write_cmos_sensor(0x034D, 0xA0);
S5K4H5YX_write_cmos_sensor(0x034E, 0x04);
S5K4H5YX_write_cmos_sensor(0x034F, 0xDA);
...
void S5K4H5YXCaptureSetting(void)
{
	...
	S5K4H5YX_write_cmos_sensor(0x0305, 0x06);
	S5K4H5YX_write_cmos_sensor(0x0306, 0x00);
	S5K4H5YX_write_cmos_sensor(0x0307, 0x41);//mipi clock 
	S5K4H5YX_write_cmos_sensor(0x0309, 0x02);
	S5K4H5YX_write_cmos_sensor(0x030B, 0x01);
	S5K4H5YX_write_cmos_sensor(0x3C59, 0x00);
	S5K4H5YX_write_cmos_sensor(0x030D, 0x06);
	S5K4H5YX_write_cmos_sensor(0x030E, 0x00);
	S5K4H5YX_write_cmos_sensor(0x030F, 0xA2);//modify data rate 648Mhz
	S5K4H5YX_write_cmos_sensor(0x3C5A, 0x00);
	S5K4H5YX_write_cmos_sensor(0x0310, 0x01);
	S5K4H5YX_write_cmos_sensor(0x3C50, 0x53);
	S5K4H5YX_write_cmos_sensor(0x3C62, 0x02);
...
UINT32 S5K4H5YXOpen(void)
{
	...
	s5k4h5yx.pvPclk =  s5k4h5yx_preview_pclk_frequency * 100;  
	s5k4h5yx.videoPclk = s5k4h5yx_video_pclk_frequency * 100; 
	...
	spin_unlock(&s5k4h5yxmipiraw_drv_lock);
    	...
    	switch(S5K4H5YXCurrentScenarioId)
		{
			case MSDK_SCENARIO_ID_CAMERA_ZSD:
				spin_lock(&s5k4h5yxmipiraw_drv_lock);
				s5k4h5yx.capPclk = s5k4h5yx_capture_pclk_frequency * 100;
	...
	s5k4h5yx.maxExposureLines =s5k4h5yx_preview_frame_length-4;
...
UINT32 S5K4H5YXSetVideoMode(UINT16 u2FrameRate)
{
    ...
    if(s5k4h5yx.sensorMode == SENSOR_MODE_VIDEO)//video ScenarioId recording
    {
    	...
    	if(s5k4h5yx.S5K4H5YXAutoFlickerMode == KAL_TRUE)
    	{
			...
			MIN_Frame_length = (s5k4h5yx.videoPclk*10000)/(s5k4h5yx_video_line_length+ s5k4h5yx.DummyPixels)/frameRate*10;
    	}
		else
			MIN_Frame_length = (s5k4h5yx.videoPclk*10000) /(s5k4h5yx_video_line_length + s5k4h5yx.DummyPixels)/u2FrameRate;
	...
	else if(s5k4h5yx.sensorMode == SENSOR_MODE_CAPTURE)
	{
		...
		if(s5k4h5yx.S5K4H5YXAutoFlickerMode == KAL_TRUE)
    	{
			...
			MIN_Frame_length = (s5k4h5yx.capPclk*10000) /(s5k4h5yx_capture_line_length + s5k4h5yx.DummyPixels)/frameRate*10;
    	}
		else
			MIN_Frame_length = (s5k4h5yx.capPclk*10000) /(s5k4h5yx_capture_line_length + s5k4h5yx.DummyPixels)/u2FrameRate;

		if((MIN_Frame_length <=s5k4h5yx_capture_frame_length))
		{
			MIN_Frame_length = s5k4h5yx_capture_frame_length;
			S5K4H5YXDB("[S5K4H5YX] [S5K4H5YXSetVideoMode] current fps = %d\n", (s5k4h5yx.capPclk*10000) /(s5k4h5yx_capture_line_length)/s5k4h5yx_capture_frame_length);

		}
		S5K4H5YXDB("[S5K4H5YX] [S5K4H5YXSetVideoMode] current fps (10 base)= %d\n", (s5k4h5yx.pvPclk*10000)*10/(s5k4h5yx_capture_line_length + s5k4h5yx.DummyPixels)/MIN_Frame_length);
...
UINT32 S5K4H5YXMIPISetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) 
{
	...
	switch (scenarioId) {
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			...
			pclk = s5k4h5yx_preview_pclk_frequency * 1000000;
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			...
			pclk = s5k4h5yx_video_pclk_frequency * 1000000;
		...
		case MSDK_SCENARIO_ID_CAMERA_ZSD:	
			...
			pclk = s5k4h5yx_capture_pclk_frequency * 1000000;
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
			...
			{
				case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
					*pFeatureReturnPara32 = s5k4h5yx_preview_pclk_frequency * 1000000;
					*pFeatureParaLen=4;
					break;
				case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
					*pFeatureReturnPara32 = s5k4h5yx_video_pclk_frequency * 1000000;
					*pFeatureParaLen=4;
					break;	 
				case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
				case MSDK_SCENARIO_ID_CAMERA_ZSD:
					*pFeatureReturnPara32 = s5k4h5yx_capture_pclk_frequency * 1000000;
					*pFeatureParaLen=4;
					break;
				default:
					*pFeatureReturnPara32 = s5k4h5yx_preview_pclk_frequency * 1000000;
