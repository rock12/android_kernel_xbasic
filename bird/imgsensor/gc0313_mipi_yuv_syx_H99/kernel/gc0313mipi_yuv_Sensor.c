...
void GC0313MIPI_Sensor_Init(void)
{
	...
	GC0313MIPI_write_cmos_sensor(0x95 , 0x54); //86
	...
	GC0313MIPI_write_cmos_sensor(0xd1 , 0x23);//38
	GC0313MIPI_write_cmos_sensor(0xd2 , 0x26);//38
	...
	GC0313MIPI_write_cmos_sensor(0x54 , 0x10); 
	GC0313MIPI_write_cmos_sensor(0x55 , 0x20); 
