 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: s5k5cagx_Sensor.c,v $
 * Revision 1.1  2013/11/04 14:06:52  maliejun
 * 13F45 162 driver
 *
 *
...
//	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //#Tune_TP_AvMoveToGamutDist
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[45]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[149]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[253]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[357]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[461]
   ...
   S5K5CAGX_write_cmos_sensor(0x0F12, 0x0600);   
    ...
    //S5K5CAGX_write_cmos_sensor(0x002a,0x0210);
   	//S5K5CAGX_write_cmos_sensor(0x0f12,0xff00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	//pSensorInfo->SensorCameraPreviewFrameRate=30;
	pSensorInfo->SensorVideoFrameRate=15;
...
UINT32 S5K5CAGXYUVSetVideoMode(UINT16 u2FrameRate)
{
	...
	/*SENSORDB("mycat xxxx setvideomode here\n");
	S5K5CAGX_PV_Mode(1);
	//S5K5CAGX_night_mode(1);
	SENSORDB("mycat xxxx setvideomode here\n");*/
