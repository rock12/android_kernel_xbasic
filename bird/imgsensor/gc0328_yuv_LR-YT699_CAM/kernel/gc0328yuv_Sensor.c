 ...
 * Revision 1.3  2013/09/13 13:24:15  wangqiang
 * modify for 13C43_YT699, by liuxd.
 *
 * Revision 1.2  2013/09/10 12:26:20  pengyajun
 * ”≈ªØ130910
 *
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x4d , 0x33);     ////////////40 
	...
	GC0328_write_cmos_sensor(0x24 , 0x3f);    
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x2d);     /////26 betty//30
	GC0328_write_cmos_sensor(0xd2 , 0x2d);  /////26 betty
	GC0328_write_cmos_sensor(0xd3 , 0x3c);
	...
	GC0328_write_cmos_sensor(0x9c , 0x80); ///////a0 
	        
//	GC0328_write_cmos_sensor(0xa3 , 0x92); 
	        	
	GC0328_write_cmos_sensor(0xa4 , 0x50);   //10 
	GC0328_write_cmos_sensor(0xa5 , 0x11);  //
	GC0328_write_cmos_sensor(0xa8 , 0xB0);    
	GC0328_write_cmos_sensor(0xaa , 0x64);  //////40  //20
	...
	GC0328_write_cmos_sensor(0x10 , 0x08);  //08 betty
	GC0328_write_cmos_sensor(0x11 , 0x11);   
	GC0328_write_cmos_sensor(0x12 , 0x10);   
	GC0328_write_cmos_sensor(0x13 , 0x50);  //80 betty 
	...
	GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps/////3c0
	GC0328_write_cmos_sensor(0x2e, 0xd0); 
	GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps   3c0  ///5a0////480
	GC0328_write_cmos_sensor(0x30, 0x48); 
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x58);// 68 betty
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
