 ...
 * Revision 1.1  2013/10/24 11:22:22  wangtinglong
...
static void GC2035_Sensor_Init(void)
{
  ...
  GC2035_write_cmos_sensor(0xf8 , 0x84);////84
	...
	GC2035_write_cmos_sensor(0xad , 0x80);//81
	GC2035_write_cmos_sensor(0xae , 0x80);//7e
	GC2035_write_cmos_sensor(0xaf , 0x82);//hyper 0x80//7d
	...
	GC2035_write_cmos_sensor(0x13 , 0x88);//y_target//75
	GC2035_write_cmos_sensor(0xfe , 0x00);
...
*/
	...
	GC2035_write_cmos_sensor(0xc1 , 0x43); //Green_cc for d//40
	...
	GC2035_write_cmos_sensor(0xd3 , 0x3a);//contrast \D3//40
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0x00);//luma_offset // 0x00	0626//f8
	...
	GC2035_write_cmos_sensor(0x97 , 0x44);// edge effect 45 betty// 0x54	0626//44//65 hyper//65
	////==============RGB Gamma 
/*#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 3; // 4	0626//4
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x88);//80
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
