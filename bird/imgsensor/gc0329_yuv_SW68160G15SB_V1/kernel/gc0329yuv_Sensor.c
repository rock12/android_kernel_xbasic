 ...
 * Revision 1.2  2013/09/16 08:04:36  zhoushaohong
 * 13E43_T9
 *
 * Revision 1.1  2013/08/13 10:11:23  wangqiang
 * 13E43_T9
 * 优化效果
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x28);//20
	GC0329_write_cmos_sensor(0x34, 0x28);//20
	...
	GC0329_write_cmos_sensor(0xb3, 0x40);
	GC0329_write_cmos_sensor(0xb4, 0xf0);//fd betty
	GC0329_write_cmos_sensor(0xb5, 0x05);//02 betty
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x2d);
	GC0329_write_cmos_sensor(0xd2, 0x2d);
	GC0329_write_cmos_sensor(0xd3, 0x42);
	...
	GC0329_write_cmos_sensor(0x21, 0x90);  //a0
  ...
  GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	...
	GC0329_write_cmos_sensor(0x7a, 0x5a);
	GC0329_write_cmos_sensor(0x7b, 0x1b);//20
	GC0329_write_cmos_sensor(0x7c, 0x32);//30
	...
	GC0329_write_cmos_sensor(0x7a, 0x76);
	GC0329_write_cmos_sensor(0x7a, 0x80);
	GC0329_SET_PAGE1;
...
void GC0329_Write_More_Registers(void)
{
	...
	//GC0329_write_cmos_sensor(0xd2,0x22);																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2e, 0xee); 
			GC0329_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x65); 
			GC0329_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
			GC0329_write_cmos_sensor(0x32, 0xdc); 
			GC0329_SET_PAGE0;
			break;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0329_write_cmos_sensor(0xd5, value_luma - 0x0a);
			GC0329_write_cmos_sensor(0xfe, 0x01);
