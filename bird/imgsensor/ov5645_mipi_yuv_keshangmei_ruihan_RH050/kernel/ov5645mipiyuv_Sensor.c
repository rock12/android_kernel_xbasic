...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3611, 0xc6);//06
	OV5645MIPI_write_cmos_sensor(0x3612, 0x0b);//ab
	...
	OV5645MIPI_write_cmos_sensor(0x3821, 0x07);//	; mirror on, H bin on  01
	...
	OV5645MIPI_write_cmos_sensor(0x3a19, 0xf8);//	; gain ceiling    60
	...
	OV5645MIPI_write_cmos_sensor(0x5186, 0x14);//
	OV5645MIPI_write_cmos_sensor(0x5187, 0x17);//
	OV5645MIPI_write_cmos_sensor(0x5188, 0xf );//
	OV5645MIPI_write_cmos_sensor(0x5189, 0x78);//
	OV5645MIPI_write_cmos_sensor(0x518a, 0x5c);//
	OV5645MIPI_write_cmos_sensor(0x518b, 0xf2);//
	OV5645MIPI_write_cmos_sensor(0x518c, 0x95);//
	OV5645MIPI_write_cmos_sensor(0x518d, 0x3a);//
	OV5645MIPI_write_cmos_sensor(0x518e, 0x2b);//
	OV5645MIPI_write_cmos_sensor(0x518f, 0x5c);//
	...
	OV5645MIPI_write_cmos_sensor(0x5800, 0x2f);//lsc                                
	...
	OV5645MIPI_write_cmos_sensor(0x5805, 0x2e);//                                   
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	//add by liuhuan 
	OV5645MIPI_write_cmos_sensor(0x3008, 0x42);//avoid preview download param err
	//add end
	...
	OV5645MIPI_write_cmos_sensor(0x3814, 0x31);//	; X INC
	OV5645MIPI_write_cmos_sensor(0x3815, 0x31);//	; Y INC
	OV5645MIPI_write_cmos_sensor(0x3820, 0x41);//	; flip off, V bin on  47
	OV5645MIPI_write_cmos_sensor(0x3821, 0x07);//	; mirror on, H bin on  01
	OV5645MIPI_write_cmos_sensor(0x4514, 0x00);
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3820, 0x40);//	; flip off, V bin off  46
	OV5645MIPI_write_cmos_sensor(0x3821, 0x06);//	; mirror on, H bin off 00
	...
	OV5645MIPI_write_cmos_sensor(0x350d, 0x00);
 	...
 	OV5645MIPI_write_cmos_sensor(0x3a09, 0x19);
 	OV5645MIPI_write_cmos_sensor(0x3a0a, 0x00);
 	OV5645MIPI_write_cmos_sensor(0x3a0b, 0xea);
...
static void OV5645MIPIFullSizeZSDSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x380a, 0x07);//	; DVPVO = 1440
	OV5645MIPI_write_cmos_sensor(0x380b, 0x98);//	; DVPVO
	OV5645MIPI_write_cmos_sensor(0x380c, 0x0b);//	; HTS = 2984 //bec
	OV5645MIPI_write_cmos_sensor(0x380d, 0xec);//	; HTS
	OV5645MIPI_write_cmos_sensor(0x380e, 0x08);//	; VTS = 1464 //7b0
	OV5645MIPI_write_cmos_sensor(0x380f, 0x0a);//	; VTS
	OV5645MIPI_write_cmos_sensor(0x3810, 0x00); //H OFF = 16
	OV5645MIPI_write_cmos_sensor(0x3811, 0x10); //H OFF
	OV5645MIPI_write_cmos_sensor(0x3812, 0x00); //V OFF = 4
	OV5645MIPI_write_cmos_sensor(0x3813, 0x06);//	; V OFF	
	...
	//OV5645MIPI_write_cmos_sensor(0x3a00, 0x3c);//	; ae mode
 	...
 	OV5645MIPI_write_cmos_sensor(0x3a08, 0x01);
 	OV5645MIPI_write_cmos_sensor(0x3a09, 0x26);
 	OV5645MIPI_write_cmos_sensor(0x3a0a, 0x00);
 	OV5645MIPI_write_cmos_sensor(0x3a0b, 0xf5);
...
BOOL OV5645MIPI_set_param_wb(UINT16 para)
{
	...
	if(OV5645MIPISensor.sceneMode != SCENE_MODE_OFF && OV5645MIPISensor.sceneMode != SCENE_MODE_NORMAL)
	{	
		//awb_mode = OV5645MIPISensor.awbMode;
		//OV5645MIPI_set_param_wb(AWB_MODE_AUTO);
		//OV5645MIPISensor.awbMode = awb_mode;
		para = AWB_MODE_AUTO;
	}
...
void OV5645MIPI_scene_mode_LANDSCAPE()
{
	...
	//OV5645MIPI_write_cmos_sensor(0x5381,0x42); //CMX
...
void OV5645MIPI_scene_mode_OFF()
{
	...
	OV5645MIPI_write_cmos_sensor(0x3A00,0x3c); //10-30
	OV5645MIPI_write_cmos_sensor(0x3a02,0x09); 
	OV5645MIPI_write_cmos_sensor(0x3a03,0x30); //b88                         
	OV5645MIPI_write_cmos_sensor(0x3a14,0x09); 
	OV5645MIPI_write_cmos_sensor(0x3a15,0x30);
	OV5645MIPI_write_cmos_sensor(0x350c,0x00);
    OV5645MIPI_write_cmos_sensor(0x350d,0x00);
...
void OV5645MIPI_set_scene_mode(UINT16 para)
{
	...
	if(OV5645MIPISensor.awbMode != AWB_MODE_OFF && OV5645MIPISensor.awbMode != AWB_MODE_AUTO
		/*&& para != SCENE_MODE_LANDSCAPE && para != SCENE_MODE_SUNSET*/)
	{	
		OV5645MIPI_set_AWB_mode(KAL_TRUE);
	}
...
void OV5645MIPI_set_iso(UINT16 para)
{
    ...
    switch (para)
    {
		...
		case AE_ISO_AUTO:
             ...
             OV5645MIPI_write_cmos_sensor(0x3a19, 0xf8);//60
             break;
        case AE_ISO_200:
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
...
UINT32 OV5645MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
	...
	if (u2FrameRate == 30)
	{
	  ...
	  OV5645MIPI_write_cmos_sensor(0x3821, 0x06);//	; mirror on, H bin on //01->07
		OV5645MIPI_write_cmos_sensor(0x4514, 0x00);
		OV5645MIPI_write_cmos_sensor(0x3a00, 0x38);//	; ae mode	
		OV5645MIPI_write_cmos_sensor(0x3a02, 0x03);//	; max exp 60 = 740
		OV5645MIPI_write_cmos_sensor(0x3a03, 0xd8);//	; max exp 60
...
static void OV5645MIPI_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
	...
	printk("OV5645MIPI_FlashTriggerCheck NormBr = [0%x]",NormBr);
