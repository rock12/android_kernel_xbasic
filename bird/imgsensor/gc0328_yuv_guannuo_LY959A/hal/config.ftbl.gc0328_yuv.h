...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      "640x480",     "1280x720", "1024x768",  "1280x960",   "1600x1200",   "2048x1536",  "2560x1440",
                "2560x1920",
            )
        ), 
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
               ...
               // MtkCameraParameters::CAPTURE_MODE_FACE_BEAUTY, //remove by meifangting for bug[95597]
