 ...
 * Revision 1.2  2013/08/21 08:53:24  xialeijie
 * no message
 *
 * Revision 1.1  2013/08/20 05:51:20  xialeijie
 * no message
 *
...
////AWB//
  ...
  GC0328_write_cmos_sensor(0x44 , 0x02);
	...
	GC0328_write_cmos_sensor(0x82 , 0x9f);    
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x2b);
	GC0328_write_cmos_sensor(0xd2 , 0x2b);
	...
	GC0328_write_cmos_sensor(0xB2 , 0xfe);   
	GC0328_write_cmos_sensor(0xB3 , 0xfc);   
	GC0328_write_cmos_sensor(0xB4 , 0xee);   
	GC0328_write_cmos_sensor(0xB5 , 0x07);   
	...
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x32, 0x2e); 
					...
					bbbb3=GC0328_read_cmos_sensor(0x77);
		bbbb4=GC0328_read_cmos_sensor(0x78);
		bbbb5=GC0328_read_cmos_sensor(0x79);
		        SENSORDB("0xb3 = 0x%04x\n", bbbb3); 
		        SENSORDB("0xb3 = 0x%04x\n", bbbb4); 
		        SENSORDB("0xb3 = 0x%04x\n", bbbb5); */
			GC0328_SET_PAGE0;
		break;
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xfc);
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x7a);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
