 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: HM5065yuv_Sensor.h,v $
 * Revision 1.1  2013/10/16 12:19:47  wangdong
 * no message
 *
 * Revision 1.1  2013/10/15 03:57:29  wangqiang
 * [97545] [Camera]进入相机时,或前置切换到后置时,界面闪现绿色。
 *
 * Revision 1.1  2013/06/07 07:59:14  huangmaohua
 * *** empty log message ***
 *
 *
...
#define HM5065_IMAGE_SENSOR_QSXGA_WITDH         (2592-16)//(2560)//(2592) 
