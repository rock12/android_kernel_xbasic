...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x1f , 0xa0);//max_post_gain  //c0
	GC2035_write_cmos_sensor(0x20 , 0x50);//max_pre_gain   //60
	...
	GC2035_write_cmos_sensor(0x5e, 0x21);  //G
	GC2035_write_cmos_sensor(0x5f, 0x21);  //G
	...
	GC2035_write_cmos_sensor(0x64, 0x21);  //G
	GC2035_write_cmos_sensor(0x65, 0x21);  //G
	...
	GC2035_write_cmos_sensor(0xc1, 0x42); ///40 
	GC2035_write_cmos_sensor(0xc2, 0xfd); ///fc 
	GC2035_write_cmos_sensor(0xc3, 0x02);  ///05
	GC2035_write_cmos_sensor(0xc4, 0xec);  
	GC2035_write_cmos_sensor(0xc5, 0x44);  
	GC2035_write_cmos_sensor(0xc6, 0xf8);  
	GC2035_write_cmos_sensor(0xc7, 0x37);  ///40
	GC2035_write_cmos_sensor(0xc8, 0xfb);///f8  
	GC2035_write_cmos_sensor(0xc9, 0x02);  ///06
	...
	GC2035_write_cmos_sensor(0x4e, 0x02);  //00 betty
	GC2035_write_cmos_sensor(0x4e, 0x04);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	...
	GC2035_write_cmos_sensor(0x4e, 0x02);  
	GC2035_write_cmos_sensor(0x4e, 0x02);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  //00 betty
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	...
	GC2035_write_cmos_sensor(0x8a , 0x00);//awb move mode  c0 betty
	...
	GC2035_write_cmos_sensor(0xb4 , 0x21); //add betty
	...
	GC2035_write_cmos_sensor(0xd1, 0x28);  ///38
	GC2035_write_cmos_sensor(0xd2, 0x28);  
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1f);//dn_b_base 15 betty
	...
	GC2035_write_cmos_sensor(0x97 , 0x44);// edge effect//0x65
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 3; //1 betty
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x29, 0x05);//
		GC2035_write_cmos_sensor(0x2a, 0x22);  
		GC2035_write_cmos_sensor(0x2b, 0x06);//5b4
		GC2035_write_cmos_sensor(0x2c, 0x46);  
		GC2035_write_cmos_sensor(0x2d, 0x07);//5b4
		GC2035_write_cmos_sensor(0x2e, 0x6a);  //6d8
		GC2035_write_cmos_sensor(0x2f, 0x08);//
		GC2035_write_cmos_sensor(0x30, 0x8e);  //76a
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x86);//80 betty
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
