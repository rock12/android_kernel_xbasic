 ...
 * Revision 1.1  2013/07/25 01:45:17  chenxiaolin
 * Editor: chenxiaolin
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast Ó
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_YUYV;//SENSOR_OUTPUT_FORMAT_UYVY;/////SENSOR_OUTPUT_FORMAT_YVYU;//SENSOR_OUTPUT_FORMAT_VYUY;//SENSOR_OUTPUT_FORMAT_UYVY;//SENSOR_OUTPUT_FORMAT_YUYV;
