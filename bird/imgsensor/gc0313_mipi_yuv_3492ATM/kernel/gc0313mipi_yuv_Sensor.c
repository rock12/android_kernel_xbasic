	...
	else 
	{
		...
		if(GC0313MIPI_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0313MIPI_write_cmos_sensor(0x33, 0x20);
           	       GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
			GC0313MIPIGammaSelect(GC0313MIPI_RGB_Gamma_m4);	//1			   
...
void GC0313MIPI_Sensor_Init(void)
{
	...
	GC0313MIPI_write_cmos_sensor(0x03 , 0x00);
	GC0313MIPI_write_cmos_sensor(0x04 , 0xd4);
	GC0313MIPI_write_cmos_sensor(0x05 , 0x01);
	...
	GC0313MIPI_write_cmos_sensor(0x03 , 0x00);
	GC0313MIPI_write_cmos_sensor(0x04 , 0xd4); //exposure time
			
	GC0313MIPI_write_cmos_sensor(0xfe , 0x01);
	GC0313MIPI_write_cmos_sensor(0x29 , 0x00);
	GC0313MIPI_write_cmos_sensor(0x2a , 0x35); //step
	GC0313MIPI_write_cmos_sensor(0x2b , 0x02); //10fps 
	GC0313MIPI_write_cmos_sensor(0x2c , 0x12);
	GC0313MIPI_write_cmos_sensor(0x2d , 0x02); //8.33fps
	GC0313MIPI_write_cmos_sensor(0x2e , 0x7c);
	GC0313MIPI_write_cmos_sensor(0x2f , 0x03); //6.67fps		2e6->7.14fps
	GC0313MIPI_write_cmos_sensor(0x30 , 0x1b);
	GC0313MIPI_write_cmos_sensor(0x31 , 0x04); // 5fps 
	...
	////////////////// YUV to RGB //////////////////////
	////////////////////////////////////////////////////
	GC0313MIPI_write_cmos_sensor(0xb0 , 0x18);//0x14
	GC0313MIPI_write_cmos_sensor(0xb1 , 0x28);//27
	GC0313MIPI_write_cmos_sensor(0xb2 , 0x0b);//07
	...
	GC0313MIPI_write_cmos_sensor(0x82 , 0x78);//78
	...
	GC0313MIPI_write_cmos_sensor(0x95 , 0x66); //86 54 0x56
	...
	GC0313MIPI_write_cmos_sensor(0xd1 , 0x2a);//38 Cr 23 0x2e
	GC0313MIPI_write_cmos_sensor(0xd2 , 0x2a);//38 Cb 26
	GC0313MIPI_write_cmos_sensor(0xd3 , 0x3b);//40
	...
	GC0313MIPI_write_cmos_sensor(0x52 , 0x24);//0x20 
	GC0313MIPI_write_cmos_sensor(0x53 , 0x10); //0x08
	GC0313MIPI_write_cmos_sensor(0x54 , 0x0d); //0x10
	GC0313MIPI_write_cmos_sensor(0x55 , 0x1d); //20
	GC0313MIPI_write_cmos_sensor(0x56 , 0x1d); //0x1b
	GC0313MIPI_write_cmos_sensor(0x57 , 0x22); //0x20
...
{
    	GC0313MIPIGammaSelect(4);//0:use default//0
}
	...
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			*/
			...
			GC0313MIPI_write_cmos_sensor(0x2d , 0x02); //11fps
			GC0313MIPI_write_cmos_sensor(0x2e , 0x7c);
			GC0313MIPI_write_cmos_sensor(0x2f , 0x03); //8fps 2e6
			GC0313MIPI_write_cmos_sensor(0x30 , 0x1b);
...
BOOL GC0313MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:		
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x78);//45
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
