...
typedef struct
{
	...
	#else
	#define S5K3H7Y_PV_PERIOD_PIXEL_NUMS					(0x0E68) 	// 0x0E68=3688	 
	#endif
	#define S5K3H7Y_PV_PERIOD_LINE_NUMS 					(0x0928)  	//(0x0940=2368
		//Video
	#define S5K3H7Y_VIDEO_PERIOD_PIXEL_NUMS					(0x0E68) 	// 0x0E68=3688
	#define S5K3H7Y_VIDEO_PERIOD_LINE_NUMS					(0x0928)  	//(0x0928=2344
		//Capture
	#define S5K3H7Y_FULL_PERIOD_PIXEL_NUMS					(0x0E68)	//0x0E68=3688
	#define S5K3H7Y_FULL_PERIOD_LINE_NUMS					(0xB72)		//0x0B72=2930	//0x09E2=2530
		//ZSD
	...
	#define S5K3H7Y_FULL_Y_START						    		(2+1)// 1
