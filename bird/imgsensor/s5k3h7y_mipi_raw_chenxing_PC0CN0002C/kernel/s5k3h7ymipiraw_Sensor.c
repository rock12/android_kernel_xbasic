...
#define SENSOR_PCLK_PREVIEW  	26000*10000  //27600*10000
#define SENSOR_PCLK_VIDEO  		26000*10000
#define SENSOR_PCLK_CAPTURE  	26000*10000
...
void S5K3H7YVideoSetting(void)
{
	...
	S5K3H7Y_wordwrite_cmos_sensor(0x034A,S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT_SETTING+3);	// smiaRegs_rw_frame_timing_y_addr_end
