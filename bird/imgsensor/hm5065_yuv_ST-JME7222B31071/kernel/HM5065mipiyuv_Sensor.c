		 ...
		 // HM5065MIPISensor.bNight_mode = KAL_FALSE;
		  ...
		  {		 
			  ...
			  printk("HM5065 night_auto mode ture camera preview--------------\r\n");
				  HM5065MIPI_write_cmos_sensor(0x00E8,0x01);//AFR
				  HM5065MIPI_write_cmos_sensor(0x00ED,0x05);//Min=12fps//08->05 by jink 20131023
				  HM5065MIPI_write_cmos_sensor(0x00EE,0x1E);//Max=30fps
...
HM5065MIPI_write_cmos_sensor(0x0083,0x00);// 01->00 by jink 20131011  // Horizontal Mirror Enable
HM5065MIPI_write_cmos_sensor(0x0084,0x00);// 01->00 by jink 20131011 // Vertical Flip Enable
HM5065MIPI_write_cmos_sensor(0x0085,0x02);//  YCbYCr Order

HM5065MIPI_write_cmos_sensor(0x00B2,0x50);// 50       // set PLL output 713MHz
HM5065MIPI_write_cmos_sensor(0x00B3,0x30);//  80->30 by jink 20131015
HM5065MIPI_write_cmos_sensor(0x00B4,0x01);//         // E_div
HM5065MIPI_write_cmos_sensor(0x00B5,0x02);//         // PLL3_div 2
...
HM5065MIPI_write_cmos_sensor(0x0130,0xff);// //20131023
...
HM5065MIPI_write_cmos_sensor(0x0143,0x61);// 5F->61 by jink 20131023
HM5065MIPI_write_cmos_sensor(0x0144,0x0D);// 
...
HM5065MIPI_write_cmos_sensor(0x02C3,0xC0);//20131023

// Set DigitalGainCeiling = 2.0
HM5065MIPI_write_cmos_sensor(0x015E,0x41);//20131023 
...
// SetPeakingControl
HM5065MIPI_write_cmos_sensor(0x004C,0x0c);//  PipeSetupBank0 fPeakingGain // //20131023
...
HM5065MIPI_write_cmos_sensor(0x0357,0x39);//  PeakingControl fUserPeakLoThresh //39 ->59 by jink 20131015
...
HM5065MIPI_write_cmos_sensor(0x004A,0x0E);//  PipeSetupBank0 bGammaInterpolationGain//20131023
HM5065MIPI_write_cmos_sensor(0x0069,0x14);//  PipeSetupBank1 bGammaGain 
HM5065MIPI_write_cmos_sensor(0x006A,0x0E);//  PipeSetupBank1 bGammaInterpolationGain//20131023
...
HM5065MIPI_write_cmos_sensor(0x0098,0x01);//   // GammaGainDamperControl fDisable {CompiledExposureTime}//20131023
...
HM5065MIPI_write_cmos_sensor(0x00A8,0x01);//  GammaInterpolationDamperControl fDisable {CompiledExposureTime} //20131023
...
HM5065MIPI_write_cmos_sensor(0x0324,0x38);    //
HM5065MIPI_write_cmos_sensor(0x0325,0xEF);    //
HM5065MIPI_write_cmos_sensor(0x0326,0x39);    //
HM5065MIPI_write_cmos_sensor(0x0327,0x79);    //
HM5065MIPI_write_cmos_sensor(0x0328,0x3A);    //
HM5065MIPI_write_cmos_sensor(0x0329,0x9F);    //
HM5065MIPI_write_cmos_sensor(0x032A,0x3B);    //
HM5065MIPI_write_cmos_sensor(0x032B,0x39);    //add by jink 20131015
...
//**********************************************
#else
///////////////////////////////////////////////////////////new LSC setting 20131012 
HM5065MIPI_write_cmos_sensor(0x0420,0x00);    // C0_GreenRed_X
HM5065MIPI_write_cmos_sensor(0x0421,0x30);    // C0_GreenRed_X LSB
HM5065MIPI_write_cmos_sensor(0x0422,0x00);    // C0_GreenRed_Y
HM5065MIPI_write_cmos_sensor(0x0423,0x44);    // C0_GreenRed_Y LSB
HM5065MIPI_write_cmos_sensor(0x0424,0x00);    // C0_GreenRed_X2
HM5065MIPI_write_cmos_sensor(0x0425,0x8C);    // C0_GreenRed_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0426,0x00);    // C0_GreenRed_Y2
HM5065MIPI_write_cmos_sensor(0x0427,0xBE);    // C0_GreenRed_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0428,0xFF);    // C0_GreenRed_XY
HM5065MIPI_write_cmos_sensor(0x0429,0x85);    // C0_GreenRed_XY LSB
HM5065MIPI_write_cmos_sensor(0x042A,0x00);    // C0_GreenRed_X2Y
HM5065MIPI_write_cmos_sensor(0x042B,0xFA);    // C0_GreenRed_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x042C,0x01);    // C0_GreenRed_XY2
HM5065MIPI_write_cmos_sensor(0x042D,0x1F);    // C0_GreenRed_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x042E,0xFF);    // C0_GreenRed_X2Y2
HM5065MIPI_write_cmos_sensor(0x042F,0xB0);    // C0_GreenRed_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0430,0x00);    // C0_Red_X
HM5065MIPI_write_cmos_sensor(0x0431,0x16);    // C0_Red_X LSB
HM5065MIPI_write_cmos_sensor(0x0432,0xFF);    // C0_Red_Y
HM5065MIPI_write_cmos_sensor(0x0433,0xAE);    // C0_Red_Y LSB
HM5065MIPI_write_cmos_sensor(0x0434,0x01);    // C0_Red_X2
HM5065MIPI_write_cmos_sensor(0x0435,0x0A);    // C0_Red_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0436,0x01);    // C0_Red_Y2
HM5065MIPI_write_cmos_sensor(0x0437,0x34);    // C0_Red_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0438,0x00);    // C0_Red_XY
HM5065MIPI_write_cmos_sensor(0x0439,0xBE);    // C0_Red_XY LSB
HM5065MIPI_write_cmos_sensor(0x043A,0xFF);    // C0_Red_X2Y
HM5065MIPI_write_cmos_sensor(0x043B,0x51);    // C0_Red_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x043C,0x00);    // C0_Red_XY2
HM5065MIPI_write_cmos_sensor(0x043D,0x3E);    // C0_Red_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x043E,0xFF);    // C0_Red_X2Y2
HM5065MIPI_write_cmos_sensor(0x043F,0x5F);    // C0_Red_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0440,0x00);    // C0_GreenBlue_X
HM5065MIPI_write_cmos_sensor(0x0441,0x02);    // C0_GreenBlue_X LSB
HM5065MIPI_write_cmos_sensor(0x0442,0x00);    // C0_GreenBlue_Y
HM5065MIPI_write_cmos_sensor(0x0443,0x19);    // C0_GreenBlue_Y LSB
HM5065MIPI_write_cmos_sensor(0x0444,0x00);    // C0_GreenBlue_X2
HM5065MIPI_write_cmos_sensor(0x0445,0xA1);    // C0_GreenBlue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0446,0x00);    // C0_GreenBlue_Y2
HM5065MIPI_write_cmos_sensor(0x0447,0xAB);    // C0_GreenBlue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0448,0xFF);    // C0_GreenBlue_XY
HM5065MIPI_write_cmos_sensor(0x0449,0x74);    // C0_GreenBlue_XY LSB
HM5065MIPI_write_cmos_sensor(0x044A,0x00);    // C0_GreenBlue_X2Y
HM5065MIPI_write_cmos_sensor(0x044B,0xD0);    // C0_GreenBlue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x044C,0x00);    // C0_GreenBlue_XY2
HM5065MIPI_write_cmos_sensor(0x044D,0x95);    // C0_GreenBlue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x044E,0xFF);    // C0_GreenBlue_X2Y2
HM5065MIPI_write_cmos_sensor(0x044F,0xB0);    // C0_GreenBlue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0450,0x00);    // C0_Blue_X
HM5065MIPI_write_cmos_sensor(0x0451,0x25);    // C0_Blue_X LSB
HM5065MIPI_write_cmos_sensor(0x0452,0xFF);    // C0_Blue_Y
HM5065MIPI_write_cmos_sensor(0x0453,0xED);    // C0_Blue_Y LSB
HM5065MIPI_write_cmos_sensor(0x0454,0x00);    // C0_Blue_X2
HM5065MIPI_write_cmos_sensor(0x0455,0x79);    // C0_Blue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0456,0x00);    // C0_Blue_Y2
HM5065MIPI_write_cmos_sensor(0x0457,0xA0);    // C0_Blue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0458,0x00);    // C0_Blue_XY
HM5065MIPI_write_cmos_sensor(0x0459,0x46);    // C0_Blue_XY LSB
HM5065MIPI_write_cmos_sensor(0x045A,0x00);    // C0_Blue_X2Y
HM5065MIPI_write_cmos_sensor(0x045B,0xB5);    // C0_Blue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x045C,0xFF);    // C0_Blue_XY2
HM5065MIPI_write_cmos_sensor(0x045D,0xC7);    // C0_Blue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x045E,0xFF);    // C0_Blue_X2Y2
HM5065MIPI_write_cmos_sensor(0x045F,0xB5);    // C0_Blue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0460,0x00);    // C1_GreenRed_X
HM5065MIPI_write_cmos_sensor(0x0461,0x35);    // C1_GreenRed_X LSB
HM5065MIPI_write_cmos_sensor(0x0462,0x00);    // C1_GreenRed_Y
HM5065MIPI_write_cmos_sensor(0x0463,0x41);    // C1_GreenRed_Y LSB
HM5065MIPI_write_cmos_sensor(0x0464,0x00);    // C1_GreenRed_X2
HM5065MIPI_write_cmos_sensor(0x0465,0x8A);    // C1_GreenRed_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0466,0x00);    // C1_GreenRed_Y2
HM5065MIPI_write_cmos_sensor(0x0467,0xB7);    // C1_GreenRed_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0468,0xFF);    // C1_GreenRed_XY
HM5065MIPI_write_cmos_sensor(0x0469,0x77);    // C1_GreenRed_XY LSB
HM5065MIPI_write_cmos_sensor(0x046A,0x01);    // C1_GreenRed_X2Y
HM5065MIPI_write_cmos_sensor(0x046B,0x08);    // C1_GreenRed_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x046C,0x01);    // C1_GreenRed_XY2
HM5065MIPI_write_cmos_sensor(0x046D,0x1D);    // C1_GreenRed_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x046E,0xFF);    // C1_GreenRed_X2Y2
HM5065MIPI_write_cmos_sensor(0x046F,0xB8);    // C1_GreenRed_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0470,0x00);    // C1_Red_X
HM5065MIPI_write_cmos_sensor(0x0471,0x19);    // C1_Red_X LSB
HM5065MIPI_write_cmos_sensor(0x0472,0xFF);    // C1_Red_Y
HM5065MIPI_write_cmos_sensor(0x0473,0xAE);    // C1_Red_Y LSB
HM5065MIPI_write_cmos_sensor(0x0474,0x00);    // C1_Red_X2
HM5065MIPI_write_cmos_sensor(0x0475,0xFC);    // C1_Red_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0476,0x01);    // C1_Red_Y2
HM5065MIPI_write_cmos_sensor(0x0477,0x25);    // C1_Red_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0478,0x00);    // C1_Red_XY
HM5065MIPI_write_cmos_sensor(0x0479,0xA9);    // C1_Red_XY LSB
HM5065MIPI_write_cmos_sensor(0x047A,0xFF);    // C1_Red_X2Y
HM5065MIPI_write_cmos_sensor(0x047B,0x8B);    // C1_Red_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x047C,0x00);    // C1_Red_XY2
HM5065MIPI_write_cmos_sensor(0x047D,0x44);    // C1_Red_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x047E,0xFF);    // C1_Red_X2Y2
HM5065MIPI_write_cmos_sensor(0x047F,0x67);    // C1_Red_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0480,0x00);    // C1_GreenBlue_X
HM5065MIPI_write_cmos_sensor(0x0481,0x02);    // C1_GreenBlue_X LSB
HM5065MIPI_write_cmos_sensor(0x0482,0x00);    // C1_GreenBlue_Y
HM5065MIPI_write_cmos_sensor(0x0483,0x1C);    // C1_GreenBlue_Y LSB
HM5065MIPI_write_cmos_sensor(0x0484,0x00);    // C1_GreenBlue_X2
HM5065MIPI_write_cmos_sensor(0x0485,0x9B);    // C1_GreenBlue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0486,0x00);    // C1_GreenBlue_Y2
HM5065MIPI_write_cmos_sensor(0x0487,0xA8);    // C1_GreenBlue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0488,0xFF);    // C1_GreenBlue_XY
HM5065MIPI_write_cmos_sensor(0x0489,0x61);    // C1_GreenBlue_XY LSB
HM5065MIPI_write_cmos_sensor(0x048A,0x00);    // C1_GreenBlue_X2Y
HM5065MIPI_write_cmos_sensor(0x048B,0xCC);    // C1_GreenBlue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x048C,0x00);    // C1_GreenBlue_XY2
HM5065MIPI_write_cmos_sensor(0x048D,0x8C);    // C1_GreenBlue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x048E,0xFF);    // C1_GreenBlue_X2Y2
HM5065MIPI_write_cmos_sensor(0x048F,0xBA);    // C1_GreenBlue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0490,0x00);    // C1_Blue_X
HM5065MIPI_write_cmos_sensor(0x0491,0x2B);    // C1_Blue_X LSB
HM5065MIPI_write_cmos_sensor(0x0492,0xFF);    // C1_Blue_Y
HM5065MIPI_write_cmos_sensor(0x0493,0xE0);    // C1_Blue_Y LSB
HM5065MIPI_write_cmos_sensor(0x0494,0x00);    // C1_Blue_X2
HM5065MIPI_write_cmos_sensor(0x0495,0x73);    // C1_Blue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0496,0x00);    // C1_Blue_Y2
HM5065MIPI_write_cmos_sensor(0x0497,0x96);    // C1_Blue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0498,0x00);    // C1_Blue_XY
HM5065MIPI_write_cmos_sensor(0x0499,0x4E);    // C1_Blue_XY LSB
HM5065MIPI_write_cmos_sensor(0x049A,0x00);    // C1_Blue_X2Y
HM5065MIPI_write_cmos_sensor(0x049B,0x99);    // C1_Blue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x049C,0xFF);    // C1_Blue_XY2
HM5065MIPI_write_cmos_sensor(0x049D,0xE2);    // C1_Blue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x049E,0xFF);    // C1_Blue_X2Y2
HM5065MIPI_write_cmos_sensor(0x049F,0xD0);    // C1_Blue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04A0,0x00);// C2_GreenRed_X
HM5065MIPI_write_cmos_sensor(0x04A1,0x24);// C2_GreenRed_X LSB
HM5065MIPI_write_cmos_sensor(0x04A2,0x00);// C2_GreenRed_Y
HM5065MIPI_write_cmos_sensor(0x04A3,0x32);// C2_GreenRed_Y LSB
HM5065MIPI_write_cmos_sensor(0x04A4,0x00);// C2_GreenRed_X2
HM5065MIPI_write_cmos_sensor(0x04A5,0x80);// C2_GreenRed_X2 LSB
HM5065MIPI_write_cmos_sensor(0x04A6,0x00);// C2_GreenRed_Y2
HM5065MIPI_write_cmos_sensor(0x04A7,0xA0);// C2_GreenRed_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04A8,0xFF);// C2_GreenRed_XY
HM5065MIPI_write_cmos_sensor(0x04A9,0x65);// C2_GreenRed_XY LSB
HM5065MIPI_write_cmos_sensor(0x04AA,0x00);// C2_GreenRed_X2Y
HM5065MIPI_write_cmos_sensor(0x04AB,0xED);// C2_GreenRed_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x04AC,0x00);// C2_GreenRed_XY2
HM5065MIPI_write_cmos_sensor(0x04AD,0xD6);// C2_GreenRed_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x04AE,0xFF);// C2_GreenRed_X2Y2
HM5065MIPI_write_cmos_sensor(0x04AF,0xCD);// C2_GreenRed_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04B0,0x00);// C2_Red_X
HM5065MIPI_write_cmos_sensor(0x04B1,0x0A);// C2_Red_X LSB
HM5065MIPI_write_cmos_sensor(0x04B2,0xFF);// C2_Red_Y
HM5065MIPI_write_cmos_sensor(0x04B3,0xB0);// C2_Red_Y LSB
HM5065MIPI_write_cmos_sensor(0x04B4,0x00);// C2_Red_X2
HM5065MIPI_write_cmos_sensor(0x04B5,0xA8);// C2_Red_X2 LSB
HM5065MIPI_write_cmos_sensor(0x04B6,0x00);// C2_Red_Y2
HM5065MIPI_write_cmos_sensor(0x04B7,0xCC);// C2_Red_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04B8,0xfe);// C2_Red_XY//00->01 20131015
HM5065MIPI_write_cmos_sensor(0x04B9,0x59);// C2_Red_XY LSB
HM5065MIPI_write_cmos_sensor(0x04BA,0xFF);// C2_Red_X2Y
HM5065MIPI_write_cmos_sensor(0x04BB,0xE5);// C2_Red_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x04BC,0xFF);// C2_Red_XY2
HM5065MIPI_write_cmos_sensor(0x04BD,0xD9);// C2_Red_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x04BE,0xFF);// C2_Red_X2Y2
HM5065MIPI_write_cmos_sensor(0x04BF,0xB4);// C2_Red_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04C0,0xFF);// C2_GreenBlue_X
HM5065MIPI_write_cmos_sensor(0x04C1,0xE9);// C2_GreenBlue_X LSB
HM5065MIPI_write_cmos_sensor(0x04C2,0x00);// C2_GreenBlue_Y
HM5065MIPI_write_cmos_sensor(0x04C3,0x1B);// C2_GreenBlue_Y LSB
HM5065MIPI_write_cmos_sensor(0x04C4,0x00);// C2_GreenBlue_X2
HM5065MIPI_write_cmos_sensor(0x04C5,0x88);// C2_GreenBlue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x04C6,0x00);// C2_GreenBlue_Y2
HM5065MIPI_write_cmos_sensor(0x04C7,0x9B);// C2_GreenBlue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04C8,0xFF);// C2_GreenBlue_XY
HM5065MIPI_write_cmos_sensor(0x04C9,0x4B);// C2_GreenBlue_XY LSB
HM5065MIPI_write_cmos_sensor(0x04CA,0x00);// C2_GreenBlue_X2Y
HM5065MIPI_write_cmos_sensor(0x04CB,0x93);// C2_GreenBlue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x04CC,0x00);// C2_GreenBlue_XY2
HM5065MIPI_write_cmos_sensor(0x04CD,0x79);// C2_GreenBlue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x04CE,0xFF);// C2_GreenBlue_X2Y2
HM5065MIPI_write_cmos_sensor(0x04CF,0xC8);// C2_GreenBlue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04D0,0x00);// C2_Blue_X
HM5065MIPI_write_cmos_sensor(0x04D1,0x21);// C2_Blue_X LSB
HM5065MIPI_write_cmos_sensor(0x04D2,0xFF);// C2_Blue_Y
HM5065MIPI_write_cmos_sensor(0x04D3,0xBE);// C2_Blue_Y LSB
HM5065MIPI_write_cmos_sensor(0x04D4,0x00);// C2_Blue_X2
HM5065MIPI_write_cmos_sensor(0x04D5,0x67);// C2_Blue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x04D6,0x00);// C2_Blue_Y2
HM5065MIPI_write_cmos_sensor(0x04D7,0x86);// C2_Blue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04D8,0x00);// C2_Blue_XY
HM5065MIPI_write_cmos_sensor(0x04D9,0x64);// C2_Blue_XY LSB
HM5065MIPI_write_cmos_sensor(0x04DA,0x00);// C2_Blue_X2Y
HM5065MIPI_write_cmos_sensor(0x04DB,0x39);// C2_Blue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x04DC,0xFF);// C2_Blue_XY2
HM5065MIPI_write_cmos_sensor(0x04DD,0xC7);// C2_Blue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x04DE,0xFF);// C2_Blue_X2Y2
HM5065MIPI_write_cmos_sensor(0x04DF,0xEA);// C2_Blue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04E0,0x00);// C3_GreenRed_X
HM5065MIPI_write_cmos_sensor(0x04E1,0x24);// C3_GreenRed_X LSB
HM5065MIPI_write_cmos_sensor(0x04E2,0x00);// C3_GreenRed_Y
HM5065MIPI_write_cmos_sensor(0x04E3,0x32);// C3_GreenRed_Y LSB
HM5065MIPI_write_cmos_sensor(0x04E4,0x00);// C3_GreenRed_X2
HM5065MIPI_write_cmos_sensor(0x04E5,0x80);// C3_GreenRed_X2 LSB
HM5065MIPI_write_cmos_sensor(0x04E6,0x00);// C3_GreenRed_Y2
HM5065MIPI_write_cmos_sensor(0x04E7,0xA0);// C3_GreenRed_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04E8,0xFF);// C3_GreenRed_XY
HM5065MIPI_write_cmos_sensor(0x04E9,0x65);// C3_GreenRed_XY LSB
HM5065MIPI_write_cmos_sensor(0x04EA,0x00);// C3_GreenRed_X2Y
HM5065MIPI_write_cmos_sensor(0x04EB,0xED);// C3_GreenRed_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x04EC,0x00);// C3_GreenRed_XY2
HM5065MIPI_write_cmos_sensor(0x04ED,0xD6);// C3_GreenRed_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x04EE,0xFF);// C3_GreenRed_X2Y2
HM5065MIPI_write_cmos_sensor(0x04EF,0xCD);// C3_GreenRed_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04F0,0x00);// C3_Red_X
HM5065MIPI_write_cmos_sensor(0x04F1,0x0A);// C3_Red_X LSB
HM5065MIPI_write_cmos_sensor(0x04F2,0xFF);// C3_Red_Y
HM5065MIPI_write_cmos_sensor(0x04F3,0xB0);// C3_Red_Y LSB
HM5065MIPI_write_cmos_sensor(0x04F4,0x00);// C3_Red_X2
HM5065MIPI_write_cmos_sensor(0x04F5,0xA8);// C3_Red_X2 LSB
HM5065MIPI_write_cmos_sensor(0x04F6,0x00);// C3_Red_Y2
HM5065MIPI_write_cmos_sensor(0x04F7,0xCC);// C3_Red_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x04F8,0xfe);// C3_Red_XY//00->01 20131015
HM5065MIPI_write_cmos_sensor(0x04F9,0x59);// C3_Red_XY LSB
HM5065MIPI_write_cmos_sensor(0x04FA,0xFF);// C3_Red_X2Y
HM5065MIPI_write_cmos_sensor(0x04FB,0xE5);// C3_Red_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x04FC,0xFF);// C3_Red_XY2
HM5065MIPI_write_cmos_sensor(0x04FD,0xD9);// C3_Red_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x04FE,0xFF);// C3_Red_X2Y2
HM5065MIPI_write_cmos_sensor(0x04FF,0xB4);// C3_Red_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0500,0xFF);// C3_GreenBlue_X
HM5065MIPI_write_cmos_sensor(0x0501,0xE9);// C3_GreenBlue_X LSB
HM5065MIPI_write_cmos_sensor(0x0502,0x00);// C3_GreenBlue_Y
HM5065MIPI_write_cmos_sensor(0x0503,0x1B);// C3_GreenBlue_Y LSB
HM5065MIPI_write_cmos_sensor(0x0504,0x00);// C3_GreenBlue_X2
HM5065MIPI_write_cmos_sensor(0x0505,0x88);// C3_GreenBlue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0506,0x00);// C3_GreenBlue_Y2
HM5065MIPI_write_cmos_sensor(0x0507,0x9B);// C3_GreenBlue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0508,0xFF);// C3_GreenBlue_XY
HM5065MIPI_write_cmos_sensor(0x0509,0x4B);// C3_GreenBlue_XY LSB
HM5065MIPI_write_cmos_sensor(0x050A,0x00);// C3_GreenBlue_X2Y
HM5065MIPI_write_cmos_sensor(0x050B,0x93);// C3_GreenBlue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x050C,0x00);// C3_GreenBlue_XY2
HM5065MIPI_write_cmos_sensor(0x050D,0x79);// C3_GreenBlue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x050E,0xFF);// C3_GreenBlue_X2Y2
HM5065MIPI_write_cmos_sensor(0x050F,0xC8);// C3_GreenBlue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0510,0x00);// C3_Blue_X
HM5065MIPI_write_cmos_sensor(0x0511,0x21);// C3_Blue_X LSB
HM5065MIPI_write_cmos_sensor(0x0512,0xFF);// C3_Blue_Y
HM5065MIPI_write_cmos_sensor(0x0513,0xBE);// C3_Blue_Y LSB
HM5065MIPI_write_cmos_sensor(0x0514,0x00);// C3_Blue_X2
HM5065MIPI_write_cmos_sensor(0x0515,0x67);// C3_Blue_X2 LSB
HM5065MIPI_write_cmos_sensor(0x0516,0x00);// C3_Blue_Y2
HM5065MIPI_write_cmos_sensor(0x0517,0x86);// C3_Blue_Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0518,0x00);// C3_Blue_XY
HM5065MIPI_write_cmos_sensor(0x0519,0x64);// C3_Blue_XY LSB
HM5065MIPI_write_cmos_sensor(0x051A,0x00);// C3_Blue_X2Y
HM5065MIPI_write_cmos_sensor(0x051B,0x39);// C3_Blue_X2Y LSB
HM5065MIPI_write_cmos_sensor(0x051C,0xFF);// C3_Blue_XY2
HM5065MIPI_write_cmos_sensor(0x051D,0xC7);// C3_Blue_XY2 LSB
HM5065MIPI_write_cmos_sensor(0x051E,0xFF);// C3_Blue_X2Y2
HM5065MIPI_write_cmos_sensor(0x051F,0xEA);// C3_Blue_X2Y2 LSB
HM5065MIPI_write_cmos_sensor(0x0561,0x07);    // C0 Unity
HM5065MIPI_write_cmos_sensor(0x0562,0x03);    // C1 Unity
HM5065MIPI_write_cmos_sensor(0x0563,0x07);// C2 Unity
HM5065MIPI_write_cmos_sensor(0x0564,0x07);// C3 Unity
HM5065MIPI_write_cmos_sensor(0x0324,0x38);    //
HM5065MIPI_write_cmos_sensor(0x0325,0xEF);    //
HM5065MIPI_write_cmos_sensor(0x0326,0x39);    //
HM5065MIPI_write_cmos_sensor(0x0327,0x79);    //
...
HM5065MIPI_write_cmos_sensor(0x0329,0x9F);    //
HM5065MIPI_write_cmos_sensor(0x032A,0x3B);    //
HM5065MIPI_write_cmos_sensor(0x032B,0x39);    //
HM5065MIPI_write_cmos_sensor(0x0320,0x01);//     // AntiVignetteControl - Enable
HM5065MIPI_write_cmos_sensor(0x0321,0x04);//     // NbOfPresets
HM5065MIPI_write_cmos_sensor(0x0322,0x01);//     // AdaptiveAntiVignetteControlEnable - Enable
HM5065MIPI_write_cmos_sensor(0x0323,0x01);//     // LoLightAntiVignetteControlDisable - Damper Off
#endif
/////////////////////////////////////////////////////new LSC setting by jink 20131015
//**********************************************
// Adaptive Colour Matrices
//**********************************************
// Adaptive Colour Matrices
...
// Set Brightness
HM5065MIPI_write_cmos_sensor(0x0082,0x5a);//  PipeSetupCommon bBrightness //20131023
...
static void HM5065MIPIPreviewSetting_SVGA(void)
{
	...
	HM5065MIPI_write_cmos_sensor(0x004c,0x0c);//add by jink 20131023
...
static void HM5065MIPIFullSizeCaptureSetting(void)
{
	...
	HM5065MIPISensor.previewShutter = HM5065MIPIReadShutter();
		...
		HM5065MIPI_write_cmos_sensor(0x004c,0x10);//add by jink 20131023
...
UINT32 HM5065MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			pSensorInfo->SensorClockFreq=26;//24->26 by jink 20131011
...
void HM5065MIPI_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_MIDDLE:
        default:
             HM5065MIPI_write_cmos_sensor(0x0081 ,0x60);//58->50 by jink 20131015
             break; 
    }	
...
void HM5065MIPI_set_iso(UINT16 para)
{
	...
	HM5065MIPI_write_cmos_sensor(0x02C3, 0x80);
			...
			case AE_ISO_AUTO:
				 //ISO Auto
	HM5065MIPI_write_cmos_sensor(0x015C, 0x3e);//40->3e by jink 20131011
	HM5065MIPI_write_cmos_sensor(0x015D, 0x00);
	HM5065MIPI_write_cmos_sensor(0x015E, 0x41);//20131023
	HM5065MIPI_write_cmos_sensor(0x015F, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C0, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C1, 0x00);//c0->00 by jink 20131011
	HM5065MIPI_write_cmos_sensor(0x02C2, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C3, 0xC0);//20131023
				 break; 
		}	
    ...
    {	
       case AE_EV_COMP_20:	                   
		...
		case AE_EV_COMP_00:
           	...
           	HM5065MIPI_write_cmos_sensor(0x0082,0x5a);//20131023
				HM5065MIPISENSORDB("[HM5065MIPI]EV 0 \n ");
				//HM5065MIPI_write_cmos_sensor(0x3a1f, 0x18);//	; control zone L  
			  break;
   		 case AE_EV_COMP_n10:
			 
			 HM5065MIPI_write_cmos_sensor(0x0082,0x4A);//20131023
			  break;
      	case AE_EV_COMP_n20:  // -2 EV
