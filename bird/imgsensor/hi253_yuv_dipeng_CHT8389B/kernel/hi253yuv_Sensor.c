...
void HI253InitSetting(void)
{
  ...
  HI253WriteCmosSensor(0x43, 0x34); // VSYNCL
  ...
  HI253WriteCmosSensor(0x92, 0x58); // BLCAGTH ON
  HI253WriteCmosSensor(0x93, 0x50); // BLCAGTH OFF
  ...
  //Dark BLC 
  HI253WriteCmosSensor(0xa0, 0x48); // BLCOFS DB
  HI253WriteCmosSensor(0xa2, 0x48); // BLCOFS DGb
  HI253WriteCmosSensor(0xa4, 0x48); // BLCOFS DR
  HI253WriteCmosSensor(0xa6, 0x48); // BLCOFS DGr
  ...
  HI253WriteCmosSensor(0xd6, 0x58); // DCDCAGTHON
  HI253WriteCmosSensor(0xd7, 0x50); // DCDCAGTHOFF
  ...
  HI253WriteCmosSensor(0x48, 0x98);
  //Saturation;
  HI253WriteCmosSensor(0x60, 0x67); // SATCTL//6f
  
  HI253WriteCmosSensor(0x61, 0x85);   // SATB//80
  HI253WriteCmosSensor(0x62, 0x8a);   // SATR//88
  ...
  HI253WriteCmosSensor(0x3e, 0x98); // INRATIO
  ...
  HI253WriteCmosSensor(0x44, 0x98); // DARK1RATIO
  ...
  HI253WriteCmosSensor(0x4b, 0x98); // YCOUT1RAT
  ...
  HI253WriteCmosSensor(0x51, 0x98); // YCINRAT
  ...
  HI253WriteCmosSensor(0x57, 0x98); // YCDARK1RAT
  ...
  HI253WriteCmosSensor(0x20, 0x18); // EDGENGAIN
  HI253WriteCmosSensor(0x21, 0x15); // EDGEPGAIN
  ...
  HI253WriteCmosSensor(0x90, 0x15); // EDGE2DNGAIN
  HI253WriteCmosSensor(0x91, 0x15); // EDGE2DPGAIN
  ...
  HI253WriteCmosSensor(0x70, 0x86);//76
  ...
  HI253WriteCmosSensor(0x83, 0x02);   //EXP Normal 33.33 fps
  HI253WriteCmosSensor(0x84, 0xf9);
  HI253WriteCmosSensor(0x85, 0xb8);
  ...
  HI253WriteCmosSensor(0xb2, 0x60);   //d0
...
void HI253NightMode(kal_bool Enable)
{
  ...
  HI253WriteCmosSensor(0x92, 0x58); // BLC_AG_TH_ON
  HI253WriteCmosSensor(0x93, 0x50); // BLC_AG_TH_OFF
  HI253SetPage(0x02); 
  HI253WriteCmosSensor(0xd4, 0x0c); // DCDC_TIME_TH_ON
  HI253WriteCmosSensor(0xd5, 0x0c); // DCDC_TIME_TH_OFF
  HI253WriteCmosSensor(0xd6, 0x58); // DCDC_AG_TH_ON
  HI253WriteCmosSensor(0xd7, 0x50); // DCDC_AG_TH_OFF
  HI253SetPage(0x20);
  spin_lock(&hi253_drv_lock);
  HI253Status.AECTL1 &= (~0x80);  
  spin_unlock(&hi253_drv_lock);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  HI253Status.MaxFrameRate = HI253_MAX_FPS;
  spin_unlock(&hi253_drv_lock);
  HI253SetMirror(IMAGE_H_MIRROR);//IMAGE_NORMAL
	spin_lock(&hi253_drv_lock);
  ...
  HI253WriteCmosSensor(0x3f, 0x00);
	...
	HI253WriteCmosSensor(0x42, 0x00); //Vblank 52
	HI253WriteCmosSensor(0x43, 0x34);
...
BOOL HI253SetExposure(UINT16 Para)
{
  ...
  switch (Para)
  {
    ...
    case AE_EV_COMP_00:                /* EV 0 */\
      HI253WriteCmosSensor(0x40,0x05);//88
      break;
