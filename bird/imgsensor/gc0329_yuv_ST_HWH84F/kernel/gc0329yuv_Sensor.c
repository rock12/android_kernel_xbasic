 ...
 * Revision 1.5  2013/10/30 12:33:36  lijunchao
 * no message
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x1d);// 20
	GC0329_write_cmos_sensor(0x34, 0x1d);
	GC0329_write_cmos_sensor(0x35, 0x1d);
	GC0329_write_cmos_sensor(0x36, 0x1d);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x28);	//2d																																																																								
	GC0329_write_cmos_sensor(0xd2,0x28);		//2d																																																																							
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
...
////analog//
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0x1e, 0x00);  //08
	GC0329_write_cmos_sensor(0x20, 0x08); //00
////blk///
	GC0329_write_cmos_sensor(0x29, 0x00); //80
	GC0329_write_cmos_sensor(0x33, 0x1c);   ///  20
	GC0329_write_cmos_sensor(0x34, 0x1c);
	GC0329_write_cmos_sensor(0x35, 0x1c);
	GC0329_write_cmos_sensor(0x36, 0x1c);
///////dndd//// 
	GC0329_write_cmos_sensor(0x82, 0x10);   ///0e//  55
	GC0329_write_cmos_sensor(0x83, 0x00);  // add by lanking 20120423
////intpee//
  GC0329_write_cmos_sensor(0x95, 0x43);  //   54 /74
...
///aec//////
	...
	////////////////////ABS////////////////////
	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x9c, 0x00);   ////  02 /01
	GC0329_write_cmos_sensor(0x9d, 0x10);
//¨¦?2¨º¡ê?¡¤?¨¦?
///////cc/////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xb3, 0x40);  ///  44
	GC0329_write_cmos_sensor(0xb4, 0xfe);  // fd
	GC0329_write_cmos_sensor(0xb5, 0x03);   /// 02
	GC0329_write_cmos_sensor(0xb6, 0xfa);
...
//////awb//////
	...
	GC0329_write_cmos_sensor(0x67, 0x70);  //// 70
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2e, 0x20); 
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2d, 0x04);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0x10); 
			GC0329_write_cmos_sensor(0x2f, 0x06);   //exp level 0  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x40); 
			GC0329_write_cmos_sensor(0x31, 0x07);   //exp level 0  7.05fps
			GC0329_write_cmos_sensor(0x32, 0x80); 
			GC0329_SET_PAGE0;
		break;
		default:
