 ...
 *------------------------------------------------------------------------------
 * $Log: gc0328yuv_Sensor.c,v $
 * Revision 1.4  2013/07/16 01:41:02  zhoushaohong
 * 3203 优化
 *
 * Revision 1.3  2013/06/24 00:50:13  shenruxuan
 * no message
 *
 * Revision 1.2  2013/06/21 11:07:19  maliejun
 * 刚进入时绿屏问题
 *
 * Revision 1.1  2013/06/09 04:04:21  wangqiang
 * no message
 *
 * Revision 1.1  2013/06/08 12:39:49  wangqiang
 * no message
 *
 * Revision 1.4  2013/05/29 08:01:43  birdlibo
 * no message
 *
 * Revision 1.3  2013/05/24 05:43:54  shenruxuan
 * no message
 *
 * Revision 1.2  2013/05/24 02:02:45  chenxiaolin
 * Editor: cxl
 * Inspector:cxl
 * Reason:
 * Reference:none
 ...
 * Reference:none
 *
 * Revision 1.1  2013/05/07 04:27:23  birdlibo
 * no message
 *
...
void GC0328NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0328_write_cmos_sensor(0xfe, 0x00);
		GC0328GammaSelect(GC0328_RGB_Gamma_m5);//////6 betty
...
void GC0328_Sensor_Init(void)
	...
	GC0328_write_cmos_sensor(0xfe , 0x00);     //page0
		...
		GC0328_write_cmos_sensor(0x54 , 0x60); 
		GC0328_write_cmos_sensor(0x55 , 0x01);
		GC0328_write_cmos_sensor(0x56 , 0x00);
		GC0328_write_cmos_sensor(0x5b , 0x02);
		GC0328_write_cmos_sensor(0xb1 , 0xdc);
		GC0328_write_cmos_sensor(0xb2 , 0xdc); 
		GC0328_write_cmos_sensor(0x7c , 0x71); 
		GC0328_write_cmos_sensor(0x7d , 0x10); 
		GC0328_write_cmos_sensor(0x76 , 0x8f); 
                /////////AWB_R/G/B_GAIN_LIMIT
                GC0328_write_cmos_sensor(0x80 , 0x68);//70
                GC0328_write_cmos_sensor(0x81 , 0x50);//58 BETTY
                GC0328_write_cmos_sensor(0x82 , 0x78);
		
		
		////AWB////
		GC0328_write_cmos_sensor(0x50 , 0x80);
		GC0328_write_cmos_sensor(0xfe , 0x01);
		GC0328_write_cmos_sensor(0x4f , 0x00); 
		GC0328_write_cmos_sensor(0x4c , 0x01);
		GC0328_write_cmos_sensor(0x4d , 0x45);
		...
		GC0328_write_cmos_sensor(0x28 , 0x5F);/////7f
		...
		GC0328_write_cmos_sensor(0x3b , 0x01);//////0ffset_manual_r
		GC0328_write_cmos_sensor(0x3c , 0x00);//////0ffset_manual_g1
		GC0328_write_cmos_sensor(0x3e , 0x00);//////0ffset_manual_g2
		GC0328_write_cmos_sensor(0x3f , 0x01);//////0ffset_manual_b
		
		GC0328_write_cmos_sensor(0x47 , 0x00);
		GC0328_write_cmos_sensor(0x48 , 0x00);///////0000
...
#if defined(BIRD_13E56_S9500)||defined(BIRD_GC0328_HV_MIRROR)
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror
#else		
		...
		GC0328_write_cmos_sensor(0x70 , 0x46);//////45
		...
		GC0328_write_cmos_sensor(0x44 , 0x02);//YUV mode
		...
		GC0328_write_cmos_sensor(0x82 , 0x85);///////85
		GC0328_write_cmos_sensor(0x83 , 0x01);////2
		GC0328_write_cmos_sensor(0x84 , 0xf3);///////e5
		GC0328_write_cmos_sensor(0x90 , 0xac);
		GC0328_write_cmos_sensor(0x92 , 0x02);
		GC0328_write_cmos_sensor(0x94 , 0x02);
		GC0328_write_cmos_sensor(0x95 , 0x65);///////43
		
		
		///////YCP
		GC0328_write_cmos_sensor(0xd1 , 0x36);//////38
		GC0328_write_cmos_sensor(0xd2 , 0x36);//////38
		GC0328_write_cmos_sensor(0xdd , 0x78);
		GC0328_write_cmos_sensor(0xde , 0x38);
		GC0328_write_cmos_sensor(0xe4 , 0x8a);/////////88
		...
		GC0328_write_cmos_sensor(0x97 , 0x18);/////wu    low_luma_value_offset_th

		GC0328_write_cmos_sensor(0x98 , 0x00);
		GC0328_write_cmos_sensor(0x9b , 0x80);////////20
		GC0328_write_cmos_sensor(0x9c , 0x80);   
		
				GC0328_write_cmos_sensor(0xa3 , 0x91);
		
		
		GC0328_write_cmos_sensor(0xa4 , 0x10);
		GC0328_write_cmos_sensor(0xa8 , 0xB0);
		GC0328_write_cmos_sensor(0xaa , 0x10);//////40
		...
		GC0328_write_cmos_sensor(0x13 , 0x58);
		GC0328_write_cmos_sensor(0x15 , 0xfc);
		GC0328_write_cmos_sensor(0x21 , 0xb0);////c0
		GC0328_write_cmos_sensor(0x22 , 0x50);////60
		...
		///cct
		GC0328_write_cmos_sensor(0xB1 , 0x05);//02 betty//07
		GC0328_write_cmos_sensor(0xB2 , 0x02);
		GC0328_write_cmos_sensor(0xB3 , 0x0a);///7
		GC0328_write_cmos_sensor(0xB4 , 0xe0);/////f0
		GC0328_write_cmos_sensor(0xB5 , 0xf0);//05 betty
		GC0328_write_cmos_sensor(0xB6 , 0xf4);////f0
		
/////contrast//////
		GC0328_write_cmos_sensor(0xd3 , 0x40);//3a betty

/////ratio//////
		GC0328_write_cmos_sensor(0xeb , 0x80);
		GC0328_write_cmos_sensor(0xec , 0x7e);//80 betty
		GC0328_write_cmos_sensor(0xed , 0x81);
#if 1
	Sleep(200);
	...
	GC0328_write_cmos_sensor(0x76 , 0x8f);   
	GC0328_write_cmos_sensor(0x80 , 0x68);//80
	GC0328_write_cmos_sensor(0x81 , 0x70);
	GC0328_write_cmos_sensor(0x82 , 0xb0);//a0
	GC0328_write_cmos_sensor(0x70 , 0xff); 
	GC0328_write_cmos_sensor(0x71 , 0x00); 
...
void GC0328_Write_More_Registers(void)
{
	...
	///////////////////////////////////////////////
    	GC0328GammaSelect(GC0328_RGB_Gamma_m5);//0:use default/////4
}
...
#if defined(BIRD_13E56_S9500)||defined(BIRD_GC0328_FORMAT_YUYV)
...
BOOL GC0328_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_AUTO:
			GC0328_write_cmos_sensor(0x77, 0x57);
			GC0328_write_cmos_sensor(0x78, 0x4d);
			GC0328_write_cmos_sensor(0x79, 0x45);
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps/////300
			GC0328_write_cmos_sensor(0x2e, 0xc0); 
			GC0328_write_cmos_sensor(0x2f, 0x06);   //exp level 2  10.00fps/////3c0
			GC0328_write_cmos_sensor(0x30, 0x00); 
			GC0328_write_cmos_sensor(0x31, 0x07);   //exp level 3  7.14fps  ////540
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0328_NIGHT_MODE?0x68:0x45);
