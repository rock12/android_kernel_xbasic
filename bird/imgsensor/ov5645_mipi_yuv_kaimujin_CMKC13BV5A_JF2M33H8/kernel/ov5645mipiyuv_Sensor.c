...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x5302, 0x22);
  OV5645MIPI_write_cmos_sensor(0x5303, 0x12);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3503, 0x00);
	//mod begin by mengjiakun@cmk at 2014/5/10
	OV5645MIPI_write_cmos_sensor(0x3a00,0x3c);	
	OV5645MIPI_write_cmos_sensor(0x3a02,0x17);
	OV5645MIPI_write_cmos_sensor(0x3a03,0x10);
	OV5645MIPI_write_cmos_sensor(0x3a14,0x17);
	...
	//mod end by mengjiakun@cmk at 2014/5/10
					   ...
					   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  spin_lock(&ov5645mipi_drv_lock);
	...
	{	
		 if(OV5645MIPISensor.zsd_flag == 0)
		 {
		    OV5645MIPI_write_cmos_sensor(0x3a00,0x3c);//38
		    OV5645MIPI_write_cmos_sensor(0x3a02,0x17);// 03
		    OV5645MIPI_write_cmos_sensor(0x3a03,0x10);// d8
		    OV5645MIPI_write_cmos_sensor(0x3a14,0x17);// 03
		    OV5645MIPI_write_cmos_sensor(0x3a15,0x10);// d8	
		 }	
		 else
		 {
...
void OV5645MIPI_scene_mode_OFF()
{
	                             ...
	                             {
                               OV5645MIPI_write_cmos_sensor(0x3a00,0x3c);  //
			                         OV5645MIPI_write_cmos_sensor(0x3a02,0x17);  //     09
                               OV5645MIPI_write_cmos_sensor(0x3a03,0x10);  //     3a
                               OV5645MIPI_write_cmos_sensor(0x3a14,0x17);  //     09
                               OV5645MIPI_write_cmos_sensor(0x3a15,0x10);  //     3a
