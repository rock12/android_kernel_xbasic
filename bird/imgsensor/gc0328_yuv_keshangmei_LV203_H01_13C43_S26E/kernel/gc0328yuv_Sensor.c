 ...
 * Revision 1.2  2013/10/17 12:23:48  wangqiang
 * 射频干扰导致的cam预览红绿线，无法彻底消除
 *
...
////AWB//
	...
	GC0328_write_cmos_sensor(0x83 , 0x00);   // 02 
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x26);     /////32
	GC0328_write_cmos_sensor(0xd2 , 0x26);  /////32
	GC0328_write_cmos_sensor(0xd3 , 0x3d);//////3c
