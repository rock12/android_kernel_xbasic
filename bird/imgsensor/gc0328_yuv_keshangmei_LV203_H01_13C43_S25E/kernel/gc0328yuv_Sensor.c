 ...
 * Revision 1.3  2013/09/29 13:06:11  wangqiang
 * modify for 13C43_S36_4P2, by liuxd.
 *
 * Revision 1.2  2013/09/11 10:12:40  lijunchao
 * Tuning noise and resolution
 *
 * Revision 1.1  2013/08/13 05:33:20  chenchuanbao
 * Editor: chenchuanbao
...
void GC0328NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0328_write_cmos_sensor(0xfe, 0x00);
		GC0328GammaSelect(GC0328_RGB_Gamma_m4);/////4
...
////AWB//
	...
	GC0328_write_cmos_sensor(0x82 , 0x8f);    
	GC0328_write_cmos_sensor(0x83 , 0x02);   // 02 
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x28);     /////32
	GC0328_write_cmos_sensor(0xd2 , 0x28);  /////32
  ...
  GC0328_write_cmos_sensor(0x06, 0x2c); 
	...
	GC0328_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps   3c0  ///5a0////480
	GC0328_write_cmos_sensor(0x30, 0x80); 
	...
	///cct       
	GC0328_write_cmos_sensor(0xB1 , 0x02);   //04//00
	GC0328_write_cmos_sensor(0xB2 , 0xfd);   
	GC0328_write_cmos_sensor(0xB3 , 0xff);//fc   
	GC0328_write_cmos_sensor(0xB4 , 0x00); ////f0  //eb
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x68);// 80   /////5c
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
