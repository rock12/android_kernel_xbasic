...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xd1, 0x36);  //38
	GC2035_write_cmos_sensor(0xd2, 0x36);//38  
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x25);//dn_b_base//15
