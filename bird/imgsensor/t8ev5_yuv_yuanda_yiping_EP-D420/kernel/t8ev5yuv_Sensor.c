...
static void T8EV5YUV_Sensor_Init_setting(void)
{
...
#if defined(BIRD_13F43_E700H_T1)
	T8EV5YUV_write_cmos_sensor(0x0101,0x03);
#else
	T8EV5YUV_write_cmos_sensor(0x0101,0x00);//-/-/-/-/-/-/VREVON/HREVON
#endif
	T8EV5YUV_write_cmos_sensor(0x0102,0x02);//-/-/-/-/-/-/VLAT_ON/GROUP_HOLD
	T8EV5YUV_write_cmos_sensor(0x0104,0x03);//-/-/-/-/-/-/PARALLEL_OUT_SW[1:0]
	...
	T8EV5YUV_write_cmos_sensor(0x0139,0x36);//PLL_MULTI[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x020B,0x1A);//-/GAM02P[6:0]
	...
	T8EV5YUV_write_cmos_sensor(0x022A,0x00); //-/-/-/-/Cbr_MGAIN2[3:0]
	...
	T8EV5YUV_write_cmos_sensor(0x022D,0x08); //EXTR_PG1[3:0]/EXTR_PG0[3:0]
	T8EV5YUV_write_cmos_sensor(0x022E,0x00);//-/-/-/-/EXTR_PG2[3:0]
	T8EV5YUV_write_cmos_sensor(0x022F,0x08); //EXTR_MG1[3:0]/EXTR_MG0[3:0]
	T8EV5YUV_write_cmos_sensor(0x0230,0x00);//-/-/-/-/EXTR_MG2[3:0]
	T8EV5YUV_write_cmos_sensor(0x0231,0xB0); //EXTR_LIM[7:0]
	T8EV5YUV_write_cmos_sensor(0x0232,0x00);//ETI_M[3:0]/ETI_P[3:0]
	T8EV5YUV_write_cmos_sensor(0x0233,0xFF);//YNC_LIM1[3:0]/YNC_LIM0[3:0]
	T8EV5YUV_write_cmos_sensor(0x0234,0x0F);//-/-/-/-/YNC_LIM2[3:0]
	T8EV5YUV_write_cmos_sensor(0x0235,0x0F);//-/-/-/-/YNC_GAIN[3:0]
	T8EV5YUV_write_cmos_sensor(0x0236,0x00);//SHP_CRING1[3:0]/SHP_CRING0[3:0]
	T8EV5YUV_write_cmos_sensor(0x0237,0x04);//-/-/-/-/SHP_CRING2[3:0]
	...
	T8EV5YUV_write_cmos_sensor(0x0248,0x08);//BRIGHT[7:0]
	T8EV5YUV_write_cmos_sensor(0x0249,0x93);//CONT_LEV[7:0]
	T8EV5YUV_write_cmos_sensor(0x024A,0x00); //BLK_CONT1[3:0]/BLK_CONT0[3:0]
	...
	T8EV5YUV_write_cmos_sensor(0x0326,0x1D); //WBGRMAX[7:0]
	T8EV5YUV_write_cmos_sensor(0x0327,0x23); //WBGRMIN[7:0]
	T8EV5YUV_write_cmos_sensor(0x0328,0x2B); //WBGBMAX[7:0]
	T8EV5YUV_write_cmos_sensor(0x0329,0x1D); //WBGBMIN[7:0]
	T8EV5YUV_write_cmos_sensor(0x032A,0x0C); //RBCUT0H[7:0]
	T8EV5YUV_write_cmos_sensor(0x032B,0xE2); //RBCUT0L[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x040E,0x00);//BBPLV[7:0]
	T8EV5YUV_write_cmos_sensor(0x040F,0x00);//WBPLV0[7:0]
	T8EV5YUV_write_cmos_sensor(0x0410,0xC4);//WBPLV2[3:0]/WBPLV1[3:0]
	T8EV5YUV_write_cmos_sensor(0x0411,0x90);//WHTAG[7:0]
	T8EV5YUV_write_cmos_sensor(0x0412,0x68);//ANCNTLV[7:0]
	T8EV5YUV_write_cmos_sensor(0x0413,0x68);//NSGAIN1[3:0]/NSGAIN0[3:0]
	T8EV5YUV_write_cmos_sensor(0x0414,0x03);//-/-/-/-/NSGAIN2[3:0]
	...
	T8EV5YUV_write_cmos_sensor(0x0422,0x84); //PWBGAINR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0423,0x40); //PWBGAINB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0426,0x00);//-/-/-/-/-/-/LIPOL/CSPOL
	T8EV5YUV_write_cmos_sensor(0x0427,0x00);//-/LS4SIG[2:0]/-/LS1SIG[2:0]
	#if 1
	T8EV5YUV_write_cmos_sensor(0x0428,0x80); //LSHOFG[7:0]
	T8EV5YUV_write_cmos_sensor(0x0429,0x80); //LSHOFR[7:0]
	T8EV5YUV_write_cmos_sensor(0x042A,0x80); //LSHOFB[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x042F,0x04); //LSALUR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0430,0x00); //LSALUB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0431,0x00); //LSARUG[7:0] 1st right up
	T8EV5YUV_write_cmos_sensor(0x0432,0x00); //LSARUR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0433,0x00); //LSARUB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0434,0x00); //LSALDG[7:0] 1st left down
	T8EV5YUV_write_cmos_sensor(0x0435,0x00); //LSALDR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0436,0x04); //LSALDB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0437,0x00); //LSARDG[7:0]  1st right down
	T8EV5YUV_write_cmos_sensor(0x0438,0x04); //LSARDR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0439,0x00); //LSARDB[7:0]
	T8EV5YUV_write_cmos_sensor(0x043A,0x34); //LSBLG[7:0] 2nd left
	T8EV5YUV_write_cmos_sensor(0x043B,0x24); //LSBLR[7:0]
	T8EV5YUV_write_cmos_sensor(0x043C,0x22); //LSBLB[7:0]
	T8EV5YUV_write_cmos_sensor(0x043D,0x38); //LSBRG[7:0]  2nd right
	T8EV5YUV_write_cmos_sensor(0x043E,0x34); //LSBRR[7:0]
	T8EV5YUV_write_cmos_sensor(0x043F,0x2C); //LSBRB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0440,0x30); //LSCUG[7:0] 2nd up  
	T8EV5YUV_write_cmos_sensor(0x0441,0x30); //LSCUR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0442,0x30); //LSCUB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0443,0x30); //LSCDG[7:0] 2nd down
	T8EV5YUV_write_cmos_sensor(0x0444,0x2A); //LSCDR[7:0] 
	T8EV5YUV_write_cmos_sensor(0x0445,0x28); //LSCDB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0446,0x00); //LSDLG[7:0] 4th left
	T8EV5YUV_write_cmos_sensor(0x0447,0x10); //LSDLR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0448,0x10); //LSDLB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0449,0x00); //LSDRG[7:0] 4th right
	T8EV5YUV_write_cmos_sensor(0x044A,0x00); //LSDRR[7:0]
	T8EV5YUV_write_cmos_sensor(0x044B,0x00); //LSDRB[7:0]
	T8EV5YUV_write_cmos_sensor(0x044C,0x00); //LSEUG[7:0] 4th up
	...
	T8EV5YUV_write_cmos_sensor(0x0450,0x00); //LSEDR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0451,0x00); //LSEDB[7:0]
	#else
	...
	T8EV5YUV_write_cmos_sensor(0x042E,0x50);//LSALUG[7:0] 1st left up
	T8EV5YUV_write_cmos_sensor(0x042F,0x79);//LSALUR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0430,0x67);//LSALUB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0431,0x70);//LSARUG[7:0] 1st right up
	...
	T8EV5YUV_write_cmos_sensor(0x0435,0x59);//LSALDR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0436,0x56);//LSALDB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0437,0x38);//LSARDG[7:0]  1st right down
	T8EV5YUV_write_cmos_sensor(0x0438,0x4A);//LSARDR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0439,0x1C);//LSARDB[7:0]
	T8EV5YUV_write_cmos_sensor(0x043A,0xB2);//LSBLG[7:0] 2nd left
	T8EV5YUV_write_cmos_sensor(0x043B,0xD0);//LSBLR[7:0] //D8
	T8EV5YUV_write_cmos_sensor(0x043C,0x7D);//LSBLB[7:0]
	T8EV5YUV_write_cmos_sensor(0x043D,0xB5);//LSBRG[7:0]  2nd right
	T8EV5YUV_write_cmos_sensor(0x043E,0xD6);//LSBRR[7:0]//De
	T8EV5YUV_write_cmos_sensor(0x043F,0x62);//LSBRB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0440,0xD0);//LSCUG[7:0] 2nd up  //D0
	T8EV5YUV_write_cmos_sensor(0x0441,0xEF);//LSCUR[7:0] //F7
	T8EV5YUV_write_cmos_sensor(0x0442,0x95);//LSCUB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0443,0x92);//LSCDG[7:0] 2nd down
	T8EV5YUV_write_cmos_sensor(0x0444,0xA0);//LSCDR[7:0] 
	T8EV5YUV_write_cmos_sensor(0x0445,0x89);//LSCDB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0446,0x60);//LSDLG[7:0] 4th left
	T8EV5YUV_write_cmos_sensor(0x0447,0x49);//LSDLR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0448,0x83);//LSDLB[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x044C,0x50);//LSEUG[7:0] 4th up
	...
	T8EV5YUV_write_cmos_sensor(0x0450,0xC0);//LSEDR[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x045E,0x03);//-/-/-/-/-/-/LSMGSEL[1:0]
	...
	T8EV5YUV_write_cmos_sensor(0x0706,0x01);//-/-/-/SERI_ON_SW/-/-/-/SERI_ON_MN
...
{
	SENSORDB("T8EV5YUV_Sensor_AF_Patch+++0000 \n");
	//AF  patch
	if(type==AF_PATCH_ICAF)
	{
		
		SENSORDB("T8EV5YUV_Sensor_AF_Patch+++1111 \n");
		...
		SENSORDB("T8EV5YUV_Sensor_AF_Patch+++2222 \n");
...
void T8EV5YUV_set_1280_960_init(void)
{
	...
	T8EV5YUV_write_cmos_sensor(0x0306,0x74);//AGMAX[7:0]
	T8EV5YUV_write_cmos_sensor(0x0307,0x0F);//MES[15:8]
...
static bool T8EV5_FOCUS_Get_CPU_ST(void)
{
	...
	while(i)
	{
		status=T8EV5YUV_read_cmos_sensor(0x2800);
		printk("T8EV5_FOCUS_Get_CPU_ST: i=%d, status=0x%x\n",i,status);
        i--;
		if(status&0x80)
			continue;
		else
...
static void T8EV5_FOCUS_Init(void)
{
	...
	T8EV5YUV_write_cmos_sensor(0x2402,0x00);//;
	T8EV5YUV_write_cmos_sensor(0x2403,0x00);//;
	T8EV5YUV_write_cmos_sensor(0x2404,0xE0);//;
	T8EV5YUV_write_cmos_sensor(0x2405,0x40);//;
	...
	*/
	...
	T8EV5_FOCUS_Get_CPU_ST();
   SENSORDB("T8EV5_FOCUS_Init+++1111 \n");
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	//zh over exploure for capture with flash 20130813
	msleep(100);
	//alc lock
	...
	//zh add for change A CCM 20130813
	AWB_R=((T8EV5YUV_read_cmos_sensor(0x036E)&0x03)<<8)+T8EV5YUV_read_cmos_sensor(0x036F);
	AWB_B=((T8EV5YUV_read_cmos_sensor(0x0372)&0x03)<<8)+T8EV5YUV_read_cmos_sensor(0x0373);
	if((AWB_R<0xD0)&&(AWB_B>0x0167))
	{
		T8EV5YUV_write_cmos_sensor(0x0204,0x1B);//;LM_RMG[7:0]
		T8EV5YUV_write_cmos_sensor(0x0205,0x01);//;LM_RMB[7:0]
		T8EV5YUV_write_cmos_sensor(0x0206,0x30);//;LM_GMR[7:0]
		T8EV5YUV_write_cmos_sensor(0x0207,0x3C);//;LM_GMB[7:0]
		T8EV5YUV_write_cmos_sensor(0x0208,0x2D);//;LM_BMR[7:0]
		T8EV5YUV_write_cmos_sensor(0x0209,0x54);//;LM_BMG[7:0]
		T8EV5YUV_write_cmos_sensor(0x0223,0x47);//;CbG_MAT[7:0]
		T8EV5YUV_write_cmos_sensor(0x0224,0x83);//;CbB_MAT[7:0]
		T8EV5YUV_write_cmos_sensor(0x0225,0x80);//;Cb_GAIN[7:0]
		T8EV5YUV_write_cmos_sensor(0x0226,0x83);//;CrR_MAT[7:0]
		T8EV5YUV_write_cmos_sensor(0x0227,0x6E);//;CrG_MAT[7:0]
...
void T8EV5YUV_set_hue(UINT16 iPara)
{
	SENSORDB("iPara=%d",iPara);
    switch(iPara)
    {
    	case ISP_HUE_LOW:
			T8EV5YUV_write_cmos_sensor(0x0204,0x63);
			T8EV5YUV_write_cmos_sensor(0x0205,0xFC);
			T8EV5YUV_write_cmos_sensor(0x0206,0x15);
			T8EV5YUV_write_cmos_sensor(0x0207,0x22);
			T8EV5YUV_write_cmos_sensor(0x0208,0x13);
			T8EV5YUV_write_cmos_sensor(0x0209,0x45);
        break;
	    case ISP_HUE_MIDDLE:
		...
		break;
	    case ISP_HUE_HIGH:
			T8EV5YUV_write_cmos_sensor(0x0204,0x4F);
			T8EV5YUV_write_cmos_sensor(0x0205,0x17);
			T8EV5YUV_write_cmos_sensor(0x0206,0x1F);
			T8EV5YUV_write_cmos_sensor(0x0207,0x14);
			T8EV5YUV_write_cmos_sensor(0x0208,0xEF);
			T8EV5YUV_write_cmos_sensor(0x0209,0x65);
		break;
	    default:
			T8EV5YUV_write_cmos_sensor(0x0204,0x5B);
			T8EV5YUV_write_cmos_sensor(0x0205,0x09);
...
void T8EV5YUV_set_sharpness(UINT16 iPara)
{
	SENSORDB("iPara=%d",iPara);
    switch(iPara)
    {
    	case ISP_EDGE_LOW:
			T8EV5YUV_write_cmos_sensor(0x023A,0x00);
			T8EV5YUV_write_cmos_sensor(0x023C,0x00);
			T8EV5YUV_write_cmos_sensor(0x0231,0x20);
        break;
	    case ISP_EDGE_MIDDLE:
			T8EV5YUV_write_cmos_sensor(0x023A,0x08);
			T8EV5YUV_write_cmos_sensor(0x023C,0x08);
			T8EV5YUV_write_cmos_sensor(0x0231,0x50);//EXTR_LIM[7:0]//zh modify for decrease sharpness;
		break;
	    case ISP_EDGE_HIGH:
			T8EV5YUV_write_cmos_sensor(0x023A,0x0F);
			T8EV5YUV_write_cmos_sensor(0x023C,0x0F);
			T8EV5YUV_write_cmos_sensor(0x0231,0xC0);
		break;
	    default:
			T8EV5YUV_write_cmos_sensor(0x023A,0x08);
			T8EV5YUV_write_cmos_sensor(0x023C,0x08);
...
void T8EV5YUV_set_capture_shutter_gain(UINT16 para)
{
   ...
   printk("%s temp_val=%d Read  MES = %d, MAG = %d,	MDG = %d\n",__FUNCTION__,temp_val,t8ev5yuv_stru.iShutter, t8ev5yuv_stru.iGain, t8ev5yuv_stru.d_gain);
...
void T8EV5YUVSetSceneMode(UINT16 iPara)
{
	...
	switch(iPara)
    {
	    ...
	    case SCENE_MODE_NIGHTSCENE:
			...
			T8EV5YUV_write_cmos_sensor(0x0229,0x2B);//Cbr_MGAIN1[3:0]/Cbr_MGAIN0[3:0]
			T8EV5YUV_write_cmos_sensor(0x0249,0x93);//CONT_LEV[7:0]
			T8EV5YUV_write_cmos_sensor(0x0315,0xa8);//FAUTO/FCOUNT[2:0]/FCLSBON/EXPLIM[2:0]
			T8EV5YUV_write_cmos_sensor(0x0302,0x01);//-/-/-/-/-/-/ALCAIM[9:8]
			T8EV5YUV_write_cmos_sensor(0x0303,0x20);//ALCAIM[7:0]
			T8EV5YUV_write_cmos_sensor(0x030C,0x55);//A1WEIGHT[1:0]/A2WEIGHT[1:0]/A3WEIGHT[1:0]/A4WEIGHT[1:0]
			T8EV5YUV_write_cmos_sensor(0x030D,0x5A);//A5WEIGHT[1:0]/B1WEIGHT[1:0]/B2WEIGHT[1:0]/B3WEIGHT[1:0]
...
UINT32 T8EV5YUVSensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
   // printk("\n T8EV5YUVSensorSetting() is called ; \n");
	...
	break;
	case FID_ISP_HUE:
		SENSORDB("FID_ISP_HUE\n");
		T8EV5YUV_set_hue(iPara);
	break;
	case FID_ISP_EDGE:
		SENSORDB("FID_ISP_EDGE\n");
		T8EV5YUV_set_sharpness(iPara);
	break;
	default:
	break;
    }
