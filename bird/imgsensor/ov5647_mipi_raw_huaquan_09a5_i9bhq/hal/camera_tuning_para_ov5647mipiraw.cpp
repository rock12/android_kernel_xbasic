...
{{
    ...
    ISPCcmPoly22:{
        ...
        23472,    // i4B_STD
        {  // i4P00[9]
            4677500, -1527500, -592500, -847500, 3517500, -110000, -37500, -2150000, 4747500
        },
        {  // i4P10[9]
            836112, -863508, 24285, 35746, -40469, 4723, 104923, 436109, -551306
        },
        {  // i4P01[9]
            345919, -408124, 56376, -111394, -157845, 269239, -31081, -263323, 288808
        },
        { // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rCCTConfig
        {
            ...
            120,    // u4PrvMaxFlareThres
            0,    // u4PrvMinFlareThres
            120,    // u4VideoMaxFlareThres
