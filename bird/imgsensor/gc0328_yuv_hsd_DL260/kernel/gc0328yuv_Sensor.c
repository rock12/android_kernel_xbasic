 ...
 * Editor: xuliu
 * Inspector:xuliu
 * Reason:for 13E45_A308?буиж??имиж?
 * Reference: Null
 *
...
////AWB//
	...
	GC0328_write_cmos_sensor(0x04 , 0xf0); 
	...
	GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  10.00fps
	GC0328_write_cmos_sensor(0x2c, 0x58); 
	GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  8.33fps
	GC0328_write_cmos_sensor(0x2e, 0xd0); 
	GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  8.33fps
	GC0328_write_cmos_sensor(0x30, 0xd0); 
	GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  6.25fps
	GC0328_write_cmos_sensor(0x32, 0xc0); 
#endif
	GC0328_SET_PAGE0;
...
#if defined(BIRD_13E56_S9500)||defined(BIRD_GC0328_HV_MIRROR)||defined(BIRD_13E45_8P32_COCLK_A308)
	...
	GC0328_write_cmos_sensor(0x23 , 0x05);   //06 changed 0421 
	...
	GC0328_write_cmos_sensor(0x82 , 0x8c); //85   
	GC0328_write_cmos_sensor(0x83 , 0x01); //02   
	GC0328_write_cmos_sensor(0x84 , 0xe5);    
	GC0328_write_cmos_sensor(0x90 , 0x2c); //ac   
	GC0328_write_cmos_sensor(0x92 , 0x02);    
	GC0328_write_cmos_sensor(0x94 , 0x02);    
	GC0328_write_cmos_sensor(0x95 , 0x45);//54  76
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x26);//32 36
	GC0328_write_cmos_sensor(0xd2 , 0x26);//32 36
	GC0328_write_cmos_sensor(0xd3 , 0x3e);//add 42
	...
	GC0328_write_cmos_sensor(0x21 , 0xa0);//c0   
...
#if defined(BIRD_13E56_S9500)||defined(BIRD_GC0328_FORMAT_YUYV)||defined(BIRD_13E45_8P32_COCLK_A308)
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		//	GC0328_write_cmos_sensor(0x04 , 0x40); 
			...
			GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  8.33fps
			GC0328_write_cmos_sensor(0x2e, 0xd0); 
			GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  7.69fps
			GC0328_write_cmos_sensor(0x30, 0xd0); 
			GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  6.25fps
			GC0328_write_cmos_sensor(0x32, 0xc0); 
#endif
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  10.00fps
			GC0328_write_cmos_sensor(0x2c, 0x58); 
			GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 0  8.57fps
			GC0328_write_cmos_sensor(0x2e, 0xbc); 
			GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 0  7.5fps
			GC0328_write_cmos_sensor(0x30, 0xbc); 
			GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 0  6.00fps
			GC0328_write_cmos_sensor(0x32, 0xe8); 
#endif
			GC0328_SET_PAGE0;
		break;
		default:
