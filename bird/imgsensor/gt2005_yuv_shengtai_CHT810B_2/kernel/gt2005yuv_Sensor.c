...
UINT32 GT2005Open(void)
{
    ...
    GT2005_write_cmos_sensor(0x0201, 0x00); //2b betty
    ...
    GT2005_write_cmos_sensor(0x020B, 0x48); //28
    GT2005_write_cmos_sensor(0x020C, 0x64); //44
    GT2005_write_cmos_sensor(0x020D, 0xC8); 
    GT2005_write_cmos_sensor(0x020E, 0xBC); 
    GT2005_write_cmos_sensor(0x020F, 0x08); 
    GT2005_write_cmos_sensor(0x0210, 0x16); //0x16
    ...
    GT2005_write_cmos_sensor(0x040A, 0x20); //00
    GT2005_write_cmos_sensor(0x040B, 0x33); //f6 betty
    ...
    GT2005_write_cmos_sensor(0x0444, 0x11); //17
...
BOOL GT2005_set_param_wb(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AWB_MODE_AUTO:
			...
			GT2005_write_cmos_sensor(0x0442,0x00);//  PWBGAINGR[7:0];
			GT2005_write_cmos_sensor(0x0443,0x00);//  PWBGAINGB[7:0];
			GT2005_write_cmos_sensor(0x0444,0x28);//  PWBGAINB[7:0];
            break;
...
BOOL GT2005_set_param_exposure(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AE_EV_COMP_00:
			GT2005_write_cmos_sensor(0x0201, 0x00);//00 betty
            break;
