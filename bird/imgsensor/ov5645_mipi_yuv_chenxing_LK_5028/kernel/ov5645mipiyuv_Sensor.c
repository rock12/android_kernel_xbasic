...
void OV5645MIPI_night_mode(kal_bool enable)
{
	...
	{   /* camera normal mode */                
		  ...
		  if(OV5645MIPISensor.zsd_flag==0)
	    {
			...
			OV5645MIPI_write_cmos_sensor(0x3a02,0x08);
      OV5645MIPI_write_cmos_sensor(0x3a03,0x12);
      OV5645MIPI_write_cmos_sensor(0x3a14,0x08);
      OV5645MIPI_write_cmos_sensor(0x3a15,0x12);	
		  }	
		  else
		  {
...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3a00, 0x3c);//30fps-12.5fps
  OV5645MIPI_write_cmos_sensor(0x3a02, 0x08);
  OV5645MIPI_write_cmos_sensor(0x3a03, 0x12);
  OV5645MIPI_write_cmos_sensor(0x3a14, 0x08);
  OV5645MIPI_write_cmos_sensor(0x3a15, 0x12);
  ...
  OV5645MIPI_write_cmos_sensor(0x5303, 0x06);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x18);//sharpness 0x24
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);          //0x10
	OV5645MIPI_write_cmos_sensor(0x5306, 0x06);//06 noise
	OV5645MIPI_write_cmos_sensor(0x5307, 0x16);//16
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x1a);
