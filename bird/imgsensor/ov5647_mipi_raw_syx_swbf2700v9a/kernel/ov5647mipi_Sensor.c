 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: ov5647mipi_Sensor.c,v $
 * Revision 1.1  2013/05/23 03:38:38  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.2  2013/04/23 08:26:39  yanwangjun
 * mirror adjust
 *
 * Revision 1.1  2013/04/08 11:35:54  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 V9 syx sensor
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/04/02 03:03:51  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 i9
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/03/23 06:54:07  huangwenjian
 * Bug[none]
 *
 * Reason:5647 getsensor id error
 * Author:Huangwenjian
 *
 *
 * 02 19 2012 koli.lin
...
{
#ifdef OV5647MIPI_DRIVER_TRACE
	//SENSORDB("OV5647MIPIGetInfo\A3\ACFeatureId:%d\n",ScenarioId);
#endif
