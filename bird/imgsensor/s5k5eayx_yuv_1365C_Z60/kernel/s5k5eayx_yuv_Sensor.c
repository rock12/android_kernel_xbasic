...
//==================================================================================    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0032); //af_pos_usTable_0_      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0066);  //af_pos_usTable_1_     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0094); //af_pos_usTable_2_      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00A2); //af_pos_usTable_3_      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00B0); //af_pos_usTable_4_      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x019F); //af_pos_usTable_20_    
...
//AE Target    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0036);  //36 ,40 
...
//Gain       
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0800); //0a00    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0100);     
...
// AWB init Start point    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x04CA);  //0x04CA  //0x0580 //0450
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400);  //0x0400  //0x0428 //0428
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x07C9);  //0x07C9  //0x07B0 //07B0
    
// AWB Convergence Speed    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0008);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0190);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00A0);     //00A0,0100
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0004);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0002);     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0002);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0074);     //00074,0134
...
//==================================================================================
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x021A);   //TVAR_wbt_pBaseCcms[36] // WW      0002
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFBE);   //TVAR_wbt_pBaseCcms[37]            FFE5
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE0);   //TVAR_wbt_pBaseCcms[38]            FEF8
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1);   //TVAR_wbt_pBaseCcms[39]            FFDA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E);   //TVAR_wbt_pBaseCcms[40]            00ED
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18);   //TVAR_wbt_pBaseCcms[41]            FF37
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE6);   //TVAR_wbt_pBaseCcms[42]            FF52
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFDD);   //TVAR_wbt_pBaseCcms[43]            FF5D
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B2);   //TVAR_wbt_pBaseCcms[44]            0192
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0133);   //TVAR_wbt_pBaseCcms[45]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00D4);   //TVAR_wbt_pBaseCcms[46]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7E);   //TVAR_wbt_pBaseCcms[47]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151);   //TVAR_wbt_pBaseCcms[48]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50);   //TVAR_wbt_pBaseCcms[49]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147);   //TVAR_wbt_pBaseCcms[50]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //TVAR_wbt_pBaseCcms[51]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //TVAR_wbt_pBaseCcms[52]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //TVAR_wbt_pBaseCcms[53]       
    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x021A);   //01C7 //TVAR_wbt_pBaseCcms[54] // CW     /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFBE);   //FFD6 //TVAR_wbt_pBaseCcms[55]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE0);   //000A //TVAR_wbt_pBaseCcms[56]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1);   //FEF1 //TVAR_wbt_pBaseCcms[57]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E);   //014E //TVAR_wbt_pBaseCcms[58]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18);   //FF18 //TVAR_wbt_pBaseCcms[59]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE6);   //FFE6 //TVAR_wbt_pBaseCcms[60]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFDD);   //FFDD //TVAR_wbt_pBaseCcms[61]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B2);   //01B2 //TVAR_wbt_pBaseCcms[62]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0133);   //00F2 //TVAR_wbt_pBaseCcms[63]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00D4);   //00CA //TVAR_wbt_pBaseCcms[64]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7E);   //FF48 //TVAR_wbt_pBaseCcms[65]          
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //FF75 //TVAR_wbt_pBaseCcms[69]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //0187 //TVAR_wbt_pBaseCcms[70]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //01BF //TVAR_wbt_pBaseCcms[71]          
    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x021A);   //01C7 //TVAR_wbt_pBaseCcms[72] // D50  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFBE);   //FFD6 //TVAR_wbt_pBaseCcms[73]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE0);   //000A //TVAR_wbt_pBaseCcms[74]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1);   //FEF1 //TVAR_wbt_pBaseCcms[75]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E);   //014E //TVAR_wbt_pBaseCcms[76]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18);   //FF18 //TVAR_wbt_pBaseCcms[77]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE6);   //FFE6 //TVAR_wbt_pBaseCcms[78]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFDD);   //FFDD //TVAR_wbt_pBaseCcms[79]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B2);   //01B2 //TVAR_wbt_pBaseCcms[80]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0133);   //00F2 //TVAR_wbt_pBaseCcms[81]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00D4);   //00CA //TVAR_wbt_pBaseCcms[82]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7E);   //FF48 //TVAR_wbt_pBaseCcms[83]         
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //FF75 //TVAR_wbt_pBaseCcms[87]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //0187 //TVAR_wbt_pBaseCcms[88]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //01BF //TVAR_wbt_pBaseCcms[89]         
    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x021A);  //0203 //01C7 //TVAR_wbt_pBaseCcms[90] // D65    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFBE);  //FFAD //FFD6 //TVAR_wbt_pBaseCcms[91]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE0);  //FFFB //000A //TVAR_wbt_pBaseCcms[92]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1);  //FEF1 //FF25 //TVAR_wbt_pBaseCcms[93]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E);  //014E //019E //TVAR_wbt_pBaseCcms[94]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18);  //FF18 //FF6D //TVAR_wbt_pBaseCcms[95]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE6);  //FFE6 //0022 //TVAR_wbt_pBaseCcms[96]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFDD);  //FFDD //FFC7 //TVAR_wbt_pBaseCcms[97]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B2);  //01B2 //019D //TVAR_wbt_pBaseCcms[98]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0133);  //0133 //00C2 //TVAR_wbt_pBaseCcms[99]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00D4);  //00D4 //009A //TVAR_wbt_pBaseCcms[100]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7E);  //FF7E //FEFD //TVAR_wbt_pBaseCcms[101]          
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);  //FF75 //FF06 //TVAR_wbt_pBaseCcms[105]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);  //0187 //01BA //TVAR_wbt_pBaseCcms[106]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);  //01BF //0108 //TVAR_wbt_pBaseCcms[107]          
...
//         AFIT 0      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x889C);  //AFIT8_Bdns_iDenoiseTH_G_L [7:0] AFIT8_Bdns_iDenoiseTH_G_H [15:8]     283C                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x889C);  //AFIT8_Bdns_iDenoiseTH_NG_L [7:0] AFIT8_Bdns_iDenoiseTH_NG_H [15:8]   283C                                
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8008);  //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                 
...
//         AFIT 1     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0009);    //AFIT16_CONTRAST                                                                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0A04);    //AFIT8_Bdns_iDispLimit_H [7:0] AFIT8_Bdns_iDispTH4HF [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0101);    //AFIT8_Bdns_iDispLimit4HF_L [7:0] AFIT8_Bdns_iDispLimit4HF_H [15:8]                                  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3E48);    //AFIT8_Bdns_iDenoiseTH_G_L [7:0] AFIT8_Bdns_iDenoiseTH_G_H [15:8]  1E28                                  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3E48);    //AFIT8_Bdns_iDenoiseTH_NG_L [7:0] AFIT8_Bdns_iDenoiseTH_NG_H [15:8]1E28                                  
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1F1F);    //AFIT8_Yuviirnr_iUVNRStrengthL [7:0] AFIT8_Yuviirnr_iUVNRStrengthH [15:8]                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8080);    //AFIT8_byr_gras_iShadingPower [7:0] AFIT8_RGBGamma2_iLinearity [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8008);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]   ,8018                             
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
...
//AFIT 2    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0011);    //AFIT16_CONTRAST                                                                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0A04);    //AFIT8_Bdns_iDispLimit_H [7:0] AFIT8_Bdns_iDispTH4HF [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0101);    //AFIT8_Bdns_iDispLimit4HF_L [7:0] AFIT8_Bdns_iDispLimit4HF_H [15:8]                                  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1014);    //AFIT8_Bdns_iDenoiseTH_G_L [7:0] AFIT8_Bdns_iDenoiseTH_G_H [15:8] 1824                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1014);    //AFIT8_Bdns_iDenoiseTH_NG_L [7:0] AFIT8_Bdns_iDenoiseTH_NG_H [15:8] 1824                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0500);    //AFIT8_Bdns_iDistSigmaMin [7:0] AFIT8_Bdns_iDistSigmaMax [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3C3C);    //AFIT8_Bdns_iDenoiseTH_Add_Plain [7:0] AFIT8_Bdns_iDenoiseTH_Add_Direc [15:8]                        
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8008);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8601);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]    3601                                  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01c8);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8] 0178                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x9686);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]4636
 
 //AFIT 3    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0012);    //AFIT16_CONTRAST                                                                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0A04);    //AFIT8_Bdns_iDispLimit_H [7:0] AFIT8_Bdns_iDispTH4HF [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0101);    //AFIT8_Bdns_iDispLimit4HF_L [7:0] AFIT8_Bdns_iDispLimit4HF_H [15:8]                                  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1010);    //AFIT8_Bdns_iDenoiseTH_G_L [7:0] AFIT8_Bdns_iDenoiseTH_G_H [15:8]   1420                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1010);    //AFIT8_Bdns_iDenoiseTH_NG_L [7:0] AFIT8_Bdns_iDenoiseTH_NG_H [15:8]  1420                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0500);    //AFIT8_Bdns_iDistSigmaMin [7:0] AFIT8_Bdns_iDistSigmaMax [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3C3C);    //AFIT8_Bdns_iDenoiseTH_Add_Plain [7:0] AFIT8_Bdns_iDenoiseTH_Add_Direc [15:8]                        
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1E04);    //AFIT8_Bdns_iDirConfidenceMin [7:0] AFIT8_Bdns_iDirConfidenceMax [15:8]                              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x2808);    //AFIT8_Bdns_iPatternTH_MIN [7:0] AFIT8_Bdns_iPatternTH_MAX [15:8]                                    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8008);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8] ,8018                               
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x9E01);    //0x4E01//AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8] 4e01                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01d1);    //0x0181//AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8] 0181                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x968A);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]463a
 
  //AFIT 4    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0008);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0006);    //AFIT16_CONTRAST                                                                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0008);    //AFIT16_SATURATION                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1C1F);    //AFIT8_Yuviirnr_iUVNRStrengthL [7:0] AFIT8_Yuviirnr_iUVNRStrengthH [15:8]                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8080);    //AFIT8_byr_gras_iShadingPower [7:0] AFIT8_RGBGamma2_iLinearity [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8020);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]  ,8000                              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x9801);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]   5801                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01d0);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8] 01a0                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xcC80);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]8c40
...
//==================================================================================  
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03E8); //0535  //REG_0TC_PCFG_usMaxFrTimeMsecMult10 10fps                                    
   ...
   //S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);   //REG_0TC_PCFG_PVIMask //mipi clk change LP from HS
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);  //0: Dynamic, 1:Not Accurate, 2: Fixed                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001);  //0: Dynamic 1: BEST FrameRate(Binning), 2: BEST QUALITY(No Binning)       
   S5K5EAYX_write_cmos_sensor(0x0F12, 0x03E8);  //10fps,5fps                                                                     
   S5K5EAYX_write_cmos_sensor(0x0F12, 0x014D);  //30fps                                                                    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //0: Dynamic 1: BEST FrameRate(Binning), 2: BEST QUALITY(No Binning)     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03E8); //REG_2TC_PCFG_usMaxFrTimeMsecMult10 30fps                               
   ...
   do {
       ...
       S5K5EAYX_write_cmos_sensor(0x002E,0x0000);//id register
            *sensorID = S5K5EAYX_read_cmos_sensor(0x0F12);     
            printk("mycat S5K5EAYXGetSensorID:Sensor ID = %x\n", *sensorID); 
...
*********************************************************/
    ...
    SENSORDB("mycat [5EA]:[Enter]:Mirror = image_mirror %d IMAGE_NORMAL = %d IMAGE_HV_MIRROR=%d \r\n",image_mirror,IMAGE_NORMAL,IMAGE_HV_MIRROR);
   S5K5EAYX_write_cmos_sensor(0xFCFC,0xd000);
   S5K5EAYX_write_cmos_sensor(0x0028,0x2000);
...
{ 
   ...
   SENSORDB("mycat [5EA]:S5K5EAYX preview func: sensor_config_data->SensorImageMirror=%d \r\n ",sensor_config_data->SensorImageMirror); 
