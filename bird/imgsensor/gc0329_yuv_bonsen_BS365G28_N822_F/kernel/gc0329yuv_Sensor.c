 ...
 * Revision 1.1  2013/08/28 07:44:55  xialeijie
 * no message
 *
 * Revision 1.3  2013/07/09 09:04:14  zhoushaohong
 * s100 效果优化
 *
 * Revision 1.2  2013/07/04 04:30:54  pengyajun
 * T10 update
 *
 * Revision 1.1  2013/06/20 09:19:45  maliejun
 * driver update
 *
 * Revision 1.2  2013/05/22 01:54:31  maliejun
 * FAE效果优化
 *
 * Revision 1.1  2013/05/14 06:00:08  maliejun
 * driver update
 *
 * Revision 1.1  2013/04/23 11:23:13  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create module
 * Reference:none
 *
 * Revision 1.1  2012/07/26 08:03:31  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: [null] create the module. port from BIRD75_GB_V1
 * Reference:none
 *
 * Revision 1.3.4.1  2012/07/11 03:06:41  maliejun
 * Editor:maliejun
 * Inspector:maliejun
 * Reason: [bug-null] add gc0329
 * Reference:none
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0xd5, 0xfb);
	...
	mdelay(400);
	GC0329_write_cmos_sensor(0xf0, 0x07);
	GC0329_write_cmos_sensor(0x44, 0xa0);//a0
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd3,0x40);//3a betty																																																																								
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
