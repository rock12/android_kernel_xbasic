...
void HM5065InitialSetting(void)
{
	...
	HM5065_write_cmos_sensor(0x02C3,0xd0);// by jink 20130808
	HM5065_write_cmos_sensor(0x015E,0x41);// by jink 20130808
	...
	HM5065_write_cmos_sensor(0x0357,0x39); //19 // 29 // by jink 20130808
...
static const kal_uint8 addr_data_pair1[] =
{
	...
	0x0144,0x0D,
	0x02C2,0x00,
	0x02C3,0xd0,// by jink 20130808
	0x015E,0x41,// by jink 20130808
	0x015F,0x00,
	0x0390,0x01,
	0x0391,0x00,
	0x0392,0x00,
	...
	0x0355,0x39,
	0x0356,0x6D,
	0x0357,0x39,//19 // by jink 20130808
	0x0358,0x00,
	0x0359,0x3C,
	0x035A,0x5A,
	0x035B,0xEE,
...
#if 1
  HM5065_write_cmos_sensor(0x01fa, 0x01);// by jink 20130808
	HM5065_write_cmos_sensor(0x01A5, 0x3d);//Hue // by jink 20130808
	HM5065_write_cmos_sensor(0x01A6, 0x8a);//HueRBias // by jink 20130808
