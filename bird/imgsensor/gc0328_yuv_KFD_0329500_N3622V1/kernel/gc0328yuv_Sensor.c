 ...
 * Revision 1.1  2013/07/15 13:52:09  wangqiang
 * no message
 *
...
////AWB//
	...
	GC0328_write_cmos_sensor(0x95 , 0x45);//54    
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x30);
	GC0328_write_cmos_sensor(0xd2 , 0x30);
	GC0328_write_cmos_sensor(0xd3 , 0x44);
	...
	GC0328_write_cmos_sensor(0x22 , 0x48);   //60  
	...
	GC0328_write_cmos_sensor(0x04 , 0x80); 
  ...
  GC0328_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			...
			GC0328_write_cmos_sensor(0x32, 0x60);  
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2b, 0x03);   //exp level 0  15.00fps
			GC0328_write_cmos_sensor(0x2c, 0x0c); 
			GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 0  12.00fps
			GC0328_write_cmos_sensor(0x2e, 0xa8); 
			GC0328_write_cmos_sensor(0x2f, 0x04);   //exp level 0  10.00fps
			GC0328_write_cmos_sensor(0x30, 0x44); 
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x88);//98  1114
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_13:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0xc0);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
