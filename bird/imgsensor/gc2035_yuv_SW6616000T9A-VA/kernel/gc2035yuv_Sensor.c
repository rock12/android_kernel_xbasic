...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf7 , 0x15); //pll enable
  	GC2035_write_cmos_sensor(0xf8 , 0x83);
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x17 , 0x14); //[0]mirror [1]flip  //14
	...
	GC2035_write_cmos_sensor(0x1f , 0xc0);//max_post_gain  c0  0813  //98
	...
	GC2035_write_cmos_sensor(0x13 , 0x7b);//y_target
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	*/
	GC2035_write_cmos_sensor(0xfe, 0x00);  
		GC2035_write_cmos_sensor(0x05, 0x01);//
		GC2035_write_cmos_sensor(0x06, 0x67); //05 
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x44); //72 
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x6b);  ///92
		GC2035_write_cmos_sensor(0x29, 0x05);//
		GC2035_write_cmos_sensor(0x2a, 0x04);  ///522
		GC2035_write_cmos_sensor(0x2b, 0x05);//
...
GC2035_write_cmos_sensor(0xfe ,0x01),
GC2035_write_cmos_sensor(0xc2 ,0x28),
GC2035_write_cmos_sensor(0xc3 ,0x17),
GC2035_write_cmos_sensor(0xc4 ,0x11),
GC2035_write_cmos_sensor(0xc8 ,0x17),
GC2035_write_cmos_sensor(0xc9 ,0x10),
GC2035_write_cmos_sensor(0xca ,0x0d),
GC2035_write_cmos_sensor(0xbc ,0x31),
GC2035_write_cmos_sensor(0xbd ,0x09),
GC2035_write_cmos_sensor(0xbe ,0x09),
GC2035_write_cmos_sensor(0xb6 ,0x34),
GC2035_write_cmos_sensor(0xb7 ,0x21),
...
GC2035_write_cmos_sensor(0xbf ,0x1c),
GC2035_write_cmos_sensor(0xc0 ,0x2f),
GC2035_write_cmos_sensor(0xc1 ,0x23),
GC2035_write_cmos_sensor(0xb9 ,0x0b),
...
GC2035_write_cmos_sensor(0xad ,0x08),
GC2035_write_cmos_sensor(0xae ,0x12),
GC2035_write_cmos_sensor(0xaf ,0x0e),
GC2035_write_cmos_sensor(0xb0 ,0x0b),
GC2035_write_cmos_sensor(0xb1 ,0x0c),
GC2035_write_cmos_sensor(0xb2 ,0x08),
GC2035_write_cmos_sensor(0xb3 ,0x02),
GC2035_write_cmos_sensor(0xb4 ,0x05),
GC2035_write_cmos_sensor(0xb5 ,0x0a),
GC2035_write_cmos_sensor(0xd0 ,0x00),
GC2035_write_cmos_sensor(0xd2 ,0x18),
GC2035_write_cmos_sensor(0xd3 ,0x14),
GC2035_write_cmos_sensor(0xd8 ,0x00),
GC2035_write_cmos_sensor(0xda ,0x04),
GC2035_write_cmos_sensor(0xdb ,0x0e),
GC2035_write_cmos_sensor(0xdc ,0x06),
GC2035_write_cmos_sensor(0xde ,0x00),
GC2035_write_cmos_sensor(0xdf ,0x10),
...
GC2035_write_cmos_sensor(0x4f ,0x01),   
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x33);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x33);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3d);//contrast \D3  //42
	...
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight  //02
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x65);// edge effect 45 betty  //44
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x7b); //80  
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
