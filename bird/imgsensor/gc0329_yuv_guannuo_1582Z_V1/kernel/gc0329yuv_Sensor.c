 ...
 * Revision 1.1  2013/07/02 01:35:10  wangqiang
 * 13E56-S9500效果优化
 *
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m4);//m1 betty
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x2b);																																																																									
	GC0329_write_cmos_sensor(0xd2,0x2b);																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(3);//0:use default//0 betty
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x32, 0x02); 
			GC0329_SET_PAGE0;
		break;
		default:
		return FALSE;
