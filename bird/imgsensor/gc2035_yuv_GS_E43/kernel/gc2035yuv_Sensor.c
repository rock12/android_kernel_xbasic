...
GC2035_write_cmos_sensor(0xa4,0x77);  // sign of b1
GC2035_write_cmos_sensor(0xa5,0x76);  // sign of b1
GC2035_write_cmos_sensor(0xa6,0x77);  // sign of b4
GC2035_write_cmos_sensor(0xa7,0x67);  // sign of b4
GC2035_write_cmos_sensor(0xa8,0x07);  // sign of b22
GC2035_write_cmos_sensor(0xa9,0x06);  // sign of b22
GC2035_write_cmos_sensor(0xaa,0x1a);  // Q1_b1 of R
GC2035_write_cmos_sensor(0xab,0x16);  // Q1_b1 of G
GC2035_write_cmos_sensor(0xac,0x14);  // Q1_b1 of B
GC2035_write_cmos_sensor(0xad,0x1b);  // Q2_b1 of R
GC2035_write_cmos_sensor(0xae,0x16);  // Q2_b1 of G
GC2035_write_cmos_sensor(0xaf,0x11);  // Q2_b1 of B
GC2035_write_cmos_sensor(0xb0,0x0e);  // Q3_b1 of R
GC2035_write_cmos_sensor(0xb1,0x0d);  // Q3_b1 of G
GC2035_write_cmos_sensor(0xb2,0x06);  // Q3_b1 of B
GC2035_write_cmos_sensor(0xb3,0x09);  // Q4_b1 of R
GC2035_write_cmos_sensor(0xb4,0x0c);  // Q4_b1 of G
GC2035_write_cmos_sensor(0xb5,0x01);  // Q4_b1 of B
GC2035_write_cmos_sensor(0xb6,0x59);  // right_b2 of R
GC2035_write_cmos_sensor(0xb7,0x49);  // right_b2 of G
GC2035_write_cmos_sensor(0xb8,0x32);  // right_b2 of B
GC2035_write_cmos_sensor(0xb9,0x16);  // right_b4 of R
GC2035_write_cmos_sensor(0xba,0x1b);  // right_b4 of G
GC2035_write_cmos_sensor(0xbb,0x04);  // right_b4 of B
GC2035_write_cmos_sensor(0xbc,0x65);  // left_b2 of R
GC2035_write_cmos_sensor(0xbd,0x59);  // left_b2 of G
GC2035_write_cmos_sensor(0xbe,0x35);  // left_b2 of B
GC2035_write_cmos_sensor(0xbf,0x18);  // left_b4 of R
GC2035_write_cmos_sensor(0xc0,0x23);  // left_b4 of G
GC2035_write_cmos_sensor(0xc1,0x0b);  // left_b4 of B
GC2035_write_cmos_sensor(0xc2,0x34);  // up_b2 of R
GC2035_write_cmos_sensor(0xc3,0x31);  // up_b2 of G
GC2035_write_cmos_sensor(0xc4,0x1e);  // up_b2 of B
GC2035_write_cmos_sensor(0xc5,0x13);  // up_b4 of R
GC2035_write_cmos_sensor(0xc6,0x1d);  // up_b4 of G
GC2035_write_cmos_sensor(0xc7,0x03);  // up_b4 of B
GC2035_write_cmos_sensor(0xc8,0x44);  // down_b2 of R
GC2035_write_cmos_sensor(0xc9,0x38);  // down_b2 of G
GC2035_write_cmos_sensor(0xca,0x1d);  // down_b2 of B
GC2035_write_cmos_sensor(0xcb,0x36);  // down_b4 of R
GC2035_write_cmos_sensor(0xcc,0x30);  // down_b4 of G
GC2035_write_cmos_sensor(0xcd,0x02);  // down_b4 of B
GC2035_write_cmos_sensor(0xd0,0x38);  // right_up_b22 of R
GC2035_write_cmos_sensor(0xd2,0x1d);  // right_up_b22 of G
GC2035_write_cmos_sensor(0xd3,0x4a);  // right_up_b22 of B
GC2035_write_cmos_sensor(0xd4,0x24);  // right_down_b22 of R
GC2035_write_cmos_sensor(0xd6,0x1a);  // right_down_b22 of G
GC2035_write_cmos_sensor(0xd7,0x0f);  // right_down_b22 of B
GC2035_write_cmos_sensor(0xd8,0x74);  // left_up_b22 of R
GC2035_write_cmos_sensor(0xda,0x37);  // left_up_b22 of G
GC2035_write_cmos_sensor(0xdb,0x68);  // left_up_b22 of B
GC2035_write_cmos_sensor(0xdc,0x19);  // left_down_b22 of R
GC2035_write_cmos_sensor(0xde,0x22);  // left_down_b22 of G
GC2035_write_cmos_sensor(0xdf,0x03);  // left_down_b22 of B
GC2035_write_cmos_sensor(0xfe,0x00);
	...
	GC2035_write_cmos_sensor(0xd3 , 0x3d);//contrast	
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x84);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
