 ...
 * Revision 1.1  2013/10/30 12:38:49  lijunchao
 * no message
 *
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0329_write_cmos_sensor(0x33, 0x20);
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m4);//3
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x76 , 0x84); //80 jambo     
	...
	GC0329_write_cmos_sensor(0x31 , 0x05);//exp level 0  6.00fps
	...
	GC0329_write_cmos_sensor(0x82 , 0x0e);//ethan 0x//93
	GC0329_write_cmos_sensor(0x83 , 0x02);//05
	GC0329_write_cmos_sensor(0x87 , 0x4a); 

	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x90 , 0x8c);
	GC0329_write_cmos_sensor(0x92 , 0x05);
	GC0329_write_cmos_sensor(0x94 , 0x05);
	GC0329_write_cmos_sensor(0x95 , 0x43); //45
	...
	GC0329_write_cmos_sensor(0xa4 , 0x30); 
	...
	//////////////////CC///////////////////
	GC0329_write_cmos_sensor(0xfe , 0x00);
	GC0329_write_cmos_sensor(0xb3 , 0x42);//40//42
	GC0329_write_cmos_sensor(0xb4 , 0xff);//fe
	GC0329_write_cmos_sensor(0xb5 , 0x02);//02//06
	GC0329_write_cmos_sensor(0xb6 , 0xf0);
	GC0329_write_cmos_sensor(0xb7 , 0x40);//42//44
	GC0329_write_cmos_sensor(0xb8 , 0xf0);//e8
	...
	GC0329_write_cmos_sensor(0xd1 , 0x28);//32
	GC0329_write_cmos_sensor(0xd2 , 0x28);//32
	GC0329_write_cmos_sensor(0xd3 , 0x3a); //cont 0x40
	...
	GC0329_write_cmos_sensor(0x12 , 0x33);	// center weight *2
	GC0329_write_cmos_sensor(0x13 , 0x5d); //// AE Target//50
	GC0329_write_cmos_sensor(0x17 , 0xa8);	
	...
	GC0329_write_cmos_sensor(0x54 , 0x30);//40
	...
	GC0329_write_cmos_sensor(0x5d , 0x13);//ethan 0x73//53
	GC0329_write_cmos_sensor(0x5e , 0x11);
	GC0329_write_cmos_sensor(0x5f , 0x40);
	GC0329_write_cmos_sensor(0x60 , 0x40);
	GC0329_write_cmos_sensor(0x61 , 0xd8);//c8
	GC0329_write_cmos_sensor(0x62 , 0x88);//a0
	GC0329_write_cmos_sensor(0x63 , 0x40);
	GC0329_write_cmos_sensor(0x64 , 0x40);//0x50
	GC0329_write_cmos_sensor(0x65 , 0xd0);//0x98
	...
	GC0329_write_cmos_sensor(0x70 , 0x50);//0x02
	...
	GC0329_write_cmos_sensor(0x44 , 0xa2); //yuv//ethan 0xa0
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 3;//0 change by junchao
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2c, 0x58); 
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps//ethan 300
			GC0329_write_cmos_sensor(0x2e, 0xee); 
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps//ethan 3c0
			GC0329_write_cmos_sensor(0x30, 0x84); 
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x04);
	value_Y = (GC0329_NIGHT_MODE?0x68:0x5d);//50
