...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	GC2035_write_cmos_sensor(0xfe, 0x00);  
		...
		GC2035_write_cmos_sensor(0x2d, 0x07);//5b4 betty   72a
	...
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xa1 , 0x7d);
	GC2035_write_cmos_sensor(0xa2 , 0x7f);
	GC2035_write_cmos_sensor(0xa4 , 0x13);
	GC2035_write_cmos_sensor(0xa5 , 0x31);
	GC2035_write_cmos_sensor(0xa6 , 0x73);
	GC2035_write_cmos_sensor(0xa7 , 0x77);
	GC2035_write_cmos_sensor(0xa8 , 0x76);
	GC2035_write_cmos_sensor(0xa9 , 0x77);
	GC2035_write_cmos_sensor(0xaa , 0x07);
	GC2035_write_cmos_sensor(0xab , 0x02);
	GC2035_write_cmos_sensor(0xac , 0x12);
	GC2035_write_cmos_sensor(0xad , 0x0d);
	GC2035_write_cmos_sensor(0xae , 0x04);
	GC2035_write_cmos_sensor(0xaf , 0x05);
	...
	GC2035_write_cmos_sensor(0xc5 , 0x36);
	GC2035_write_cmos_sensor(0xc6 , 0x1f);
	GC2035_write_cmos_sensor(0xc7 , 0x1f);
	GC2035_write_cmos_sensor(0xc8 , 0x38);
	GC2035_write_cmos_sensor(0xc9 , 0x32);
	GC2035_write_cmos_sensor(0xca , 0x24);
	GC2035_write_cmos_sensor(0xcb , 0x2e);
	GC2035_write_cmos_sensor(0xcc , 0x1f);
	GC2035_write_cmos_sensor(0xcd , 0x0e);
	GC2035_write_cmos_sensor(0xd0 , 0x3f);
	GC2035_write_cmos_sensor(0xd2 , 0x3f);
	GC2035_write_cmos_sensor(0xd3 , 0x0e);
	GC2035_write_cmos_sensor(0xd4 , 0x3f);
	GC2035_write_cmos_sensor(0xd6 , 0x3f);
	GC2035_write_cmos_sensor(0xd7 , 0x01);
	GC2035_write_cmos_sensor(0xd8 , 0x3f);
	GC2035_write_cmos_sensor(0xda , 0x36);
	GC2035_write_cmos_sensor(0xdb , 0x19);
	GC2035_write_cmos_sensor(0xdc , 0x3f);
	GC2035_write_cmos_sensor(0xde , 0x3c);
	GC2035_write_cmos_sensor(0xdf , 0x17);
                        
	//////////cc//////////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0xc0 , 0x01);
	GC2035_write_cmos_sensor(0xc1 , 0x38); //Green_cc for d
	...
	GC2035_write_cmos_sensor(0x4e , 0x04);//04
	GC2035_write_cmos_sensor(0x4e , 0x04);
	GC2035_write_cmos_sensor(0x4e , 0x04);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x10);//10
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x20);//20
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x40);//40
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0xa9 , 0x60); //6f
	GC2035_write_cmos_sensor(0xa9 , 0xaf);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x34);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x34);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3c);//contrast \D3
