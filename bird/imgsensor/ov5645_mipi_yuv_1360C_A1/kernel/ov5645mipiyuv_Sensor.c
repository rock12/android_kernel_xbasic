...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3a19, 0x38);//f8
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x6e);//5e
  OV5645MIPI_write_cmos_sensor(0x518a, 0x5e);
  ...
  OV5645MIPI_write_cmos_sensor(0x5483, 0x28);//1e
  ...
  */
  ...
  OV5645MIPI_write_cmos_sensor(0x558b, 0xa8);//f8
  //lens shading
  OV5645MIPI_write_cmos_sensor(0x5000, 0xa7);
  OV5645MIPI_write_cmos_sensor(0x5800, 0x3c);
  OV5645MIPI_write_cmos_sensor(0x5801, 0x1b);
  OV5645MIPI_write_cmos_sensor(0x5802, 0x14);
  OV5645MIPI_write_cmos_sensor(0x5803, 0x14);
  OV5645MIPI_write_cmos_sensor(0x5804, 0x19);
  ...
  OV5645MIPI_write_cmos_sensor(0x5816, 0x03);
  ...
  OV5645MIPI_write_cmos_sensor(0x581c, 0x09);
  OV5645MIPI_write_cmos_sensor(0x581d, 0x0f);
  OV5645MIPI_write_cmos_sensor(0x581e, 0x31);
  OV5645MIPI_write_cmos_sensor(0x581f, 0x19);
  OV5645MIPI_write_cmos_sensor(0x5820, 0x13);
  OV5645MIPI_write_cmos_sensor(0x5821, 0x14);
  OV5645MIPI_write_cmos_sensor(0x5822, 0x17);
  OV5645MIPI_write_cmos_sensor(0x5823, 0x29);
  OV5645MIPI_write_cmos_sensor(0x5824, 0x46);
  OV5645MIPI_write_cmos_sensor(0x5825, 0x26);
  OV5645MIPI_write_cmos_sensor(0x5826, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x5827, 0x26);
  OV5645MIPI_write_cmos_sensor(0x5828, 0x46);
  OV5645MIPI_write_cmos_sensor(0x5829, 0x08);
  OV5645MIPI_write_cmos_sensor(0x582a, 0x46);
  OV5645MIPI_write_cmos_sensor(0x582b, 0x24);
  OV5645MIPI_write_cmos_sensor(0x582c, 0x26);
  OV5645MIPI_write_cmos_sensor(0x582d, 0x04);
  OV5645MIPI_write_cmos_sensor(0x582e, 0x28);
  ...
  OV5645MIPI_write_cmos_sensor(0x5833, 0x08);
  OV5645MIPI_write_cmos_sensor(0x5834, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5835, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5836, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5837, 0x08);
  OV5645MIPI_write_cmos_sensor(0x5838, 0x46);
  OV5645MIPI_write_cmos_sensor(0x5839, 0x26);
  OV5645MIPI_write_cmos_sensor(0x583a, 0x28);
  OV5645MIPI_write_cmos_sensor(0x583b, 0x26);
  OV5645MIPI_write_cmos_sensor(0x583c, 0x48);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x30);//sharpness 0x24
	OV5645MIPI_write_cmos_sensor(0x5303, 0x18);          //0x10
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//06 noise
	OV5645MIPI_write_cmos_sensor(0x5307, 0x10);//16
...
void OV5645MIPI_set_iso(UINT16 para)
{
    ...
    switch (para)
    {
        case AE_ISO_100:
             //ISO 100
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
             OV5645MIPI_write_cmos_sensor(0x3a19, 0x38);//78
             break;
		case AE_ISO_AUTO:
...
UINT32 OV5645MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    OV5645MIPI_write_cmos_sensor(0x3036, 0x38);
    OV5645MIPI_write_cmos_sensor(0x3037, 0x13);
		  OV5645MIPI_write_cmos_sensor(0x3a19, 0x50);  
		OV5645MIPI_write_cmos_sensor(0x380c, 0x07); 
		OV5645MIPI_write_cmos_sensor(0x380d, 0x68); 
		OV5645MIPI_write_cmos_sensor(0x380e, 0x03); 
		OV5645MIPI_write_cmos_sensor(0x380f, 0xd8);		   
