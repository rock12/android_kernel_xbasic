 ...
 * Revision 1.1  2013/07/26 12:50:34  zhoushaohong
 * no message
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x38);//saturation_cb//32 betty//32
	GC2035_write_cmos_sensor(0xd2 , 0x38);//saturation_Cr//32
	GC2035_write_cmos_sensor(0xd3 , 0x3c);//contrast \D3  40 
