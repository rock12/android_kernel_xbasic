 ...
 * Revision 1.2  2013/08/21 08:59:54  xialeijie
 * no message
 *
 * Revision 1.1  2013/08/09 07:10:46  dinghongzhen
 * V26E lanqilong
 *
...
/*
	...
	GC2035_write_cmos_sensor(0x44 , 0x20);
	GC2035_write_cmos_sensor(0x45 , 0x20);
	GC2035_write_cmos_sensor(0x46 , 0x20);
	GC2035_write_cmos_sensor(0x47 , 0x20);
	GC2035_write_cmos_sensor(0x48 , 0x20);
	GC2035_write_cmos_sensor(0x49 , 0x20);
	GC2035_write_cmos_sensor(0x4a , 0x20);
	GC2035_write_cmos_sensor(0x4b , 0x20);
	GC2035_write_cmos_sensor(0x54 , 0x20);
	GC2035_write_cmos_sensor(0x55, 0x20);
	GC2035_write_cmos_sensor(0x56 , 0x20);
	GC2035_write_cmos_sensor(0x57 , 0x20);
	GC2035_write_cmos_sensor(0x58 , 0x20);
	GC2035_write_cmos_sensor(0x59 , 0x20);
	GC2035_write_cmos_sensor(0x5a , 0x20);
	GC2035_write_cmos_sensor(0x5b, 0x20);
*/
		GC2035_write_cmos_sensor(0x40 , 0x77);//
	...
	GC2035_write_cmos_sensor(0x57 , 0x20); //pre adjust//20
	...
	GC2035_write_cmos_sensor(0x89 , 0x75);//75
...
BOOL GC2035_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		case AWB_MODE_AUTO:
				...
				GC2035_write_cmos_sensor(0x82, 0xfc);
			GC2035_write_cmos_sensor(0xb3, 0x70);//61 40 61
			GC2035_write_cmos_sensor(0xb4, 0x40);
			GC2035_write_cmos_sensor(0xb5, 0x53);
...
kal_uint32 b5 = 0;*/
	...
	#if 0
	y4=GC2035_read_cmos_sensor(0x44);
	        SENSORDB("0x44 = 0x%04x\n", y4); 
	y5=GC2035_read_cmos_sensor(0x45);
	        SENSORDB("0x45 = 0x%04x\n", y5); 
	y6=GC2035_read_cmos_sensor(0x46);
	        SENSORDB("0x46 = 0x%04x\n", y6); 
	y7=GC2035_read_cmos_sensor(0x47);
	        SENSORDB("0x47 = 0x%04x\n", y7); 
	y8=GC2035_read_cmos_sensor(0x48);
	        SENSORDB("0x48 = 0x%04x\n", y8); 
	y9=GC2035_read_cmos_sensor(0x49);
	        SENSORDB("0x49 = 0x%04x\n", y9); 
	ya=GC2035_read_cmos_sensor(0x4a);
	        SENSORDB("0x4a = 0x%04x\n", ya); 
	yb=GC2035_read_cmos_sensor(0x4b);
	        SENSORDB("0x4b = 0x%04x\n", yb); 
	x4=GC2035_read_cmos_sensor(0x54);
	        SENSORDB("0x54 = 0x%04x\n", x4); 
	x5=GC2035_read_cmos_sensor(0x55);
	        SENSORDB("0x55 = 0x%04x\n", x5); 
	x6=GC2035_read_cmos_sensor(0x56);
	        SENSORDB("0x56 = 0x%04x\n", x6); 
	x7=GC2035_read_cmos_sensor(0x57);
	        SENSORDB("0x57 = 0x%04x\n", x7); 
	x8=GC2035_read_cmos_sensor(0x58);
	        SENSORDB("0x58 = 0x%04x\n", x8); 
	x9=GC2035_read_cmos_sensor(0x59);
	        SENSORDB("0x59 = 0x%04x\n", x9); 
	xa=GC2035_read_cmos_sensor(0x5a);
	        SENSORDB("0x5a = 0x%04x\n", xa); 
	xb=GC2035_read_cmos_sensor(0x5b);
	        SENSORDB("0x58 = 0x%04x\n", xb); 
	#endif
            break;
