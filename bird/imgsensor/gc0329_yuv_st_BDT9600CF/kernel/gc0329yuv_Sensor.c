 ...
 * Revision 1.3  2013/11/08 06:33:39  dongxiaocheng
 * Editor:dongxiaocheng
 * Inspector:dongxiaocheng
 * Reason:13F43-E700W效果优化
 * Reference:none
 *
 * Revision 1.2  2013/08/01 06:14:16  zhoushaohong
 * 9600c
 *
 * Revision 1.1  2013/07/03 03:07:27  maliejun
 * 13E43 T9600C驱动调试
 *
 * Revision 1.1  2013/05/23 03:38:17  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.1  2013/04/01 03:22:02  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 H8
 * Author:Huangwenjian
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x78, 0x45);//4d
	...
	GC0329_write_cmos_sensor(0xb3, 0x46);
	...
	GC0329_write_cmos_sensor(0xd2, 0x24);
		GC0329_write_cmos_sensor(0xd3, 0x3a);
	...
	GC0329_write_cmos_sensor(0x53, 0x30);//20
	...
	GC0329_write_cmos_sensor(0x66, 0xea);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x68,0x50);//60																																																																									
	GC0329_write_cmos_sensor(0x69,0xb0);	//90																																																																								
	...
	GC0329_write_cmos_sensor(0xd1,0x22);																																																																									
	GC0329_write_cmos_sensor(0xd2,0x22);
		GC0329_write_cmos_sensor(0x7a,0x83);//add m
...
///////////////////////////////////////////////
	...
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(GC0329_RGB_Gamma_m4);//0:use default//3
}
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x60);//58
