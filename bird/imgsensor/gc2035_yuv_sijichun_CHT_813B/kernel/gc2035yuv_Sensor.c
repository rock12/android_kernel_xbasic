...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf7 , 0x15); //pll enable
  	GC2035_write_cmos_sensor(0xf8 , 0x83);////84_hms
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0xad , 0x7b);//81 betty
	GC2035_write_cmos_sensor(0xae , 0x80);//7e betty
	...
	GC2035_write_cmos_sensor(0x24 , 0x13); //pad drive 13 16 17 1f  //libo
	...
	*/
		...
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x44);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x6B);  
		GC2035_write_cmos_sensor(0x29, 0x05);//
		GC2035_write_cmos_sensor(0x2a, 0x04);  
		...
		GC2035_write_cmos_sensor(0x2e, 0x04);  
		GC2035_write_cmos_sensor(0x2f, 0x05);//76a betty
		GC2035_write_cmos_sensor(0x30, 0xDA);  
		GC2035_write_cmos_sensor(0xfe, 0x00);
...
GC2035_write_cmos_sensor(0xa2 , 0x80); 	
	...
	GC2035_write_cmos_sensor(0x4e , 0x80);
	GC2035_write_cmos_sensor(0x4e , 0x80);
	GC2035_write_cmos_sensor(0x4e , 0x02);//08
	GC2035_write_cmos_sensor(0x4e , 0x02);//04
	GC2035_write_cmos_sensor(0x4e , 0x02);//04
	GC2035_write_cmos_sensor(0x4d , 0x52);
	GC2035_write_cmos_sensor(0x4e , 0x04);///ad
	GC2035_write_cmos_sensor(0x4e , 0x08);
	GC2035_write_cmos_sensor(0x4e , 0x04);//00
	GC2035_write_cmos_sensor(0x4d , 0x62);
	...
	GC2035_write_cmos_sensor(0xde , 0xb4);  //b6 betty
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x68);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		...
		GC2035_write_cmos_sensor(0x2d, 0x04);//
		GC2035_write_cmos_sensor(0x2e, 0xD0);  
		GC2035_write_cmos_sensor(0x2f, 0x05);//
		GC2035_write_cmos_sensor(0x30, 0x80);  
		GC2035_write_cmos_sensor(0xfe, 0x00); 
            break;
#else
        case AE_FLICKER_MODE_50HZ: 
