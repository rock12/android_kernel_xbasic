...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x1f, 0x08);//b0 seaser
	GC0329_write_cmos_sensor(0x20, 0x01);//50 seaser
	...
	GC0329_write_cmos_sensor(0x29, 0x00); //80 seaser
	...
	GC0329_write_cmos_sensor(0x12, 0x17);//0x07
  ...
  GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	...
	GC0329_write_cmos_sensor(0x9d, 0x10);//0x20 seaser
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y + 0x06);
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
