...
SP2529_write_cmos_sensor(0xfd,0x00);
SP2529_write_cmos_sensor(0x2f,0x04);// pll 2
...
SP2529_write_cmos_sensor(0x94,0x20);//dpix_wht_ofst_normal2
...
SP2529_write_cmos_sensor(0x95,0x80);//dpix_blk_ofst_normal2
...
SP2529_write_cmos_sensor(0x96,0x68);//dpix_wht/blk_ratio_nr2
...
SP2529_write_cmos_sensor(0xcb,0x0a);//18	 //raw_sharp_range_base_outdoor	                                          
SP2529_write_cmos_sensor(0xcc,0x0a);//18	 //raw_sharp_range_base_nr 	                                          
SP2529_write_cmos_sensor(0xcd,0x24);//18	 //raw_sharp_range_base_dummy	                                          
...
SP2529_write_cmos_sensor(0xfd,0x02);
SP2529_write_cmos_sensor(0xe8,0x5c);   //sharpness gain for increasing pixel’s Y, in outdoor                             
SP2529_write_cmos_sensor(0xec,0x60);   //sharpness gain for decreasing pixel’s Y, in outdoor                             
SP2529_write_cmos_sensor(0xe9,0x5c);   //sharpness gain for increasing pixel’s Y, in normal                           
SP2529_write_cmos_sensor(0xed,0x60);   //sharpness gain for decreasing pixel’s Y, in normal                           
SP2529_write_cmos_sensor(0xea,0x38);   //sharpness gain for increasing pixel’s Y,in dummy                                
SP2529_write_cmos_sensor(0xee,0x38);   //sharpness gain for decreasing pixel’s Y, in dummy                               
SP2529_write_cmos_sensor(0xeb,0x30);   //sharpness gain for increasing pixel’s Y,in lowlight                             
...
SP2529_write_cmos_sensor(0x98,0x98);  //raw_ymax_normal                                                                   
...
SP2529_write_cmos_sensor(0x78,0x08);//20 //raw_dif_thr_outdoor                                                                
SP2529_write_cmos_sensor(0x79,0x0a);//18//0a                                                                                  
SP2529_write_cmos_sensor(0x7a,0x20);//10//10                                                                                  
SP2529_write_cmos_sensor(0x7b,0x20);//08//20                                                                                  
                                                        
//Gr、Gb通道銄兄                                                                                
SP2529_write_cmos_sensor(0x81,0x30);//18 //10//raw_grgb_thr_outdoor                                                            
SP2529_write_cmos_sensor(0x82,0x30);//10 //10                                                                                 
SP2529_write_cmos_sensor(0x83,0x50);//08 //10                                                                                 
SP2529_write_cmos_sensor(0x84,0x50);//08 //10                                                                                 
                                                      
SP2529_write_cmos_sensor(0xfd,0x03);                                                                                     
SP2529_write_cmos_sensor(0x7e,0x0c);     //raw_noise_base_outdoor                                                         
SP2529_write_cmos_sensor(0x7f,0x0f);     //raw_noise_base_normal                                                          
...
SP2529_write_cmos_sensor(0x82,0x88);     //raw_dns_fac_outdoor,raw_dns_fac_normal}                                       
SP2529_write_cmos_sensor(0x83,0x43);     //raw_dns_fac_dummy,raw_dns_fac_low}                                            
...
//sat u                                                                                           
SP2529_write_cmos_sensor(0xfd,0x01);                                                                                     
SP2529_write_cmos_sensor(0xd3,0x80);                                                                                     
SP2529_write_cmos_sensor(0xd4,0x78);                                                                                     
SP2529_write_cmos_sensor(0xd5,0x70);                                                                                     
SP2529_write_cmos_sensor(0xd6,0x70);                                                                                     
//sat v     7                                                                                     
SP2529_write_cmos_sensor(0xd7,0x80);                                                                                    
SP2529_write_cmos_sensor(0xd8,0x78);                                                                                    
...
//low_lum_offset                                                                                   
SP2529_write_cmos_sensor(0xfd,0x01);                                                                                     
SP2529_write_cmos_sensor(0xcd,0x24);//09 yc 2014-04-01                                                                                    
...
SP2529_write_cmos_sensor(0x12,0x78);//ku_dummy
SP2529_write_cmos_sensor(0x13,0x78);//ku_low 
SP2529_write_cmos_sensor(0x14,0xa8);//kl_outdoor                                                                              
SP2529_write_cmos_sensor(0x15,0xa8);//kl_nr                                                                               
...
UINT32 SP2529Open(void)
{
	...
	if(fromsd == 1)//是否从SD读取//gepeiwei   120903
	{
		...
		SP2529_Initialize_from_T_Flash();//从SD卡读取的主要函数
	}
	else
	{
		SP2529_Sensor_Init();
