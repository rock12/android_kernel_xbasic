...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x1f, 0x08);//b0
	GC0329_write_cmos_sensor(0x20, 0x01);//50
	...
	GC0329_write_cmos_sensor(0x28, 0x7f); //add
	...
	GC0329_write_cmos_sensor(0x44, 0xa0);//0xa0 hyper
	...
	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x95, 0x46);//45
	...
	GC0329_write_cmos_sensor(0x28, 0x7f);//hyper add
  ...
  GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	...
	GC0329_write_cmos_sensor(0x9d, 0x10);//20
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x56);
