 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: gc2035mipiyuv_Sensor.c,v $
 * Revision 1.1  2013/10/30 02:20:50  wangqiang
 * no message
 *
 * Revision 1.1  2013/09/11 06:06:18  wangqiang
 * no message
 *
 * Revision 1.1  2013/03/30 03:31:30  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 3061 cta
 * Author:Huangwenjian
 *
 *
...
{
	printk("wqcat GC2035MIPI_read_cmos_sensor GPIO_CAMERA_CMPDN_PIN=%d,GPIO_CAMERA_CMPDN1_PIN=%d"
...
static void GC2035MIPI_Sensor_Init(void)
{
	...
	GC2035MIPI_write_cmos_sensor(0x10, 0x60);  //58 pheobe
	...
	GC2035MIPI_write_cmos_sensor(0x94, 0x0a);  //58 pheobe
	//AWB_gray
	GC2035MIPI_write_cmos_sensor(0xfe , 0x01);
	...
	GC2035MIPI_write_cmos_sensor(0x30, 0xa7);  
	GC2035MIPI_write_cmos_sensor(0x3e, 0x40);//
	GC2035MIPI_write_cmos_sensor(0xfe, 0x00);  
...
//	GC2035MIPI_write_cmos_sensor(0x5e, 0x20);
	GC2035MIPI_write_cmos_sensor(0x6a, 0x04);
	GC2035MIPI_write_cmos_sensor(0x6b, 0x04);
	GC2035MIPI_write_cmos_sensor(0x6c, 0x04);
	GC2035MIPI_write_cmos_sensor(0x6d, 0x04);
	GC2035MIPI_write_cmos_sensor(0x6e, 0x04);
	GC2035MIPI_write_cmos_sensor(0x6f, 0x04);
	GC2035MIPI_write_cmos_sensor(0x70, 0x04);
  GC2035MIPI_write_cmos_sensor(0x71, 0x04);  
	...
	GC2035MIPI_write_cmos_sensor(0xfe, 0x01);  
	GC2035MIPI_write_cmos_sensor(0x9c, 0x02);//pheobe 
...
//	Sleep(200);
	...
	GC2035MIPI_write_cmos_sensor(0x5b, 0x02);  
	...
	GC2035MIPI_write_cmos_sensor(0x8e, 0x70);  
	...
	GC2035MIPI_write_cmos_sensor(0xd3 , 0x40);//contrast ?	GC2035MIPI_write_cmos_sensor(0xd4 , 0x80);//contrast center 
...
UINT32 GC2035MIPIOpen(void)
{
	...
	printk("wqcat GC2035MIPIOpen GPIO_CAMERA_CMPDN_PIN=%d,GPIO_CAMERA_CMPDN1_PIN=%d"
				, mt_get_gpio_out(GPIO_CAMERA_CMPDN_PIN),mt_get_gpio_out(GPIO_CAMERA_CMPDN1_PIN));
...
BOOL GC2035MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035MIPI_write_cmos_sensor(0xfe, 0x00);  
		GC2035MIPI_write_cmos_sensor(0x05, 0x01);//
		GC2035MIPI_write_cmos_sensor(0x06, 0x02);  
		GC2035MIPI_write_cmos_sensor(0x07, 0x00);//
		GC2035MIPI_write_cmos_sensor(0x08, 0x8e);  
		GC2035MIPI_write_cmos_sensor(0xfe, 0x01);  
		GC2035MIPI_write_cmos_sensor(0x27, 0x00);//
		GC2035MIPI_write_cmos_sensor(0x28, 0x7a);  
		GC2035MIPI_write_cmos_sensor(0x29, 0x05);//
		GC2035MIPI_write_cmos_sensor(0x2a, 0x3e);  
		GC2035MIPI_write_cmos_sensor(0x2b, 0x05);//
		GC2035MIPI_write_cmos_sensor(0x2c, 0xb8);  
		GC2035MIPI_write_cmos_sensor(0x2d, 0x06);//
		GC2035MIPI_write_cmos_sensor(0x2e, 0x32);  
		GC2035MIPI_write_cmos_sensor(0x2f, 0x07);//
		GC2035MIPI_write_cmos_sensor(0x30, 0xa0);  
		GC2035MIPI_write_cmos_sensor(0xfe, 0x00);  
            break;
...
BOOL GC2035MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_n03:
			GC2035MIPI_SET_PAGE1;
			GC2035MIPI_write_cmos_sensor(0x13,0x70);
			GC2035MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_00:
			GC2035MIPI_SET_PAGE1;
		...
		case AE_EV_COMP_03:
			GC2035MIPI_SET_PAGE1;
			GC2035MIPI_write_cmos_sensor(0x13,0x90);
			GC2035MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_07:
			GC2035MIPI_SET_PAGE1;
