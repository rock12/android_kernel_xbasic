...
static void GC2035MIPI_Sensor_Init(void)
{
	...
	GC2035MIPI_write_cmos_sensor(0x04, 0xda);  
	...
	GC2035MIPI_write_cmos_sensor(0xd3 , 0x3d);//contrast ?0x40 seaser
	GC2035MIPI_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035MIPI_write_cmos_sensor(0xd5 , 0x06);//luma_offset 0x00
...
BOOL GC2035MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035MIPI_SET_PAGE1;
			GC2035MIPI_write_cmos_sensor(0x13,0x84);//0x80
			GC2035MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035MIPI_SET_PAGE1;
