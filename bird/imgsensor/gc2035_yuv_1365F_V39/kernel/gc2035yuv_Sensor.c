...
static void GC2035_Sensor_Init(void)
{
  ...
  GC2035_write_cmos_sensor(0xf8 , 0x83); //84---20130619
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x13 , 0x90);//y_target //75 14-03-17 0x86
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	*/
	...
	GC2035_write_cmos_sensor(0x81 , 0x24);//38 , 0x//skin_Y 8c_debug   26
...
/*	
	...
	GC2035_write_cmos_sensor(0xbd , 0x10);//1f
	...
	GC2035_write_cmos_sensor(0xae , 0x00);//03
	...
	GC2035_write_cmos_sensor(0xb4 , 0x04);//00
	...
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xa1 , 0x89);
	GC2035_write_cmos_sensor(0xa2 , 0x83);
	GC2035_write_cmos_sensor(0xa4 , 0x77);
	GC2035_write_cmos_sensor(0xa5 , 0x77);
	GC2035_write_cmos_sensor(0xa6 , 0x70);
	GC2035_write_cmos_sensor(0xa7 , 0x57);
	GC2035_write_cmos_sensor(0xa8 , 0x77);
	GC2035_write_cmos_sensor(0xa9 , 0x00);
	GC2035_write_cmos_sensor(0xaa , 0x18);
	GC2035_write_cmos_sensor(0xab , 0x0f);
	GC2035_write_cmos_sensor(0xac , 0x18);
	GC2035_write_cmos_sensor(0xad , 0x34);
	GC2035_write_cmos_sensor(0xae , 0x3a);
	GC2035_write_cmos_sensor(0xaf , 0x2a);
	GC2035_write_cmos_sensor(0xb0 , 0x27);
	GC2035_write_cmos_sensor(0xb1 , 0x33);
	GC2035_write_cmos_sensor(0xb2 , 0x3b);
	GC2035_write_cmos_sensor(0xb3 , 0x16);
	GC2035_write_cmos_sensor(0xb4 , 0x0e);
	GC2035_write_cmos_sensor(0xb5 , 0x16);
	GC2035_write_cmos_sensor(0xb6 , 0x7c);
	GC2035_write_cmos_sensor(0xb7 , 0x6f);
	GC2035_write_cmos_sensor(0xb8 , 0x57);
	GC2035_write_cmos_sensor(0xb9 , 0x2b);
	GC2035_write_cmos_sensor(0xba , 0x1c);
	GC2035_write_cmos_sensor(0xbb , 0x14);
	GC2035_write_cmos_sensor(0xbc , 0x66);
	GC2035_write_cmos_sensor(0xbd , 0x3f);
	GC2035_write_cmos_sensor(0xbe , 0x45);
	GC2035_write_cmos_sensor(0xbf , 0x3a);
	GC2035_write_cmos_sensor(0xc0 , 0x43);
	GC2035_write_cmos_sensor(0xc1 , 0x3a);
	GC2035_write_cmos_sensor(0xc2 , 0x46);
	GC2035_write_cmos_sensor(0xc3 , 0x37);
	GC2035_write_cmos_sensor(0xc4 , 0x35);
	GC2035_write_cmos_sensor(0xc5 , 0x00);
	GC2035_write_cmos_sensor(0xc6 , 0x09);
	GC2035_write_cmos_sensor(0xc7 , 0x01);
	GC2035_write_cmos_sensor(0xc8 , 0x4f);
	GC2035_write_cmos_sensor(0xc9 , 0x3e);
	GC2035_write_cmos_sensor(0xca , 0x36);
	GC2035_write_cmos_sensor(0xcb , 0x40);
	GC2035_write_cmos_sensor(0xcc , 0x1b);
	GC2035_write_cmos_sensor(0xcd , 0x22);
	GC2035_write_cmos_sensor(0xd0 , 0x04);
	GC2035_write_cmos_sensor(0xd2 , 0x12);
	GC2035_write_cmos_sensor(0xd3 , 0x09);
	GC2035_write_cmos_sensor(0xd4 , 0x1a);
	GC2035_write_cmos_sensor(0xd6 , 0x30);
	GC2035_write_cmos_sensor(0xd7 , 0x1f);
	GC2035_write_cmos_sensor(0xd8 , 0xff);
	GC2035_write_cmos_sensor(0xda , 0xff);
	GC2035_write_cmos_sensor(0xdb , 0xe3);
	GC2035_write_cmos_sensor(0xdc , 0x8b);
	GC2035_write_cmos_sensor(0xde , 0x9d);
	GC2035_write_cmos_sensor(0xdf , 0x9a);
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0xc1 , 0x3d); //Green_cc for d 0x40
	GC2035_write_cmos_sensor(0xc2 , 0xfc);
	GC2035_write_cmos_sensor(0xc3 , 0x05);
	GC2035_write_cmos_sensor(0xc4 , 0xec);//ec 0422
	GC2035_write_cmos_sensor(0xc5 , 0x40);//0x42
	...
	GC2035_write_cmos_sensor(0x56 , 0x06);//06
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x28);//saturation_cb//32 betty 0x32
	GC2035_write_cmos_sensor(0xd2 , 0x28);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x30);//contrast \D3
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xf8);//luma_offset 
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x18);//dn_b_base 0x1f
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x05); //dn_c_weight 0x02
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x92 , 0x05);
	GC2035_write_cmos_sensor(0x93 , 0x01);
	GC2035_write_cmos_sensor(0x97 , 0x77);// edge effect 45 betty 0x54
	////==============RGB Gamma 
#if 0
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		case AE_EV_COMP_n13:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x58);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n10:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x90);//50  0x86
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_07:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x98);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_10:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_13:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0xa8);
			GC2035_SET_PAGE0;
		break;
		default:
		return FALSE;
