 ...
 * Revision 1.3  2013/07/17 07:51:02  birdlibo
 * no message
 *
 * Revision 1.2  2013/07/17 04:56:13  birdlibo
 * no message
 *
 * Revision 1.1  2013/05/23 03:38:18  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.2  2013/05/06 10:53:58  lanqilong
 * Editor: lanqilong
 * Inspector:lanqilong
 * Reason:12Y36_klt3061
 * Reference:none
 *
 * Revision 1.1  2013/04/03 01:57:56  huangwenjian
 * Bug[none]
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x82, 0x5a);//55 andy 
	GC0329_write_cmos_sensor(0x83, 0x02);  // add by lanking 20120423//03 
	...
	GC0329_write_cmos_sensor(0xa8, 0x1f);//0f 
	...
	GC0329_write_cmos_sensor(0xc0, 0x28);//17 
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x28);//2a																																																																									
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0xd0); 
			GC0329_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps//348 
			GC0329_write_cmos_sensor(0x30, 0x38); 
			GC0329_write_cmos_sensor(0x31, 0x04);   //exp level 3  7.14fps
			GC0329_write_cmos_sensor(0x32, 0xb0);
			GC0329_SET_PAGE0;
			break;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x48);//50
