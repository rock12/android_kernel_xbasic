 ...
 * Revision 1.1  2013/09/18 04:15:56  zhoushaohong
 * 13C43_C806
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0xb5, 0x07);
	...
	////////add ratio////////////
	GC0329_write_cmos_sensor(0x7a, 0x7d);
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 2  7.5fps
