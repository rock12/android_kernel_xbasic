		...
		//	 HM5065MIPISensor.NightMode = KAL_TRUE;
		 if(HM5065MIPISensor.VideoMode == KAL_TRUE)
		  { 	  
		      ...
		      //HM5065MIPI_write_cmos_sensor(0x0144,0x09);//mark by jink 20131018
		 }	  
		  else 
		 {
				printk("HM5065 night mode ture camera preview\r\n");
				  ...
				  //HM5065MIPI_write_cmos_sensor(0x0144,0x0D);//mark by jink 20131018
		  } 	  
	  }
	  else
		  {
		 // HM5065MIPISensor.bNight_mode = KAL_FALSE;
		  if(HM5065MIPISensor.VideoMode == KAL_TRUE)
		  {
			  ...
			  printk("HM5065 night_auto mode ture camera preview--------------\r\n");
				  HM5065MIPI_write_cmos_sensor(0x00E8,0x01);//AFR
				  HM5065MIPI_write_cmos_sensor(0x00ED,0x08);//Min=8fps by jink 20130930
				  HM5065MIPI_write_cmos_sensor(0x00EE,0x1E);//Max=30fps
				  //HM5065MIPI_write_cmos_sensor(0x0143,0x60);	//5f->60 by jink 20130930//max int 1/10s
				  //HM5065MIPI_write_cmos_sensor(0x0144,0x0D);//mark by jink 20131018
			  } 	 
		  }  
	  }
	...
	{ 
		  ...
		  { 
					printk("HM5065 night mode ture camera ZSD preview \r\n");
					  ...
					  //HM5065MIPI_write_cmos_sensor(0x0143,0x61);	//max int = 1/5s		  
					  //HM5065MIPI_write_cmos_sensor(0x0144,0x34);//mark by jink 20131018
		  }
		  else
			  {
...
HM5065MIPI_write_cmos_sensor(0x00B2,0x50);//4e->50 by jink 20130930 // set PLL output 713MHz
HM5065MIPI_write_cmos_sensor(0x00B3,0x80);//ca->80 by jink 20130930
HM5065MIPI_write_cmos_sensor(0x00B4,0x01);//         // E_div
HM5065MIPI_write_cmos_sensor(0x00B5,0x02);//01->02 by jink 20131009         // PLL3_div 2
...
HM5065MIPI_write_cmos_sensor(0x019D,0x20);//c0->20 by jink 20130930 
...
HM5065MIPI_write_cmos_sensor(0x0357,0x59);//  PeakingControl fUserPeakLoThresh 19->39 by jink 20130930
...
// Set Saturation 
HM5065MIPI_write_cmos_sensor(0x0081,0x50);//  PipeSetupCommon bColourSaturation 60->50 by jink 20131009
...
UINT32 HM5065MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			pSensorInfo->SensorClockFreq=26;//24->26 by jink 20130930
...
void HM5065MIPI_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_MIDDLE:
        default:
             HM5065MIPI_write_cmos_sensor(0x0081 ,0x50);//58->50 by jink 20131009
             break; 
    }	
...
void HM5065MIPI_set_iso(UINT16 para)
{
	...
	HM5065MIPI_write_cmos_sensor(0x02C3, 0x80);
			...
			case AE_ISO_AUTO:
				 //ISO Auto
	HM5065MIPI_write_cmos_sensor(0x015C, 0x3e);//40->3e by jink 20130930
	HM5065MIPI_write_cmos_sensor(0x015D, 0x00);
	HM5065MIPI_write_cmos_sensor(0x015E, 0x40);
	HM5065MIPI_write_cmos_sensor(0x015F, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C0, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C1, 0x00);//c0->00 by jink 20130930
	HM5065MIPI_write_cmos_sensor(0x02C2, 0x00);
	HM5065MIPI_write_cmos_sensor(0x02C3, 0xC0);
				 break; 
		}	
