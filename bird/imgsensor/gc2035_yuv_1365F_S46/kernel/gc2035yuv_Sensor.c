...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	///////////////////////////////////////////////
	///////////////// 2035 LSC SET 2014-05-10////////////////
	///////////////////////////////////////////////
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xa1 , 0x80);  // center_row
	GC2035_write_cmos_sensor(0xa2 , 0x80);  // center_col
	GC2035_write_cmos_sensor(0xa4 , 0x72);  // sign of b1
	GC2035_write_cmos_sensor(0xa5 , 0x37);  // sign of b1
	GC2035_write_cmos_sensor(0xa6 , 0x77);  // sign of b4
	GC2035_write_cmos_sensor(0xa7 , 0x77);  // sign of b4
	GC2035_write_cmos_sensor(0xa8 , 0x67);  // sign of b22
	GC2035_write_cmos_sensor(0xa9 , 0x57);  // sign of b22
	GC2035_write_cmos_sensor(0xaa , 0x06);  // Q1_b1 of R
	GC2035_write_cmos_sensor(0xab , 0x06);  // Q1_b1 of G
	GC2035_write_cmos_sensor(0xac , 0x09);  // Q1_b1 of B
	GC2035_write_cmos_sensor(0xad , 0x07);  // Q2_b1 of R
	GC2035_write_cmos_sensor(0xae , 0x0b);  // Q2_b1 of G
	GC2035_write_cmos_sensor(0xaf , 0x02);  // Q2_b1 of B
	GC2035_write_cmos_sensor(0xb0 , 0x0a);  // Q3_b1 of R
	GC2035_write_cmos_sensor(0xb1 , 0x07);  // Q3_b1 of G
	GC2035_write_cmos_sensor(0xb2 , 0x02);  // Q3_b1 of B
	GC2035_write_cmos_sensor(0xb3 , 0x07);  // Q4_b1 of R
	GC2035_write_cmos_sensor(0xb4 , 0x08);  // Q4_b1 of G
	GC2035_write_cmos_sensor(0xb5 , 0x06);  // Q4_b1 of B
	GC2035_write_cmos_sensor(0xb6 , 0x35);  // right_b2 of R
	GC2035_write_cmos_sensor(0xb7 , 0x2f);  // right_b2 of G
	GC2035_write_cmos_sensor(0xb8 , 0x1a);  // right_b2 of B
	GC2035_write_cmos_sensor(0xb9 , 0x12);  // right_b4 of R
	GC2035_write_cmos_sensor(0xba , 0x12);  // right_b4 of G
	GC2035_write_cmos_sensor(0xbb , 0x02);  // right_b4 of B
	GC2035_write_cmos_sensor(0xbc , 0x40);  // left_b2 of R
	GC2035_write_cmos_sensor(0xbd , 0x2d);  // left_b2 of G
	GC2035_write_cmos_sensor(0xbe , 0x2d);  // left_b2 of B
	GC2035_write_cmos_sensor(0xbf , 0x08);  // left_b4 of R
	GC2035_write_cmos_sensor(0xc0 , 0x10);  // left_b4 of G
	GC2035_write_cmos_sensor(0xc1 , 0x12);  // left_b4 of B
	GC2035_write_cmos_sensor(0xc2 , 0x2b);  // up_b2 of R
	GC2035_write_cmos_sensor(0xc3 , 0x1d);  // up_b2 of G
	GC2035_write_cmos_sensor(0xc4 , 0x16);  // up_b2 of B
	GC2035_write_cmos_sensor(0xc5 , 0x21);  // up_b4 of R
	GC2035_write_cmos_sensor(0xc6 , 0x14);  // up_b4 of G
	GC2035_write_cmos_sensor(0xc7 , 0x0c);  // up_b4 of B
	GC2035_write_cmos_sensor(0xc8 , 0x23);  // down_b2 of R
	GC2035_write_cmos_sensor(0xc9 , 0x22);  // down_b2 of G
	GC2035_write_cmos_sensor(0xca , 0x1a);  // down_b2 of B
	GC2035_write_cmos_sensor(0xcb , 0x0f);  // down_b4 of R
	GC2035_write_cmos_sensor(0xcc , 0x15);  // down_b4 of G
	GC2035_write_cmos_sensor(0xcd , 0x0a);  // down_b4 of B
	GC2035_write_cmos_sensor(0xd0 , 0x0f);  // right_up_b22 of R
	GC2035_write_cmos_sensor(0xd2 , 0x07);  // right_up_b22 of G
	GC2035_write_cmos_sensor(0xd3 , 0x07);  // right_up_b22 of B
	GC2035_write_cmos_sensor(0xd4 , 0x16);  // right_down_b22 of R
	GC2035_write_cmos_sensor(0xd6 , 0x0e);  // right_down_b22 of G
	GC2035_write_cmos_sensor(0xd7 , 0x0e);  // right_down_b22 of B
	GC2035_write_cmos_sensor(0xd8 , 0x2d);  // left_up_b22 of R
	GC2035_write_cmos_sensor(0xda , 0x00);  // left_up_b22 of G
	GC2035_write_cmos_sensor(0xdb , 0x0e);  // left_up_b22 of B
	GC2035_write_cmos_sensor(0xdc , 0x3b);  // left_down_b22 of R
	GC2035_write_cmos_sensor(0xde , 0x0e);  // left_down_b22 of G
	GC2035_write_cmos_sensor(0xdf , 0x14);  // left_down_b22 of B
	GC2035_write_cmos_sensor(0xfe , 0x00);
