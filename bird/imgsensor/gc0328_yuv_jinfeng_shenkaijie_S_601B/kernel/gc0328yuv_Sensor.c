 ...
 * Revision 1.1  2013/09/24 07:47:21  wangdong
 * no message
 *
 * Revision 1.1  2013/07/02 12:30:12  wangqiang
 * cam效果优化
 *
 * Revision 1.6  2013/06/14 12:35:42  maliejun
 * driver update
 *
 * Revision 1.5  2013/06/05 07:54:34  birdlibo
 * no message
 *
...
void GC0328_Sensor_Init(void)
    ...
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror
		...
		///////YCP
		GC0328_write_cmos_sensor(0xd1 , 0x38);
		GC0328_write_cmos_sensor(0xd2 , 0x38);
