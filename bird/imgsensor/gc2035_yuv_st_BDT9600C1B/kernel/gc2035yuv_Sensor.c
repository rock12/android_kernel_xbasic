 ...
 * Revision 1.2  2013/08/01 06:09:32  zhoushaohong
 * 9600c
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	/*
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x38);//24
	...
	GC2035_write_cmos_sensor(0xbc , 0x43);//48
	...
	GC2035_write_cmos_sensor(0xad , 0x25);//03
	...
	GC2035_write_cmos_sensor(0xb3 , 0x14);//04
	
	GC2035_write_cmos_sensor(0xb4 , 0x15);
	GC2035_write_cmos_sensor(0xb5 , 0x16);//0b
...
*/
///////////////lsc shading 20131211 seaser /////
   
	GC2035_write_cmos_sensor(0xfe, 0x01);
	GC2035_write_cmos_sensor(0xc2, 0x26);
	GC2035_write_cmos_sensor(0xc3, 0x18);
	...
	GC2035_write_cmos_sensor(0xbc, 0x58);
	GC2035_write_cmos_sensor(0xbd, 0x4a);
	GC2035_write_cmos_sensor(0xbe, 0x3d);
	GC2035_write_cmos_sensor(0xb6, 0x46);
	GC2035_write_cmos_sensor(0xb7, 0x45);
	GC2035_write_cmos_sensor(0xb8, 0x25);
	GC2035_write_cmos_sensor(0xc5, 0x15);
	GC2035_write_cmos_sensor(0xc6, 0x1a);
	GC2035_write_cmos_sensor(0xc7, 0x15);
	GC2035_write_cmos_sensor(0xcb, 0x12);
	GC2035_write_cmos_sensor(0xcc, 0x0d);
	GC2035_write_cmos_sensor(0xcd, 0x0a);
	GC2035_write_cmos_sensor(0xbf, 0x00);
	GC2035_write_cmos_sensor(0xc0, 0x00);
	GC2035_write_cmos_sensor(0xc1, 0x00);
	GC2035_write_cmos_sensor(0xb9, 0x15);
	GC2035_write_cmos_sensor(0xba, 0x00);
	GC2035_write_cmos_sensor(0xbb, 0x16);
	GC2035_write_cmos_sensor(0xaa, 0x30);
	GC2035_write_cmos_sensor(0xab, 0x25);
	GC2035_write_cmos_sensor(0xac, 0x28);
	GC2035_write_cmos_sensor(0xad, 0x45);
	GC2035_write_cmos_sensor(0xae, 0x2d);
	GC2035_write_cmos_sensor(0xaf, 0x33);
	GC2035_write_cmos_sensor(0xb0, 0x4f);
	GC2035_write_cmos_sensor(0xb1, 0x45);
	GC2035_write_cmos_sensor(0xb2, 0x43);
	GC2035_write_cmos_sensor(0xb3, 0x30);//
	GC2035_write_cmos_sensor(0xb4, 0x2e);
	GC2035_write_cmos_sensor(0xb5, 0x1b);
	GC2035_write_cmos_sensor(0xd0, 0x00);
	...
	GC2035_write_cmos_sensor(0xdc, 0x06);
	GC2035_write_cmos_sensor(0xde, 0x00);
	GC2035_write_cmos_sensor(0xdf, 0x00);
	GC2035_write_cmos_sensor(0xd4, 0x32);
	...
	GC2035_write_cmos_sensor(0xc1 , 0x44); //Green_cc for d//40
	...
	GC2035_write_cmos_sensor(0xd3 , 0x38);//contrast \D3
	...
	GC2035_write_cmos_sensor(0xdd , 0xba);//edge_sa_g,b 0xb8
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x97 , 0x66);// edge effect 45 betty//54
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
static void GC2035_Write_More(void)
{
  //////////////For FAE ////////////////
	...
	GC2035_write_cmos_sensor(0x44 , 0x00);// 00
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		case AE_EV_COMP_n13:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x30);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n10:
			GC2035_SET_PAGE1;
