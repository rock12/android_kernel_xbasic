 ...
 * Revision 1.1  2013/08/28 07:46:59  xialeijie
 * no message
 *
 * Revision 1.3  2013/07/09 09:02:30  zhoushaohong
 * s100 效果优化
 *
 * Revision 1.2  2013/07/04 04:30:51  pengyajun
 * T10 update
 *
 * Revision 1.1  2013/06/20 09:19:15  maliejun
 * driver update
 *
 * Revision 1.1  2013/05/14 05:59:33  maliejun
 * driver update
 *
...
void GC0328_Sensor_Init(void)
	...
	GC0328_write_cmos_sensor(0x46 , 0x02); //0x02  
	...
	GC0328_write_cmos_sensor(0x82 , 0x8c);    
	...
	GC0328_write_cmos_sensor(0x95 , 0x33);    
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x30);
	GC0328_write_cmos_sensor(0xd2 , 0x30);
	GC0328_write_cmos_sensor(0xd3 , 0x44);//40 betty
	GC0328_write_cmos_sensor(0xd5 , 0xfb);//fa betty
	GC0328_write_cmos_sensor(0xdd , 0x18);
	GC0328_write_cmos_sensor(0xde , 0x34);
	...
	///cct       
	GC0328_write_cmos_sensor(0xB1 , 0x00); //04 betty  
	GC0328_write_cmos_sensor(0xB2 , 0xfd);   
	GC0328_write_cmos_sensor(0xB3 , 0x07); //fc betty  
	GC0328_write_cmos_sensor(0xB4 , 0xf0);   
	GC0328_write_cmos_sensor(0xB5 , 0x00); //05 betty  
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xfb);
			GC0328_write_cmos_sensor(0xfe, 0x01);
