...
static void T8EV5YUV_Sensor_Init_setting(int lines)
{
	...
	T8EV5YUV_write_cmos_sensor(0x0101,0x03);//-/-/-/-/-/-/VREVON/HREVON                                                        
	...
	T8EV5YUV_write_cmos_sensor(0x013C,0x08);//-/-/-/-/VT_PIX_CNTL[3:0]
	...
	T8EV5YUV_write_cmos_sensor(0x0229,0x2C);//Cbr_MGAIN1[3:0]/Cbr_MGAIN0[3:0]                                                  
	T8EV5YUV_write_cmos_sensor(0x022A,0x00);//-/-/-/-/Cbr_MGAIN2[3:0]                                                          
	T8EV5YUV_write_cmos_sensor(0x022B,0x02);//EXTR_CRNG1[3:0]/EXTR_CRNG0[3:0]!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	T8EV5YUV_write_cmos_sensor(0x030D,0x1B);//A5WEIGHT[1:0]/B1WEIGHT[1:0]/B2WEIGHT[1:0]/B3WEIGHT[1:0]                          
	T8EV5YUV_write_cmos_sensor(0x030E,0x90);//B4WEIGHT[1:0]/B5WEIGHT[1:0]/C1WEIGHT[1:0]/C2WEIGHT[1:0]                          
	...
	T8EV5YUV_write_cmos_sensor(0x0316,0x67);//FLLONGON/FRMSPD[1:0]/FL600S[12:8]
	T8EV5YUV_write_cmos_sensor(0x0317,0xc1);//FL600S[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x034E,0x60);//MMES[7:0]30
	...
	T8EV5YUV_write_cmos_sensor(0x0422,0x4A);////PWBGAINR[7:0]                                                                  
	T8EV5YUV_write_cmos_sensor(0x0423,0x56);////PWBGAINB[7:0]                                                                  
	T8EV5YUV_write_cmos_sensor(0x0426,0x00);////-/-/-/-/-/-/LIPOL/CSPOL                                                        
	T8EV5YUV_write_cmos_sensor(0x0427,0x00);////-/LS4SIG[2:0]/-/LS1SIG[2:0]                                                    
	T8EV5YUV_write_cmos_sensor(0x0428,0x80);////LSHOFG[7:0]//80                                                                
	T8EV5YUV_write_cmos_sensor(0x0429,0x80);////LSHOFR[7:0]                                                                    
	T8EV5YUV_write_cmos_sensor(0x042A,0x80);////LSHOFB[7:0]                                                                    
	T8EV5YUV_write_cmos_sensor(0x042B,0x80);////LSVOFG[7:0]//B8                                                                
	T8EV5YUV_write_cmos_sensor(0x042C,0x80);////LSVOFR[7:0]//B0                                                                
	T8EV5YUV_write_cmos_sensor(0x042D,0x80);////LSVOFB[7:0]//A8                                                                
	T8EV5YUV_write_cmos_sensor(0x042E,0x00);////LSALUG[7:0] 1st left up                                                        
	T8EV5YUV_write_cmos_sensor(0x042F,0x00);////LSALUR[7:0]                                                                    
	T8EV5YUV_write_cmos_sensor(0x0430,0x04);////LSALUB[7:0]                                                                    
	...
	T8EV5YUV_write_cmos_sensor(0x0435,0x04);////LSALDR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0436,0x08);////LSALDB[7:0]                                                                    
	T8EV5YUV_write_cmos_sensor(0x0437,0x00);////LSARDG[7:0]  1st right down                                                    
	T8EV5YUV_write_cmos_sensor(0x0438,0x08);////LSARDR[7:0]                                                                    
	T8EV5YUV_write_cmos_sensor(0x0439,0x08);////LSARDB[7:0]                                                                    
	T8EV5YUV_write_cmos_sensor(0x043A,0x30);////LSBLG[7:0] 2nd left
	T8EV5YUV_write_cmos_sensor(0x043B,0x20);////LSBLR[7:0] //D8
	T8EV5YUV_write_cmos_sensor(0x043C,0x10);////LSBLB[7:0]                                                                     
	T8EV5YUV_write_cmos_sensor(0x043D,0x3C);////LSBRG[7:0]  2nd right
	T8EV5YUV_write_cmos_sensor(0x043E,0x44);////LSBRR[7:0]//De
	T8EV5YUV_write_cmos_sensor(0x043F,0x30);////LSBRB[7:0]                                                                     
	T8EV5YUV_write_cmos_sensor(0x0440,0x30);////LSCUG[7:0] 2nd up  //D0                                                        
	T8EV5YUV_write_cmos_sensor(0x0441,0x38);////LSCUR[7:0] //F7                                                                
	T8EV5YUV_write_cmos_sensor(0x0442,0x28);////LSCUB[7:0]                                                                     
	T8EV5YUV_write_cmos_sensor(0x0443,0x3C);////LSCDG[7:0] 2nd down                                                            
	T8EV5YUV_write_cmos_sensor(0x0444,0x3C);////LSCDR[7:0]                                                                     
	T8EV5YUV_write_cmos_sensor(0x0445,0x30);////LSCDB[7:0]                                                                     
	T8EV5YUV_write_cmos_sensor(0x0446,0x20);////LSDLG[7:0] 4th left                                                            
	T8EV5YUV_write_cmos_sensor(0x0447,0x40);////LSDLR[7:0]                                                                     
	T8EV5YUV_write_cmos_sensor(0x0448,0x40);////LSDLB[7:0]                                                                     
...
static void T8EV5YUV_set_1280_960_init(void)
{
	...
	T8EV5YUV_write_cmos_sensor(0x0113,0x00);//VCROP[7:0] 
	T8EV5YUV_write_cmos_sensor(0x013A,0x02);//-/-/-/-/VT_SYS_CNTL[3:0]
	//T8EV5YUV_write_cmos_sensor(0x013C,0x0C);
	//T8EV5YUV_write_cmos_sensor(0x0229,0x2A);//Cbr_MGAIN1[3:0]/Cbr_MGAIN0[3:0]
	T8EV5YUV_write_cmos_sensor(0x0305,0x02);//-/-/-/-/AGMAX[11:8]
	T8EV5YUV_write_cmos_sensor(0x0306,0x39);//AGMAX[7:0]
	T8EV5YUV_write_cmos_sensor(0x0307,0x0F);//MES[15:8]
...
static void T8EV5YUV_set_5M_init(void)
{
	...
	T8EV5YUV_write_cmos_sensor(0x0315,0x08);//FAUTO/FCOUNT[2:0]/FCLSBON/EXPLIM[2:0]
	T8EV5YUV_write_cmos_sensor(0x0316,0x64);//FLLONGON/FRMSPD[1:0]/FL600S[12:8]66
	T8EV5YUV_write_cmos_sensor(0x0317,0x02);//FL600S[7:0]69
	T8EV5YUV_write_cmos_sensor(0x0102,0x02);//-/-/-/-/-/-/VLAT_ON/GROUP_HOLD
...
static UINT32 T8EV5YUVOpen(void)
{
    ...
    do {
        ...
        printk("MYCAT Read Sensor ID = 0x%04x\n", T8EV5YUV_sensor_id);        
        if (T8EV5YUV_sensor_id == T8EV5_MIPI_SENSOR_ID)
            break; 
...
static void T8EV5_FOCUS_Init(void)
{
	...
	T8EV5YUV_write_cmos_sensor(0x2402,0x40);// INF LSB[7:0]
...
/*
static void WriteCaptureReg(void)
{
	T8EV5YUV_write_cmos_sensor(0x0137,0x01);//-/-/-/-/-/PRE_PLL_CNTL[2:0]                                                      
	T8EV5YUV_write_cmos_sensor(0x0138,0x00);//-/-/-/-/-/-/-/PLL_MULTI[8]                                                       
	T8EV5YUV_write_cmos_sensor(0x0139,0x36);//PLL_MULTI[7:0]                                                                   
	...
	T8EV5YUV_write_cmos_sensor(0x0316,0x66);  
	T8EV5YUV_write_cmos_sensor(0x0317,0x6a);  
}
*/
...
static kal_uint32 T8EV5_set_param_exposure(kal_uint32 para)
{
    ...
    switch (para)
    {
        ...
        case AE_EV_COMP_00:
			T8EV5YUV_write_cmos_sensor(0x0302,0x01);
			T8EV5YUV_write_cmos_sensor(0x0303,0x25);
		...
		case SCENE_MODE_HDR:
		 ...
		 break;
	   	...
	   	case SCENE_MODE_OFF:
			...
			T8EV5YUV_write_cmos_sensor(0x0108,0x7C);//V_COUNT[7:0] 
			T8EV5YUV_write_cmos_sensor(0x0229,0x2C);//Cbr_MGAIN1[3:0]/Cbr_MGAIN0[3:0]
			T8EV5YUV_write_cmos_sensor(0x0249,0x86);//CONT_LEV[7:0]
			T8EV5YUV_write_cmos_sensor(0x0315,0x98);//FAUTO/FCOUNT[2:0]/FCLSBON/EXPLIM[2:0]
			T8EV5YUV_write_cmos_sensor(0x0302,0x01);//-/-/-/-/-/-/ALCAIM[9:8]
			T8EV5YUV_write_cmos_sensor(0x0303,0x25);//ALCAIM[7:0]
			T8EV5YUV_write_cmos_sensor(0x030C,0x55);//A1WEIGHT[1:0]/A2WEIGHT[1:0]/A3WEIGHT[1:0]/A4WEIGHT[1:0]
			T8EV5YUV_write_cmos_sensor(0x030D,0x5A);//A5WEIGHT[1:0]/B1WEIGHT[1:0]/B2WEIGHT[1:0]/B3WEIGHT[1:0]
			T8EV5YUV_write_cmos_sensor(0x030E,0x95);//B4WEIGHT[1:0]/B5WEIGHT[1:0]/C1WEIGHT[1:0]/C2WEIGHT[1:0]
    ...
    do {
      ...
      //  printk("MYCAT Read Sensor ID1,ID2  = %x,%x\n", u_sensorid1,u_sensorid2);   
		*sensorID =   (((u_sensorid1&0XFF) << 8 )| (u_sensorid2&0XFF));
        if (*sensorID == T8EV5_MIPI_SENSOR_ID)
            break; 
       // printk("MYCAT Read Sensor ID Fail = 0x%04x\n", *sensorID); 
        retry--; 
    } while (retry > 0);
	 ...
	 case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
		...
		SENSORDB("SENSOR_FEATURE_GET_REGISTER_DEFAULT\n");
            ...
            if (*pFeatureParaLen>=sizeof(NVRAM_SENSOR_DATA_STRUCT))
            {
                ...
                pSensorDefaultData->SensorId=T8EV5_MIPI_SENSOR_ID;
