...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x24 , 0x3f); //pad drive  17
	//AEC
	GC2035_write_cmos_sensor(0xfe, 0x01);  
	...
	GC2035_write_cmos_sensor(0xd1, 0x32);  
	GC2035_write_cmos_sensor(0xd2, 0x32);  
	...
	GC2035_write_cmos_sensor(0x97 , 0x67);// edge effect//0x45 hyper
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
