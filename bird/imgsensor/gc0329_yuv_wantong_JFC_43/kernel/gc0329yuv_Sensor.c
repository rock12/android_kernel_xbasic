 ...
 * Revision 1.1  2013/11/08 06:18:10  xialeijie
 * no message
 *
 * Revision 1.3  2013/11/08 06:01:54  xialeijie
 * no message
 *
 * Revision 1.2  2013/09/06 04:34:43  wangtinglong
 * 13C43 S26E
 *
 * Revision 1.1  2013/08/13 02:55:46  chenchuanbao
 * Editor: chenchuanbao
 ...
 * Bug 86348:¨°1?¡ã?¡ê¨º?¡ê????¨¤?¨²??¨¨?¨ª?3???¡ä?o¨®¡ê??¨¢¨¬¨¢¨º??¡ão¨¹¡À¡ì??¡ê??¨¤?¨²¨°?¨ª¡ê?1??DD
 *
 ...
 * Editor: maliejun
 * Inspector:maliejun
 * Reason:[84290] [N803]?y?¡¥D¨¨¨°a¨°?¦Ì?ICS_V2¨¦?
 * Reference:none
 *
...
void GC0329_Sensor_Init(void)
{
	...
	//GC0329_write_cmos_sensor(0x42, 0xfc);
		GC0329_write_cmos_sensor(0x7a, 0x82);
	GC0329_write_cmos_sensor(0x7b, 0x7b);
		GC0329_write_cmos_sensor(0x7c, 0x81);
	////////////////////analog////////////////////
	GC0329_write_cmos_sensor(0x0a, 0x02);
	GC0329_write_cmos_sensor(0x0c, 0x02);

	GC0329_write_cmos_sensor(0x17, 0x14);//MIRROR
	...
	GC0329_write_cmos_sensor(0x24, 0x00);//16 07 3f
	...
	GC0329_write_cmos_sensor(0x46, 0x03);//02
	...
	GC0329_write_cmos_sensor(0xb3, 0x45);   //40
	GC0329_write_cmos_sensor(0xb4, 0xfa);//fd betty//f0
	GC0329_write_cmos_sensor(0xb5, 0x00);//02 betty
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x40);
	...
	GC0329_write_cmos_sensor(0xdd, 0x54);
		GC0329_write_cmos_sensor(0xd3, 0x3d);

	////////////////////AEC////////////////////
	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x10, 0x40);
	GC0329_write_cmos_sensor(0x11, 0x21);
	GC0329_write_cmos_sensor(0x12, 0x47);//07
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(5);//0:use default
...
/*
	...
	*/
    ...
    pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;//2 4 8
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x70:0x5c);
