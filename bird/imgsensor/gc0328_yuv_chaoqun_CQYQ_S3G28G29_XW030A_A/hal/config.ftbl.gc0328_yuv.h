...
FTABLE_SCENE_INDEP()
...
#endif
    //==========================================================================
#if 1 //def BIRD_MAIN_CAMERA_CFG_5M pyj
...
#elif defined(BIRD_MAIN_CAMERA_CFG_8M)
    //  Picture Size (Both width & height must be 16-aligned)
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_PICTURE_SIZE), 
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960", 
                "1600x1200",    "2048x1536",    "2560x1440",    "2560x1920",     "3264x2448",     "3840x2160",
            )
        ), 
    )
#elif defined(BIRD_MAIN_CAMERA_CFG_3M)
    //  Picture Size (Both width & height must be 16-aligned)
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_PICTURE_SIZE), 
        SCENE_AS_DEFAULT_SCENE(
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960",     "1408x1056",
				"1440x864",     "1440x960",     "1600x960",     "1600x1200",    "1840x1104"
            )
        ), 
    )
#endif
