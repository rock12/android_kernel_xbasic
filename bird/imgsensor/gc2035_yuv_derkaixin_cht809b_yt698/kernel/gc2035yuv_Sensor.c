 ...
 * Revision 1.3  2013/10/24 12:18:29  wangqiang
 * bug [97955]
 *
 * Revision 1.2  2013/10/09 11:53:15  wangqiang
 * modify for 13C45_YT698's awb, by liuxd.
 *
 * Revision 1.1  2013/08/12 03:58:03  wangqiang
 * no message
 *
 * Revision 1.1  2013/08/02 03:40:21  chenxiaolin
 * Editor: chenxiaolin
 * Inspector:chenxiaolin
 * Reason:
 * Reference:none
 *
 *
		...
		if (GC2035_sensor_cap_state == KAL_FALSE) 
		{
			if (enable) 
			{
				if (GC2035_VEDIO_encode_mode == KAL_TRUE) 
				{
					...
					GC2035_write_cmos_sensor(0x3e, 0x00);//60
					GC2035_write_cmos_sensor(0xfe, 0x00);
				}
				else 
				{
			...
			else 
			{
				...
				{
					GC2035_write_cmos_sensor(0xfe, 0x01);
					GC2035_write_cmos_sensor(0x3e, 0x00);//40
					GC2035_write_cmos_sensor(0xfe, 0x00);
				}
				else 
				{
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0x12);
#else
	GC2035_write_cmos_sensor(0x03 , 0x02);
...
*/
  ...
  GC2035_write_cmos_sensor(0xfe , 0x01);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x2e);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x2e);//saturation_Cr
