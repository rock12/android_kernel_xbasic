...
static void GC2035_Sensor_Init(void)
{
	...
	*/
	...
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast \D3//3b
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfe);//luma_offset 
	...
	GC2035_write_cmos_sensor(0x97 , 0x67);// edge effect 45 betty
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	/*GC2035_write_cmos_sensor(0xfe , 0x02);
