 ...
 * STANDARD OR OPEN FORUM. RECEIVER'S SOLE AND EX CLUSIVE REMEDY AND MEDIATEK'S ENTIRE AND  
 ...
 * Editor:sujian
 * Inspector:lanqilong
 * Reason:12Y36_H8 main camera D?━1?：????�ぁ�a：o3：|
 * Reference:none
 *
...
GC2035_write_cmos_sensor(0xfe , 0x01);
	...
	GC2035_write_cmos_sensor(0xd5 , 0xfb);//luma_offset 
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1a);//dn_b_base
