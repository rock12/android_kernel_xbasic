 ...
 * Revision 1.2  2013/09/16 06:05:54  wangqiang
 * modify for 13C35_K500, by liuxd.
 *
 * Revision 1.1  2013/07/15 13:55:24  wangqiang
 * no message
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x1b);
	GC0329_write_cmos_sensor(0x34, 0x1b);
	GC0329_write_cmos_sensor(0x35, 0x1b);
	GC0329_write_cmos_sensor(0x36, 0x1b);
	...
	GC0329_write_cmos_sensor(0x13, 0x52);
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  10fps
			GC0329_write_cmos_sensor(0x2c, 0x58); 
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  8.57fps
			GC0329_write_cmos_sensor(0x2e, 0x58); 
			GC0329_write_cmos_sensor(0x2f, 0x02);   //exp level 2  7.5fps
			GC0329_write_cmos_sensor(0x30, 0x58); 
			GC0329_write_cmos_sensor(0x31, 0x04);   //exp level 3  6.67fps
			GC0329_write_cmos_sensor(0x32, 0x10); 
			//24M
			/*GC0329_write_cmos_sensor(0x05, 0x02); 	
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y - 0x08);  // >08 dark <08 bright
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
