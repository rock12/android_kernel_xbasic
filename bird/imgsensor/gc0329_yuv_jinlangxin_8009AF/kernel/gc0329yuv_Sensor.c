...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x73, 0x88);//0x90 hyper
	...
	GC0329_write_cmos_sensor(0x04, 0xf0);
	...
	GC0329_write_cmos_sensor(0x2c, 0xd0); 
	...
	GC0329_write_cmos_sensor(0x28, 0x7f); // 20130819  lanking 
	...
	GC0329_SET_PAGE0;
#if 0
	GC0329_write_cmos_sensor(0xb3, 0x3e);
...
#else
	GC0329_write_cmos_sensor(0xb3 , 0x42);  //40   C11
	GC0329_write_cmos_sensor(0xb4 , 0xff);  //00   C12
	GC0329_write_cmos_sensor(0xb5 , 0x07);  //06   C13
	GC0329_write_cmos_sensor(0xb6 , 0xf0);  //00   C21
	GC0329_write_cmos_sensor(0xb7 , 0x42);  //40   C22
	GC0329_write_cmos_sensor(0xb8 , 0xf0);  //00   C23
#endif
	...
	GC0329_write_cmos_sensor(0x12, 0x27);
	...
	GC0329_write_cmos_sensor(0x67, 0x68);//0x70 hyper
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x67,0x78);																																																																									
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x06, 0x32); 
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x58);
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x06);
