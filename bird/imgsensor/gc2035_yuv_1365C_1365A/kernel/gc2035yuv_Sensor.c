...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x24 , 0x1f); //pad drive  16
  ...
  GC2035_write_cmos_sensor(0xfe , 0x00);  
		...
		GC2035_write_cmos_sensor(0x06 , 0x01);  
		GC2035_write_cmos_sensor(0x07 , 0x00);//  VB
		GC2035_write_cmos_sensor(0x08 , 0x62);  
		GC2035_write_cmos_sensor(0xfe , 0x01);  
		...
		GC2035_write_cmos_sensor(0x2a , 0xb4);  
		GC2035_write_cmos_sensor(0x2b , 0x06);//  level 1 13.75
		GC2035_write_cmos_sensor(0x2c , 0xd8);  
		GC2035_write_cmos_sensor(0x2d , 0x07);//  level 2 10
		GC2035_write_cmos_sensor(0x2e , 0x6a);  
		GC2035_write_cmos_sensor(0x2f , 0x09);//  level 3 7.5
	...
	GC2035_write_cmos_sensor(0x86 , 0xc2);//02 //sync plority  lanking 
	...
	GC2035_write_cmos_sensor(0xa7 , 0x40);
	GC2035_write_cmos_sensor(0xa8 , 0x77);
	GC2035_write_cmos_sensor(0xa9 , 0x73);
	GC2035_write_cmos_sensor(0xaa , 0x32);
	GC2035_write_cmos_sensor(0xab , 0x20);
	GC2035_write_cmos_sensor(0xac , 0x07);
	GC2035_write_cmos_sensor(0xad , 0x28);//40
	GC2035_write_cmos_sensor(0xae , 0x28);
	GC2035_write_cmos_sensor(0xaf , 0x28);
	GC2035_write_cmos_sensor(0xb0 , 0x24);//40
	GC2035_write_cmos_sensor(0xb1 , 0x36);
	GC2035_write_cmos_sensor(0xb2 , 0x39);
	GC2035_write_cmos_sensor(0xb3 , 0x38);//40
	...
	GC2035_write_cmos_sensor(0xb8 , 0x40);
	GC2035_write_cmos_sensor(0xb9 , 0x40);
	GC2035_write_cmos_sensor(0xba , 0x2c);
	GC2035_write_cmos_sensor(0xbb , 0x10);
	GC2035_write_cmos_sensor(0xbc , 0x40);
	GC2035_write_cmos_sensor(0xbd , 0x38);//40
	GC2035_write_cmos_sensor(0xbe , 0x40);
	GC2035_write_cmos_sensor(0xbf , 0x40);
	GC2035_write_cmos_sensor(0xc0 , 0x34);//36
	GC2035_write_cmos_sensor(0xc1 , 0x3c);
	GC2035_write_cmos_sensor(0xc2 , 0x2c);
	GC2035_write_cmos_sensor(0xc3 , 0x1e);//23
	GC2035_write_cmos_sensor(0xc4 , 0x24);
	GC2035_write_cmos_sensor(0xc5 , 0x08);
	GC2035_write_cmos_sensor(0xc6 , 0x1c);
	GC2035_write_cmos_sensor(0xc7 , 0x11);
	GC2035_write_cmos_sensor(0xc8 , 0x34);//38
	GC2035_write_cmos_sensor(0xc9 , 0x3a);
	GC2035_write_cmos_sensor(0xca , 0x30);
	GC2035_write_cmos_sensor(0xcb , 0x2c);
	GC2035_write_cmos_sensor(0xcc , 0x02);
	GC2035_write_cmos_sensor(0xcd , 0x08);
	GC2035_write_cmos_sensor(0xd0 , 0x3f);
	GC2035_write_cmos_sensor(0xd2 , 0x36);
	GC2035_write_cmos_sensor(0xd3 , 0x02);
	GC2035_write_cmos_sensor(0xd4 , 0x3f);
	GC2035_write_cmos_sensor(0xd6 , 0x3f);
	GC2035_write_cmos_sensor(0xd7 , 0x35);
	GC2035_write_cmos_sensor(0xd8 , 0x08);//12
	GC2035_write_cmos_sensor(0xda , 0x3f);
	GC2035_write_cmos_sensor(0xdb , 0x3f);
	GC2035_write_cmos_sensor(0xdc , 0x24);//40
...
*/
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x36);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x36);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3a);//contrast	
