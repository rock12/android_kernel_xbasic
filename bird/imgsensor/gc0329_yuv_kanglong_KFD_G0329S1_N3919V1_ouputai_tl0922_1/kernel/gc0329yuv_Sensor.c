 ...
 * Revision 1.2  2013/10/19 01:10:59  lijunchao
 * Tuning_proformance
 *
 * Revision 1.1  2013/09/12 07:35:48  zhoushaohong
 * S100A
 *
 * Revision 1.1  2013/07/19 02:53:09  zhoushaohong
 * 13C43-BT45B
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x24);//20
	GC0329_write_cmos_sensor(0x34, 0x24);//20
	...
	GC0329_write_cmos_sensor(0xb5, 0x07);//02
	...
	GC0329_write_cmos_sensor(0xd3, 0x3a);//3c 0x43
  ...
  GC0329_write_cmos_sensor(0x05, 0x00); 	
	...
	GC0329_write_cmos_sensor(0x54, 0x48);//40
	...
	GC0329_write_cmos_sensor(0x5d, 0x13);//73
	...
	GC0329_write_cmos_sensor(0x7b, 0x76);
	GC0329_write_cmos_sensor(0x7c, 0x80);
	GC0329_SET_PAGE1;
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x5d,0x12);	//72																																																																								
	GC0329_write_cmos_sensor(0x67,0x7d);//80																																																																									
	...
	GC0329_write_cmos_sensor(0xd1,0x26);//0x30																																																																									
	GC0329_write_cmos_sensor(0xd2,0x26);//0x30																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(1);//0:use default
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n03:
			GC0329_write_cmos_sensor(0xd5, value_luma - 0x18);
			GC0329_write_cmos_sensor(0xfe, 0x01);
		...
		case AE_EV_COMP_00:
			GC0329_write_cmos_sensor(0xd5, value_luma);//- 0x12
			GC0329_write_cmos_sensor(0xfe, 0x01);
