 ...
 * Revision 1.1  2013/09/18 01:39:50  wangdong
 * no message
 *
 * Revision 1.3  2013/08/21 10:36:12  wangqiang
 * 13C43_3471
 * 效果优化
 *
 * Revision 1.1  2013/08/15 14:10:30  pengyajun
 * 3471
 *
 * Revision 1.4  2013/08/07 10:40:30  wangqiang
 * 13C35_3203_4P2
 * 效果优化
 *
 * Revision 1.3  2013/07/16 12:13:23  shenruxuan
 * no message
 *
 * Revision 1.2  2013/07/16 01:42:02  zhoushaohong
 * 3203 优化
 *
 * Revision 1.1  2013/06/09 04:07:15  wangqiang
 * no message
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x73, 0x8c);//90
	...
	GC0329_write_cmos_sensor(0x77, 0x63);
	...
	GC0329_write_cmos_sensor(0x82, 0x4f); 
	...
	GC0329_write_cmos_sensor(0xb3, 0x3d);///////44  42
	GC0329_write_cmos_sensor(0xb4, 0xfe);//fd
	GC0329_write_cmos_sensor(0xb5, 0x05);///////2
	GC0329_write_cmos_sensor(0xb6, 0xf8);///////fa
	GC0329_write_cmos_sensor(0xb7, 0x3f);/////48  45
	...
	GC0329_write_cmos_sensor(0x12, 0x27);//07
	...
	GC0329_write_cmos_sensor(0x3e, 0x48); 
			...
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps/////300
			GC0329_write_cmos_sensor(0x2e, 0xd0); 
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps/////3c0
			GC0329_write_cmos_sensor(0x30, 0x48); 
			GC0329_write_cmos_sensor(0x31, 0x04);   //exp level 3  7.14fps  ////540
	...
	////////////////////ABS////////////////////
	GC0329_write_cmos_sensor(0x9c, 0x00); ///////2
	...
	//GC0329_write_cmos_sensor(0x7a, 0x00);
	//GC0329_write_cmos_sensor(0x7b, 0x00);
	//GC0329_write_cmos_sensor(0x7c, 0x00);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x67,0x6c);	//80																																																																								
	GC0329_write_cmos_sensor(0x68,0x58);	//60																																																																								
	GC0329_write_cmos_sensor(0x69,0x85);	//90																																																																								
...
/*
	...
	*/
    ...
    pSensorInfo->PreviewDelayFrame = 3;// 0
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x70:0x64);//54
