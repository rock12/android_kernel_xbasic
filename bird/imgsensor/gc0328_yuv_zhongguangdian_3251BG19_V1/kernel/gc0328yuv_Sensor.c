...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x03 , 0x01);
	GC0328_write_cmos_sensor(0x04 , 0x2c);
	...
	GC0328_write_cmos_sensor(0x2e, 0x94); 
	GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  10.00fps/////3c0
	GC0328_write_cmos_sensor(0x30, 0xd0); 
	GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  7.14fps  ////540
	GC0328_write_cmos_sensor(0x32, 0xfc); 
	GC0328_write_cmos_sensor(0xfe , 0x00);//
	...
	GC0328_write_cmos_sensor(0x41 , 0x26);   // 26
	GC0328_write_cmos_sensor(0x42 , 0xfb); ///ff
	...
	GC0328_write_cmos_sensor(0x95 , 0x34);//35
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x35);     /////32
	GC0328_write_cmos_sensor(0xd2 , 0x35);  /////32
	GC0328_write_cmos_sensor(0xd3 , 0x3a);//////3c
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 0  10.00fps
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xfe);
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x6e);// 80   /////5c//64
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
