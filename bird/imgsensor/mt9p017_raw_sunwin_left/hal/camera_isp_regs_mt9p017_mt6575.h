...
EE:{// EE
    ...
    {set:{//05 Capture ISO100 (middle sharpness)
        0x00000008, 0x0032322D, 0x00320123, 0x0320183C, 0x0190F864, 0x003CFEDC, 0xFFFFFF0B, 
    }},
    ...
    {set:{//08 Capture ISO800 (middle sharpness)
        0x00000008, 0x0032322D, 0x00140123, 0x01F4183C, 0x00FAF864, 0x001EFEDC, 0xFFFFFF0B, 
    }},
    {set:{//09 Capture ISO1600 (middle sharpness)
        0x00000008, 0x0032322D, 0x00140123, 0x012C183C, 0x00C8F864, 0x0014FEDC, 0xFFFFFF0B, 
    }},
...
Saturation:{
    {set:{//00 (middle saturation)
        0x00000709, 0x1020E0F0, 0x284A4C4A, 0x2A000000, 0xFF00FF00, 0x00000000, 0x00000000, 0x001E140A, 
    }},
    ...
    {set:{//02 (middle saturation)
        0x00000708, 0x1020E0F0, 0x1E3A3C3A, 0x20000000, 0xFF00FF00, 0x00000000, 0x00000000, 0x001E140A, 
    }},
    {set:{//03 (middle saturation)
        0x00000709, 0x1020E0F0, 0x1C2E2E2E, 0x1C000000, 0xFF00FF00, 0x00000000, 0x00000000, 0x001E140A, 
    }},
...
CCM:{
    {set:{//00
  0x01900478, 0x04180448, 0x01400008, 0x04280430, 0x01580000, 
    }},
    {set:{//01
        0x0026F058C, 0x001D042D, 0x0123000A, 0x000C0475, 0x01690000, 
    }},
    {set:{//02
        0x023B0562, 0x00270425, 0x010B001A, 0x000B046F, 0x01640000, 
    }}
            },
Gamma:{
    {set:{//00
        0x42261309, 0x897D6D59, 0xBFB1A095, 0xE6DFD3CB, 0xFFFEF8F2, 
    }}
}
