 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: mt9p017_CameraCustomized.h,v $
 * Revision 1.1  2013/05/23 03:38:32  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.1  2013/02/23 02:34:26  zhuyaozhong
 * Create 6589 12U25 project
 *
 * Revision 1.1  2012/12/10 05:51:12  birdlibo
 * no message
 *
 * 
 * 09 12 2012 wcpadmin
