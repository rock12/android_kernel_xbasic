...
HM5065MIPI_write_cmos_sensor(0x0143,0x60);//5f->60 by jink 20130930
HM5065MIPI_write_cmos_sensor(0x0144,0x0D);//
...
HM5065MIPI_write_cmos_sensor(0x0357,0x39);//  PeakingControl fUserPeakLoThresh 19->39 by jink 20130930
