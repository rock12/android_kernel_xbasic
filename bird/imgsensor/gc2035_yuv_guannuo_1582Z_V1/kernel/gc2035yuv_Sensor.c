 ...
 * Revision 1.2  2013/07/26 01:28:25  wangqiang
 * 13E56_S9500_FWVGA_SOJA
 * 2035”≈ªØ
 *
 * Revision 1.1  2013/07/02 01:36:44  wangqiang
 * 13E56-S9500–ßπ˚”≈ªØ
 *
 *
 * [GC2035YUV V1.0.0]
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x03 , 0x02);//2da betty
	...
	GC2035_write_cmos_sensor(0x13 , 0x60);//y_target  75  0719
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	/*  GC2035_write_cmos_sensor(0xfe, 0x00);  
	  ...
	  GC2035_write_cmos_sensor(0xfe, 0x00);  
		...
		GC2035_write_cmos_sensor(0x2d, 0x07);//6a7 7.14fps
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x3b);//saturation_cb 38  0719
	GC2035_write_cmos_sensor(0xd2 , 0x3b);//saturation_Cr
	...
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight  02 0719
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x34);// edge effect  45  0719
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->CaptureDelayFrame = 0; //4  0719
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2b, 0x06);//
		GC2035_write_cmos_sensor(0x2c, 0x24);  
		GC2035_write_cmos_sensor(0x2d, 0x06);//6a7 7.69fps
