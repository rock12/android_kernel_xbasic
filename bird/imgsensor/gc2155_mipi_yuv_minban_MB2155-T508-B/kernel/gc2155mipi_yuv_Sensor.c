...
static void GC2155MIPI_Sensor_Init(void)
{
	...
	GC2155MIPI_write_cmos_sensor(0x82 , 0xfe); //fa-hms abs enable
	...
	////////////////////////////////////////
	GC2155MIPI_write_cmos_sensor(0xfe , 0x01);
	GC2155MIPI_write_cmos_sensor(0x9c , 0x02);
	...
	//hms++
	GC2155MIPI_write_cmos_sensor(0x0e , 0xe0);
	GC2155MIPI_write_cmos_sensor(0x0f , 0x25);	
	//hms--
	
	GC2155MIPI_write_cmos_sensor(0x13 , 0x30);// 0x2a  20140617 
	...
	GC2155MIPI_write_cmos_sensor(0x82 , 0x08);
	GC2155MIPI_write_cmos_sensor(0x83 , 0x0b);
	...
	****************************************/
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2155MIPI_write_cmos_sensor(0x10 , 0x06);
	GC2155MIPI_write_cmos_sensor(0x11 , 0x0d);
	GC2155MIPI_write_cmos_sensor(0x12 , 0x15);
	GC2155MIPI_write_cmos_sensor(0x13 , 0x1b);
	GC2155MIPI_write_cmos_sensor(0x14 , 0x2a);
	GC2155MIPI_write_cmos_sensor(0x15 , 0x38);
	GC2155MIPI_write_cmos_sensor(0x16 , 0x48);
	GC2155MIPI_write_cmos_sensor(0x17 , 0x55);
	GC2155MIPI_write_cmos_sensor(0x18 , 0x6b);
	GC2155MIPI_write_cmos_sensor(0x19 , 0x7e);
	GC2155MIPI_write_cmos_sensor(0x1a , 0x92);
	GC2155MIPI_write_cmos_sensor(0x1b , 0xa3);
	GC2155MIPI_write_cmos_sensor(0x1c , 0xaf);
	GC2155MIPI_write_cmos_sensor(0x1d , 0xc5);
	GC2155MIPI_write_cmos_sensor(0x1e , 0xd5);
	GC2155MIPI_write_cmos_sensor(0x1f , 0xe0);
	GC2155MIPI_write_cmos_sensor(0x20 , 0xe7);
	GC2155MIPI_write_cmos_sensor(0x21 , 0xee);
	GC2155MIPI_write_cmos_sensor(0x22 , 0xf1);
	...
	/////////////////////////////////////////////// 
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2155MIPI_write_cmos_sensor(0xd1 , 0x2b);
	GC2155MIPI_write_cmos_sensor(0xd2 , 0x2b);
	GC2155MIPI_write_cmos_sensor(0xd3 , 0x44);
	GC2155MIPI_write_cmos_sensor(0xd5 , 0xfb);
	...
	GC2155MIPI_write_cmos_sensor(0xc1 , 0x43);
	...
	GC2155MIPI_write_cmos_sensor(0x2c , 0xca); //12fps
...
BOOL GC2155MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2155MIPI_write_cmos_sensor(0x2b , 0x08); 
		GC2155MIPI_write_cmos_sensor(0x2c , 0x20); //10fps 
		GC2155MIPI_write_cmos_sensor(0x2d , 0x0b); 
