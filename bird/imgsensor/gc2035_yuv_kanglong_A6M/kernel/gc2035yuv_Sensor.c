 ...
 * Revision 1.1  2013/08/30 05:42:32  wangtinglong
 * 13C43 A6M
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	*/
		...
		GC2035_write_cmos_sensor(0x29, 0x06);//
		GC2035_write_cmos_sensor(0x2a, 0x24);  
		GC2035_write_cmos_sensor(0x2b, 0x06);//   624//6a7
		GC2035_write_cmos_sensor(0x2c, 0x24);  
		GC2035_write_cmos_sensor(0x2d, 0x06);//5b4 betty   72a
		GC2035_write_cmos_sensor(0x2e, 0x24);  
		GC2035_write_cmos_sensor(0x2f, 0x08);//76a betty
	...
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast \D3
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_4MA;// ISP_DRIVING_8MA	0626
...
BOOL GC2035_set_param_banding(UINT16 para)
{
	...
	/*	GC2035_write_cmos_sensor(0xfe, 0x00);  
		...
		GC2035_write_cmos_sensor(0x06, 0xf2);  
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x74);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x94);  
		GC2035_write_cmos_sensor(0x29, 0x05);//
		GC2035_write_cmos_sensor(0x2a, 0x34);  
		GC2035_write_cmos_sensor(0x2b, 0x05);//   624//6a7
		GC2035_write_cmos_sensor(0x2c, 0x34);  
		GC2035_write_cmos_sensor(0x2d, 0x05);//5b4 betty   72a
		GC2035_write_cmos_sensor(0x2e, 0x34);  
		GC2035_write_cmos_sensor(0x2f, 0x05);//76a betty
		GC2035_write_cmos_sensor(0x30, 0x34);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  */
    GC2035_write_cmos_sensor(0xfe, 0x00);  
		GC2035_write_cmos_sensor(0x05, 0x01);//
		GC2035_write_cmos_sensor(0x06, 0x25);  
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x75);////modey 2
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
