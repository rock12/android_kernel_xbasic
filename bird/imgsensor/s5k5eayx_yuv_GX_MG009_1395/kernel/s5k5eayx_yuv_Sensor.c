...
//WRITE     #ash_bUseGasAlphaOTP         0000         //
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);          //wbt_bUseOutdoorASH   
...
// GAS Alpha Table    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3600);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3B00);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3B00);
...
//AE Target    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0038);  //42  
...
//AE Concept     
	...
	S5K5EAYX_write_cmos_sensor(0x002A, 0x0858);    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3520); 
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x3880);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x3520); 
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x3880);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0470); 
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0800);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x0100);
	S5K5EAYX_write_cmos_sensor(0x0F12, 0x1000);
...
// Lei Control    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000A);    //lt_uMaxLei
...
//         param_start    awbb_IndoorGrZones_m_BGrid     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0C00);    // 70003CD2 
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0324);    //awbb_IndoorGrZones_m_BGrid[0]    0432
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03B8);    //awbb_IndoorGrZones_m_BGrid[1]    044A
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02E8);    //awbb_IndoorGrZones_m_BGrid[2]    0432
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03E0);    //awbb_IndoorGrZones_m_BGrid[3]    0418
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02BA);    //awbb_IndoorGrZones_m_BGrid[4]    03FC
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03F6);    //awbb_IndoorGrZones_m_BGrid[5]    03D6
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02A0);    //awbb_IndoorGrZones_m_BGrid[6]    036E
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03DC);    //awbb_IndoorGrZones_m_BGrid[7]    034C
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x028E);    //awbb_IndoorGrZones_m_BGrid[8]    0308
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03C4);    //awbb_IndoorGrZones_m_BGrid[9]    02EA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x027A);    //awbb_IndoorGrZones_m_BGrid[10]   02E0
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03A6);    //awbb_IndoorGrZones_m_BGrid[11]   02CA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0262);    //awbb_IndoorGrZones_m_BGrid[12]   02C0
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0382);    //awbb_IndoorGrZones_m_BGrid[13]   02B0
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0250);    //awbb_IndoorGrZones_m_BGrid[14]   029E
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0318);    //awbb_IndoorGrZones_m_BGrid[15]   0286
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0236);    //awbb_IndoorGrZones_m_BGrid[16]   026A
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02F4);    //awbb_IndoorGrZones_m_BGrid[17]   0250
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0212);    //awbb_IndoorGrZones_m_BGrid[18]   023E
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02AC);    //awbb_IndoorGrZones_m_BGrid[19]   0232
...
//==================================================================================
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00E0); //B0   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00F0);    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0100);    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0120);    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0150);    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF33);   //TVAR_wbt_pBaseCcms[39]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C0);   //TVAR_wbt_pBaseCcms[40]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF3F);   //TVAR_wbt_pBaseCcms[41]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000F);   //TVAR_wbt_pBaseCcms[42]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFFB);   //TVAR_wbt_pBaseCcms[43]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C4);   //TVAR_wbt_pBaseCcms[44]       
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01EA);   //TVAR_wbt_pBaseCcms[48]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7B);   //TVAR_wbt_pBaseCcms[49]       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B1);   //TVAR_wbt_pBaseCcms[50]       
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0204);    //TVAR_wbt_pBaseCcms[72] // CW  
...
//Tune//5EA //FPGA    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B0);    
...
//         AFIT 0      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x2F0F);  //AFIT8_Dspcl_edge_low [7:0] AFIT8_Dspcl_edge_high [15:8]                                              
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x407C);  //AFIT8_EE_iFSmagPosPwrLow [7:0] AFIT8_EE_iFSmagPosPwrHigh [15:8]                                      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0F10);  //AFIT8_EE_iReduceNoiseRatio [7:0] AFIT8_EE_iFlatSpan [15:8]                                           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8088);  //AFIT8_EE_iMSharpenLow [7:0] AFIT8_EE_iMSharpenHigh [15:8]                                            
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x587C);  //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0E00);  //AFIT8_Postdmsc_NoisePower_Low [7:0] AFIT8_Postdmsc_NoisePower_High [15:8]                            
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5001);  //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                       
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0160);  //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6070);  //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]                       

//         AFIT 1     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_CONTRAST                                                                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0020);    //AFIT16_SATURATION                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0E10);    //AFIT8_EE_iReduceNoiseRatio [7:0] AFIT8_EE_iFlatSpan [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8488);    //AFIT8_EE_iMSharpenLow [7:0] AFIT8_EE_iMSharpenHigh [15:8]                                           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x183C);    //AFIT8_EE_iFlatMean [7:0] AFIT8_EE_iFlatOffset [15:8]                                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_EE_iMShThLow [7:0] AFIT8_EE_iMShThHigh [15:8]                                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0406);    //AFIT8_EE_iMShDirThLow [7:0] AFIT8_EE_iMShDirThHigh [15:8]                                           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0608);    //AFIT8_EE_iMShVLowPwr [7:0] AFIT8_EE_iMShVLowThrld [15:8]                                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x547C);    //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x180C);    //AFIT8_EE_iWSharpenNegLow [7:0] AFIT8_EE_iWSharpenNegHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0204);    //AFIT8_EE_iWShThLow [7:0] AFIT8_EE_iWShThHigh [15:8]                                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x040C);    //AFIT8_EE_iWShVLowPwr [7:0] AFIT8_EE_iWShVLowThrld [15:8]                                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5A00);    //AFIT8_EE_iReduceNegative [7:0] AFIT8_EE_iRadialLimitSh [15:8]                                       
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0E02);    //AFIT8_Postdmsc_NoisePower_Low [7:0] AFIT8_Postdmsc_NoisePower_High [15:8]                           
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8020);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6001);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0160);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6080);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]                               
...
//AFIT 2    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0E10);    //AFIT8_EE_iReduceNoiseRatio [7:0] AFIT8_EE_iFlatSpan [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x888C);    //AFIT8_EE_iMSharpenLow [7:0] AFIT8_EE_iMSharpenHigh [15:8]                                           
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5480);    //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1E10);    //AFIT8_Postdmsc_iBCoeff [7:0] AFIT8_Postdmsc_iGCoeff [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1C0B);    //AFIT8_Postdmsc_iWideMult [7:0] AFIT8_Postdmsc_iTune [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0F04);    //AFIT8_Postdmsc_NoisePower_Low [7:0] AFIT8_Postdmsc_NoisePower_High [15:8]                           
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8020);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6601);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0175);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6686);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]
 ...
 //AFIT 3    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0406);    //AFIT8_EE_iMShDirThLow [7:0] AFIT8_EE_iMShDirThHigh [15:8]                                           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0608);    //AFIT8_EE_iMShVLowPwr [7:0] AFIT8_EE_iMShVLowThrld [15:8]                                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5887);    //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x2010);    //AFIT8_EE_iWSharpenNegLow [7:0] AFIT8_EE_iWSharpenNegHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0204);    //AFIT8_EE_iWShThLow [7:0] AFIT8_EE_iWShThHigh [15:8]                                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x040C);    //AFIT8_EE_iWShVLowPwr [7:0] AFIT8_EE_iWShVLowThrld [15:8]                                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5A00);    //AFIT8_EE_iReduceNegative [7:0] AFIT8_EE_iRadialLimitSh [15:8]                                       
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x7E01);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0183);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6D8A);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]
  ...
  //AFIT 4    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0C0C);    //AFIT8_Dspcl_iVarianceMultThresh_C [7:0] AFIT8_Dspcl_iVariancePlainMax_C [15:8]                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3010);    //AFIT8_Dspcl_iVarianceLimitMax_C [7:0] AFIT8_EE_iShVLowRegion [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x487C);    //AFIT8_EE_iFSmagPosPwrLow [7:0] AFIT8_EE_iFSmagPosPwrHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1810);    //AFIT8_EE_iFSmagNegPwrLow [7:0] AFIT8_EE_iFSmagNegPwrHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_EE_iFSThLow [7:0] AFIT8_EE_iFSThHigh [15:8]                                                   
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0E0C);    //AFIT8_EE_iReduceNoiseRatio [7:0] AFIT8_EE_iFlatSpan [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8E94);    //AFIT8_EE_iMSharpenLow [7:0] AFIT8_EE_iMSharpenHigh [15:8]                                           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0101);    //AFIT8_EE_iFlatMean [7:0] AFIT8_EE_iFlatOffset [15:8]                                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_EE_iMShThLow [7:0] AFIT8_EE_iMShThHigh [15:8]                                                 
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x6693);    //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1E10);    //AFIT8_Postdmsc_iBCoeff [7:0] AFIT8_Postdmsc_iGCoeff [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1C0B);    //AFIT8_Postdmsc_iWideMult [7:0] AFIT8_Postdmsc_iTune [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1108);    //AFIT8_Postdmsc_NoisePower_Low [7:0] AFIT8_Postdmsc_NoisePower_High [15:8]                           
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x802E);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8801);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0194);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x7790);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]
...
//==================================================================================  
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0002);   //0: Dynamic 1: BEST FrameRate(Binning), 2: BEST QUALITY(No Binning)          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0535);   //REG_0TC_PCFG_usMaxFrTimeMsecMult10 10fps                                    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);   //REG_0TC_PCFG_usMinFrTimeMsecMult10 30fps                                  
   ...
   //S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);   //REG_0TC_PCFG_PVIMask //mipi clk change LP from HS
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);  //30fps                                                                    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000); //REG_2TC_PCFG_usMinFrTimeMsecMult10 30fps                               
   ...
   //S5K5EAYX_write_cmos_sensor(0x0F12, 0x0340);  //REG_0TC_CCFG_usMinFrTimeMsecMult10 15fps                                                               
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);  //REG_0TC_CCFG_usMinFrTimeMsecMult10 15fps                                                               
   ...
   //S5K5EAYX_write_cmos_sensor(0x0F12, 0x0340); //REG_1TC_CCFG_usMinFrTimeMsecMult10 15fps                                                             
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000); //REG_1TC_CCFG_usMinFrTimeMsecMult10 15fps                                                             
...
BOOL S5K5EAYX_set_param_wb(UINT16 para)
{
   ...
   {            
            ...
            case AWB_MODE_CLOUDY_DAYLIGHT:
                     ...
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0585); //Reg_sf_user_Rgain
                     ...
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x04EB); //0460Reg_sf_user_Bgain
            ...
            case AWB_MODE_DAYLIGHT:
                {
                     ...
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0777);
                     S5K5EAYX_write_cmos_sensor(0x002A, 0x04F6); 
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0500); //05E0Reg_sf_user_Rgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_RgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400); //0400Reg_sf_user_Ggain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_GgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x067A); //0530Reg_sf_user_Bgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_BgainChanged
            }      
                break;
            case AWB_MODE_INCANDESCENT:       
                {
                     ...
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0777);
                     S5K5EAYX_write_cmos_sensor(0x002A, 0x04F6); 
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0447); //0575Reg_sf_user_Rgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_RgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400); //0400Reg_sf_user_Ggain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_GgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x07D7); //0800Reg_sf_user_Bgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_BgainChanged
            }                 
                break;  
            case AWB_MODE_FLUORESCENT:
                {
                     ...
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0777);
                     S5K5EAYX_write_cmos_sensor(0x002A, 0x04F6); 
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400); //0400Reg_sf_user_Rgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_RgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x047A); //0400Reg_sf_user_Ggain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_GgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0A47); //Reg_sf_user_Bgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_BgainChanged
            }        
                break;  
            case AWB_MODE_TUNGSTEN:
                {
                     ...
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400); //0400Reg_sf_user_Rgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_RgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x051E); //0400Reg_sf_user_Ggain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_GgainChanged
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0D0A); //Reg_sf_user_Bgain
                     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_BgainChanged
            }        
                break;                         
            default:
