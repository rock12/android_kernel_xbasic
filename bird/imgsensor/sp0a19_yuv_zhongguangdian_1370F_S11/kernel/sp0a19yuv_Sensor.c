...
//SP0A19 ini
    ...
    SP0A19_write_cmos_sensor(0x58,0x0a); //raw_dif_thr_normal
    SP0A19_write_cmos_sensor(0x56,0x14); //raw_dif_thr_dummy
    SP0A19_write_cmos_sensor(0x59,0x1c); //raw_dif_thr_lowlight
    //GrGb
    SP0A19_write_cmos_sensor(0x89,0x06); //raw_grgb_thr_outdoor
    SP0A19_write_cmos_sensor(0x8a,0x0a); //raw_grgb_thr_normal
    SP0A19_write_cmos_sensor(0x9c,0x14); //raw_grgb_thr_dummy
    SP0A19_write_cmos_sensor(0x9d,0x1c); //raw_grgb_thr_lowlight
    //Gr\Gb
...
#if 1//lj_test
    SP0A19_write_cmos_sensor(0xe8,0x24);  //sharp_fac_pos_outdoor  // 0x35
    SP0A19_write_cmos_sensor(0xec,0x30);  //sharp_fac_neg_outdoor
    SP0A19_write_cmos_sensor(0xe9,0x24);  //sharp_fac_pos_nr	  // 0x35
    SP0A19_write_cmos_sensor(0xed,0x30);  //sharp_fac_neg_nr
    SP0A19_write_cmos_sensor(0xea,0x15);  //sharp_fac_pos_dummy   // 0x30
    SP0A19_write_cmos_sensor(0xef,0x1c);  //sharp_fac_neg_dummy   // 0x20
    ...
    //lowlight lum
    SP0A19_write_cmos_sensor(0xfd,0x00); //
    SP0A19_write_cmos_sensor(0xb2,0x10); //lum_limit  // 0x10
    ...
    SP0A19_write_cmos_sensor(0xd6,0x68); //0x78 	   (0xd7,0x60); //0x78  //lj_test 0x70
    SP0A19_write_cmos_sensor(0xd7,0x58); //lj_test 0x60
