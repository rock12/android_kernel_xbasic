 ...
 * Revision 1.3  2013/08/20 03:16:35  wangqiang
 * 13C43_H84_3P红绿线问题。
 * 修改点说明：
 * 1.降频并配置anti-flicker相应的参数；
 * 2.降低平台驱动能力。
 * 限制：预览帧率最大只能达到8fps左右。
 *
 * Revision 1.2  2013/08/03 07:23:35  zhoushaohong
 * H84 效果优化
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0x8f);// 0x02da	0626//28f
	...
	GC2035_write_cmos_sensor(0xad , 0x81); //7d betty
	GC2035_write_cmos_sensor(0xae , 0x82);//80
	GC2035_write_cmos_sensor(0xaf , 0x80);//82
	...
	*/
	...
	GC2035_write_cmos_sensor(0x2d, 0x05);//
	GC2035_write_cmos_sensor(0x2e, 0x62);  
	GC2035_write_cmos_sensor(0x2f, 0x05);//
	GC2035_write_cmos_sensor(0x30, 0x62);  
	GC2035_write_cmos_sensor(0xfe, 0x00);  
#else
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	GC2035_write_cmos_sensor(0x05, 0x01);//
	...
	GC2035_write_cmos_sensor(0x2c, 0xa1);  
	GC2035_write_cmos_sensor(0x2d, 0x06);//5b4 betty   72a
	GC2035_write_cmos_sensor(0x2e, 0x24);  
	GC2035_write_cmos_sensor(0x2f, 0x0a);//76a betty
	...
	GC2035_write_cmos_sensor(0xc3 , 0x14);
	GC2035_write_cmos_sensor(0xc4 , 0x10);
	GC2035_write_cmos_sensor(0xc8 , 0x1a);
	GC2035_write_cmos_sensor(0xc9 , 0x15);
	GC2035_write_cmos_sensor(0xca , 0x10);
	GC2035_write_cmos_sensor(0xbc , 0x38);
	GC2035_write_cmos_sensor(0xbd , 0x1e);
	GC2035_write_cmos_sensor(0xbe , 0x1a);
	GC2035_write_cmos_sensor(0xb6 , 0x42);
	...
	GC2035_write_cmos_sensor(0xc0 , 0x03);
	GC2035_write_cmos_sensor(0xc1 , 0x00);
	GC2035_write_cmos_sensor(0xb9 , 0x16);
	GC2035_write_cmos_sensor(0xba , 0x00);
	GC2035_write_cmos_sensor(0xbb , 0x00);
	GC2035_write_cmos_sensor(0xaa , 0x09);
	GC2035_write_cmos_sensor(0xab , 0x0b);
	GC2035_write_cmos_sensor(0xac , 0x0f);
	GC2035_write_cmos_sensor(0xad , 0x03);
	GC2035_write_cmos_sensor(0xae , 0x0b);
	GC2035_write_cmos_sensor(0xaf , 0x0f);
	GC2035_write_cmos_sensor(0xb0 , 0x00);
	GC2035_write_cmos_sensor(0xb1 , 0x05);
	GC2035_write_cmos_sensor(0xb2 , 0x05);
	GC2035_write_cmos_sensor(0xb3 , 0x03);
	GC2035_write_cmos_sensor(0xb4 , 0x04);
	GC2035_write_cmos_sensor(0xb5 , 0x07);
	GC2035_write_cmos_sensor(0xd0 , 0x09);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x08);
	GC2035_write_cmos_sensor(0xd8 , 0x00);
	GC2035_write_cmos_sensor(0xda , 0x00);
	...
	GC2035_write_cmos_sensor(0xc0 , 0x01);// auto cc mode
	...
	GC2035_write_cmos_sensor(0xc9 , 0x00);//06 betty
	GC2035_write_cmos_sensor(0xca , 0xfd);
	GC2035_write_cmos_sensor(0xcb , 0x3e);
	GC2035_write_cmos_sensor(0xcc , 0xf3);
	GC2035_write_cmos_sensor(0xcd , 0x32);//for A 36 betty
	GC2035_write_cmos_sensor(0xce , 0xf6);
	GC2035_write_cmos_sensor(0xcf , 0x00);//04 betty
	GC2035_write_cmos_sensor(0xe3 , 0x0c);
	GC2035_write_cmos_sensor(0xe4 , 0x40);//44 betty
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x2d);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x2d);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3a);//contrast \D3
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfd);//luma_offset // 0x00	0626
	...
	GC2035_write_cmos_sensor(0x89 , 0x02); //dn_c_weight // 0x02  01
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x65);// edge effect 45 betty// 0x54	0626//44
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
#if 1///def 	BIRD_GC2035_HV_MIRROR
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;// ISP_DRIVING_8MA	0626
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0xfe, 0x00);  
		GC2035_write_cmos_sensor(0x05, 0x01);//
		GC2035_write_cmos_sensor(0x06, 0xae);  
		GC2035_write_cmos_sensor(0x07, 0x00);//
		GC2035_write_cmos_sensor(0x08, 0x7e);  
		GC2035_write_cmos_sensor(0xfe, 0x01);  
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x4e);  
		GC2035_write_cmos_sensor(0x29, 0x02);//
		GC2035_write_cmos_sensor(0x2a, 0x70);  
		GC2035_write_cmos_sensor(0x2b, 0x02);//
		GC2035_write_cmos_sensor(0x2c, 0x70);  
		GC2035_write_cmos_sensor(0x2d, 0x02);//
		GC2035_write_cmos_sensor(0x2e, 0x70);  
		GC2035_write_cmos_sensor(0x2f, 0x02);//
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x88);////modey 2
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
