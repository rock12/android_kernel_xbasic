 ...
 * Revision 1.1  2013/09/18 01:36:30  wangdong
 * no message
 *
 * Revision 1.3  2013/08/21 10:33:54  wangqiang
 * 13C43_3471
 * 效果优化
 *
 * Revision 1.1  2013/08/15 13:54:48  pengyajun
 * 3471
 *
 * Revision 1.1  2013/08/12 09:29:06  chenchuanbao
 * Editor: chenchuanbao
 * Inspector:chenchuanbao
 * Reason:13C43_S26E
 * Reference:none
 *
 * Revision 1.6  2013/07/17 01:46:02  zhoushaohong
 * H84
 *
 * Revision 1.5  2013/07/08 02:41:40  zhoushaohong
 * H84 效果优化
 *
 * Revision 1.4  2013/06/27 08:56:01  wangtinglong
 * 13E43 H84 camera
 *
 * Revision 1.3  2013/06/25 05:33:11  maliejun
 * 刚进入时绿屏问题
 *
 * Revision 1.2  2013/06/07 05:56:13  wangtinglong
 * 13E43 GC0328
 *
 * Revision 1.1  2013/05/31 01:58:39  maliejun
 * driver update
 *
...
void GC0328NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0328_write_cmos_sensor(0xfe, 0x00);
		GC0328GammaSelect(GC0328_RGB_Gamma_m3);/////4
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x62 , 0xca);   
...
////AWB//
	...
	GC0328_write_cmos_sensor(0x41 , 0x24);   // 26
	GC0328_write_cmos_sensor(0x42 , 0xff);
	GC0328_write_cmos_sensor(0x45 , 0x00);   
	GC0328_write_cmos_sensor(0x44 , 0x00);//YUV mode 02
	...
	GC0328_write_cmos_sensor(0x81 , 0x15); //15   
	...
	GC0328_write_cmos_sensor(0x95 , 0x44);   //54 
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x38);     /////32
	GC0328_write_cmos_sensor(0xd2 , 0x38);  /////32
	GC0328_write_cmos_sensor(0xd3 , 0x3c);//////3c
	GC0328_write_cmos_sensor(0xdd , 0x15);//18
	...
	GC0328_write_cmos_sensor(0x9c , 0xa0); ///////80 
	        
	GC0328_write_cmos_sensor(0xa3 , 0x92); 
	        	
	GC0328_write_cmos_sensor(0xa4 , 0x10);    
	GC0328_write_cmos_sensor(0xa8 , 0xB0);    
	GC0328_write_cmos_sensor(0xaa , 0x20);  //////40  
	...
	//////////////////////////////////////////////
	GC0328_write_cmos_sensor(0xfe , 0x01);   
	GC0328_write_cmos_sensor(0x9c , 0x01);   // 02
	GC0328_write_cmos_sensor(0x08 , 0xa0);   
	GC0328_write_cmos_sensor(0x09 , 0xe8);   
	
	GC0328_write_cmos_sensor(0x10 , 0x08);  //00
	...
	GC0328_write_cmos_sensor(0x22 , 0x58);  ////60 
	...
	GC0328_write_cmos_sensor(0x05, 0x01); 	
			...
			GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps/////300
			GC0328_write_cmos_sensor(0x2e, 0xd0); 
			GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps/////3c0
			GC0328_write_cmos_sensor(0x30, 0xc0); 
			GC0328_write_cmos_sensor(0x31, 0x04);   //exp level 3  7.14fps  ////540
			GC0328_write_cmos_sensor(0x32, 0xb0); 
			GC0328_SET_PAGE0;
	...
	///cct       
	GC0328_write_cmos_sensor(0xB1 , 0x02);   //04//00//02
	GC0328_write_cmos_sensor(0xB2 , 0x00); //fd  
	GC0328_write_cmos_sensor(0xB3 , 0x07);//fc    ff 
	GC0328_write_cmos_sensor(0xB4 , 0xf0); ////f0  //eb
	GC0328_write_cmos_sensor(0xB5 , 0x02);   //05
...
void GC0328_Write_More_Registers(void)
{
	...
	///////////////////////////////////////////////
    	GC0328GammaSelect(GC0328_RGB_Gamma_m3);//0:use default
}
...
#else	
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_UYVY;//SENSOR_OUTPUT_FORMAT_VYUY;
#endif	
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps/////3c0
			GC0328_write_cmos_sensor(0x2e, 0xc0); 
			GC0328_write_cmos_sensor(0x2f, 0x06);   //exp level 2  10.00fps   3c0  ///5a0////480
			...
			GC0328_write_cmos_sensor(0x2e, 0xd0); 
			GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps/////3c0
			GC0328_write_cmos_sensor(0x30, 0x84); 
			GC0328_write_cmos_sensor(0x31, 0x04);   //exp level 3  7.14fps  ////540
			GC0328_write_cmos_sensor(0x32, 0xb0); 
			GC0328_SET_PAGE0;
			#endif
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0328_write_cmos_sensor(0x2c, 0x58); 
			GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 0  12.00fps
			GC0328_write_cmos_sensor(0x2e, 0xbc); 
			GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 0  10.00fps
			GC0328_write_cmos_sensor(0x30, 0x52); 
			GC0328_write_cmos_sensor(0x31, 0x04);   //exp level 0  7.05fps
			GC0328_write_cmos_sensor(0x32, 0xb0); 
			GC0328_SET_PAGE0;
			#endif
		break;
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n13:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x38);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_n10:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x40);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_n07:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x48);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_n03:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x50);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;				
		
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xfa);
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x6d);// 80   /////5c//64
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_03:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x65);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
