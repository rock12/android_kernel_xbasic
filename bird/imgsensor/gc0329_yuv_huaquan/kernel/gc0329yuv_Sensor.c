 ...
 * no message
 *
 * Revision 1.1.2.1  2013/05/09 06:12:43  birdlibo
 * no message
 *
 * Revision 1.2.4.1  2013/04/18 08:22:43  birdlibo
 * no message
 *
 * Revision 1.2  2013/03/11 09:09:52  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36_B15W gc0329 hm5065 imgsensor
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/03/11 06:27:32  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36_B15W imgsensor
 * Author:Huangwenjian
 *
...
void GC0329_Sensor_Init(void)
{
	...
	////////////////////ABS////////////////////
	GC0329_write_cmos_sensor(0x9c, 0x01); //02
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x30);//30																																																																									
