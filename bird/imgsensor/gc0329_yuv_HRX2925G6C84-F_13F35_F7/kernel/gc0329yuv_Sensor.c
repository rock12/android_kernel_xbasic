 ...
 * Revision 1.1  2013/09/17 10:32:19  wangqiang
 * add for 13F35_F7, by liuxd.
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x78, 0x40);//4d
    ...
    GC0329_write_cmos_sensor(0x24, 0x17);//pclk 10ma//data 4ma
	...
	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x95, 0x43);//43 betty
	...
	GC0329_write_cmos_sensor(0xb5, 0x05);
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x3e);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xfe,0x01); 																																
	GC0329_write_cmos_sensor(0x18,0x22); 																																
	GC0329_write_cmos_sensor(0x21,0xc0); //b0 betty																																
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x05);//00 betty
