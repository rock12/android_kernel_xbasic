 ...
 * $Revision: 1.1 $
 * $Modtime:$
 * $Log: imx105mipiraw_Sensor.c,v $
 * Revision 1.1  2013/05/23 03:38:31  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.1  2013/02/23 02:34:24  zhuyaozhong
 * Create 6589 12U25 project
 *
 * Revision 1.4  2013/01/02 08:46:37  birdlibo
 * no message
 *
 * Revision 1.3  2013/01/02 05:30:15  birdlibo
 * no message
 *
 * Revision 1.2  2012/12/12 04:08:54  birdlibo
 * no message
 *
 * Revision 1.1  2012/12/11 09:27:41  birdlibo
 * no message
 *
 * Revision 1.2  2012/12/10 00:40:57  zhuyaozhong
 * merged from BIRD75_ICS_V2
 *
 * Revision 1.2  2012/07/05 02:18:05  zhuyaozhong
 * merge code from BIRD75_ICS_V1
 *
 * Revision 1.2  2012/06/30 09:05:37  wuyiping
 * Editor:wuyiping
 * Inspector:wuyiping
 * Reason:update for  IMX105_HW_MIRROR
 * Reference:none
 *
 * Revision 1.1  2012/05/04 03:23:47  zhuyaozhong
 * no message
 *
 * Revision 1.3  2012/03/20 01:43:34  birdlibo
 * no message
 *
 * Revision 1.2  2012/03/17 09:01:16  birdlibo
 * no message
 *
 * Revision 1.1  2012/02/27 01:17:14  birdlibo
 * no message
 *
 *
 * 06 13 2011 koli.lin
...
#if defined(BIRD_IMX105_HV_MIRROR)
	IMX105MIPISetFlipMirror(IMAGE_HV_MIRROR);
#else	
	IMX105MIPISetFlipMirror(IMAGE_NORMAL);
#endif	
...
#if defined(BIRD_11T9_CJ106)||defined(BIRD_IMX105_HV_MIRROR)	 	 
	IMX105MIPISetFlipMirror(IMAGE_HV_MIRROR);
#else	
	IMX105MIPISetFlipMirror(IMAGE_NORMAL);
#endif	
  ...
  //  pSensorInfo->SensorCameraPreviewFrameRate=30;
    ...
    switch (ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_VIDEO_CAPTURE_MPEG4:
            pSensorInfo->SensorClockFreq=13;//26;
