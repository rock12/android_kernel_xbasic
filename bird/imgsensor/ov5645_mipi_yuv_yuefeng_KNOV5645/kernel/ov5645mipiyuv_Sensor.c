...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3a19, 0x48);//f8 48
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x68);//0x5e
  OV5645MIPI_write_cmos_sensor(0x518a, 0x5c);//0x5e
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x24);//sharpness 0x24
...
void OV5645MIPI_set_iso(UINT16 para)
{
    ...
    switch (para)
    {
        case AE_ISO_100:
             //ISO 100
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
             OV5645MIPI_write_cmos_sensor(0x3a19, 0x48);//78
             break;
		case AE_ISO_AUTO:
