 ...
 * Revision 1.1  2013/09/25 05:11:11  wangqiang
 * add for 13E45_Z317, by liuxd.
 *
...
*/
	...
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x1a);
	GC2035_write_cmos_sensor(0xc3 , 0x15);
	GC2035_write_cmos_sensor(0xc4 , 0x10);
	GC2035_write_cmos_sensor(0xc8 , 0x27);
	GC2035_write_cmos_sensor(0xc9 , 0x14);
	GC2035_write_cmos_sensor(0xca , 0x10);
	GC2035_write_cmos_sensor(0xbc , 0x42);
	GC2035_write_cmos_sensor(0xbd , 0x24);
	GC2035_write_cmos_sensor(0xbe , 0x1a);
	GC2035_write_cmos_sensor(0xb6 , 0x38);
	GC2035_write_cmos_sensor(0xb7 , 0x1e);
	GC2035_write_cmos_sensor(0xb8 , 0x1a);
	GC2035_write_cmos_sensor(0xc5 , 0x00);
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x0c);
	GC2035_write_cmos_sensor(0xcc , 0x00);
	GC2035_write_cmos_sensor(0xcd , 0x00);
	GC2035_write_cmos_sensor(0xbf , 0x16);
	GC2035_write_cmos_sensor(0xc0 , 0x00);
	GC2035_write_cmos_sensor(0xc1 , 0x00);
	GC2035_write_cmos_sensor(0xb9 , 0x0c);
	GC2035_write_cmos_sensor(0xba , 0x03);
	GC2035_write_cmos_sensor(0xbb , 0x00);
	GC2035_write_cmos_sensor(0xaa , 0x00);
	GC2035_write_cmos_sensor(0xab , 0x05);
	GC2035_write_cmos_sensor(0xac , 0x05);
	GC2035_write_cmos_sensor(0xad , 0x03);
	GC2035_write_cmos_sensor(0xae , 0x04);
	GC2035_write_cmos_sensor(0xaf , 0x07);
	GC2035_write_cmos_sensor(0xb0 , 0x09);
	GC2035_write_cmos_sensor(0xb1 , 0x0b);
	...
	GC2035_write_cmos_sensor(0xda , 0x00);
	GC2035_write_cmos_sensor(0xdb , 0x07);
	GC2035_write_cmos_sensor(0xdc , 0x09);
	GC2035_write_cmos_sensor(0xde , 0x00);
	GC2035_write_cmos_sensor(0xdf , 0x08);
	GC2035_write_cmos_sensor(0xd4 , 0x00);
	GC2035_write_cmos_sensor(0xd6 , 0x00);
	GC2035_write_cmos_sensor(0xd7 , 0x07);
	GC2035_write_cmos_sensor(0xa4 , 0x00);
	GC2035_write_cmos_sensor(0xa5 , 0x00);
	...
	GC2035_write_cmos_sensor(0xa9 , 0x00);
	GC2035_write_cmos_sensor(0xa1 , 0x80);
	GC2035_write_cmos_sensor(0xa2 , 0x80);//hyper BaWangM2002C
	/*
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x14);
	GC2035_write_cmos_sensor(0xc3 , 0x10);
	GC2035_write_cmos_sensor(0xc4 , 0x0c);
	GC2035_write_cmos_sensor(0xc8 , 0x22);
	GC2035_write_cmos_sensor(0xc9 , 0x16);
	GC2035_write_cmos_sensor(0xca , 0x0b);
	GC2035_write_cmos_sensor(0xbc , 0x2f);
	GC2035_write_cmos_sensor(0xbd , 0x20);
	GC2035_write_cmos_sensor(0xbe , 0x19);
	GC2035_write_cmos_sensor(0xb6 , 0x3a);
	GC2035_write_cmos_sensor(0xb7 , 0x24);
	GC2035_write_cmos_sensor(0xb8 , 0x20);
	GC2035_write_cmos_sensor(0xc5 , 0x00);
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x00);
	GC2035_write_cmos_sensor(0xcc , 0x00);
	GC2035_write_cmos_sensor(0xcd , 0x10);
	...
	GC2035_write_cmos_sensor(0xad , 0x01);
	GC2035_write_cmos_sensor(0xae , 0x00);
	GC2035_write_cmos_sensor(0xaf , 0x08);
	GC2035_write_cmos_sensor(0xb0 , 0x09);
	GC2035_write_cmos_sensor(0xb1 , 0x09);
	GC2035_write_cmos_sensor(0xb2 , 0x09);
	GC2035_write_cmos_sensor(0xb3 , 0x0b);
	GC2035_write_cmos_sensor(0xb4 , 0x0b);
	GC2035_write_cmos_sensor(0xb5 , 0x0b);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x00);
	GC2035_write_cmos_sensor(0xd8 , 0x00);
	...
	GC2035_write_cmos_sensor(0xde , 0x00);
	GC2035_write_cmos_sensor(0xdf , 0x0e);
	GC2035_write_cmos_sensor(0xd4 , 0x00);
	GC2035_write_cmos_sensor(0xd6 , 0x00);
	GC2035_write_cmos_sensor(0xd7 , 0x00);
	GC2035_write_cmos_sensor(0xa4 , 0x00);
	...
	GC2035_write_cmos_sensor(0xa9 , 0x00);
	GC2035_write_cmos_sensor(0xa1 , 0x80);
	GC2035_write_cmos_sensor(0xa2 , 0x80);//hyper shuntaily963
	*/
	//////////cc//////////////
...
*/
	...
	GC2035_write_cmos_sensor(0x4e , 0x80);   
	GC2035_write_cmos_sensor(0x4e , 0x02);
	GC2035_write_cmos_sensor(0x4e , 0x04);  //office
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x80);
	GC2035_write_cmos_sensor(0x4e , 0x80); //cwf
	GC2035_write_cmos_sensor(0x4e , 0x02);  
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);  //tl84 ok
	GC2035_write_cmos_sensor(0x4e , 0x08);  //tl84
	GC2035_write_cmos_sensor(0x4e , 0x04);
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x20);
	GC2035_write_cmos_sensor(0x4e , 0x20); //a ok
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x20);  
	GC2035_write_cmos_sensor(0x4e , 0x00); //a ok
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);  //h
	GC2035_write_cmos_sensor(0x4e , 0x00);  //h 检测到H光，但是AWB做不过来
	GC2035_write_cmos_sensor(0x4e , 0x00);  //h
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00); 
	GC2035_write_cmos_sensor(0x4d , 0xe0); /////////////////////////////////e0
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00); 
	GC2035_write_cmos_sensor(0x4e , 0x00); 
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4f , 0x01);//hyper
	/*
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x50 , 0x80);
	GC2035_write_cmos_sensor(0x4f , 0x00); 
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);  //tl84 ok
	GC2035_write_cmos_sensor(0x4e , 0x00);  //tl84
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);  
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
...
*/
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x2d);//saturation_cb//32  betty  //32
	GC2035_write_cmos_sensor(0xd2 , 0x2d);//saturation_Cr  //32
	GC2035_write_cmos_sensor(0xd3 , 0x42);//contrast \D3
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfa);//luma_offset 
	...
	///////dndd///////////
	//GC2035_write_cmos_sensor(0xfe , 0x00);
	//GC2035_write_cmos_sensor(0x87 , 0x20);//hyper second DN enable
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1a);//dn_b_base //1f
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x02); //dn_c_weight  //02
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x77);// edge effect 45 betty  //54
	////==============RGB Gamma 
#if 1
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x96);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x94);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_07:
			GC2035_SET_PAGE1;
