...
void GC2155_write_cmos_sensor(kal_uint8 addr, kal_uint8 para);
kal_uint8 GC2155_read_cmos_sensor(kal_uint8 addr);
...
GC2155_initial_set_struct GC2155_Init_Reg[1000];
...
u8 GC2155_Initialize_from_T_Flash()
{
	...
	//open file
	fp = filp_open("/storage/sdcard1/T_DEBUG/GC2155_sd", O_RDONLY , 0); 
	if (IS_ERR(fp)) { 
...
static void GC2155_Sensor_Init(void)
{
	...
	GC2155_write_cmos_sensor(0x17 , 0x17);//14 wangdong
	GC2155_write_cmos_sensor(0x18 , 0x02);
	GC2155_write_cmos_sensor(0x19 , 0x0f);
	...
	GC2155_write_cmos_sensor(0x24 , 0x17);//0x16
	...
	GC2155_write_cmos_sensor(0x86 , 0x02);//06 wangdong
	...
	GC2155_write_cmos_sensor(0xc3 , 0x00);
	GC2155_write_cmos_sensor(0xc4 , 0x80);
	GC2155_write_cmos_sensor(0xc5 , 0x90);
	...
	GC2155_write_cmos_sensor(0x6a , 0x04);
	GC2155_write_cmos_sensor(0x6b , 0x04);
	GC2155_write_cmos_sensor(0x6c , 0x04);
	GC2155_write_cmos_sensor(0x6d , 0x04);
	GC2155_write_cmos_sensor(0x6e , 0x04);
	GC2155_write_cmos_sensor(0x6f , 0x04);
	GC2155_write_cmos_sensor(0x70 , 0x04);
	GC2155_write_cmos_sensor(0x71 , 0x04);
	...
	GC2155_write_cmos_sensor(0x13 , 0x2a);
	...
	GC2155_write_cmos_sensor(0x91 , 0x02);
	GC2155_write_cmos_sensor(0x92 , 0x44);
	...
	GC2155_write_cmos_sensor(0xa3 , 0x40);
	GC2155_write_cmos_sensor(0xa4 , 0x20);
	GC2155_write_cmos_sensor(0xa5 , 0x40);
	GC2155_write_cmos_sensor(0xa6 , 0x80);
	GC2155_write_cmos_sensor(0xab , 0x20);
	...
	GC2155_write_cmos_sensor(0xb9 , 0x25); 
	GC2155_write_cmos_sensor(0xfe , 0x00);	 
	///////////////////gamma1////////////////////
	GC2155_write_cmos_sensor(0xfe , 0x02);
	GC2155_write_cmos_sensor(0x10 , 0x0a);
	GC2155_write_cmos_sensor(0x11 , 0x12);
	GC2155_write_cmos_sensor(0x12 , 0x19);
	GC2155_write_cmos_sensor(0x13 , 0x1f);
	GC2155_write_cmos_sensor(0x14 , 0x2c);
	GC2155_write_cmos_sensor(0x15 , 0x38);
	GC2155_write_cmos_sensor(0x16 , 0x42);
	GC2155_write_cmos_sensor(0x17 , 0x4e);
	GC2155_write_cmos_sensor(0x18 , 0x63);
	GC2155_write_cmos_sensor(0x19 , 0x76);
	GC2155_write_cmos_sensor(0x1a , 0x87);
	GC2155_write_cmos_sensor(0x1b , 0x96);
	GC2155_write_cmos_sensor(0x1c , 0xa2);
	GC2155_write_cmos_sensor(0x1d , 0xb8);
	GC2155_write_cmos_sensor(0x1e , 0xcb);
	GC2155_write_cmos_sensor(0x1f , 0xd8);
	GC2155_write_cmos_sensor(0x20 , 0xe2);
	GC2155_write_cmos_sensor(0x21 , 0xe9);
	GC2155_write_cmos_sensor(0x22 , 0xf0);
	GC2155_write_cmos_sensor(0x23 , 0xf8);
	GC2155_write_cmos_sensor(0x24 , 0xfd);
	...
	/////////////////////////////////////////////// 
	GC2155_write_cmos_sensor(0xfe , 0x02);
	GC2155_write_cmos_sensor(0xd1 , 0x24);
	GC2155_write_cmos_sensor(0xd2 , 0x24);
	...
	////////////////////////////
	GC2155_write_cmos_sensor(0xfe , 0x01);
	GC2155_write_cmos_sensor(0xc2 , 0x15);
	GC2155_write_cmos_sensor(0xc3 , 0x0c);
	GC2155_write_cmos_sensor(0xc4 , 0x0b);
	GC2155_write_cmos_sensor(0xc8 , 0x12);
	GC2155_write_cmos_sensor(0xc9 , 0x0b);
	GC2155_write_cmos_sensor(0xca , 0x07);
	GC2155_write_cmos_sensor(0xbc , 0x4d);
	GC2155_write_cmos_sensor(0xbd , 0x2d);
	GC2155_write_cmos_sensor(0xbe , 0x29);
	GC2155_write_cmos_sensor(0xb6 , 0x3f);
	GC2155_write_cmos_sensor(0xb7 , 0x28);
	GC2155_write_cmos_sensor(0xb8 , 0x2a);
	...
	GC2155_write_cmos_sensor(0xaa , 0x01);
	GC2155_write_cmos_sensor(0xab , 0x0f);
	GC2155_write_cmos_sensor(0xac , 0x0d);
	GC2155_write_cmos_sensor(0xad , 0x00);
	GC2155_write_cmos_sensor(0xae , 0x06);
	GC2155_write_cmos_sensor(0xaf , 0x08);
	GC2155_write_cmos_sensor(0xb0 , 0x00);
	GC2155_write_cmos_sensor(0xb1 , 0x06);
	GC2155_write_cmos_sensor(0xb2 , 0x02);
	GC2155_write_cmos_sensor(0xb3 , 0x01);
	GC2155_write_cmos_sensor(0xb4 , 0x08);
	...
	GC2155_write_cmos_sensor(0xd6 , 0x00);
	...
	GC2155_write_cmos_sensor(0xa4 , 0x00);
	...
	GC2155_write_cmos_sensor(0xdf , 0x0c);
	GC2155_write_cmos_sensor(0xe0 , 0x70);
	GC2155_write_cmos_sensor(0xe1 , 0x80);
	GC2155_write_cmos_sensor(0xe2 , 0x80);
	GC2155_write_cmos_sensor(0xe3 , 0x80);
	GC2155_write_cmos_sensor(0xe6 , 0x90);
	GC2155_write_cmos_sensor(0xe7 , 0x50);
	GC2155_write_cmos_sensor(0xe8 , 0x90);
	GC2155_write_cmos_sensor(0xe9 , 0x60);
	GC2155_write_cmos_sensor(0xfe , 0x00);
	///////////////////////////////////////////////
	/////////// AWB////////////////////////
	///////////////////////////////////////////////
	...
	GC2155_write_cmos_sensor(0x4e , 0x00);
	GC2155_write_cmos_sensor(0x4c , 0x02);
	...
	GC2155_write_cmos_sensor(0x54 , 0x38);
	GC2155_write_cmos_sensor(0x55 , 0xc7);
	...
	GC2155_write_cmos_sensor(0x63 , 0x04);
	...
	GC2155_write_cmos_sensor(0x6f , 0x50);
	...
	GC2155_write_cmos_sensor(0xc1 , 0x4e);
	GC2155_write_cmos_sensor(0xc2 , 0xf8);
	GC2155_write_cmos_sensor(0xc3 , 0x00);
	GC2155_write_cmos_sensor(0xc4 , 0xec);
	GC2155_write_cmos_sensor(0xc5 , 0x45);
	GC2155_write_cmos_sensor(0xc6 , 0xee);
	...
	GC2155_write_cmos_sensor(0x29 , 0x05); 
	GC2155_write_cmos_sensor(0x2a , 0xdc); //16fps 
	GC2155_write_cmos_sensor(0x2b , 0x06); 
	GC2155_write_cmos_sensor(0x2c , 0xd6); //16fps
...
UINT32 GC2155Open(void)
{
...
#ifdef DEBUG_SENSOR_GC2155
	//判断手机对应目录下是否有名为GC2155_sd的调试文件,没有的话走默认参数
	...
	if (IS_ERR(fp)) { 
		fromsd = 0;   
		printk("wqcat open file error\n");
	} 
	else 
	{
		fromsd = 1;
		printk("wqcat open file ok\n");
		filp_close(fp, NULL); 
		set_fs(fs);
	}
	...
	if(fromsd == 1)//是否从SD读取
	{
		printk("wqcat initialize from SD!\n");
		GC2155_Initialize_from_T_Flash();//从SD卡读取的主要函数
	}
	else
	{
		printk("wqcat initialize from code!\n");
		GC2155_Sensor_Init();
	}
#else  
	GC2155_Sensor_Init();
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_4MA;//ISP_DRIVING_6MA
...
BOOL GC2155_set_param_wb(UINT16 para)
{
	...
	{
		case AWB_MODE_AUTO:
			GC2155_write_cmos_sensor(0xb3, 0x61);
			GC2155_write_cmos_sensor(0xb4, 0x40);
			GC2155_write_cmos_sensor(0xb5, 0x61);
...
BOOL GC2155_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2155_write_cmos_sensor(0x29, 0x05);
		GC2155_write_cmos_sensor(0x2a, 0xb0); //16fps 
		GC2155_write_cmos_sensor(0x2b, 0x06);
		GC2155_write_cmos_sensor(0x2c, 0x80); //16fps  
		GC2155_write_cmos_sensor(0x2d, 0x0b);
...
BOOL GC2155_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2155_SET_PAGE1;
			GC2155_write_cmos_sensor(0x13,0x30);
			GC2155_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2155_SET_PAGE1;
