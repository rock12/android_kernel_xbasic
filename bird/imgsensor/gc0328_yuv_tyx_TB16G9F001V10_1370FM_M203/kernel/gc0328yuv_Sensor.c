...
void GC0328NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0328_write_cmos_sensor(0xfe, 0x00);
#if defined(BIRD_GC0328_HV_MIRROR)
...
////AWB//
	...
	GC0328_write_cmos_sensor(0x24 , 0x13);    //0x11
...
#if defined(BIRD_GC0328_HV_MIRROR)	//base on 60Hz
	 GC0328_write_cmos_sensor(0x05 , 0x01);//hb
  ...
  GC0328_write_cmos_sensor(0x44 , 0x02);
	...
	///////YCP
 #if defined(BIRD_GC0328_HV_MIRROR)
	GC0328_write_cmos_sensor(0xd1 , 0x24);
	GC0328_write_cmos_sensor(0xd2 , 0x24);
	GC0328_write_cmos_sensor(0xd3 , 0x3b); //luma_contrast
 #else
...
void GC0328_Write_More_Registers(void)
{
    ...
    #if defined(BIRD_GC0328_HV_MIRROR)
	GC0328_write_cmos_sensor(0xfe , 0x00);  
	GC0328_write_cmos_sensor(0xeb , 0x82);  
	GC0328_write_cmos_sensor(0xec , 0x82);  
	GC0328_write_cmos_sensor(0xed , 0x7a);  
    #endif
}
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x86); //80
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
