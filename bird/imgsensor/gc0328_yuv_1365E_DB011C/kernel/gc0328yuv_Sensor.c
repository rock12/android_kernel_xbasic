...
void GC0328_Sensor_Init(void)
{
	...
	////////////YCP///////////
	GC0328_write_cmos_sensor(0xd1 , 0x24);// 0x30 for front
	GC0328_write_cmos_sensor(0xd2 , 0x24);// 0x30 for front
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0328_write_cmos_sensor(0x2c, 0xa0); 
			GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps
			GC0328_write_cmos_sensor(0x2e, 0x60); 
			GC0328_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps
			GC0328_write_cmos_sensor(0x30, 0x20); 
			GC0328_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
			GC0328_write_cmos_sensor(0x32, 0x40); 
			GC0328_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x2e, 0x5a); 
			GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 0  10.00fps
			GC0328_write_cmos_sensor(0x30, 0xf6); 
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n13:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x25);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_n07:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x35);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_07:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x55);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
