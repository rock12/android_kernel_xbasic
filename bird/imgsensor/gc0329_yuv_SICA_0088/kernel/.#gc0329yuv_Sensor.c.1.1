 ...
 * Revision 1.1  2013/08/14 01:47:51  chenchuanbao
 * Editor: chenchuanbao
 * Inspector:chenchuanbao
 * Reason:13C43_45C
 * Reference:none
 *
 * Revision 1.3  2013/07/26 11:35:34  lijunchao
 * Finally performance
 *
 * Revision 1.2  2013/07/25 11:58:35  lijunchao
 * Denoise
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x1f, 0xc8); //c0  0719
	...
	GC0329_write_cmos_sensor(0x33, 0x1d); //20 0719
	...
	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x95, 0x65);//43 0719
	...
	GC0329_write_cmos_sensor(0xb5, 0x05);//02  0719
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x2d);  //38  0719
	...
	GC0329_write_cmos_sensor(0x12, 0x27);  //27  0719
	GC0329_write_cmos_sensor(0x13, 0x40);  //5a 0719
	GC0329_write_cmos_sensor(0x17, 0x88);
	GC0329_write_cmos_sensor(0x21, 0xa0);
  ...
  GC0329_write_cmos_sensor(0x05, 0x01); 	
	...
	GC0329_write_cmos_sensor(0x67, 0x75);  //70 0719
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x2e);		//34		 2a 0719																																																																					
	GC0329_write_cmos_sensor(0xd2,0x2a);
	GC0329_write_cmos_sensor(0xd3,0x3d);		//3a 0719																																																																						
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(3);//0:use default  5  0719
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
      ...
      GC0329_write_cmos_sensor(0x05, 0x01); 	
			...
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0xd0); 
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps  384
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2f, 0x04);   //exp level 0  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x44); 
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x08);
	value_Y = (GC0329_NIGHT_MODE?0x68:0x40);  //58 0719
//printk("GC0329_set_param_exposure");
	switch (para)
	{
		case AE_EV_COMP_n13:
