...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x5800, 0x26);
  OV5645MIPI_write_cmos_sensor(0x5801, 0x11);
  OV5645MIPI_write_cmos_sensor(0x5802, 0x0f);
  OV5645MIPI_write_cmos_sensor(0x5803, 0x0e);
  OV5645MIPI_write_cmos_sensor(0x5804, 0x11);
  OV5645MIPI_write_cmos_sensor(0x5805, 0x20);
  OV5645MIPI_write_cmos_sensor(0x5806, 0x0d);
  OV5645MIPI_write_cmos_sensor(0x5807, 0x09);
  OV5645MIPI_write_cmos_sensor(0x5808, 0x06);
  OV5645MIPI_write_cmos_sensor(0x5809, 0x06);
  OV5645MIPI_write_cmos_sensor(0x580a, 0x08);
  OV5645MIPI_write_cmos_sensor(0x580b, 0x0c);
  ...
  OV5645MIPI_write_cmos_sensor(0x581e, 0x24);
  ...
  OV5645MIPI_write_cmos_sensor(0x5823, 0x23);
  ...
  OV5645MIPI_write_cmos_sensor(0x5833, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5834, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5835, 0x22);
  OV5645MIPI_write_cmos_sensor(0x5836, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5837, 0x06);
  OV5645MIPI_write_cmos_sensor(0x5838, 0x6c);
  OV5645MIPI_write_cmos_sensor(0x5839, 0x04);
  OV5645MIPI_write_cmos_sensor(0x583a, 0x28);
  OV5645MIPI_write_cmos_sensor(0x583b, 0x06);
...
//  afPowerOn();//motor power
	hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_2800,"af");
	mDELAY(20);
...
UINT32 OV5645MIPIClose(void)
{
  ...
  lastadc = OV5645read_vcm_adc();
	...
	OV5645MIPI_write_cmos_sensor(0x3023,0x01);
	OV5645MIPI_write_cmos_sensor(0x3022,0x08); 
	hwPowerDown(CAMERA_POWER_VCAM_A2, "af");
	return ERROR_NONE;
}	/* OV5645MIPIClose() */
/*************************************************************************
* FUNCTION
...
UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			...
			pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = 0x14; 
...
UINT32 OV5645MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    OV5645MIPI_write_cmos_sensor(0x3034, 0x18);
    OV5645MIPI_write_cmos_sensor(0x3035, 0x11);//25fps
    OV5645MIPI_write_cmos_sensor(0x3036, 0x38);
    OV5645MIPI_write_cmos_sensor(0x3037, 0x13);
		    
		OV5645MIPI_write_cmos_sensor(0x380c, 0x07); 
		OV5645MIPI_write_cmos_sensor(0x380d, 0x68); 
		OV5645MIPI_write_cmos_sensor(0x380e, 0x04); 
		OV5645MIPI_write_cmos_sensor(0x380f, 0x9c);		   
		
		OV5645MIPI_write_cmos_sensor(0x3a08, 0x01); 
		OV5645MIPI_write_cmos_sensor(0x3a09, 0x27); 
		OV5645MIPI_write_cmos_sensor(0x3a0e, 0x04);
		OV5645MIPI_write_cmos_sensor(0x3a0a, 0x00); 
		OV5645MIPI_write_cmos_sensor(0x3a0b, 0xf6); 		 
		OV5645MIPI_write_cmos_sensor(0x3a0d, 0x04);        	
      
    OV5645MIPI_write_cmos_sensor(0x3a00, 0x38);
		OV5645MIPI_write_cmos_sensor(0x3a02 ,0x04);
		OV5645MIPI_write_cmos_sensor(0x3a03 ,0x9c);
		OV5645MIPI_write_cmos_sensor(0x3a14 ,0x04);
		OV5645MIPI_write_cmos_sensor(0x3a15 ,0x9c);				
    ...
    else if (u2FrameRate == 15)   
	{
		...
		OV5645MIPI_write_cmos_sensor(0x3034, 0x18);
    OV5645MIPI_write_cmos_sensor(0x3035, 0x21);//12.5fps
    OV5645MIPI_write_cmos_sensor(0x3036, 0x38);
    OV5645MIPI_write_cmos_sensor(0x3037, 0x13);
		...
		OV5645MIPI_write_cmos_sensor(0x3a0e, 0x08);
		OV5645MIPI_write_cmos_sensor(0x3a0a, 0x00); 
		OV5645MIPI_write_cmos_sensor(0x3a0b, 0x7b); 		 
		OV5645MIPI_write_cmos_sensor(0x3a0d, 0x09);        	
