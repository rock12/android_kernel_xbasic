 ...
 * Revision 1.3  2013/08/15 12:58:21  wangqiang
 * 退回v1.1
 *
...
void GC0328_Sensor_Init(void)
	...
	*/
    ...
    GC0328_write_cmos_sensor(0x17 , 0x14);   //cxl mirror
		...
		GC0328_write_cmos_sensor(0x82 , 0x8F);//85
		...
		GC0328_write_cmos_sensor(0x95 , 0x44);//43
		
		
		///////YCP
		GC0328_write_cmos_sensor(0xd1 , 0x30);//38
		GC0328_write_cmos_sensor(0xd2 , 0x30);
		...
		///////////////////////////////////////
		GC0328_write_cmos_sensor(0xfe , 0x01);
		GC0328_write_cmos_sensor(0x9c , 0x03);//02
...
void GC0328_Write_More_Registers(void)
{
	...
	GC0328_write_cmos_sensor(0xed , 0x86);
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, value_luma - 0x04);
			GC0328_write_cmos_sensor(0xfe, 0x01);
