 ...
 * Revision 1.5  2013/09/29 13:12:33  maliejun
 * no message
 *
 ...
 * Bug 86348:“～1?????那“o??那????“∟?“2??““?“a?3??????o“??那??“⊿“?“⊿“o????o“1?角?足???那??“∟?“2“～?“a?那?1??DD
 *
 ...
 * Editor: maliejun
 * Inspector:maliejun
 * Reason:[84290] [N803]?y??ㄓD“““～a“～?|足?ICS_V2“|?
 * Reference:none
 *
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m5);//5 // 3 jon
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0xb4, 0xff);//fd betty //0xf0 jon
	GC0329_write_cmos_sensor(0xb5, 0x02);//02 betty //0x02 jon
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x18);
	GC0329_write_cmos_sensor(0xd2, 0x18);
	GC0329_write_cmos_sensor(0xd3, 0x3a);//add
	...
	GC0329_write_cmos_sensor(0x12, 0x27);//0x07 jon
	GC0329_write_cmos_sensor(0x13, 0x56);
	GC0329_write_cmos_sensor(0x17, 0x88);
	GC0329_write_cmos_sensor(0x21, 0xd8);//b0 //0xa0 jon
...
void GC0329_Write_More_Registers(void)
{
	...
	/*GC0329_write_cmos_sensor(0xfe,0x01); 																																
	GC0329_write_cmos_sensor(0x18,0x22); 																																
	GC0329_write_cmos_sensor(0x21,0xd8); 																																
	GC0329_write_cmos_sensor(0x06,0x12);																																																																									
	GC0329_write_cmos_sensor(0x08,0x9c);																																																																									
	GC0329_write_cmos_sensor(0x51,0x28);																																																																									
	GC0329_write_cmos_sensor(0x52,0x10);																																																																									
	...
	GC0329_write_cmos_sensor(0xd1,0x18);//0x26																																																																									
	GC0329_write_cmos_sensor(0xd2,0x18);																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x58);//0x50 jon
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n03:
			...
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y - 0x0b);
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;				
