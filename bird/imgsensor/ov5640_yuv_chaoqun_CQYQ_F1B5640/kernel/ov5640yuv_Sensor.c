...
#define OV5640YUV_multi_write_cmos_sensor(pData, bytes)  iMultiWriteReg(pData, bytes)
//change burst to multi by liuxinming

DECLARE_MUTEX(af_status);
#define PROFILE 1
#if PROFILE 
...
void OV5640YUV_Sensor_Dvp_Init(void)
{
		OV5640YUV_write_cmos_sensor(0x4740, 0x20);
		
		OV5640YUV_write_cmos_sensor(0x4050, 0x6e);
    OV5640YUV_write_cmos_sensor(0x4051, 0x7f);
		...
		OV5640YUV_write_cmos_sensor(0x302c, 0xc2); 		
		...
		OV5640YUV_write_cmos_sensor(0x3820, 0x41); //41
		OV5640YUV_write_cmos_sensor(0x3821, 0x07); //07
		//windows setup
		...
		OV5640YUV_write_cmos_sensor(0x3035, 0x31); //20fps
		OV5640YUV_write_cmos_sensor(0x3036, 0x8c); 
		...
		OV5640YUV_write_cmos_sensor(0x3a09, 0xc4); 
		OV5640YUV_write_cmos_sensor(0x3a0e, 0x05);
		OV5640YUV_write_cmos_sensor(0x3a0a, 0x00); 
		OV5640YUV_write_cmos_sensor(0x3a0b, 0xa4); 		 
		OV5640YUV_write_cmos_sensor(0x3a0d, 0x06); 
		
		OV5640YUV_write_cmos_sensor(0x3a00, 0x38); //20fps
	  ...
	  //awb           
		...
		OV5640YUV_write_cmos_sensor(0x5189, 0x62);    
		OV5640YUV_write_cmos_sensor(0x518a, 0x62);    
		...
		OV5640YUV_write_cmos_sensor(0x518f, 0x4c);    
		OV5640YUV_write_cmos_sensor(0x5190, 0x56);    
		...
		OV5640YUV_write_cmos_sensor(0x5383, 0x12); 
		OV5640YUV_write_cmos_sensor(0x5384, 0x05); 
		OV5640YUV_write_cmos_sensor(0x5385, 0x75); 
		OV5640YUV_write_cmos_sensor(0x5386, 0x7a); 
		OV5640YUV_write_cmos_sensor(0x5387, 0x7e); 
		OV5640YUV_write_cmos_sensor(0x5388, 0x74); 
		OV5640YUV_write_cmos_sensor(0x5389, 0x0a); 
		OV5640YUV_write_cmos_sensor(0x538a, 0x01); 
		OV5640YUV_write_cmos_sensor(0x538b, 0x98); 
		//sharp&noise
		OV5640YUV_write_cmos_sensor(0x5300, 0x08); 
		OV5640YUV_write_cmos_sensor(0x5301, 0x3a); //30
		OV5640YUV_write_cmos_sensor(0x5302, 0x2c); //28
		...
		OV5640YUV_write_cmos_sensor(0x5483, 0x24);  
		...
		OV5640YUV_write_cmos_sensor(0x5800, 0x2e); 
		OV5640YUV_write_cmos_sensor(0x5801, 0x20); 
		OV5640YUV_write_cmos_sensor(0x5802, 0x18); 
		OV5640YUV_write_cmos_sensor(0x5803, 0x18); 
		OV5640YUV_write_cmos_sensor(0x5804, 0x20); 
		OV5640YUV_write_cmos_sensor(0x5805, 0x3f); 
		OV5640YUV_write_cmos_sensor(0x5806, 0x11); 
		OV5640YUV_write_cmos_sensor(0x5807, 0x0a); 
		OV5640YUV_write_cmos_sensor(0x5808, 0x08); 
		OV5640YUV_write_cmos_sensor(0x5809, 0x09); 
		OV5640YUV_write_cmos_sensor(0x580a, 0x0c); 
		OV5640YUV_write_cmos_sensor(0x580b, 0x18); 
		OV5640YUV_write_cmos_sensor(0x580c, 0x09); 
		OV5640YUV_write_cmos_sensor(0x580d, 0x03); 
		OV5640YUV_write_cmos_sensor(0x580e, 0x01); 
		OV5640YUV_write_cmos_sensor(0x580f, 0x01); 
		OV5640YUV_write_cmos_sensor(0x5810, 0x05); 
		OV5640YUV_write_cmos_sensor(0x5811, 0x0e); 
		...
		OV5640YUV_write_cmos_sensor(0x5816, 0x06); 
		OV5640YUV_write_cmos_sensor(0x5817, 0x0f); 
		OV5640YUV_write_cmos_sensor(0x5818, 0x10); 
		OV5640YUV_write_cmos_sensor(0x5819, 0x0a); 
		OV5640YUV_write_cmos_sensor(0x581a, 0x07); 
		OV5640YUV_write_cmos_sensor(0x581b, 0x08); 
		OV5640YUV_write_cmos_sensor(0x581c, 0x0d); 
		OV5640YUV_write_cmos_sensor(0x581d, 0x16); 
		OV5640YUV_write_cmos_sensor(0x581e, 0x2e); 
		OV5640YUV_write_cmos_sensor(0x581f, 0x1a); 
		OV5640YUV_write_cmos_sensor(0x5820, 0x15); 
		OV5640YUV_write_cmos_sensor(0x5821, 0x16); 
		OV5640YUV_write_cmos_sensor(0x5822, 0x22); 
		OV5640YUV_write_cmos_sensor(0x5823, 0x3d); 
		OV5640YUV_write_cmos_sensor(0x5824, 0x2a); 
		OV5640YUV_write_cmos_sensor(0x5825, 0x0c); 
		OV5640YUV_write_cmos_sensor(0x5826, 0x0e); 
		OV5640YUV_write_cmos_sensor(0x5827, 0x0c); 
		OV5640YUV_write_cmos_sensor(0x5828, 0x26); 
		...
		OV5640YUV_write_cmos_sensor(0x582e, 0x2c); 
		...
		OV5640YUV_write_cmos_sensor(0x5836, 0x28); 
		OV5640YUV_write_cmos_sensor(0x5837, 0x2a); 
		OV5640YUV_write_cmos_sensor(0x5838, 0x48); 
		OV5640YUV_write_cmos_sensor(0x5839, 0x2c); 
		OV5640YUV_write_cmos_sensor(0x583a, 0x2e); 
		OV5640YUV_write_cmos_sensor(0x583b, 0x2c); 
		OV5640YUV_write_cmos_sensor(0x583c, 0x44); 
		OV5640YUV_write_cmos_sensor(0x583d, 0xce); 	
		
		OV5640YUV_write_cmos_sensor(0x5688, 0x11); 
		OV5640YUV_write_cmos_sensor(0x5689, 0x11); 
		OV5640YUV_write_cmos_sensor(0x568a, 0x11); 
		OV5640YUV_write_cmos_sensor(0x568b, 0x11); 
		OV5640YUV_write_cmos_sensor(0x568c, 0x11); 
		OV5640YUV_write_cmos_sensor(0x568d, 0x11); 
		OV5640YUV_write_cmos_sensor(0x568e, 0x11); 
		OV5640YUV_write_cmos_sensor(0x568f, 0x11); 
		
		OV5640YUV_write_cmos_sensor(0x5025, 0x00); 
		
		OV5640YUV_write_cmos_sensor(0x3a0f, 0x34);//28
		OV5640YUV_write_cmos_sensor(0x3a10, 0x32); //20
		OV5640YUV_write_cmos_sensor(0x3a1b, 0x34);//28 
		OV5640YUV_write_cmos_sensor(0x3a1e, 0x32); //20
		OV5640YUV_write_cmos_sensor(0x3a11, 0x81); //51
		OV5640YUV_write_cmos_sensor(0x3a1f, 0x1c); //10
    ...
    OV5640YUV_write_cmos_sensor(0x3503, 0x00);//awbinit
		...
		OV5640YUV_write_cmos_sensor(0x501d, 0x10);
    OV5640YUV_write_cmos_sensor(0x5680, 0x00); 
    OV5640YUV_write_cmos_sensor(0x5681, 0x00);
    OV5640YUV_write_cmos_sensor(0x5682, 0x00);  
    OV5640YUV_write_cmos_sensor(0x5683, 0x00);
    OV5640YUV_write_cmos_sensor(0x5684, 0x03); 
    OV5640YUV_write_cmos_sensor(0x5685, 0xc0);
    OV5640YUV_write_cmos_sensor(0x5686, 0x02); 
    OV5640YUV_write_cmos_sensor(0x5687, 0xd0);	
}
...
void OV5640YUV_set_720P_init(void)
{
		...
		OV5640YUV_write_cmos_sensor(0x3a00, 0x3c);//enable night		
		
		OV5640YUV_write_cmos_sensor(0x4050, 0x6e);
    OV5640YUV_write_cmos_sensor(0x4051, 0x7f);
		
		OV5640YUV_write_cmos_sensor(0x5302, 0x30);  //24
		OV5640YUV_write_cmos_sensor(0x5303, 0x2c);  
		OV5640YUV_write_cmos_sensor(0x5306, 0x08);//18    
		OV5640YUV_write_cmos_sensor(0x5307, 0x1f);//28		 
		...
		OV5640YUV_write_cmos_sensor(0x3806, 0x07);
		OV5640YUV_write_cmos_sensor(0x3807, 0x9b);
		OV5640YUV_write_cmos_sensor(0x3808, 0x05); //1024//1280 
		OV5640YUV_write_cmos_sensor(0x3809, 0x00); 
		OV5640YUV_write_cmos_sensor(0x380a, 0x03);//768 //960
		OV5640YUV_write_cmos_sensor(0x380b, 0xc0); 	
		OV5640YUV_write_cmos_sensor(0x3810, 0x00); 
		OV5640YUV_write_cmos_sensor(0x3811, 0x10); 
		OV5640YUV_write_cmos_sensor(0x3812, 0x00); 
...
void OV5640YUV_set_5M_init(void)
{
		...
		OV5640YUV_write_cmos_sensor(0x4050, 0x6e);
    OV5640YUV_write_cmos_sensor(0x4051, 0x8f);
		
		OV5640YUV_write_cmos_sensor(0x5302, 0x30);//1c  
		OV5640YUV_write_cmos_sensor(0x5303, 0x1c); //08 
		OV5640YUV_write_cmos_sensor(0x5306, 0x0c);     
		OV5640YUV_write_cmos_sensor(0x5307, 0x1c);  		

		OV5640YUV_write_cmos_sensor(0x3820, 0x46); //40
		OV5640YUV_write_cmos_sensor(0x3821, 0x00); //06
...
{
    SENSORDB("lln:: OV5640YUV_Sensor_Init, use OV5640YUV_Sensor_Dvp_Init");
...
void OV5640YUV_NightMode(kal_bool bEnable)
{
    if(bEnable)
    {
        ...
        {
        	 OV5640YUV_write_cmos_sensor(0x3034, 0x1a); 
		       OV5640YUV_write_cmos_sensor(0x3035, 0x31); //10fps
		       OV5640YUV_write_cmos_sensor(0x3036, 0x46); 
		       OV5640YUV_write_cmos_sensor(0x3037, 0x13); 
		       OV5640YUV_write_cmos_sensor(0x3038, 0x00); 
		       OV5640YUV_write_cmos_sensor(0x3039, 0x00); 
		       ...
		       OV5640YUV_write_cmos_sensor(0x3c00, 0x04); 
		       OV5640YUV_write_cmos_sensor(0x3a08, 0x00); 
		       OV5640YUV_write_cmos_sensor(0x3a09, 0x62); 
		       OV5640YUV_write_cmos_sensor(0x3a0e, 0x0a);
		       OV5640YUV_write_cmos_sensor(0x3a0a, 0x00); 
		       OV5640YUV_write_cmos_sensor(0x3a0b, 0x52); 		 
		       OV5640YUV_write_cmos_sensor(0x3a0d, 0x0c);   	
        ...
        {
   	       OV5640YUV_write_cmos_sensor(0x3a00, 0x3c);//20fps-5fps
           OV5640YUV_write_cmos_sensor(0x3a02 ,0x0f);
           OV5640YUV_write_cmos_sensor(0x3a03 ,0x60);
           OV5640YUV_write_cmos_sensor(0x3a14 ,0x0f);
           OV5640YUV_write_cmos_sensor(0x3a15 ,0x60);
        }
    }
    else
    {
        ...
        {
        	 OV5640YUV_write_cmos_sensor(0x3034, 0x1a); 
		       OV5640YUV_write_cmos_sensor(0x3035, 0x31); //25fps
		       OV5640YUV_write_cmos_sensor(0x3036, 0xaf); 
		       OV5640YUV_write_cmos_sensor(0x3037, 0x13); 
		       OV5640YUV_write_cmos_sensor(0x3038, 0x00); 
		       OV5640YUV_write_cmos_sensor(0x3039, 0x00); 
		       ...
		       OV5640YUV_write_cmos_sensor(0x3c00, 0x04); 
		       OV5640YUV_write_cmos_sensor(0x3a08, 0x00); 
		       OV5640YUV_write_cmos_sensor(0x3a09, 0xf6); 
		       OV5640YUV_write_cmos_sensor(0x3a0e, 0x04);
		       OV5640YUV_write_cmos_sensor(0x3a0a, 0x00); 
		       OV5640YUV_write_cmos_sensor(0x3a0b, 0xcd); 		 
		       OV5640YUV_write_cmos_sensor(0x3a0d, 0x04);  	
...
{   
    UINT32 state_focused=0;
	  ...
	  state_focused = OV5640YUV_read_cmos_sensor(0x3029);
	
    if(0x70 == state_focused)
    {
        *pFeatureReturnPara32 = SENSOR_AF_IDLE;
	
    }
    else if(0x00 == state_focused)
    {
        *pFeatureReturnPara32 = SENSOR_AF_FOCUSING;
	
    }
    else if(0x10 == state_focused)
    {
        *pFeatureReturnPara32 = SENSOR_AF_FOCUSED;
		
    }
    //else if(0x20 == state_focused)
   // {
...
void OV5640YUV_Set_Mirror_Flip(kal_uint8 image_mirror)
{
  ...
  switch (image_mirror)
	{
	    case IMAGE_NORMAL:
					OV5640YUV_write_cmos_sensor(0x3820,0x47);	//Set normal
...
tem =0;
	...
	OV5640YUV_Set_Mirror_Flip(IMAGE_HV_MIRROR);
...
{
		kal_bool bflag=false;
		bflag = OV5640YUV_MPEG4_encode_mode;
		
    OV5640YUV_MPEG4_encode_mode = KAL_TRUE;
		OV5640YUV_NightMode(false);
		
    OV5640YUV_MPEG4_encode_mode = bflag;
    return TRUE;
}
...
kal_uint32 OV5640_set_param_exposure(kal_uint32 para)
{
    ...
    {
        case AE_EV_COMP_n10:
				OV5640YUV_write_cmos_sensor(0x3a0f, 0x10);
				OV5640YUV_write_cmos_sensor(0x3a10, 0x08);
				OV5640YUV_write_cmos_sensor(0x3a11, 0x20);
				OV5640YUV_write_cmos_sensor(0x3a1b, 0x10);
				OV5640YUV_write_cmos_sensor(0x3a1e, 0x08);
				OV5640YUV_write_cmos_sensor(0x3a1f, 0x10);
        break;

        case AE_EV_COMP_n07:
				OV5640YUV_write_cmos_sensor(0x3a0f, 0x18);
				OV5640YUV_write_cmos_sensor(0x3a10, 0x10);
				OV5640YUV_write_cmos_sensor(0x3a11, 0x31);
				OV5640YUV_write_cmos_sensor(0x3a1b, 0x18);
				OV5640YUV_write_cmos_sensor(0x3a1e, 0x10);
				OV5640YUV_write_cmos_sensor(0x3a1f, 0x10);
        break;
        ...
        case AE_EV_COMP_n03:
				...
				OV5640YUV_write_cmos_sensor(0x3a11, 0x41);
        ...
        case AE_EV_COMP_00:
			  OV5640YUV_write_cmos_sensor(0x3a0f, 0x28);
				...
				OV5640YUV_write_cmos_sensor(0x3a11, 0x51);
...
kal_uint32 OV5640_set_param_effect(kal_uint32 para)
{
    ...
    {      
	 ...
	 case MEFFECT_MONO:
	 	        OV5640YUV_write_cmos_sensor(0x3212, 0x03);//add
        ...
        case MEFFECT_SEPIA:         
            OV5640YUV_write_cmos_sensor(0x3212, 0x03);
						OV5640YUV_write_cmos_sensor(0x5580, 0x1e);
						OV5640YUV_write_cmos_sensor(0x5583, 0x40); //80
						OV5640YUV_write_cmos_sensor(0x5584, 0xa0); //c0
						OV5640YUV_write_cmos_sensor(0x3212, 0x13);
						OV5640YUV_write_cmos_sensor(0x3212, 0xa3);           
            break;
        ...
        case MEFFECT_NEGATIVE:
            OV5640YUV_write_cmos_sensor(0x3212, 0x03);
						OV5640YUV_write_cmos_sensor(0x5580, 0x46);
						OV5640YUV_write_cmos_sensor(0x5583, 0x40);
						OV5640YUV_write_cmos_sensor(0x5584, 0x10);
						OV5640YUV_write_cmos_sensor(0x3212, 0x13);
						OV5640YUV_write_cmos_sensor(0x3212, 0xa3);
...
kal_uint32 OV5640_set_param_af_mode(kal_uint32 para)
{
    ...
    switch (para)
    {
        case AF_MODE_AFS:
			//OV5640_FOCUS_AD5820_Single_Focus();
			printk("\n [lxm_camera]OV5640_FOCUS_AD5820_Single_Focus() is called ; \n");
			break;
        case AF_MODE_AFC:
			OV5640_FOCUS_AD5820_Constant_Focus();
			printk("\n  [lxm_camera]OV5640_FOCUS_AD5820_Constant_Focus() is called ; \n");
			break;
	 default:
	 	return KAL_FALSE;
    }
...
//liuxinming
static void OV5640_FOCUS_AD5820_Get_AF_Max_Num_Focus_Areas(UINT32 *pFeatureReturnPara32)
{ 	
...
static void OV5640_FOCUS_AD5820_Get_AE_Max_Num_Metering_Areas(UINT32 *pFeatureReturnPara32)
{ 	
...
kal_uint32 OV5640_set_param_edge_mode(kal_uint32 para)
{
	kal_uint8 buf;
...
//OV5640YUV_write_cmos_sensor(0x5302, 0x24);
//OV5640YUV_write_cmos_sensor(0x5303, 0x10);
				break;
...
//OV5640YUV_write_cmos_sensor(0x5302, 0x4f);
//OV5640YUV_write_cmos_sensor(0x5303, 0x10);
				break;
...
kal_uint32 OV5640_set_param_saturation_mode(kal_uint32 para)
{
    ...
    switch (para)
    {
        case ISP_SAT_LOW:
				OV5640YUV_write_cmos_sensor(0x3212, 0x00);
		                     OV5640YUV_write_cmos_sensor(0x5384, 0x05);//0.8
		                     OV5640YUV_write_cmos_sensor(0x5385, 0x68); 
		                     OV5640YUV_write_cmos_sensor(0x5386, 0x6d); 
		                     OV5640YUV_write_cmos_sensor(0x5387, 0x63); 
		                     OV5640YUV_write_cmos_sensor(0x5388, 0x4d); 
		                     OV5640YUV_write_cmos_sensor(0x5389, 0x16); 
				OV5640YUV_write_cmos_sensor(0x3212, 0x10);
				OV5640YUV_write_cmos_sensor(0x3212, 0xa0);
				break;
        ...
        case ISP_SAT_MIDDLE:
				OV5640YUV_write_cmos_sensor(0x3212, 0x00);
		                     OV5640YUV_write_cmos_sensor(0x5384, 0x06);//1.0
        ...
        case ISP_SAT_HIGH:
				OV5640YUV_write_cmos_sensor(0x3212, 0x00);
		                     OV5640YUV_write_cmos_sensor(0x5384, 0x07);//1.2
		                     OV5640YUV_write_cmos_sensor(0x5385, 0x9c); 
		                     OV5640YUV_write_cmos_sensor(0x5386, 0xa3); 
		                     OV5640YUV_write_cmos_sensor(0x5387, 0x95); 
		                     OV5640YUV_write_cmos_sensor(0x5388, 0x73); 
		                     OV5640YUV_write_cmos_sensor(0x5389, 0x22); 
				OV5640YUV_write_cmos_sensor(0x3212, 0x10);
				OV5640YUV_write_cmos_sensor(0x3212, 0xa0);
				break;
...
kal_uint32 OV5640_set_param_contrast_mode(kal_uint32 para)
{
	kal_uint8 buf;
    ...
    switch (para)
    {
        case ISP_CONTRAST_LOW:
				...
				OV5640YUV_write_cmos_sensor(0x5001, 0xa7);
				buf = OV5640YUV_read_cmos_sensor(0x5580);
				buf |= (0x04);
				OV5640YUV_write_cmos_sensor(0x5586, 0x10);
				break;
        ...
        case ISP_CONTRAST_MIDDLE:
				...
				buf = OV5640YUV_read_cmos_sensor(0x5580);
				buf |= (0x04);
				OV5640YUV_write_cmos_sensor(0x5586, 0x20);			
				break;
        ...
        case ISP_CONTRAST_HIGH:
				...
				buf = OV5640YUV_read_cmos_sensor(0x5580);
				buf |= (0x04);
				OV5640YUV_write_cmos_sensor(0x5586, 0x30);
				break;
...
kal_uint32 OV5640_set_param_hue_mode(kal_uint32 para)
{
	kal_uint8 buf;
    ...
    switch (para)
    {
        case ISP_HUE_LOW:
				...
				buf = OV5640YUV_read_cmos_sensor(0x5580);
				buf |= (0x01);
				OV5640YUV_write_cmos_sensor(0x5580, buf);
				buf = OV5640YUV_read_cmos_sensor(0x5588);
				buf |= (0x03);
				OV5640YUV_write_cmos_sensor(0x5588, buf);
				OV5640YUV_write_cmos_sensor(0x5581, 0x40);
				OV5640YUV_write_cmos_sensor(0x5582, 0x6f);
        break;
        ...
        case ISP_HUE_MIDDLE:
				...
				buf &= ~(0x03);
				OV5640YUV_write_cmos_sensor(0x5588, buf);
				OV5640YUV_write_cmos_sensor(0x5581, 0x80);
				OV5640YUV_write_cmos_sensor(0x5582, 0x00);
        break;
...
kal_uint32 OV5640_set_param_metering_mode(kal_uint32 para)
{	
    switch (para)
    {
...
kal_uint32 OV5640_set_param_bright_mode(kal_uint32 para)
{
	kal_uint8 buf;
    ...
    switch (para)
    {
        case ISP_BRIGHT_LOW:
				...
				buf = OV5640YUV_read_cmos_sensor(0x5001);		
				buf |= 0x80;
				OV5640YUV_write_cmos_sensor(0x5001, buf);
				OV5640YUV_write_cmos_sensor(0x5587, 0x20);
				buf = OV5640YUV_read_cmos_sensor(0x5580);
				buf |= 0x04;
				OV5640YUV_write_cmos_sensor(0x5580, buf);
				buf = OV5640YUV_read_cmos_sensor(0x5588);
        ...
        case ISP_BRIGHT_MIDDLE:
				...
				buf |= 0x80;
				OV5640YUV_write_cmos_sensor(0x5001, buf);
				OV5640YUV_write_cmos_sensor(0x5587, 0x00);
				buf = OV5640YUV_read_cmos_sensor(0x5580);
				buf |= 0x04;
				OV5640YUV_write_cmos_sensor(0x5580, buf);
				buf = OV5640YUV_read_cmos_sensor(0x5588);
...
kal_uint32 OV5640_set_param_iso_mode(kal_uint32 para)
{
    ...
    switch (para)
    {
        ...
        case AE_ISO_100:        	
             OV5640YUV_write_cmos_sensor(0x3a18, 0x00);
             OV5640YUV_write_cmos_sensor(0x3a19, 0x3c);
        break;

        case AE_ISO_200:
             OV5640YUV_write_cmos_sensor(0x3a18, 0x00);
             OV5640YUV_write_cmos_sensor(0x3a19, 0x7c);
				break;
        ...
        case AE_ISO_800:
             OV5640YUV_write_cmos_sensor(0x3a18, 0x01);
             OV5640YUV_write_cmos_sensor(0x3a19, 0xf8);
				break;
...
UINT32 OV5640YUVSensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
	...
	break;
	case FID_AF_MODE:
		OV5640_set_param_af_mode(iPara);
	break;
	/*
	case FID_ISP_SAT:
		OV5640_set_param_saturation_mode(iPara);
	break;
	case FID_ISP_CONTRAST:
		OV5640_set_param_contrast_mode(iPara);
	break;
	case FID_ISP_EDGE:
		OV5640_set_param_edge_mode(iPara);
	break;
	case FID_ISP_HUE:
		OV5640_set_param_hue_mode(iPara);
	break;
	case FID_ISP_BRIGHT:
		OV5640_set_param_bright_mode(iPara);
	break;
*/
	case FID_AE_METERING:
		OV5640_set_param_metering_mode(iPara);
	break;
	case FID_AE_ISO:
		OV5640_set_param_iso_mode(iPara);
	break;
	default:
	break;
	}
...
printk("----lxm----OV5640YUVFeatureControl FeatureId=%d\n",FeatureId);
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_INIT_OPERATION_PARA:
        {
            ...
            pSensorOperData->CaptureDelayFrame = 3;        //2 /* wait stable frame when sensor change mode (pre to cap) */
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
            *pFeatureReturnPara32 = 56000000; //19500000;
            *pFeatureParaLen=4;
            break;
...
case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
            OV5640_FOCUS_AD5820_Get_AF_Max_Num_Focus_Areas(pFeatureReturnPara32);            
            *pFeatureParaLen=4;
            break;
case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
            OV5640_FOCUS_AD5820_Get_AE_Max_Num_Metering_Areas(pFeatureReturnPara32);            
            *pFeatureParaLen=4;
            break;
//end
        case SENSOR_FEATURE_INITIALIZE_AF:
            SENSORDB("OV5640_FOCUS_AD5820_Init\n");
            OV5640_FOCUS_AD5820_Init();
            break;
        case SENSOR_FEATURE_CONSTANT_AF:
            SENSORDB("OV5640_FOCUS_AD5820_Constant_Focus\n");
	     printk("kiwi-OV5640_FOCUS_AD5820_Constant_Focus\n");
            OV5640_FOCUS_AD5820_Constant_Focus();
            break;
        ...
        case SENSOR_FEATURE_GET_AF_STATUS:
            //for yuv use:
            printk("----lxm----SENSOR_FEATURE_GET_AF_STATUS pFeatureReturnPara32=0x%x\n",pFeatureReturnPara32);
        ...
        case SENSOR_FEATURE_CANCEL_AF:
            ...
            OV5640_FOCUS_AD5820_Cancel_Focus();//liuxinming
            break;			
...
SENSOR_FUNCTION_STRUCT	SensorFuncOV5640YUV=
{
    OV5640YUVOpen,
    OV5640YUVGetInfo,
    OV5640YUVGetResolution,
