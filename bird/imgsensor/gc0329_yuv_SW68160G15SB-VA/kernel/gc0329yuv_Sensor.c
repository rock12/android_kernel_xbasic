 ...
 * Revision 1.3  2013/09/25 10:56:45  zhoushaohong
 * T3C 效果优化
 *
 * Revision 1.2  2013/09/25 01:17:51  zhoushaohong
 * T3C
 *
 * Revision 1.1  2013/08/29 15:10:17  pengyajun
 * GXQ T3
 *
 * Revision 1.3  2013/07/17 01:47:31  zhoushaohong
 * H84
 *
 * Revision 1.2  2013/07/08 02:48:07  zhoushaohong
 * H84 效果优化
 *
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x76, 0x80);//94

	GC0329_write_cmos_sensor(0x42, 0x00);
	GC0329_write_cmos_sensor(0x77, 0x57);
	GC0329_write_cmos_sensor(0x78, 0x40);//4d betty
	...
	GC0329_write_cmos_sensor(0xb5, 0x09);
	...
	////////////////////AEC////////////////////
	GC0329_set_param_banding(AE_FLICKER_MODE_50HZ);
	GC0329_SET_PAGE1;
	...
	GC0329_write_cmos_sensor(0x51, 0x30);//20
	GC0329_write_cmos_sensor(0x52, 0x0b);
	GC0329_write_cmos_sensor(0x53, 0x20);//18
	GC0329_write_cmos_sensor(0x54, 0x40);//38
	...
	GC0329_write_cmos_sensor(0x5c, 0x33);//34
	...
	GC0329_write_cmos_sensor(0x69, 0x78);//85
	...
	GC0329_SET_PAGE0;	
  GC0329_write_cmos_sensor(0x7a, 0x7b);
	GC0329_write_cmos_sensor(0x7b, 0x7b);////////////////////asde ///////////////////
	GC0329_write_cmos_sensor(0x7c, 0x82);
	//GC0329_write_cmos_sensor(0xa2, 0xff);
	mdelay(400);
	GC0329_write_cmos_sensor(0xf0, 0x07);
	GC0329_write_cmos_sensor(0x44, 0xa0);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0x51,0x28);	//30 betty																																																																							
	GC0329_write_cmos_sensor(0x52,0x10);																																																																									
	GC0329_write_cmos_sensor(0x53,0x10);	//20 betty																																																																							
	GC0329_write_cmos_sensor(0x54,0x10);	//40 betty																																																																					
	...
	GC0329_write_cmos_sensor(0x5c,0x33);																																																																									
	GC0329_write_cmos_sensor(0x5d,0x76);																																																																									
	GC0329_write_cmos_sensor(0x67,0x7d);	//801																																																																								
	GC0329_write_cmos_sensor(0x68,0x5e);	//60																																																																								
	GC0329_write_cmos_sensor(0x69,0x7a);//78																																																																									
	...
	GC0329_write_cmos_sensor(0xd1,0x26);		//34																																																																							
...
/*
	...
	*/
    ...
    pSensorInfo->PreviewDelayFrame = 6;//7 betty
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x5c);// 50//55
