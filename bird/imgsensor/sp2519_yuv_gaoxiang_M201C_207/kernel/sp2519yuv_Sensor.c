...
void SP2519_Sensor_Init(void)
{
	...
	SP2519_write_cmos_sensor(0xeb,0x78);//80
	SP2519_write_cmos_sensor(0xec,0x78);//80
	...
	SP2519_write_cmos_sensor(0xf7,0xe0);
	...
	SP2519_write_cmos_sensor(0x94,0x7d);
	SP2519_write_cmos_sensor(0x95,0x8d);
	SP2519_write_cmos_sensor(0x96,0x9c);
	SP2519_write_cmos_sensor(0x97,0xa8);
	SP2519_write_cmos_sensor(0x98,0xb4);
	SP2519_write_cmos_sensor(0x99,0xbe);
	SP2519_write_cmos_sensor(0x9a,0xc8);
	SP2519_write_cmos_sensor(0x9b,0xd0);
	SP2519_write_cmos_sensor(0x9c,0xd6);
	SP2519_write_cmos_sensor(0x9d,0xdc);
	SP2519_write_cmos_sensor(0x9e,0xe2);
	SP2519_write_cmos_sensor(0x9f,0xe7);
	SP2519_write_cmos_sensor(0xa0,0xea); 
	#endif
	SP2519_write_cmos_sensor(0xfd,0x02); 
	SP2519_write_cmos_sensor(0x15,0xa9); 
	SP2519_write_cmos_sensor(0x16,0x84); 
	SP2519_write_cmos_sensor(0xa0,0xa6);
	SP2519_write_cmos_sensor(0xa1,0xe7); 
	SP2519_write_cmos_sensor(0xa2,0xf4); 
	SP2519_write_cmos_sensor(0xa3,0x0c); 
	SP2519_write_cmos_sensor(0xa4,0x80); 
	SP2519_write_cmos_sensor(0xa5,0xf4); 
	SP2519_write_cmos_sensor(0xa6,0xfa); 
	SP2519_write_cmos_sensor(0xa7,0xc7); 
	SP2519_write_cmos_sensor(0xa8,0xc0); 
	...
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0xd3,0x90);
	SP2519_write_cmos_sensor(0xd4,0x88);
	SP2519_write_cmos_sensor(0xd5,0x88);
	SP2519_write_cmos_sensor(0xd6,0x84);
	SP2519_write_cmos_sensor(0xd7,0x90);
	SP2519_write_cmos_sensor(0xd8,0x88);
	SP2519_write_cmos_sensor(0xd9,0x88);
	SP2519_write_cmos_sensor(0xda,0x84);
	SP2519_write_cmos_sensor(0xfd,0x03);
	...
	SP2519_write_cmos_sensor(0xce,0x08);
	SP2519_write_cmos_sensor(0xfd,0x02);
	...
	SP2519_write_cmos_sensor(0x10,0x70);//88
	SP2519_write_cmos_sensor(0x11,0x70);//88
	SP2519_write_cmos_sensor(0x12,0x70);//88
	SP2519_write_cmos_sensor(0x13,0x70);//8a
	SP2519_write_cmos_sensor(0x14,0x9a);
	SP2519_write_cmos_sensor(0x15,0xaa);
	SP2519_write_cmos_sensor(0x16,0xa0);
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	SP2519_write_cmos_sensor(0xce,0x1a);
	SP2519_write_cmos_sensor(0xe8,0x70);//68
	SP2519_write_cmos_sensor(0xec,0x80);//78
	SP2519_write_cmos_sensor(0xe9,0x80);//78
	SP2519_write_cmos_sensor(0xed,0x90);//88
	SP2519_write_cmos_sensor(0xea,0x80);//78
	SP2519_write_cmos_sensor(0xee,0x88);//80
	SP2519_write_cmos_sensor(0xeb,0x6c);//68
	SP2519_write_cmos_sensor(0xef,0x64);//60
	
	SP2519_write_cmos_sensor(0xfd,0x02);
	//SP2519_write_cmos_sensor(0x0f,0x00);//01 yc  for preview to UXGA  
...

{
	...
	SP2519_write_cmos_sensor(0xcd,0x1a);
	SP2519_write_cmos_sensor(0xce,0x1a);
	SP2519_write_cmos_sensor(0xe8,0x68);//58
	SP2519_write_cmos_sensor(0xec,0x78);//68
	SP2519_write_cmos_sensor(0xe9,0x68);//58
	SP2519_write_cmos_sensor(0xed,0x70);//60
	SP2519_write_cmos_sensor(0xea,0x60);//50
	SP2519_write_cmos_sensor(0xee,0x68);//58
	SP2519_write_cmos_sensor(0xeb,0x58);//48
	SP2519_write_cmos_sensor(0xef,0x50);//40
	SP2519_write_cmos_sensor(0xfd,0x02);
	//SP2519_write_cmos_sensor(0x0f,0x00);
	SP2519_write_cmos_sensor(0x57,0x40);
#endif
...
BOOL SP2519_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_AUTO:
			SP2519_write_cmos_sensor(0xfd,0x02);
			SP2519_write_cmos_sensor(0x26,0xac);
			SP2519_write_cmos_sensor(0x27,0x91);	   
			SP2519_write_cmos_sensor(0xfd,0x01);
			SP2519_write_cmos_sensor(0x32,0x15);
		 break;
	   case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			 ...
			 SP2519_write_cmos_sensor(0x27,0x65);
			 SP2519_write_cmos_sensor(0xfd,0x00);
		 break;
