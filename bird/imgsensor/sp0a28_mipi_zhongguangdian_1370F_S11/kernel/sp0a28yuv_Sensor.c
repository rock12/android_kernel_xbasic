...
#define SP0A28_P0_0xd4	0x60
#define SP0A28_P0_0xd6	0x58
#define SP0A28_P0_0xd7	0x50
#define SP0A28_P0_0xd8	0x70
#define SP0A28_P0_0xd9	0x60
#define SP0A28_P0_0xda	0x58
...
//smooth
	...
	SP0A28_write_cmos_sensor(0x83, 0x60); //   ;raw_gflt_fac_dummy
	SP0A28_write_cmos_sensor(0x84, 0x20); //   ;raw_gflt_fac_lowlight

	SP0A28_write_cmos_sensor(0x85, 0xc0); //;raw_gf_fac_outdoor
	SP0A28_write_cmos_sensor(0x86, 0x90); //;raw_gf_fac_normal
	SP0A28_write_cmos_sensor(0x87, 0x60); //;raw_gf_fac_dummy
	SP0A28_write_cmos_sensor(0x88, 0x20); //;raw_gf_fac_lowlight
	...
	SP0A28_write_cmos_sensor(0x5d, 0x80); 	 //;raw_rb_fac_lowlight
...
//CCM
	...
	#else//zouyu 20131121
	SP0A28_write_cmos_sensor(0xfd, 0x01);
	SP0A28_write_cmos_sensor(0xa0,0xca);
	SP0A28_write_cmos_sensor(0xa1,0xb6);
	SP0A28_write_cmos_sensor(0xa2,0x00);
	SP0A28_write_cmos_sensor(0xa3,0x19);
	SP0A28_write_cmos_sensor(0xa4,0x70);
	SP0A28_write_cmos_sensor(0xa5,0xf7);
	SP0A28_write_cmos_sensor(0xa6,0x18);
	SP0A28_write_cmos_sensor(0xa7,0xc1);
	SP0A28_write_cmos_sensor(0xa8,0xa6);
	SP0A28_write_cmos_sensor(0xa9,0x0c);
	SP0A28_write_cmos_sensor(0xaa,0x30);
	SP0A28_write_cmos_sensor(0xab,0x0c);
	#endif*/
	SP0A28_write_cmos_sensor(0xfd,0x01);
	SP0A28_write_cmos_sensor(0xa0,0xc0);
	SP0A28_write_cmos_sensor(0xa1,0xc0);
	SP0A28_write_cmos_sensor(0xa2,0x00);
	SP0A28_write_cmos_sensor(0xa3,0x19);
	SP0A28_write_cmos_sensor(0xa4,0x70);
	SP0A28_write_cmos_sensor(0xa5,0xf7);
