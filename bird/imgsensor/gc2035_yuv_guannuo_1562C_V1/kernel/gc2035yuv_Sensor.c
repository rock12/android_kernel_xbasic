 ...
 * Revision 1.3  2013/07/04 01:51:58  wangqiang
 * ‘§¿¿∫Ï¬Ãœﬂ
 *
 * Revision 1.1  2013/05/23 03:38:21  ningzhiyu
 * Editor: ningzhiyu
 * Inspector:ningzhiyu
 * Reason: create 72 JB3 module
 * Reference:none
 *
 * Revision 1.3  2013/05/06 11:00:05  lanqilong
 * Editor: lanqilong
 * Inspector:lanqilong
 * Reason:12Y36_klt3061
 * Reference:none
 *
 * Revision 1.1  2013/04/03 01:57:57  huangwenjian
 * Bug[none]
 *
 * Reason:12Y36 3061 syx imgsensor
 * Author:Huangwenjian
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x24 , 0x13); //pad drive  16
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x2a);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x2a);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3e);//
	...
	GC2035_write_cmos_sensor(0x97 , 0x44);// edge effect//65
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x75);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
