...
void OV5645MIPI_night_mode(kal_bool enable)
{
	...
	{ 
      ...
      OV5645MIPI_write_cmos_sensor(0x3a15,0x10);
		  ...
		  {
		  OV5645MIPI_write_cmos_sensor(0x3A00,night|0x04); // 15fps-5fps
      OV5645MIPI_write_cmos_sensor(0x3a02,0x17); 
      OV5645MIPI_write_cmos_sensor(0x3a03,0x10);                         
      OV5645MIPI_write_cmos_sensor(0x3a14,0x17); 
      OV5645MIPI_write_cmos_sensor(0x3a15,0x10);	
	...
	{   /* camera normal mode */                
		  ...
		  if(OV5645MIPISensor.zsd_flag==0)
	    {
			...
			OV5645MIPI_write_cmos_sensor(0x3a02,0x05);
      OV5645MIPI_write_cmos_sensor(0x3a03,0xc4);
      OV5645MIPI_write_cmos_sensor(0x3a14,0x05);
      OV5645MIPI_write_cmos_sensor(0x3a15,0xc4);	
		  }	
		  else
		  {
			OV5645MIPI_write_cmos_sensor(0x3A00,night|0x04); //15fps-10fps             
...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3611, 0xc6);
  ...
  OV5645MIPI_write_cmos_sensor(0x3a00, 0x3c);//30fps-20fps
  OV5645MIPI_write_cmos_sensor(0x3a02, 0x05);
  OV5645MIPI_write_cmos_sensor(0x3a03, 0xc4);
  OV5645MIPI_write_cmos_sensor(0x3a14, 0x05);
  OV5645MIPI_write_cmos_sensor(0x3a15, 0xc4);
  ...
  OV5645MIPI_write_cmos_sensor(0x3612, 0x0b);
  ...
  OV5645MIPI_write_cmos_sensor(0x4837, 0x20);//11
  OV5645MIPI_write_cmos_sensor(0x3824, 0x01);
  OV5645MIPI_write_cmos_sensor(0x5001, 0xa3);
  
  OV5645MIPI_write_cmos_sensor(0x5180, 0xff);//ff
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x62);
  OV5645MIPI_write_cmos_sensor(0x518a, 0x62);
  ...
  OV5645MIPI_write_cmos_sensor(0x5385, 0x71);
  OV5645MIPI_write_cmos_sensor(0x5386, 0x75);
  OV5645MIPI_write_cmos_sensor(0x5387, 0x7a);
  OV5645MIPI_write_cmos_sensor(0x5388, 0x5f);//67
  OV5645MIPI_write_cmos_sensor(0x5389, 0x1b);//13
  ...
  OV5645MIPI_write_cmos_sensor(0x5482, 0x12);
  OV5645MIPI_write_cmos_sensor(0x5483, 0x24);//1e
  ...
  OV5645MIPI_write_cmos_sensor(0x5306, 0x0e);
  OV5645MIPI_write_cmos_sensor(0x5307, 0x1e);
  ...
  OV5645MIPI_write_cmos_sensor(0x5800, 0x29);
  OV5645MIPI_write_cmos_sensor(0x5801, 0x1c);
  OV5645MIPI_write_cmos_sensor(0x5802, 0x16);
  OV5645MIPI_write_cmos_sensor(0x5803, 0x16);
  OV5645MIPI_write_cmos_sensor(0x5804, 0x1e);
  OV5645MIPI_write_cmos_sensor(0x5805, 0x22);
  OV5645MIPI_write_cmos_sensor(0x5806, 0x15);
  ...
  OV5645MIPI_write_cmos_sensor(0x580c, 0x0b);
  ...
  OV5645MIPI_write_cmos_sensor(0x581d, 0x13);
  OV5645MIPI_write_cmos_sensor(0x581e, 0x25);
  OV5645MIPI_write_cmos_sensor(0x581f, 0x1d);
  OV5645MIPI_write_cmos_sensor(0x5820, 0x15);
  OV5645MIPI_write_cmos_sensor(0x5821, 0x15);
  OV5645MIPI_write_cmos_sensor(0x5822, 0x1d);
  OV5645MIPI_write_cmos_sensor(0x5823, 0x27);
  OV5645MIPI_write_cmos_sensor(0x5824, 0x28);
  OV5645MIPI_write_cmos_sensor(0x5825, 0x2f);
  OV5645MIPI_write_cmos_sensor(0x5826, 0x2f);
  OV5645MIPI_write_cmos_sensor(0x5827, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x5828, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x5829, 0x2f);
  OV5645MIPI_write_cmos_sensor(0x582a, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x582b, 0x28);
  OV5645MIPI_write_cmos_sensor(0x582c, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x582d, 0x0f);
  OV5645MIPI_write_cmos_sensor(0x582e, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x582f, 0x46);
  OV5645MIPI_write_cmos_sensor(0x5830, 0x40);
  OV5645MIPI_write_cmos_sensor(0x5831, 0x44);
  OV5645MIPI_write_cmos_sensor(0x5832, 0x0c);
  OV5645MIPI_write_cmos_sensor(0x5833, 0x4f);
  OV5645MIPI_write_cmos_sensor(0x5834, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x5835, 0x28);
  OV5645MIPI_write_cmos_sensor(0x5836, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x5837, 0x0f);
  OV5645MIPI_write_cmos_sensor(0x5838, 0x2c);
  ...
  OV5645MIPI_write_cmos_sensor(0x3a0f, 0x30);
	...
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x51);
  ...
  OV5645MIPI_write_cmos_sensor(0x5682, 0x00);  
  OV5645MIPI_write_cmos_sensor(0x5683, 0x00);
  OV5645MIPI_write_cmos_sensor(0x5684, 0x03); 
  OV5645MIPI_write_cmos_sensor(0x5685, 0xc0);
  OV5645MIPI_write_cmos_sensor(0x5686, 0x02); 
  OV5645MIPI_write_cmos_sensor(0x5687, 0xd0);	
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x2c);//sharpness 0x24
	OV5645MIPI_write_cmos_sensor(0x5303, 0x10);          //0x10
	OV5645MIPI_write_cmos_sensor(0x5306, 0x04);//06 noise
	OV5645MIPI_write_cmos_sensor(0x5307, 0x14);//16
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x4202, 0x02);
	...
	OV5645MIPI_write_cmos_sensor(0x5307, 0x18);
  ...
  spin_lock(&ov5645mipi_drv_lock);
	...
	{	
		 ...
		 else
		 {
		 	  OV5645MIPI_write_cmos_sensor(0x3a00,0x38);
		    OV5645MIPI_write_cmos_sensor(0x3a02,0x0b);
		    OV5645MIPI_write_cmos_sensor(0x3a03,0x70);
		    OV5645MIPI_write_cmos_sensor(0x3a14,0x0b);
		    OV5645MIPI_write_cmos_sensor(0x3a15,0x70);			 	
		 }	 	
	}	 
...
UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 3;//3  1023
...
void OV5645MIPI_set_saturation(UINT16 para)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x5386, 0x75);
  OV5645MIPI_write_cmos_sensor(0x5387, 0x7a);
  OV5645MIPI_write_cmos_sensor(0x5388, 0x67);
  OV5645MIPI_write_cmos_sensor(0x5389, 0x13);
