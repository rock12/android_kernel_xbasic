...
static void S5K4ECGX_MIPI_Init_Setting(void)
{
    ...
    //==================================================================================
             ...
             0x0F12, 0x1416, //70000AE0//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
             ...
             0x0F12, 0x0a0a, //70000B96//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
             ...
             0x0F12, 0x0808, //70000C4C//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
             ...
             0x0F12, 0x0505, //70000D02//AFIT8_ee_iLowShDenoise [7:0] AFIT8_ee_iHighShDenoise
    ...
    //91MHz, 1280x960, Dynamic mode 30~7.5fps
             ...
             0x0F12, 0x0000, //REG_0TC_PCFG_usMinFrTimeMsecMult10  014d
             0x002A, 0x02D0,
    ...
    if (15 >= u2FrameRate)
    {
       switch (scen)
       {
           ...
           case MSDK_SCENARIO_ID_CAMERA_PREVIEW: 
            ...
            S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //REG_xTC_PCFG_usMinFrTimeMsecMult10 //014Ah:30fps
            break;
