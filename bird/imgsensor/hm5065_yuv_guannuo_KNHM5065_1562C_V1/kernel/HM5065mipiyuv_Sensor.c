...
HM5065_write_cmos_sensor(0xffff,0x01);
	...
	HM5065_write_cmos_sensor(0x0130,0xfd);//00
	...
	HM5065_write_cmos_sensor(0x0357,0x3F); //19
	...
	HM5065_write_cmos_sensor(0x0081,0x54); //6E
    ...
    HM5065SENSORDB("[HM5065]CONTROLFLOW enter HM5065_set_brightness function:\n ");
		...
		switch (para)
		{
			...
			case ISP_BRIGHT_HIGH:  
				  HM5065_write_cmos_sensor(0x0130,0x08);
				 break; 
