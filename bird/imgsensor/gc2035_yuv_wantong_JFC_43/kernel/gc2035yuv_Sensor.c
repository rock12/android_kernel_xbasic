 ...
 * Revision 1.1  2013/11/08 06:20:31  xialeijie
 * no message
 *
 * Revision 1.6  2013/11/08 05:59:42  xialeijie
 * no message
 *
 * Revision 1.5  2013/08/13 01:24:45  zhoushaohong
 * 减小拍照延时
 *
 * Revision 1.4  2013/08/07 12:36:14  wangqiang
 * 13C43-T56A
 * 量产装机发现camera拍照花屏的问题
 *
 * Revision 1.3  2013/08/01 06:31:48  wangqiang
 * 13C43_T56A
 * 2035优化
 *
 * Revision 1.2  2013/07/31 07:33:47  lijunchao
 * Finally performance
 *
 * Revision 1.1  2013/07/16 01:20:03  lijunchao
 * commit gc2035 yuv riyong for T56A
 *
 * Revision 1.1  2013/07/03 03:07:59  maliejun
 * 13E43 T9600C驱动调试
 *
		...
		if (GC2035_sensor_cap_state == KAL_FALSE) 
		{
			if (enable) 
			{
				if (GC2035_VEDIO_encode_mode == KAL_TRUE) 
				{
					...
					GC2035_write_cmos_sensor(0x3e, 0x00);
					GC2035_write_cmos_sensor(0xfe, 0x00);
				}
				else 
				{
...
static void GC2035_Sensor_Init(void)
{
  ...
  GC2035_write_cmos_sensor(0xf8 , 0x84);
	...
	GC2035_write_cmos_sensor(0xae , 0x7c);
	...
	GC2035_write_cmos_sensor(0x17 , 0x17); //[0]mirror [1]flip//14
	...
	GC2035_write_cmos_sensor(0x24 , 0x07); //pad drive  16 //0x17 jon 15
	...
	GC2035_write_cmos_sensor(0x13 , 0x90);//y_target//75
	GC2035_write_cmos_sensor(0xfe , 0x00);
...
GC2035_write_cmos_sensor(0xa4 ,0x33); 
GC2035_write_cmos_sensor(0xa5 ,0x33); 
GC2035_write_cmos_sensor(0xa6 ,0x00); 
GC2035_write_cmos_sensor(0xa7 ,0x20); 
GC2035_write_cmos_sensor(0xa8 ,0x00); 
GC2035_write_cmos_sensor(0xa9 ,0x00); 
GC2035_write_cmos_sensor(0xaa ,0x25); 
GC2035_write_cmos_sensor(0xab ,0x13); 
GC2035_write_cmos_sensor(0xac ,0x15);
GC2035_write_cmos_sensor(0xad ,0x29); 
GC2035_write_cmos_sensor(0xae ,0x06); 
GC2035_write_cmos_sensor(0xaf ,0x00); 
GC2035_write_cmos_sensor(0xb0 ,0x19); 
GC2035_write_cmos_sensor(0xb1 ,0x0d); 
GC2035_write_cmos_sensor(0xb2 ,0x0e); 
GC2035_write_cmos_sensor(0xb3 ,0x27); 
GC2035_write_cmos_sensor(0xb4 ,0x19); 
GC2035_write_cmos_sensor(0xb5 ,0x12); 
GC2035_write_cmos_sensor(0xb6 ,0x40); 
GC2035_write_cmos_sensor(0xb7 ,0x4c);
GC2035_write_cmos_sensor(0xb8 ,0x2b); 
GC2035_write_cmos_sensor(0xb9 ,0x97); 
GC2035_write_cmos_sensor(0xba ,0x2c);
GC2035_write_cmos_sensor(0xbb ,0x41); 
GC2035_write_cmos_sensor(0xbc ,0x4c);
GC2035_write_cmos_sensor(0xbd ,0x45); 
GC2035_write_cmos_sensor(0xbe ,0x3c);
GC2035_write_cmos_sensor(0xbf ,0x9e); 
GC2035_write_cmos_sensor(0xc0 ,0x2c);
GC2035_write_cmos_sensor(0xc1 ,0x35);
GC2035_write_cmos_sensor(0xc2 ,0x2a);
GC2035_write_cmos_sensor(0xc3 ,0x37);
GC2035_write_cmos_sensor(0xc4 ,0x26);
GC2035_write_cmos_sensor(0xc5 ,0x5f);
GC2035_write_cmos_sensor(0xc6 ,0x09);
GC2035_write_cmos_sensor(0xc7 ,0x08);
GC2035_write_cmos_sensor(0xc8 ,0x0a);
GC2035_write_cmos_sensor(0xc9 ,0x23);
GC2035_write_cmos_sensor(0xca ,0x15);
GC2035_write_cmos_sensor(0xcb ,0xc6);
GC2035_write_cmos_sensor(0xcc ,0x2c);
GC2035_write_cmos_sensor(0xcd ,0x4b);
GC2035_write_cmos_sensor(0xd0 ,0xff);
GC2035_write_cmos_sensor(0xd2 ,0xcf); 
GC2035_write_cmos_sensor(0xd3 ,0xd2); 
GC2035_write_cmos_sensor(0xd4 ,0xff);
GC2035_write_cmos_sensor(0xd6 ,0xff);
GC2035_write_cmos_sensor(0xd7 ,0xff);
GC2035_write_cmos_sensor(0xd8 ,0xff);
GC2035_write_cmos_sensor(0xda ,0x8e); 
GC2035_write_cmos_sensor(0xdb ,0x8e); 
GC2035_write_cmos_sensor(0xdc ,0xff);
GC2035_write_cmos_sensor(0xde ,0x7f); 
GC2035_write_cmos_sensor(0xdf ,0xad); 
GC2035_write_cmos_sensor(0xfe ,0x00);

*/
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x0d);
	GC2035_write_cmos_sensor(0xc3 , 0x0c);//14
	GC2035_write_cmos_sensor(0xc4 , 0x06);
	GC2035_write_cmos_sensor(0xc8 , 0x29);
	GC2035_write_cmos_sensor(0xc9 , 0x1d);//15
	GC2035_write_cmos_sensor(0xca , 0x14);
	GC2035_write_cmos_sensor(0xbc , 0x2d);
	GC2035_write_cmos_sensor(0xbd , 0x23);//1e
	GC2035_write_cmos_sensor(0xbe , 0x16);
	GC2035_write_cmos_sensor(0xb6 , 0x39);
	GC2035_write_cmos_sensor(0xb7 , 0x1f);//24
	GC2035_write_cmos_sensor(0xb8 , 0x1d);
	GC2035_write_cmos_sensor(0xc5 , 0x00);
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x13);
	GC2035_write_cmos_sensor(0xcc , 0x0e);
	GC2035_write_cmos_sensor(0xcd , 0x0b);
	GC2035_write_cmos_sensor(0xbf , 0x05);
	GC2035_write_cmos_sensor(0xc0 , 0x05);//03
	...
	GC2035_write_cmos_sensor(0xad , 0x04);//03
	GC2035_write_cmos_sensor(0xae , 0x00);
	GC2035_write_cmos_sensor(0xaf , 0x04);
	GC2035_write_cmos_sensor(0xb0 , 0x06);
	GC2035_write_cmos_sensor(0xb1 , 0x02);//05
	GC2035_write_cmos_sensor(0xb2 , 0x02);
	GC2035_write_cmos_sensor(0xb3 , 0x00);
	GC2035_write_cmos_sensor(0xb4 , 0x00);//04
...
/*
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x19);
	GC2035_write_cmos_sensor(0xc3 , 0x12);
	GC2035_write_cmos_sensor(0xc4 , 0x0e);
	GC2035_write_cmos_sensor(0xc8 , 0x38);
	GC2035_write_cmos_sensor(0xc9 , 0x25);
	GC2035_write_cmos_sensor(0xca , 0x21);
	GC2035_write_cmos_sensor(0xbc , 0x40);
	GC2035_write_cmos_sensor(0xbd , 0x2e);
	GC2035_write_cmos_sensor(0xbe , 0x05);
	GC2035_write_cmos_sensor(0xb6 , 0x43);
	GC2035_write_cmos_sensor(0xb7 , 0x18);
	GC2035_write_cmos_sensor(0xb8 , 0x1b);
	GC2035_write_cmos_sensor(0xc5 , 0x00);
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x03);
	GC2035_write_cmos_sensor(0xcc , 0x04);
	...
	GC2035_write_cmos_sensor(0xb9 , 0x14);
	GC2035_write_cmos_sensor(0xba , 0x22);
	GC2035_write_cmos_sensor(0xbb , 0x1b);
	GC2035_write_cmos_sensor(0xaa , 0x1d);
	GC2035_write_cmos_sensor(0xab , 0x20);
	GC2035_write_cmos_sensor(0xac , 0x22);
	GC2035_write_cmos_sensor(0xad , 0x14);
	GC2035_write_cmos_sensor(0xae , 0x15);
	GC2035_write_cmos_sensor(0xaf , 0x16);
	GC2035_write_cmos_sensor(0xb0 , 0x35);
	GC2035_write_cmos_sensor(0xb1 , 0x33);
	GC2035_write_cmos_sensor(0xb2 , 0x33);
	GC2035_write_cmos_sensor(0xb3 , 0x25);
	GC2035_write_cmos_sensor(0xb4 , 0x22);
	GC2035_write_cmos_sensor(0xb5 , 0x27);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x0a);
	GC2035_write_cmos_sensor(0xd3 , 0x00);
	GC2035_write_cmos_sensor(0xd8 , 0x00);
	GC2035_write_cmos_sensor(0xda , 0x0c);
	GC2035_write_cmos_sensor(0xdb , 0x00);
	GC2035_write_cmos_sensor(0xdc , 0x07);
	GC2035_write_cmos_sensor(0xde , 0x08);
	GC2035_write_cmos_sensor(0xdf , 0x00);
	GC2035_write_cmos_sensor(0xd4 , 0x13);
	GC2035_write_cmos_sensor(0xd6 , 0x17);
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x32);//saturation_cb//32 betty
	GC2035_write_cmos_sensor(0xd2 , 0x32);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x3a);//contrast \D3
...
static void GC2035_Sensor_2M(void)
{
	...
	GC2035_write_cmos_sensor(0x9a,0x06);//0x06
	GC2035_write_cmos_sensor(0x9b,0x00);  
	GC2035_write_cmos_sensor(0x9c,0x00);
	GC2035_write_cmos_sensor(0x9d,0x00);
	GC2035_write_cmos_sensor(0x9e,0x00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;//ISP_DRIVING_6MA
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2d, 0x05);//
		GC2035_write_cmos_sensor(0x2e, 0xb4);  
		GC2035_write_cmos_sensor(0x2f, 0x06);//76a
		GC2035_write_cmos_sensor(0x30, 0xd8);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x94);//80   //88
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
