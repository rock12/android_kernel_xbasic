 ...
 * Revision 1.7  2013/09/16 01:11:12  maliejun
 * no message
 *
 * Revision 1.6  2013/09/12 12:20:29  maliejun
 * sp0a19 ©�� 8mA
 *
...
//SP0A19 ini
    ...
    //sharpen
    SP0A19_write_cmos_sensor(0xfd,0x01);
    SP0A19_write_cmos_sensor(0xe2,0x50); //sharpen_y_base //0x30
    SP0A19_write_cmos_sensor(0xe4,0xa0); //sharpen_y_max 

    SP0A19_write_cmos_sensor(0xe5,0x08); //rangek_neg_outdoor  //0x08 0x04
    SP0A19_write_cmos_sensor(0xd3,0x08); //rangek_pos_outdoor	//0x08 0x04
    SP0A19_write_cmos_sensor(0xd7,0x08); //range_base_outdoor	//0x08 0x04

    SP0A19_write_cmos_sensor(0xe6,0x0a); //rangek_neg_normal   // 0x08 0x04
    SP0A19_write_cmos_sensor(0xd4,0x0a); //rangek_pos_normal   // 0x08 0x04
    SP0A19_write_cmos_sensor(0xd8,0x0a); //range_base_normal   // 0x08 0x04

    SP0A19_write_cmos_sensor(0xe7,0x12); //rangek_neg_dummy   // 0x10 0x08
    SP0A19_write_cmos_sensor(0xd5,0x12); //rangek_pos_dummy   // 0x10 0x08
    SP0A19_write_cmos_sensor(0xd9,0x12); //range_base_dummy    // 0x10 0x08

    SP0A19_write_cmos_sensor(0xd2,0x15); //rangek_neg_lowlight 0x10
    SP0A19_write_cmos_sensor(0xd6,0x15); //rangek_pos_lowlight 0x10
    SP0A19_write_cmos_sensor(0xda,0x15); //range_base_lowlight 0x10
    ...
    SP0A19_write_cmos_sensor(0xd3,0x80); //0x78 0x88
    SP0A19_write_cmos_sensor(0xd4,0x80); //0x78  //lj_test 0x88
    SP0A19_write_cmos_sensor(0xd6,0x70); //0x78 	   (0xd7,0x60); //0x78  //lj_test 0x70 0x68
    SP0A19_write_cmos_sensor(0xd7,0x50); //lj_test 0x60 0x58

    //HEQ
    SP0A19_write_cmos_sensor(0xfd,0x00);
    SP0A19_write_cmos_sensor(0xdc,0x00);
    SP0A19_write_cmos_sensor(0xdd,0x7c); //0x80 0813  // 0x78 0x80
    SP0A19_write_cmos_sensor(0xde,0xc4); //80  0x88  0813 //0xa8
...
UINT32 SP0A19Open(void)
{
    ...
    do {
        ...
        SP0A19_write_cmos_sensor(0xfd,0x00);
        sensor_id=SP0A19_read_cmos_sensor(0x02);
        printk("wangdong SP0a19 Sensor id = %x\n", sensor_id); 
        if (sensor_id == SP0A19_SENSOR_ID) {
            break;
        }
        SENSORDB("Read Sensor ID Fail = 0x%x\n", sensor_id);
