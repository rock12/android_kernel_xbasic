  ...
  //ndef AE_and_AF_FACE
	  if((pvx0==pvx1)&&(pvy0==pvy1))
	  {
	   if(CurrentScenarioId == MSDK_SCENARIO_ID_CAMERA_ZSD )
		  ...
		  /*
		  HM5065_write_cmos_sensor(0x0120,0x02);
		  HM5065_write_cmos_sensor(0x0121,0x1C); 
		  HM5065_write_cmos_sensor(0x0122,0x01);
		  HM5065_write_cmos_sensor(0x0123,0x7C);  
		  HM5065_write_cmos_sensor(0x0124,0x00);
		  HM5065_write_cmos_sensor(0x0125,0x32);
		  HM5065_write_cmos_sensor(0x0126,0x00); 		
		  HM5065_write_cmos_sensor(0x0127,0x32);
		  */
...
void HM5065InitialSetting(void)
{
	...
	HM5065_write_cmos_sensor(0x0084,0x00);//modify by jink 0731
	...
	HM5065_write_cmos_sensor(0x0130,0xfb);//00->fe->f9//by jink 0806
	...
	HM5065_write_cmos_sensor(0x0049,0x16);//gamma by jink 0806
	...
	HM5065_write_cmos_sensor(0x0081,0x5a); //6E//60//by jink 0806
	...
	HM5065_write_cmos_sensor(0x0080,0x5c);// modify by jink 20130806
	HM5065_write_cmos_sensor(0x0082,0x60);// modify by jink 20130802
#if 0
...
static const kal_uint8 addr_data_pair1[] =
{
	...
	0x0066,0x02,
	0x0083,0x00,
	0x0084,0x00,// modify by jink 0731
	0x0085,0x02,
	0x00B2,0x50,
	0x00B3,0x80,
	0x00B4,0x01,
	...
	0x058D,	0x3D,
	0x058E,	0x3D,
	0x0080,	0x5c,// modify by jink 20130802
	0x0082,	0x60,//modify by jink 20130802
...
static void HM5065PreviewSetting_SVGA(void)
{
  ...
  HM5065_write_cmos_sensor(0x01fa, 0x01);
	HM5065_write_cmos_sensor(0x01A5, 0x3d);//Hue //3e modify by jink 0731
	HM5065_write_cmos_sensor(0x01A6, 0x9a);//HueRBias //00 modify by jink 0731 
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	//HM5065_FOCUS_OVT_AFC_Init();
	HM5065_set_AE_mode(KAL_TRUE); //modify by jink 0731
...
{   
    ...
    switch (para)
    {
        case ISP_CONTRAST_LOW:
             HM5065_write_cmos_sensor(0x0080,0x58);//by jink 0806
             break; 
        case ISP_CONTRAST_HIGH:
             HM5065_write_cmos_sensor(0x0080,0x68);//by jink 0806
             break; 
        case ISP_CONTRAST_MIDDLE:
             HM5065_write_cmos_sensor(0x0080,0x5c);//by jink 0806
        default:
             break; 
    ...
    HM5065SENSORDB("[HM5065]CONTROLFLOW enter HM5065_set_brightness function:\n ");
		...
		switch (para)
		{
			...
			case ISP_BRIGHT_MIDDLE:
				  HM5065_write_cmos_sensor(0x0130,0xfb);//00->fe//by jink 0806
			default:	
				 break; 
		}
...
void HM5065_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_MIDDLE:
        default:
             HM5065_write_cmos_sensor(0x0081 ,0x5a); //54->60->5a//by jink 0806
             break; 
    }	
...
void HM5065_set_iso(UINT16 para)
{
	...
	HM5065_write_cmos_sensor(0x02C1, 0x00);
	HM5065_write_cmos_sensor(0x02C2, 0x00);
	HM5065_write_cmos_sensor(0x02C3, 0xe0);
				 break; 
		}	
