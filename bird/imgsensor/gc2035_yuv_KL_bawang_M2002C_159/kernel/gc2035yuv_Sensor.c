 ...
 * Revision 1.3  2013/10/30 05:47:59  xialeijie
 * no message
 *
 * Revision 1.2  2013/10/22 09:24:45  xialeijie
 * no message
 *
 * Revision 1.1  2013/09/23 12:44:43  wangdong
 * no message
 *
 * Revision 1.2  2013/07/26 13:16:08  zhoushaohong
 * no message
 *
 * Revision 1.1  2013/07/18 05:25:12  huangwenjian
 * Bug[none]
 *
 * Reason:13C43 Y05C1
 * Author:Huangwenjian
 *
 * Revision 1.3  2013/07/18 05:21:08  huangwenjian
 * Bug[none]
 *
 * Reason:13C43 Y05C1
 * Author:Huangwenjian
 *
 * Revision 1.2  2013/07/10 08:59:23  huangwenjian
 * Bug[none]
 *
 * Reason:13C43 Y05C1 borad debug
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/07/09 07:28:55  huangwenjian
 * Bug[none]
 *
 * Reason:13C43 Y05C1 borad debug
 * Author:Huangwenjian
 *
 * Revision 1.1  2013/06/27 07:51:17  wangqiang
 * 13E43-H82
 * 效果优化；
 *
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0x8f);// 0x02da	0626
	...
	*/
		...
		GC2035_write_cmos_sensor(0x2e, 0x2a);  
	...
	////Record date: 2012-10-24 17:50:24
	...
	GC2035_write_cmos_sensor(0xc5 , 0x3d);//42 
	...
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x80);//green
	GC2035_write_cmos_sensor(0x4e,0x80);//green
	GC2035_write_cmos_sensor(0x4e,0x02);//OPT  
	GC2035_write_cmos_sensor(0x4e,0x04);//office&M60 D65
	GC2035_write_cmos_sensor(0x4e,0x02);//SPL d65&7000K
	GC2035_write_cmos_sensor(0x4d,0x40); ////////////40
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x80);//green
	GC2035_write_cmos_sensor(0x4e,0x80);//M60 CWF&green
	GC2035_write_cmos_sensor(0x4e,0x02);//SPL cwf&OFFICE
	GC2035_write_cmos_sensor(0x4e,0x02);//SPL D50 &M60 D65
	GC2035_write_cmos_sensor(0x4e,0x02);//outdoor
	GC2035_write_cmos_sensor(0x4d,0x50); /////////////50
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x08); //SPL cwf&TL84
	GC2035_write_cmos_sensor(0x4e,0x04);//D50 
	GC2035_write_cmos_sensor(0x4d,0x60); /////////////60
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x20); //SPL A&M60 U30
	GC2035_write_cmos_sensor(0x4d,0x70); /////////////70
	GC2035_write_cmos_sensor(0x4e,0x00); 
	GC2035_write_cmos_sensor(0x4e,0x20);//SPL H
	GC2035_write_cmos_sensor(0x4e,0x20);//M60 A
	GC2035_write_cmos_sensor(0x4d,0x80); //////////////80
	GC2035_write_cmos_sensor(0x4e,0x00);
	GC2035_write_cmos_sensor(0x4e,0x20);//M60 A                     
	GC2035_write_cmos_sensor(0x4f,0x01); 
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x34);//saturation_cb//32 betty//32
	GC2035_write_cmos_sensor(0xd2 , 0x34);//saturation_Cr//32
	GC2035_write_cmos_sensor(0xd3 , 0x3a);//contrast \D3  40 //3c//40
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0x00);//luma_offset // 0x00	0626
	...
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight // 0x02
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x54);// edge effect 45 betty// 0x54	0626//76
	////==============RGB Gamma 
#if 0
   //// small  RGB gamma////
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x84);//80 
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
