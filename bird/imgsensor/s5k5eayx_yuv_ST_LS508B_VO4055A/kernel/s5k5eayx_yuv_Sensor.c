...
static void S5K5EAYX_Init_Setting(void)
	{
		...
		//AE Target    
			...
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0038);   //34 
		...
		//		   AFIT 0	   
			...
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0002);  //AFIT16_SATURATION																					
		...
		//==================================================================================  
			...
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0535); //0535	//REG_0TC_PCFG_usMaxFrTimeMsecMult10 10fps									  
