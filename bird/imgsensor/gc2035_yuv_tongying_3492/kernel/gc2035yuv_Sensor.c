...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xc1, 0x42); ///37 
	GC2035_write_cmos_sensor(0xc2, 0xfc); ///fd
	GC2035_write_cmos_sensor(0xc3, 0x05);  ///02
	GC2035_write_cmos_sensor(0xc4, 0xec);  
	GC2035_write_cmos_sensor(0xc5, 0x42);  
	GC2035_write_cmos_sensor(0xc6, 0xf8);  
	GC2035_write_cmos_sensor(0xc7, 0x38);  ///37
	GC2035_write_cmos_sensor(0xc8, 0xf8);///fb 
	GC2035_write_cmos_sensor(0xc9, 0x06);  ///02
	...
	GC2035_write_cmos_sensor(0xd1, 0x34);  ///38
	...
	GC2035_write_cmos_sensor(0xd5 , 0x10);//luma_offset //00 betty//05
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2d, 0x06);//5b4
		GC2035_write_cmos_sensor(0x2e, 0xd8);  
		GC2035_write_cmos_sensor(0x2f, 0x07);//
		GC2035_write_cmos_sensor(0x30, 0x6a);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
