...
{//update global zone
  ...
  //ndef AE_and_AF_FACE
	  ...
	  else
	  {
		  ...
		  HM5065_write_cmos_sensor(0x0124,(pvx1-pvx0)>>8);
		  HM5065_write_cmos_sensor(0x0125,(pvx1-pvx0)&0xff);
		  HM5065_write_cmos_sensor(0x0126,(pvy1-pvy0)>>8);		
		  HM5065_write_cmos_sensor(0x0127,(pvy1-pvy0)&0xff);
...
{
    kal_uint8 AeTemp;
	HM5065SENSORDB("[HM5065]enter HM5065_set_AE_mode function:\n ");
    //
...
{
	HM5065SENSORDB("[HM5065]enter HM5065_night_mode function:\n ");
		  ...
		  if(HM5065Sensor.VideoMode == KAL_TRUE)
		  {
			  ...
			  printk("HM5065 night_auto mode ture camera preview--------------\r\n");
				...
				//HM5065_write_cmos_sensor(0x0030,0x14);  //  Max.Derate=4
				  ...
				  HM5065_write_cmos_sensor(0x00E8,0x01);//AFR
				  HM5065_write_cmos_sensor(0x00ED,0x05);//Min=12fps	//0c
				  HM5065_write_cmos_sensor(0x00EE,0x1E);//Max=30fps
				  //HM5065_write_cmos_sensor(0x0330,0x01);
...
void HM5065InitialSetting(void)
{
	...
	HM5065_write_cmos_sensor(0x0081,0x58); //6E
	...
	HM5065_write_cmos_sensor(0x0756,0x00);
	...
	HM5065_write_cmos_sensor(0x0770,0x98);
	...
	//20121101
	HM5065_write_cmos_sensor(0x0420,0xff);   //    ; C0_GreenRed_X -120
	HM5065_write_cmos_sensor(0x0421,0x88);   //    ; C0_GreenRed_X_LSB 
	HM5065_write_cmos_sensor(0x0422,0x00);   //    ; C0_GreenRed_Y 40
	HM5065_write_cmos_sensor(0x0423,0x28);   //    ; C0_GreenRed_Y_LSB 
	HM5065_write_cmos_sensor(0x0424,0x00);   //    ; C0_GreenRed_X2 89
	HM5065_write_cmos_sensor(0x0425,0x59);   //    ; C0_GreenRed_X2_LSB 
	HM5065_write_cmos_sensor(0x0426,0x00);   //    ; C0_GreenRed_Y2 125
	HM5065_write_cmos_sensor(0x0427,0x7d);   //    ; C0_GreenRed_Y2_LSB 
	HM5065_write_cmos_sensor(0x0428,0x00);   //    ; C0_GreenRed_XY 11
	HM5065_write_cmos_sensor(0x0429,0x0b);   //    ; C0_GreenRed_XY_LSB 
	HM5065_write_cmos_sensor(0x042A,0x00);   //    ; C0_GreenRed_X2Y 58
	HM5065_write_cmos_sensor(0x042B,0x3a);   //    ; C0_GreenRed_X2Y_LSB 
	HM5065_write_cmos_sensor(0x042C,0xff);   //    ; C0_GreenRed_XY2 -131
	HM5065_write_cmos_sensor(0x042D,0x7d);   //    ; C0_GreenRed_XY2_LSB 
	HM5065_write_cmos_sensor(0x042E,0xff);   //    ; C0_GreenRed_X2Y2 -168
	HM5065_write_cmos_sensor(0x042F,0x58);   //    ; C0_GreenRed_X2Y2_LSB       
	HM5065_write_cmos_sensor(0x0430,0xff);   //    ; C0_Red_X -109   
	HM5065_write_cmos_sensor(0x0431,0x93);   //    ; C0_Red_X_LSB                     
	HM5065_write_cmos_sensor(0x0432,0xff);   //    ; C0_Red_Y -111   
	HM5065_write_cmos_sensor(0x0433,0x91);   //    ; C0_Red_Y_LSB                     
	HM5065_write_cmos_sensor(0x0434,0x00);   //    ; C0_Red_X2 180  
	HM5065_write_cmos_sensor(0x0435,0xb4);   //    ; C0_Red_X2_LSB                    
	HM5065_write_cmos_sensor(0x0436,0x00);   //    ; C0_Red_Y2 234  
	HM5065_write_cmos_sensor(0x0437,0xea);   //    ; C0_Red_Y2_LSB                    
	HM5065_write_cmos_sensor(0x0438,0xff);   //    ; C0_Red_XY -16  
	HM5065_write_cmos_sensor(0x0439,0xf0);   //    ; C0_Red_XY_LSB                    
	HM5065_write_cmos_sensor(0x043A,0x00);   //    ; C0_Red_X2Y 120 
	HM5065_write_cmos_sensor(0x043B,0x78);   //    ; C0_Red_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x043C,0xff);   //    ; C0_Red_XY2 -13 
	HM5065_write_cmos_sensor(0x043D,0xf3);   //    ; C0_Red_XY2_LSB                   
	HM5065_write_cmos_sensor(0x043E,0xfe);   //    ; C0_Red_X2Y2 -326
	HM5065_write_cmos_sensor(0x043F,0xba);   //    ; C0_Red_X2Y2_LSB       
	HM5065_write_cmos_sensor(0x0450,0xff);   //    ; C0_Blue_X -57   
	HM5065_write_cmos_sensor(0x0451,0xc7);   //    ; C0_Blue_X_LSB                     
	HM5065_write_cmos_sensor(0x0452,0xff);   //    ; C0_Blue_Y -28   
	HM5065_write_cmos_sensor(0x0453,0xe4);   //    ; C0_Blue_Y_LSB                     
	HM5065_write_cmos_sensor(0x0454,0x00);   //    ; C0_Blue_X2 60  
	HM5065_write_cmos_sensor(0x0455,0x3c);   //    ; C0_Blue_X2_LSB                    
	HM5065_write_cmos_sensor(0x0456,0x00);   //    ; C0_Blue_Y2 106  
	HM5065_write_cmos_sensor(0x0457,0x6a);   //    ; C0_Blue_Y2_LSB                    
	HM5065_write_cmos_sensor(0x0458,0xff);   //    ; C0_Blue_XY -15  
	HM5065_write_cmos_sensor(0x0459,0xf1);   //    ; C0_Blue_XY_LSB                    
	HM5065_write_cmos_sensor(0x045A,0x00);   //    ; C0_Blue_X2Y 90 
	HM5065_write_cmos_sensor(0x045B,0x5a);   //    ; C0_Blue_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x045C,0xff);   //    ; C0_Blue_XY2 -74 
	HM5065_write_cmos_sensor(0x045D,0xb6);   //    ; C0_Blue_XY2_LSB                   
	HM5065_write_cmos_sensor(0x045E,0xff);   //    ; C0_Blue_X2Y2 -158
	HM5065_write_cmos_sensor(0x045F,0x62);   //    ; C0_Blue_X2Y2_LSB         
	HM5065_write_cmos_sensor(0x0440,0xff);   //    ; C0_GreenBlue_X -123   
	HM5065_write_cmos_sensor(0x0441,0x85);   //    ; C0_GreenBlue_X_LSB                      
	HM5065_write_cmos_sensor(0x0442,0xff);   //    ; C0_GreenBlue_Y -3   
	HM5065_write_cmos_sensor(0x0443,0xfd);   //    ; C0_GreenBlue_Y_LSB                      
	HM5065_write_cmos_sensor(0x0444,0x00);   //    ; C0_GreenBlue_X2 92  
	HM5065_write_cmos_sensor(0x0445,0x5c);   //    ; C0_GreenBlue_X2_LSB                     
	HM5065_write_cmos_sensor(0x0446,0x00);   //    ; C0_GreenBlue_Y2 119  
	HM5065_write_cmos_sensor(0x0447,0x77);   //    ; C0_GreenBlue_Y2_LSB                     
	HM5065_write_cmos_sensor(0x0448,0x00);   //    ; C0_GreenBlue_XY 46  
	HM5065_write_cmos_sensor(0x0449,0x2e);   //    ; C0_GreenBlue_XY_LSB                     
	HM5065_write_cmos_sensor(0x044A,0x00);   //    ; C0_GreenBlue_X2Y 107 
	HM5065_write_cmos_sensor(0x044B,0x6b);   //    ; C0_GreenBlue_X2Y_LSB                    
	HM5065_write_cmos_sensor(0x044C,0xff);   //    ; C0_GreenBlue_XY2 -179 
	HM5065_write_cmos_sensor(0x044D,0x4d);   //    ; C0_GreenBlue_XY2_LSB                    
	HM5065_write_cmos_sensor(0x044E,0xff);   //    ; C0_GreenBlue_X2Y2 -171
	HM5065_write_cmos_sensor(0x044F,0x55);   //    ; C0_GreenBlue_X2Y2_LSB                                
	HM5065_write_cmos_sensor(0x0561,0x0d);   //    ; C0_Unity       
	HM5065_write_cmos_sensor(0x0460,0xff);   //    ; C1_GreenRed_X -106
	HM5065_write_cmos_sensor(0x0461,0x96);   //    ; C1_GreenRed_X_LSB 
	HM5065_write_cmos_sensor(0x0462,0x00);   //    ; C1_GreenRed_Y 37
	HM5065_write_cmos_sensor(0x0463,0x25);   //    ; C1_GreenRed_Y_LSB 
	HM5065_write_cmos_sensor(0x0464,0x00);   //    ; C1_GreenRed_X2 84
	HM5065_write_cmos_sensor(0x0465,0x54);   //    ; C1_GreenRed_X2_LSB 
	HM5065_write_cmos_sensor(0x0466,0x00);   //    ; C1_GreenRed_Y2 111
	HM5065_write_cmos_sensor(0x0467,0x6f);   //    ; C1_GreenRed_Y2_LSB 
	HM5065_write_cmos_sensor(0x0468,0x00);   //    ; C1_GreenRed_XY 8
	HM5065_write_cmos_sensor(0x0469,0x08);   //    ; C1_GreenRed_XY_LSB 
	HM5065_write_cmos_sensor(0x046A,0x00);   //    ; C1_GreenRed_X2Y 78
	HM5065_write_cmos_sensor(0x046B,0x4e);   //    ; C1_GreenRed_X2Y_LSB 
	HM5065_write_cmos_sensor(0x046C,0xff);   //    ; C1_GreenRed_XY2 -156
	HM5065_write_cmos_sensor(0x046D,0x64);   //    ; C1_GreenRed_XY2_LSB 
	HM5065_write_cmos_sensor(0x046E,0xff);   //    ; C1_GreenRed_X2Y2 -148
	HM5065_write_cmos_sensor(0x046F,0x6c);   //    ; C1_GreenRed_X2Y2_LSB       
	HM5065_write_cmos_sensor(0x0470,0xff);   //    ; C1_Red_X -46   
	HM5065_write_cmos_sensor(0x0471,0xd2);   //    ; C1_Red_X_LSB                     
	HM5065_write_cmos_sensor(0x0472,0xff);   //    ; C1_Red_Y -86   
	HM5065_write_cmos_sensor(0x0473,0xaa);   //    ; C1_Red_Y_LSB                     
	HM5065_write_cmos_sensor(0x0474,0x00);   //    ; C1_Red_X2 112  
	HM5065_write_cmos_sensor(0x0475,0x70);   //    ; C1_Red_X2_LSB                    
	HM5065_write_cmos_sensor(0x0476,0x00);   //    ; C1_Red_Y2 158  
	HM5065_write_cmos_sensor(0x0477,0x9e);   //    ; C1_Red_Y2_LSB                    
	HM5065_write_cmos_sensor(0x0478,0xff);   //    ; C1_Red_XY -19  
	HM5065_write_cmos_sensor(0x0479,0xed);   //    ; C1_Red_XY_LSB                    
	HM5065_write_cmos_sensor(0x047A,0x00);   //    ; C1_Red_X2Y 156 
	HM5065_write_cmos_sensor(0x047B,0x9c);   //    ; C1_Red_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x047C,0xff);   //    ; C1_Red_XY2 -65 
	HM5065_write_cmos_sensor(0x047D,0xbf);   //    ; C1_Red_XY2_LSB                   
	HM5065_write_cmos_sensor(0x047E,0xff);   //    ; C1_Red_X2Y2 -208
	HM5065_write_cmos_sensor(0x047F,0x30);   //    ; C1_Red_X2Y2_LSB     
	HM5065_write_cmos_sensor(0x0490,0xff);   //    ; C1_Blue_X -41   
	HM5065_write_cmos_sensor(0x0491,0xd7);   //    ; C1_Blue_X_LSB                     
	HM5065_write_cmos_sensor(0x0492,0xff);   //    ; C1_Blue_Y -41   
	HM5065_write_cmos_sensor(0x0493,0xd7);   //    ; C1_Blue_Y_LSB                     
	HM5065_write_cmos_sensor(0x0494,0x00);   //    ; C1_Blue_X2 54  
	HM5065_write_cmos_sensor(0x0495,0x36);   //    ; C1_Blue_X2_LSB                    
	HM5065_write_cmos_sensor(0x0496,0x00);   //    ; C1_Blue_Y2 95  
	HM5065_write_cmos_sensor(0x0497,0x5f);   //    ; C1_Blue_Y2_LSB                    
	HM5065_write_cmos_sensor(0x0498,0xff);   //    ; C1_Blue_XY -24  
	HM5065_write_cmos_sensor(0x0499,0xe8);   //    ; C1_Blue_XY_LSB                    
	HM5065_write_cmos_sensor(0x049A,0x00);   //    ; C1_Blue_X2Y 113 
	HM5065_write_cmos_sensor(0x049B,0x71);   //    ; C1_Blue_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x049C,0xff);   //    ; C1_Blue_XY2 -112 
	HM5065_write_cmos_sensor(0x049D,0x90);   //    ; C1_Blue_XY2_LSB                   
	HM5065_write_cmos_sensor(0x049E,0xff);   //    ; C1_Blue_X2Y2 -126
	HM5065_write_cmos_sensor(0x049F,0x82);   //    ; C1_Blue_X2Y2_LSB                                                            
	HM5065_write_cmos_sensor(0x0480,0xff);   //    ; C1_GreenBlue_X -115   
	HM5065_write_cmos_sensor(0x0481,0x8d);   //    ; C1_GreenBlue_X_LSB                      
	HM5065_write_cmos_sensor(0x0482,0x00);   //    ; C1_GreenBlue_Y 2   
	HM5065_write_cmos_sensor(0x0483,0x02);   //    ; C1_GreenBlue_Y_LSB                      
	HM5065_write_cmos_sensor(0x0484,0x00);   //    ; C1_GreenBlue_X2 82  
	HM5065_write_cmos_sensor(0x0485,0x52);   //    ; C1_GreenBlue_X2_LSB                     
	HM5065_write_cmos_sensor(0x0486,0x00);   //    ; C1_GreenBlue_Y2 110  
	HM5065_write_cmos_sensor(0x0487,0x6e);   //    ; C1_GreenBlue_Y2_LSB                     
	HM5065_write_cmos_sensor(0x0488,0x00);   //    ; C1_GreenBlue_XY 44  
	HM5065_write_cmos_sensor(0x0489,0x2c);   //    ; C1_GreenBlue_XY_LSB                     
	HM5065_write_cmos_sensor(0x048A,0x00);   //    ; C1_GreenBlue_X2Y 102 
	HM5065_write_cmos_sensor(0x048B,0x66);   //    ; C1_GreenBlue_X2Y_LSB                    
	HM5065_write_cmos_sensor(0x048C,0xff);   //    ; C1_GreenBlue_XY2 -192 
	HM5065_write_cmos_sensor(0x048D,0x40);   //    ; C1_GreenBlue_XY2_LSB                    
	HM5065_write_cmos_sensor(0x048E,0xff);   //    ; C1_GreenBlue_X2Y2 -150
	HM5065_write_cmos_sensor(0x048F,0x6a);   //    ; C1_GreenBlue_X2Y2_LSB                                
	HM5065_write_cmos_sensor(0x0562,0x0c);   //    ; C1_Unity      
	HM5065_write_cmos_sensor(0x04A0,0xff);   //    ; C2_GreenRed_X -94
	HM5065_write_cmos_sensor(0x04A1,0xa2);   //    ; C2_GreenRed_X_LSB 
	HM5065_write_cmos_sensor(0x04A2,0x00);   //    ; C2_GreenRed_Y 36
	HM5065_write_cmos_sensor(0x04A3,0x24);   //    ; C2_GreenRed_Y_LSB 
	HM5065_write_cmos_sensor(0x04A4,0x00);   //    ; C2_GreenRed_X2 86
	HM5065_write_cmos_sensor(0x04A5,0x56);   //    ; C2_GreenRed_X2_LSB 
	HM5065_write_cmos_sensor(0x04A6,0x00);   //    ; C2_GreenRed_Y2 114
	HM5065_write_cmos_sensor(0x04A7,0x72);   //    ; C2_GreenRed_Y2_LSB 
	HM5065_write_cmos_sensor(0x04A8,0x00);   //    ; C2_GreenRed_XY 28
	HM5065_write_cmos_sensor(0x04A9,0x1c);   //    ; C2_GreenRed_XY_LSB 
	HM5065_write_cmos_sensor(0x04AA,0x00);   //    ; C2_GreenRed_X2Y 64
	HM5065_write_cmos_sensor(0x04AB,0x40);   //    ; C2_GreenRed_X2Y_LSB 
	HM5065_write_cmos_sensor(0x04AC,0xff);   //    ; C2_GreenRed_XY2 -114
	HM5065_write_cmos_sensor(0x04AD,0x8e);   //    ; C2_GreenRed_XY2_LSB 
	HM5065_write_cmos_sensor(0x04AE,0xff);   //    ; C2_GreenRed_X2Y2 -155
	HM5065_write_cmos_sensor(0x04AF,0x65);   //    ; C2_GreenRed_X2Y2_LSB        
	HM5065_write_cmos_sensor(0x04B0,0xff);   //    ; C2_Red_X -68   
	HM5065_write_cmos_sensor(0x04B1,0xbc);   //    ; C2_Red_X_LSB                     
	HM5065_write_cmos_sensor(0x04B2,0xff);   //    ; C2_Red_Y -77   
	HM5065_write_cmos_sensor(0x04B3,0xb3);   //    ; C2_Red_Y_LSB                     
	HM5065_write_cmos_sensor(0x04B4,0x00);   //    ; C2_Red_X2 144  
	HM5065_write_cmos_sensor(0x04B5,0x90);   //    ; C2_Red_X2_LSB                    
	HM5065_write_cmos_sensor(0x04B6,0x00);   //    ; C2_Red_Y2 199  
	HM5065_write_cmos_sensor(0x04B7,0xc7);   //    ; C2_Red_Y2_LSB                    
	HM5065_write_cmos_sensor(0x04B8,0xff);   //    ; C2_Red_XY -5  
	HM5065_write_cmos_sensor(0x04B9,0xfb);   //    ; C2_Red_XY_LSB                    
	HM5065_write_cmos_sensor(0x04BA,0x00);   //    ; C2_Red_X2Y 156 
	HM5065_write_cmos_sensor(0x04BB,0x9c);   //    ; C2_Red_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x04BC,0xff);   //    ; C2_Red_XY2 -5 
	HM5065_write_cmos_sensor(0x04BD,0xfb);   //    ; C2_Red_XY2_LSB                   
	HM5065_write_cmos_sensor(0x04BE,0xfe);   //    ; C2_Red_X2Y2 -277
	HM5065_write_cmos_sensor(0x04BF,0xeb);   //    ; C2_Red_X2Y2_LSB        
	HM5065_write_cmos_sensor(0x04D0,0xff);   //    ; C2_Blue_X -39   
	HM5065_write_cmos_sensor(0x04D1,0xd9);   //    ; C2_Blue_X_LSB                     
	HM5065_write_cmos_sensor(0x04D2,0xff);   //    ; C2_Blue_Y -54   
	HM5065_write_cmos_sensor(0x04D3,0xca);   //    ; C2_Blue_Y_LSB                     
	HM5065_write_cmos_sensor(0x04D4,0x00);   //    ; C2_Blue_X2 62  
	HM5065_write_cmos_sensor(0x04D5,0x3e);   //    ; C2_Blue_X2_LSB                    
	HM5065_write_cmos_sensor(0x04D6,0x00);   //    ; C2_Blue_Y2 99  
	HM5065_write_cmos_sensor(0x04D7,0x63);   //    ; C2_Blue_Y2_LSB                    
	HM5065_write_cmos_sensor(0x04D8,0xff);   //    ; C2_Blue_XY -15  
	HM5065_write_cmos_sensor(0x04D9,0xf1);   //    ; C2_Blue_XY_LSB                    
	HM5065_write_cmos_sensor(0x04DA,0x00);   //    ; C2_Blue_X2Y 90 
	HM5065_write_cmos_sensor(0x04DB,0x5a);   //    ; C2_Blue_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x04DC,0xff);   //    ; C2_Blue_XY2 -116 
	HM5065_write_cmos_sensor(0x04DD,0x8c);   //    ; C2_Blue_XY2_LSB                   
	HM5065_write_cmos_sensor(0x04DE,0xff);   //    ; C2_Blue_X2Y2 -135
	HM5065_write_cmos_sensor(0x04DF,0x79);   //    ; C2_Blue_X2Y2_LSB                                                                
	HM5065_write_cmos_sensor(0x04C0,0xff);   //    ; C2_GreenBlue_X -111   
	HM5065_write_cmos_sensor(0x04C1,0x91);   //    ; C2_GreenBlue_X_LSB                      
	HM5065_write_cmos_sensor(0x04C2,0x00);   //    ; C2_GreenBlue_Y 5   
	HM5065_write_cmos_sensor(0x04C3,0x05);   //    ; C2_GreenBlue_Y_LSB                      
	HM5065_write_cmos_sensor(0x04C4,0x00);   //    ; C2_GreenBlue_X2 83  
	HM5065_write_cmos_sensor(0x04C5,0x53);   //    ; C2_GreenBlue_X2_LSB                     
	HM5065_write_cmos_sensor(0x04C6,0x00);   //    ; C2_GreenBlue_Y2 115  
	HM5065_write_cmos_sensor(0x04C7,0x73);   //    ; C2_GreenBlue_Y2_LSB                     
	HM5065_write_cmos_sensor(0x04C8,0x00);   //    ; C2_GreenBlue_XY 60  
	HM5065_write_cmos_sensor(0x04C9,0x3c);   //    ; C2_GreenBlue_XY_LSB                     
	HM5065_write_cmos_sensor(0x04CA,0x00);   //    ; C2_GreenBlue_X2Y 64 
	HM5065_write_cmos_sensor(0x04CB,0x40);   //    ; C2_GreenBlue_X2Y_LSB                    
	HM5065_write_cmos_sensor(0x04CC,0xff);   //    ; C2_GreenBlue_XY2 -159 
	HM5065_write_cmos_sensor(0x04CD,0x61);   //    ; C2_GreenBlue_XY2_LSB                    
	HM5065_write_cmos_sensor(0x04CE,0xff);   //    ; C2_GreenBlue_X2Y2 -157
	HM5065_write_cmos_sensor(0x04CF,0x63);   //    ; C2_GreenBlue_X2Y2_LSB                                 
	HM5065_write_cmos_sensor(0x0563,0x09);   //    ; C2_Unity  
	HM5065_write_cmos_sensor(0x04E0,0xff);   //    ; C3_GreenRed_X -91
	HM5065_write_cmos_sensor(0x04E1,0xa5);   //    ; C3_GreenRed_X_LSB 
	HM5065_write_cmos_sensor(0x04E2,0x00);   //    ; C3_GreenRed_Y 51
	HM5065_write_cmos_sensor(0x04E3,0x33);   //    ; C3_GreenRed_Y_LSB 
	HM5065_write_cmos_sensor(0x04E4,0x00);   //    ; C3_GreenRed_X2 84
	HM5065_write_cmos_sensor(0x04E5,0x54);   //    ; C3_GreenRed_X2_LSB 
	HM5065_write_cmos_sensor(0x04E6,0x00);   //    ; C3_GreenRed_Y2 108
	HM5065_write_cmos_sensor(0x04E7,0x6c);   //    ; C3_GreenRed_Y2_LSB 
	HM5065_write_cmos_sensor(0x04E8,0x00);   //    ; C3_GreenRed_XY 13
	HM5065_write_cmos_sensor(0x04E9,0x0d);   //    ; C3_GreenRed_XY_LSB 
	HM5065_write_cmos_sensor(0x04EA,0x00);   //    ; C3_GreenRed_X2Y 81
	HM5065_write_cmos_sensor(0x04EB,0x51);   //    ; C3_GreenRed_X2Y_LSB 
	HM5065_write_cmos_sensor(0x04EC,0xff);   //    ; C3_GreenRed_XY2 -136
	HM5065_write_cmos_sensor(0x04ED,0x78);   //    ; C3_GreenRed_XY2_LSB 
	HM5065_write_cmos_sensor(0x04EE,0xff);   //    ; C3_GreenRed_X2Y2 -149
	HM5065_write_cmos_sensor(0x04EF,0x6b);   //    ; C3_GreenRed_X2Y2_LSB          
	HM5065_write_cmos_sensor(0x04F0,0xff);   //    ; C3_Red_X -28   
	HM5065_write_cmos_sensor(0x04F1,0xe4);   //    ; C3_Red_X_LSB                     
	HM5065_write_cmos_sensor(0x04F2,0xff);   //    ; C3_Red_Y -44   
	HM5065_write_cmos_sensor(0x04F3,0xd4);   //    ; C3_Red_Y_LSB                     
	HM5065_write_cmos_sensor(0x04F4,0x00);   //    ; C3_Red_X2 103  
	HM5065_write_cmos_sensor(0x04F5,0x67);   //    ; C3_Red_X2_LSB                    
	HM5065_write_cmos_sensor(0x04F6,0x00);   //    ; C3_Red_Y2 155  
	HM5065_write_cmos_sensor(0x04F7,0x9b);   //    ; C3_Red_Y2_LSB                    
	HM5065_write_cmos_sensor(0x04F8,0xff);   //    ; C3_Red_XY -16  
	HM5065_write_cmos_sensor(0x04F9,0xf0);   //    ; C3_Red_XY_LSB                    
	HM5065_write_cmos_sensor(0x04FA,0x00);   //    ; C3_Red_X2Y 168 
	HM5065_write_cmos_sensor(0x04FB,0xa8);   //    ; C3_Red_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x04FC,0xff);   //    ; C3_Red_XY2 -26 
	HM5065_write_cmos_sensor(0x04FD,0xe6);   //    ; C3_Red_XY2_LSB                   
	HM5065_write_cmos_sensor(0x04FE,0xff);   //    ; C3_Red_X2Y2 -214
	HM5065_write_cmos_sensor(0x04FF,0x2a);   //    ; C3_Red_X2Y2_LSB                          
	HM5065_write_cmos_sensor(0x0510,0xff);   //    ; C3_Blue_X -34   
	HM5065_write_cmos_sensor(0x0511,0xde);   //    ; C3_Blue_X_LSB                     
	HM5065_write_cmos_sensor(0x0512,0xff);   //    ; C3_Blue_Y -40   
	HM5065_write_cmos_sensor(0x0513,0xd8);   //    ; C3_Blue_Y_LSB                     
	HM5065_write_cmos_sensor(0x0514,0x00);   //    ; C3_Blue_X2 60  
	HM5065_write_cmos_sensor(0x0515,0x3c);   //    ; C3_Blue_X2_LSB                    
	HM5065_write_cmos_sensor(0x0516,0x00);   //    ; C3_Blue_Y2 97  
	HM5065_write_cmos_sensor(0x0517,0x61);   //    ; C3_Blue_Y2_LSB                    
	HM5065_write_cmos_sensor(0x0518,0xff);   //    ; C3_Blue_XY -33  
	HM5065_write_cmos_sensor(0x0519,0xdf);   //    ; C3_Blue_XY_LSB                    
	HM5065_write_cmos_sensor(0x051A,0x00);   //    ; C3_Blue_X2Y 103 
	HM5065_write_cmos_sensor(0x051B,0x67);   //    ; C3_Blue_X2Y_LSB                   
	HM5065_write_cmos_sensor(0x051C,0xff);   //    ; C3_Blue_XY2 -120 
	HM5065_write_cmos_sensor(0x051D,0x88);   //    ; C3_Blue_XY2_LSB                   
	HM5065_write_cmos_sensor(0x051E,0xff);   //    ; C3_Blue_X2Y2 -133
	HM5065_write_cmos_sensor(0x051F,0x7b);   //    ; C3_Blue_X2Y2_LSB                         
	HM5065_write_cmos_sensor(0x0500,0xff);   //    ; C3_GreenBlue_X -107   
	HM5065_write_cmos_sensor(0x0501,0x95);   //    ; C3_GreenBlue_X_LSB                      
	HM5065_write_cmos_sensor(0x0502,0x00);   //    ; C3_GreenBlue_Y 21   
	HM5065_write_cmos_sensor(0x0503,0x15);   //    ; C3_GreenBlue_Y_LSB                      
	HM5065_write_cmos_sensor(0x0504,0x00);   //    ; C3_GreenBlue_X2 78  
	HM5065_write_cmos_sensor(0x0505,0x4e);   //    ; C3_GreenBlue_X2_LSB                     
	HM5065_write_cmos_sensor(0x0506,0x00);   //    ; C3_GreenBlue_Y2 111  
	HM5065_write_cmos_sensor(0x0507,0x6f);   //    ; C3_GreenBlue_Y2_LSB                     
	HM5065_write_cmos_sensor(0x0508,0x00);   //    ; C3_GreenBlue_XY 46  
	HM5065_write_cmos_sensor(0x0509,0x2e);   //    ; C3_GreenBlue_XY_LSB                     
	HM5065_write_cmos_sensor(0x050A,0x00);   //    ; C3_GreenBlue_X2Y 81 
	HM5065_write_cmos_sensor(0x050B,0x51);   //    ; C3_GreenBlue_X2Y_LSB                    
	HM5065_write_cmos_sensor(0x050C,0xff);   //    ; C3_GreenBlue_XY2 -181 
	HM5065_write_cmos_sensor(0x050D,0x4b);   //    ; C3_GreenBlue_XY2_LSB                    
	HM5065_write_cmos_sensor(0x050E,0xff);   //    ; C3_GreenBlue_X2Y2 -149
	HM5065_write_cmos_sensor(0x050F,0x6b);   //    ; C3_GreenBlue_X2Y2_LSB  
	HM5065_write_cmos_sensor(0x0564,0x08);   //    ; C3_Unity     
	HM5065_write_cmos_sensor(0x0324,0x3a);   //    ; NormRedGain_Cast0 Hor
	HM5065_write_cmos_sensor(0x0325,0x15);   //    ; NormRedGain_Cast0_LSB 0.260254
	HM5065_write_cmos_sensor(0x0326,0x3a);   //    ; NormRedGain_Cast1 IncA
	HM5065_write_cmos_sensor(0x0327,0xe2);   //    ; NormRedGain_Cast1_LSB 0.360352
	HM5065_write_cmos_sensor(0x0328,0x3b);   //    ; NormRedGain_Cast2 CWF
	HM5065_write_cmos_sensor(0x0329,0x34);   //    ; NormRedGain_Cast2_LSB 0.400391
	HM5065_write_cmos_sensor(0x032A,0x3b);   //    ; NormRedGain_Cast3 D65
	HM5065_write_cmos_sensor(0x032B,0x85);   //    ; NormRedGain_Cast3_LSB 0.439941
	HM5065_write_cmos_sensor(0x0320,0x01);   //    ; AntiVignetteControl - Enable
	HM5065_write_cmos_sensor(0x0321,0x04);   //    ; NbOfPresets
	HM5065_write_cmos_sensor(0x0322,0x01);   //    ; AdaptiveAntiVignetteControlEnable - Enable
	HM5065_write_cmos_sensor(0x0323,0x01);   //    ; LoLightAntiVignetteControlDisable - Damper Off
  ...
  HM5065_write_cmos_sensor(0x0420,0x00);
	...
	HM5065_write_cmos_sensor(0x0435,0xba);
	HM5065_write_cmos_sensor(0x0436,0x00);
	HM5065_write_cmos_sensor(0x0437,0xdd);
	...
	HM5065_write_cmos_sensor(0x0454,0x00);
	HM5065_write_cmos_sensor(0x0455,0x52);
	HM5065_write_cmos_sensor(0x0456,0x00);
	HM5065_write_cmos_sensor(0x0457,0x66);
	HM5065_write_cmos_sensor(0x0458,0xff);
	...
	HM5065_write_cmos_sensor(0x0474,0x00);
	HM5065_write_cmos_sensor(0x0475,0x85);
	HM5065_write_cmos_sensor(0x0476,0x00);
	HM5065_write_cmos_sensor(0x0477,0xa5);
	...
	HM5065_write_cmos_sensor(0x04d4,0x00);
	HM5065_write_cmos_sensor(0x04d5,0x53);
	HM5065_write_cmos_sensor(0x04d6,0x00);
	HM5065_write_cmos_sensor(0x04d7,0x67);
	HM5065_write_cmos_sensor(0x04d8,0xff);
	...
	HM5065_write_cmos_sensor(0x0514,0x00);
	HM5065_write_cmos_sensor(0x0515,0x4d);
	HM5065_write_cmos_sensor(0x0516,0x00);
	HM5065_write_cmos_sensor(0x0517,0x61);
...
static void HM5065_FOCUS_OVT_AFC_Constant_Focus(void)
{
	...
	HM5065_write_cmos_sensor(0x0711,0x00);	
...
{
	HM5065_write_cmos_sensor(0x0711,0x01);	
...
{   
    HM5065SENSORDB("[HM5065]enter HM5065_set_contrast function:\n ");
    switch (para)
    {
        case ISP_CONTRAST_LOW:
             HM5065_write_cmos_sensor(0x0080,0x63);
             break; 
        case ISP_CONTRAST_HIGH:
             HM5065_write_cmos_sensor(0x0080,0x83);
             break; 
        case ISP_CONTRAST_MIDDLE:
             HM5065_write_cmos_sensor(0x0080,0x73);
        default:
             break; 
...
{
    HM5065SENSORDB("[HM5065]enter HM5065_set_brightness function:\n ");
    switch (para)
    {
        case ISP_BRIGHT_LOW:
			  HM5065_write_cmos_sensor(0x0082,0x65);
             break; 
        case ISP_BRIGHT_HIGH:  
			  HM5065_write_cmos_sensor(0x0082,0xA3);
             break; 
...
{
	HM5065SENSORDB("[HM5065]enter HM5065_set_saturation function:\n ");
    switch (para)
    {
        case ISP_SAT_HIGH:
             ...
             break; 
        case ISP_SAT_LOW:
             HM5065_write_cmos_sensor(0x0081 ,0x48);
             break; 
        case ISP_SAT_MIDDLE:
        default:
...
void HM5065_set_iso(UINT16 para)
{
	...
	HM5065_write_cmos_sensor(0x015F, 0x00);
	HM5065_write_cmos_sensor(0x02C0, 0x00);
	HM5065_write_cmos_sensor(0x02C1, 0xC0);
	HM5065_write_cmos_sensor(0x02C2, 0x00);
	HM5065_write_cmos_sensor(0x02C3, 0xC0);
				 break; 
		}	
...
{
	HM5065SENSORDB("[HM5065]enter HM5065_set_param_banding function:\n ");
	switch (para)
    {
        ...
        case AE_FLICKER_MODE_AUTO:
		  ...
		  HM5065_write_cmos_sensor(0x0190,0x00);
			HM5065_write_cmos_sensor(0x019C,0x4B);
			HM5065_write_cmos_sensor(0x019D,0x20);
			HM5065SENSORDB("[HM5065]Setup HM5065_set_param_banding is 50Hz\n ");
            break;
        case AE_FLICKER_MODE_60HZ:			
		  ...
		  HM5065_write_cmos_sensor(0x0190,0x00);
			HM5065_write_cmos_sensor(0x019C,0x4B);
			HM5065_write_cmos_sensor(0x019D,0xC0);
			HM5065SENSORDB("[HM5065]Setup HM5065_set_param_banding is 60Hz\n ");
