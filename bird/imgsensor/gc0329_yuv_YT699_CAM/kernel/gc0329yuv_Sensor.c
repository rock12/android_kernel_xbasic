 ...
 * Revision 1.3  2013/09/13 13:24:32  wangqiang
 * modify for 13C43_YT699, by liuxd.
 *
 * Revision 1.2  2013/09/10 12:27:15  pengyajun
 * 优化
 *
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m4);//m5 betty
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x24, 0x3f);
	...
	GC0329_write_cmos_sensor(0xdd, 0x54);
        ...
        GC0329_write_cmos_sensor(0x7a, 0x80);//add betty
	...
	GC0329_write_cmos_sensor(0x13, 0x48);//56 betty
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x68:0x48);//50 betty
