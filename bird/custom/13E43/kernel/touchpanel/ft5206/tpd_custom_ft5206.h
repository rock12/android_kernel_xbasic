...
#if defined(BIRD_TP_PARAM_FWVGA) 
#define TPD_RES_X                480
#define TPD_RES_Y                854

#ifndef BIRD_13C43_S26E
#define TPD_WARP_X
#endif
#define TPD_WARP_Y
...
#ifdef BIRD_13C43_S32E
#define TPD_KEYS                { KEY_SEARCH, KEY_MENU,KEY_BACK}
#else
...
#elif defined(BIRD_TP_PARAM_WVGA)
...
#define TPD_KEY_COUNT           3
#define TPD_KEYS                { KEY_MENU, KEY_HOMEPAGE,KEY_BACK}
#define TPD_KEYS_DIM            {{80,900,160,TPD_BUTTON_HEIGH},{220,900,160,TPD_BUTTON_HEIGH},{400,900,160,TPD_BUTTON_HEIGH}}

#elif defined(BIRD_TP_PARAM_HVGA)
...
#define TPD_KEY_COUNT           3
#define TPD_KEYS                { KEY_MENU, KEY_HOMEPAGE,KEY_BACK}
#define TPD_KEYS_DIM            {{60,530,160,TPD_BUTTON_HEIGH},{160,530,160,TPD_BUTTON_HEIGH},{260,530,160,TPD_BUTTON_HEIGH}}

#else

#error "pls check ft5206 TP PARAM"
