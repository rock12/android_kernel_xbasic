...
cp -u out/host/linux-x86/bin/minigzip  out/host/linux-x86/bin/mkbootfs out/host/linux-x86/bin/mkbootimg out/host/linux-x86/bin/fs_config  out/host/linux-x86/bin/mkyaffs2image  out/host/linux-x86/bin/zipalign  out/host/linux-x86/bin/bsdiff out/host/linux-x86/bin/imgdiff out/host/linux-x86/bin/mkuserimg.sh  out/host/linux-x86/bin/make_ext4fs  out/host/linux-x86/bin/aapt  $ROOTPATH/out/host/linux-x86/bin/
...
if [ -f $1/fota-otaPackage.zip ]; then
echo "delete exist file:$1/fota-otaPackage.zip"
rm -f $1/fota-otaPackage.zip
fi
...
mv otaPackage/otaPackage.zip $1/fota-otaPackage.zip
rm -rf otaPackage
