...
#lvhuaiyi add BIRD_MASS_STORAGE_ON change default usb function to charging
ifeq ($(strip $(MTK_MASS_STORAGE)),yes)
  ifeq ($(strip $(BIRD_MASS_STORAGE_ON)),yes)
