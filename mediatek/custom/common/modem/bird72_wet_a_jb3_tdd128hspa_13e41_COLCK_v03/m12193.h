 ...
 * $Log: m12193.h,v $
 * Revision 1.3  2013/11/07 08:56:00  xuliu
 * no message
 *
 * Revision 1.1  2013/07/04 07:18:12  dinghongzhen
 * 6月27号生成的modem
 *
 *
 ...
 *
 * removed!
 * deliver MAUI_00174200 on 2006/2/27 と 05:12:46.
 *
 *
 * removed!
 * removed!
...
/* Due to 13bits DAC */
      ...
      #if IS_RF_MT6251RF || IS_RF_MT6255RF || IS_RF_MT6163 || IS_RF_MT6162 || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166
#define  PSI_EE               (4711)            /* DAC initial value */
      #else
...
/*MT6167*/ #define  C_PSI_STA     (457)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6167*/ #else
...
/*MT6166*/ #define  C_PSI_STA     (457)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6166*/ #else
