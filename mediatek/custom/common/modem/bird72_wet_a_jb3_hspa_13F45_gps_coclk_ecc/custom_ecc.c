...
const kal_uint16 ecc_default_num[ ][ECC_CUSTOM_DEFAULT_ECC_LENGTH + 1] = 
{
...
#if 1//defined(__OP01__) || defined(__OP02__) || defined(__OP09__) || defined(__CTA_ECC_SUPPORT__)
    ...
    //axioo ecc number add by chengting begin
    {0x0031, 0x0031, 0x0033, 0x0000, 0}, /* 113 */
    {0x0031, 0x0031, 0x0035, 0x0000, 0}, /* 115 */
    //axioo ecc number add by chengting end
