 ...
 * $Log: m12193.h,v $
 * Revision 1.1  2013/09/16 07:34:51  wangtinglong
 * 13F45 COCLK
 *
 *
...
#define  PSI_EE               (4505)            /* DAC initial value */
      #else
#define  PSI_EE               (4505)            /* DAC initial value */
      #endif
   #else                 /* VCTCXO */
...
/*MT6167*/ #define  C_PSI_STA     (537)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6167*/ #else
...
/*MT6166*/ #define  C_PSI_STA     (537)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6166*/ #else
