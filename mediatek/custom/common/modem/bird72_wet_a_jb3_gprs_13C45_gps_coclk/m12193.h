 ...
 * $Log: m12193.h,v $
 * Revision 1.1  2013/09/12 09:27:44  wangtinglong
 * 13C45 COCLK
 *
 *
...
/*MT6167*/ #define  C_PSI_STA     (574)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6167*/ #else
...
/*MT6166*/ #define  C_PSI_STA     (574)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6166*/ #else
