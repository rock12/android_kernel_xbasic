...
/* Evelyn 20090511: open the PFC support bit */
  ...
  #if defined(__BIRD_EDGE_CLOSE__)
   0x80,
  #else
...
/* under construction !*/
   ...
   0x10+ /* supportForUE_GPS_TimingOfCellFrames: 0x10: supported, 0x00 not supported */
#endif
...
#endif    
    0x08+ /* supportEDPDCHPowerInterpolation: 0x08 supported, 0x00 not supported */
