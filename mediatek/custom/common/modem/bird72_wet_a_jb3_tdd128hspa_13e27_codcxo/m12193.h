 ...
 * $Log: m12193.h,v $
 * Revision 1.1  2013/08/12 11:57:37  dinghongzhen
 * no message
 *
 *
...
#define  PSI_EE               (4503)            /* DAC initial value */
      #else
#define  PSI_EE               (4503)            /* DAC initial value */
      #endif
   #else                 /* VCTCXO */
...
/*MT6167*/ #define  C_PSI_STA     (512)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6167*/ #else
...
/*MT6166*/ #define  C_PSI_STA     (512)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6166*/ #else
