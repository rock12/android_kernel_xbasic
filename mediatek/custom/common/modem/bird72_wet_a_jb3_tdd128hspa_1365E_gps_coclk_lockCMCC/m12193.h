 ...
 * 13E45 COCLK
 *
 * Revision 1.1  2013/07/31 00:58:44  wangtinglong
 * 13E45 modem
 *
 *
...
#define  PSI_EE               (4519)            /* DAC initial value */
      #else
#define  PSI_EE               (4519)            /* DAC initial value */
      #endif
   #else                 /* VCTCXO */
...
/*MT6167*/ #define  C_PSI_STA     (594)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6167*/ #else
...
/*MT6166*/ #define  C_PSI_STA     (594)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6166*/ #else
