...
# Generated at 2013-05-14 14:47:30
...
ENLARGE_CODE_BBM = FALSE
  # Description:
  #   To reserve more ROM space for code area bad block replacement.
  # Option Values:
  #   FALSE: Disable this feature and CODE area reserve 2% IMAGE SIZE to do NAND bad block replacement
  #   TRUE: Enable this feature and CODE area reserve 2% FLASH SIZE to do NAND bad block replacement
  # Switch-ability:
  #   [Any] -> [Any]
...
SWLA_SELFSPACE_SUPPORT = FALSE
  # Description:
  #   While it is set to true, use may config the size used by SWLA
  # Option Values:
  #   TRUE: Enabling this feature
...
#[MTK internal used]# ------------------------------ 
ORIGINAL_VERNO = MOLY.WR8.W1319.MD.TG.MP.V1.P4
IC_TEST_TYPE = NONE
  # Description:
  #   N/A
  # Option Values:
...
ORIGINAL_PROJECT_NAME = BIRD72_WET_A_JB3_TDD128HSPA
  # Description:
...
HW_VER = BIRD72_WET_A_JB3_TDD128HSPA_HW
...
# *************************************************************************
COM_DEFS_FOR_MT6166_2G_TDD_CUSTOM  = MT6166_2G_RF MT6166_2G_TDD_CUSTOM
COM_DEFS_FOR_CUSTOM_MT6166_UMTS_TDD  = MT6166_RF CUSTOM_MT6166_UMTS_TDD
# *************************************************************************
# Include MODEM.mak
# *************************************************************************
