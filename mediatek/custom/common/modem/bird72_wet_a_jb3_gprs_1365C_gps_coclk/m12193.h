...
#define  PSI_EE               (4496)            /* DAC initial value */
      #else
#define  PSI_EE               (4496)            /* DAC initial value */
      #endif
   #else                 /* VCTCXO */
...
/*MT6167*/ #define  C_PSI_STA     (633)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6167*/ #else
...
/*MT6166*/ #define  C_PSI_STA     (633)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=8.64   */
/*MT6166*/ #else
