...
SWLA_SELFSPACE_SUPPORT = FALSE     # TRUE:Enabling this feature
                                   # FALSE:Disabling this feature


MODEMRESERVEDSIZE_AUTOCONFIG = TRUE    # TRUE:Image layout is able to be adjusted
                                         # FALSE:Image layout is not able to be adjusted


2G_TX_VOLTAGE_COMPENSATION_SUPPORT = TRUE     # TRUE:2G TX voltage compensation is enable
                                              # FALSE:2G TX voltage compensation is disable


RES_PROT = FALSE     # TRUE:Enable encryption on some important
                     # FALSE:Description:Resource protection is disabled
...
ORIGINAL_PROJECT_NAME = MT6572_DEMO_TDD128HSPA    # 
...
L1_GPS_CO_CLOCK_SUPPORT = TRUE    # Value:TRUE,Description:Fixed AFC is supported.
                                   # Value:FALSE,Description:Fixed AFC is unsupported.

L1_LOCK_AFCDAC_AT_STARTUP_SUPPORT = FALSE    # Value:TRUE,Description:Lock AFC DAC at start-up
                                             #   Value:FALSE,Description:UnLock AFC DAC at start-up
...
UMTS_TDD128_RF_MODULE = MT6572_DEMO_MT6166RF_UMTS_TDD
  # Description:
  #   Modem Capability
  # Option Values:
  #   NA: the RF module used in this project
...
ORIGINAL_VERNO = WR8.W1315.MD.WG.MP.W13.15.P1

VERNO   =   WR8.W1315.MD.WG.MP.W13.15.P1

BUILD   =   BUILD_NO

BRANCH  =   WR8.W1315.MD.WG.MP

HW_VER = MT6572_DEMO_TDD128HSPA_HW
...
COM_DEFS_FOR_MT6572_DEMO_MT6166RF_UMTS_TDD = MT6166_RF
# *************************************************************************
# Include MODEM.mak
# *************************************************************************
...
CUSTOM_OPTION += __UMAC_DCH_LISR__ __GEMINI_3G_SWITCH__ __OP01_3G__
...
CUSTOM_OPTION += __AST_TRACE_TST_ENABLE__ __AST_TL1_TDD_RF_PARAMETER_SUPPORT__ 

CUSTOM_OPTION += __ADD_MEAS_FREQ_NUM__ __PREPARE_TX_AHEAD__

CUSTOM_OPTION += __VSIM__ __NVRAM_IMPORTANT_PARTITIONS__
