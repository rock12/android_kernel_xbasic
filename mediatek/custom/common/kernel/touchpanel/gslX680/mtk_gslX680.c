...
static int tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	if(err < 0)
		{
		printk("mycat tpd_i2c_probe GSLX680 error\n");
		return -1;
		}
	else
		printk("mycat tpd_i2c_probe use GSLX680\n");
...
static int __init tpd_driver_init(void) {
	printk("mycat gslX680 touch panel driver init\n");
...
static void __exit tpd_driver_exit(void) {
	printk("mycat gslX680 touch panel driver exit\n");
