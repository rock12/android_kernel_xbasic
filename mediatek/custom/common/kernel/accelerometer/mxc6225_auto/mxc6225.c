...
static int MXC6225_CheckDeviceID(struct i2c_client *client)
{
    ...
    if ((databuf[0]&0x3f)!=MXC6225_FIXED_DEVID)
    {
        printk("MYCAT MXC6225_CheckDeviceID 0x%x failt!\n ", databuf[0]);
        return MXC6225_ERR_IDENTIFICATION;
    }
    else
    {
        printk("MYCAT MXC6225_CheckDeviceID 0x%x pass!\n ", databuf[0]);
