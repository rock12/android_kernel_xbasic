...
static void init_lcm_registers(void)
{
	...
	send_ctrl_cmd(0xB3A7); send_data_cmd(0x10);
	...
	send_ctrl_cmd(0xC0A3); send_data_cmd(0x12);
	send_ctrl_cmd(0xC0A4); send_data_cmd(0x07);
	...
	send_ctrl_cmd(0xCEAA); send_data_cmd(0x53);
	send_ctrl_cmd(0xCEAB); send_data_cmd(0x00);
	send_ctrl_cmd(0xCEAC); send_data_cmd(0x14);
	...
	send_ctrl_cmd(0xCEB3); send_data_cmd(0x54);
	send_ctrl_cmd(0xCEB4); send_data_cmd(0x00);
	send_ctrl_cmd(0xCEB5); send_data_cmd(0x14);
	...
	send_ctrl_cmd(0xCEBA); send_data_cmd(0x55);
	send_ctrl_cmd(0xCEBB); send_data_cmd(0x00);
	send_ctrl_cmd(0xCEBC); send_data_cmd(0x14);
	...
	send_ctrl_cmd(0xCEC3); send_data_cmd(0x56);
	send_ctrl_cmd(0xCEC4); send_data_cmd(0x00);
	send_ctrl_cmd(0xCEC5); send_data_cmd(0x14);
	...
	send_ctrl_cmd(0xCECA); send_data_cmd(0x57);
	send_ctrl_cmd(0xCECB); send_data_cmd(0x00);
	send_ctrl_cmd(0xCECC); send_data_cmd(0x14);
	...
	send_ctrl_cmd(0xCED3); send_data_cmd(0x58);
	send_ctrl_cmd(0xCED4); send_data_cmd(0x00);
	send_ctrl_cmd(0xCED5); send_data_cmd(0x14);
	...
	send_ctrl_cmd(0xCEDA); send_data_cmd(0x59);
	send_ctrl_cmd(0xCEDB); send_data_cmd(0x00);
	send_ctrl_cmd(0xCEDC); send_data_cmd(0x14);
	send_ctrl_cmd(0xCEDD); send_data_cmd(0x00);
	
	send_ctrl_cmd(0xCBC0); send_data_cmd(0x00);
	send_ctrl_cmd(0xCBC1); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBC2); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBC3); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBC4); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBC5); send_data_cmd(0x00);
	send_ctrl_cmd(0xCBC6); send_data_cmd(0x00);
	send_ctrl_cmd(0xCBC7); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBC8); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBC9); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBCA); send_data_cmd(0x05);
	...
	send_ctrl_cmd(0xCBDA); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBDB); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBDC); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBDD); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBDE); send_data_cmd(0x00);
	
	send_ctrl_cmd(0xCBE0); send_data_cmd(0x00);
	send_ctrl_cmd(0xCBE1); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBE2); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBE3); send_data_cmd(0x05);
	send_ctrl_cmd(0xCBE4); send_data_cmd(0x05);
	...
	send_ctrl_cmd(0xCCA0); send_data_cmd(0x0F);
	send_ctrl_cmd(0xCCA1); send_data_cmd(0x0B);
	send_ctrl_cmd(0xCCA2); send_data_cmd(0x0D);
	send_ctrl_cmd(0xCCA3); send_data_cmd(0x09);
	send_ctrl_cmd(0xCCA4); send_data_cmd(0x00);
	send_ctrl_cmd(0xCCA5); send_data_cmd(0x00);
	send_ctrl_cmd(0xCCA6); send_data_cmd(0x05);
	send_ctrl_cmd(0xCCA7); send_data_cmd(0x01);
	send_ctrl_cmd(0xCCA8); send_data_cmd(0x25);
	send_ctrl_cmd(0xCCA9); send_data_cmd(0x26);
	...
	send_ctrl_cmd(0xCCB7); send_data_cmd(0x0F);
	send_ctrl_cmd(0xCCB8); send_data_cmd(0x0B);
	send_ctrl_cmd(0xCCB9); send_data_cmd(0x0D);
	
	send_ctrl_cmd(0xCCC0); send_data_cmd(0x09);
	...
	send_ctrl_cmd(0xCCD0); send_data_cmd(0x0A);
	send_ctrl_cmd(0xCCD1); send_data_cmd(0x0E);
	...
	send_ctrl_cmd(0xCCD7); send_data_cmd(0x06);
	send_ctrl_cmd(0xCCD8); send_data_cmd(0x26);
	send_ctrl_cmd(0xCCD9); send_data_cmd(0x25);
	...
	send_ctrl_cmd(0xCFC9); send_data_cmd(0x08);
	send_ctrl_cmd(0xCFCA); send_data_cmd(0x03);
	
	send_ctrl_cmd(0xD800); send_data_cmd(0x6f);
	send_ctrl_cmd(0xD801); send_data_cmd(0x6f);
	
	send_ctrl_cmd(0xD900); send_data_cmd(0x19);//0x23
	
	send_ctrl_cmd(0xE100); send_data_cmd(0x09);
	send_ctrl_cmd(0xE101); send_data_cmd(0x0a);
	send_ctrl_cmd(0xE102); send_data_cmd(0x0c);
	send_ctrl_cmd(0xE103); send_data_cmd(0x12);
	send_ctrl_cmd(0xE104); send_data_cmd(0x20);
	send_ctrl_cmd(0xE105); send_data_cmd(0x38);
	send_ctrl_cmd(0xE106); send_data_cmd(0x48);
	send_ctrl_cmd(0xE107); send_data_cmd(0x88);
	send_ctrl_cmd(0xE108); send_data_cmd(0x7a);
	send_ctrl_cmd(0xE109); send_data_cmd(0x90);
	
	send_ctrl_cmd(0xE10A); send_data_cmd(0x76);
	send_ctrl_cmd(0xE10B); send_data_cmd(0x65);
	send_ctrl_cmd(0xE10C); send_data_cmd(0x7e);
	send_ctrl_cmd(0xE10D); send_data_cmd(0x6a);
	send_ctrl_cmd(0xE10E); send_data_cmd(0x70);
	send_ctrl_cmd(0xE10F); send_data_cmd(0x69);
	send_ctrl_cmd(0xE110); send_data_cmd(0x62);
	send_ctrl_cmd(0xE111); send_data_cmd(0x59);
	send_ctrl_cmd(0xE112); send_data_cmd(0x4f);
	send_ctrl_cmd(0xE113); send_data_cmd(0x20);
	
	
	send_ctrl_cmd(0xE200); send_data_cmd(0x09);
	send_ctrl_cmd(0xE201); send_data_cmd(0x0a);
	send_ctrl_cmd(0xE202); send_data_cmd(0x0c);
	send_ctrl_cmd(0xE203); send_data_cmd(0x12);
	send_ctrl_cmd(0xE204); send_data_cmd(0x20);
	send_ctrl_cmd(0xE205); send_data_cmd(0x35);
	send_ctrl_cmd(0xE206); send_data_cmd(0x45);
	send_ctrl_cmd(0xE207); send_data_cmd(0x88);
	send_ctrl_cmd(0xE208); send_data_cmd(0x7a);
	send_ctrl_cmd(0xE209); send_data_cmd(0x90);
	
	send_ctrl_cmd(0xE20A); send_data_cmd(0x76);
	send_ctrl_cmd(0xE20B); send_data_cmd(0x66);
	send_ctrl_cmd(0xE20C); send_data_cmd(0x7d);
	send_ctrl_cmd(0xE20D); send_data_cmd(0x69);
	send_ctrl_cmd(0xE20E); send_data_cmd(0x6f);
	send_ctrl_cmd(0xE20F); send_data_cmd(0x69);
	send_ctrl_cmd(0xE210); send_data_cmd(0x62);
	send_ctrl_cmd(0xE211); send_data_cmd(0x59);
	send_ctrl_cmd(0xE212); send_data_cmd(0x4e);
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8012_hansen_HS5063FWNC39_02_CPT_mcu18_fwvga_lcm_drv =
    {
        .name		= "otm8012_hansen_HS5063FWNC39_02_CPT_mcu18_fwvga",
