...
static void RX_LCM_INIT(void)
{
	...
	data_array[1]=0x040000B1; //06->04
	data_array[2]=0x111059E8; 
	data_array[3]=0x453DF491;//F1->F4  0x453DF4D1;
	data_array[4]=0x01422E2E; 
	data_array[5]=0xE600F758; 
	dsi_set_cmdq(&data_array, 6, 1);
	data_array[0]=0x00043902;
	...
	data_array[0]=0x00053902;
	data_array[1]=0x009D00B6; //0x009400B6;
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8389b_zhuoershi_MSZ50172N50X2H_HSD_dsi_vdo_qhd_lcm_drv = 
{
    .name			= "hx8389b_zhuoershi_MSZ50172N50X2H_HSD_dsi_vdo_qhd",
