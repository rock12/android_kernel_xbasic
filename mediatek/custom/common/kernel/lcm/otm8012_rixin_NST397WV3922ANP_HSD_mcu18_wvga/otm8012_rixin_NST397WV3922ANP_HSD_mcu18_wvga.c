...
static void init_lcm_registers(void)
{
	...
	if ( get_lcd_id()==1 )		//otm8012+TN+HSD
	{
			#if defined(BUILD_LK)
			        printf("mycat LCD otm8012_rixin_NST397WV3922ANP_mcu_wvga_lcm_drv \n");
			#endif
			
			
			//============ OTM8009A+HSD3.97 20120613 ===============================================//
			...
			send_ctrl_cmd(0xB390); send_data_cmd(0x03);
			...
			send_ctrl_cmd(0xF5BC); send_data_cmd(0xB0);
			send_ctrl_cmd(0xF5BD); send_data_cmd(0x18);
		
			send_ctrl_cmd(0xC0B4); send_data_cmd(0x11); // 0x55 // inversion : 0x55  column    0x00  1 Dot    
			...
			send_ctrl_cmd(0xD900); send_data_cmd(0x5E);  //45  50  vcom adj flicker
		
			send_ctrl_cmd(0xE100); send_data_cmd(0x04);
			send_ctrl_cmd(0xE101); send_data_cmd(0x04);
			send_ctrl_cmd(0xE102); send_data_cmd(0x08);
			send_ctrl_cmd(0xE103); send_data_cmd(0x0C);
			send_ctrl_cmd(0xE104); send_data_cmd(0x16);
			send_ctrl_cmd(0xE105); send_data_cmd(0x26);
			send_ctrl_cmd(0xE106); send_data_cmd(0x2D);
			send_ctrl_cmd(0xE107); send_data_cmd(0x63);
			send_ctrl_cmd(0xE108); send_data_cmd(0x57);
			send_ctrl_cmd(0xE109); send_data_cmd(0x71);
		
			send_ctrl_cmd(0xE100); send_data_cmd(0x92);
			send_ctrl_cmd(0xE101); send_data_cmd(0x7D);
			send_ctrl_cmd(0xE102); send_data_cmd(0x92);
			send_ctrl_cmd(0xE103); send_data_cmd(0x7A);
			send_ctrl_cmd(0xE104); send_data_cmd(0x7E);
			send_ctrl_cmd(0xE105); send_data_cmd(0x76);
			send_ctrl_cmd(0xE106); send_data_cmd(0x6E);
			send_ctrl_cmd(0xE107); send_data_cmd(0x64);
			send_ctrl_cmd(0xE108); send_data_cmd(0x59);
			send_ctrl_cmd(0xE109); send_data_cmd(0x20);
		
			send_ctrl_cmd(0xE200); send_data_cmd(0x04);
			send_ctrl_cmd(0xE201); send_data_cmd(0x04);
			send_ctrl_cmd(0xE202); send_data_cmd(0x08);
			send_ctrl_cmd(0xE203); send_data_cmd(0x0C);
			send_ctrl_cmd(0xE204); send_data_cmd(0x16);
			send_ctrl_cmd(0xE205); send_data_cmd(0x26);
			send_ctrl_cmd(0xE206); send_data_cmd(0x2D);
			send_ctrl_cmd(0xE207); send_data_cmd(0x63);
			send_ctrl_cmd(0xE208); send_data_cmd(0x58);
			send_ctrl_cmd(0xE209); send_data_cmd(0x72);
		
			send_ctrl_cmd(0xE200); send_data_cmd(0x92);
			send_ctrl_cmd(0xE201); send_data_cmd(0x7D);
			send_ctrl_cmd(0xE202); send_data_cmd(0x92);
			send_ctrl_cmd(0xE203); send_data_cmd(0x7A);
			send_ctrl_cmd(0xE204); send_data_cmd(0x7E);
			send_ctrl_cmd(0xE205); send_data_cmd(0x76);
			send_ctrl_cmd(0xE206); send_data_cmd(0x6E);
			send_ctrl_cmd(0xE207); send_data_cmd(0x64);
			send_ctrl_cmd(0xE208); send_data_cmd(0x58);
			send_ctrl_cmd(0xE209); send_data_cmd(0x20);
			...
			send_ctrl_cmd(0x3A00); send_data_cmd(0x0066);     //MCU 24 bits 
	...
	else			//otm8012+IPS+CMI
	{
        ...
        printf("mycat LCD otm8012_nisin_NST397WV3932ANP_mcu_wvga_lcm_drv \n");
			...
			send_ctrl_cmd(0xB0C6); send_data_cmd(0x03);
			...
			send_ctrl_cmd(0xC0B4); send_data_cmd(0x55);//11
			...
			send_ctrl_cmd(0xC582); send_data_cmd(0xF0);
			send_ctrl_cmd(0xC583); send_data_cmd(0x55);
			...
			send_ctrl_cmd(0xCE84); send_data_cmd(0x03);
			send_ctrl_cmd(0xCE85); send_data_cmd(0x00);
			send_ctrl_cmd(0xCE86); send_data_cmd(0x87);
			send_ctrl_cmd(0xCE87); send_data_cmd(0x03);
			send_ctrl_cmd(0xCE88); send_data_cmd(0x00);
			send_ctrl_cmd(0xCE89); send_data_cmd(0x86);
			send_ctrl_cmd(0xCE8A); send_data_cmd(0x03);
			send_ctrl_cmd(0xCE8B); send_data_cmd(0x00);

			send_ctrl_cmd(0xCE90); send_data_cmd(0x33);
			send_ctrl_cmd(0xCE91); send_data_cmd(0x26);
			send_ctrl_cmd(0xCE92); send_data_cmd(0x00);
			send_ctrl_cmd(0xCE93); send_data_cmd(0x33);
			send_ctrl_cmd(0xCE94); send_data_cmd(0x27);
			send_ctrl_cmd(0xCE95); send_data_cmd(0x00);

			send_ctrl_cmd(0xCEA0); send_data_cmd(0x38);
			send_ctrl_cmd(0xCEA1); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEA2); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEA3); send_data_cmd(0x20);
			send_ctrl_cmd(0xCEA4); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEA5); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEA6); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEA7); send_data_cmd(0x38);
			...
			send_ctrl_cmd(0xCEA9); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEAA); send_data_cmd(0x21);
			send_ctrl_cmd(0xCEAB); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEAC); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEAD); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCEB2); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEB3); send_data_cmd(0x22);
			send_ctrl_cmd(0xCEB4); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEB5); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEB6); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCEB8); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEB9); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEBA); send_data_cmd(0x23);
			send_ctrl_cmd(0xCEBB); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEBC); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEBD); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCEC2); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEC3); send_data_cmd(0x24);
			send_ctrl_cmd(0xCEC4); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEC5); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEC6); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEC7); send_data_cmd(0x30);
			...
			send_ctrl_cmd(0xCEC9); send_data_cmd(0x03);
			send_ctrl_cmd(0xCECA); send_data_cmd(0x25);
			send_ctrl_cmd(0xCECB); send_data_cmd(0x00);
			send_ctrl_cmd(0xCECC); send_data_cmd(0x00);
			send_ctrl_cmd(0xCECD); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCED2); send_data_cmd(0x03);
			send_ctrl_cmd(0xCED3); send_data_cmd(0x26);
			send_ctrl_cmd(0xCED4); send_data_cmd(0x00);
			send_ctrl_cmd(0xCED5); send_data_cmd(0x00);
			send_ctrl_cmd(0xCED6); send_data_cmd(0x00);
			send_ctrl_cmd(0xCED7); send_data_cmd(0x30);
			...
			send_ctrl_cmd(0xCED9); send_data_cmd(0x03);
			send_ctrl_cmd(0xCEDA); send_data_cmd(0x27);
			send_ctrl_cmd(0xCEDB); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEDC); send_data_cmd(0x00);
			send_ctrl_cmd(0xCEDD); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCBC5); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBC6); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBC7); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBC8); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBC9); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBCA); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBCB); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBCC); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBCD); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBCE); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCBDE); send_data_cmd(0x54);

			send_ctrl_cmd(0xCBE0); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBE1); send_data_cmd(0x54);
			send_ctrl_cmd(0xCBE2); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBE3); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBE4); send_data_cmd(0x00);
			send_ctrl_cmd(0xCBE5); send_data_cmd(0x00);
			...
			send_ctrl_cmd(0xCCD0); send_data_cmd(0x00);
			send_ctrl_cmd(0xCCD1); send_data_cmd(0x06);
			send_ctrl_cmd(0xCCD2); send_data_cmd(0x00);
			send_ctrl_cmd(0xCCD3); send_data_cmd(0x0C);
			send_ctrl_cmd(0xCCD4); send_data_cmd(0x0A);
			send_ctrl_cmd(0xCCD5); send_data_cmd(0x10);
			send_ctrl_cmd(0xCCD6); send_data_cmd(0x0E);
			...
			send_ctrl_cmd(0xD800); send_data_cmd(0x83);  //83
			send_ctrl_cmd(0xD801); send_data_cmd(0x80);  //83

			send_ctrl_cmd(0xD900); send_data_cmd(0x78);//Vcom  5e  68

			send_ctrl_cmd(0xE100); send_data_cmd(0x1C);
			send_ctrl_cmd(0xE101); send_data_cmd(0x25);
			send_ctrl_cmd(0xE102); send_data_cmd(0x2D);
			send_ctrl_cmd(0xE103); send_data_cmd(0x36);
			send_ctrl_cmd(0xE104); send_data_cmd(0x41);
			send_ctrl_cmd(0xE105); send_data_cmd(0x4D);
			send_ctrl_cmd(0xE106); send_data_cmd(0x4D);
			send_ctrl_cmd(0xE107); send_data_cmd(0x78);
			send_ctrl_cmd(0xE108); send_data_cmd(0x69);
			send_ctrl_cmd(0xE109); send_data_cmd(0x84);
			send_ctrl_cmd(0xE10A); send_data_cmd(0x7C);
			send_ctrl_cmd(0xE10B); send_data_cmd(0x63);
			send_ctrl_cmd(0xE10C); send_data_cmd(0x70);
			send_ctrl_cmd(0xE10D); send_data_cmd(0x46);
			send_ctrl_cmd(0xE10E); send_data_cmd(0x41);
			send_ctrl_cmd(0xE10F); send_data_cmd(0x34);
			send_ctrl_cmd(0xE110); send_data_cmd(0x27);
			send_ctrl_cmd(0xE111); send_data_cmd(0x1F);
			send_ctrl_cmd(0xE112); send_data_cmd(0x25);
			send_ctrl_cmd(0xE113); send_data_cmd(0x1F);
			
			send_ctrl_cmd(0xE200); send_data_cmd(0x1C);
			send_ctrl_cmd(0xE201); send_data_cmd(0x26);
			send_ctrl_cmd(0xE202); send_data_cmd(0x2D);
			send_ctrl_cmd(0xE203); send_data_cmd(0x36);
			send_ctrl_cmd(0xE204); send_data_cmd(0x41);
			send_ctrl_cmd(0xE205); send_data_cmd(0x4D);
			send_ctrl_cmd(0xE206); send_data_cmd(0x4D);
			send_ctrl_cmd(0xE207); send_data_cmd(0x78);
			send_ctrl_cmd(0xE208); send_data_cmd(0x69);
			send_ctrl_cmd(0xE209); send_data_cmd(0x84);
			send_ctrl_cmd(0xE20A); send_data_cmd(0x7C);
			send_ctrl_cmd(0xE20B); send_data_cmd(0x63);
			send_ctrl_cmd(0xE20C); send_data_cmd(0x70);
			send_ctrl_cmd(0xE20D); send_data_cmd(0x46);
			send_ctrl_cmd(0xE20E); send_data_cmd(0x41);
			send_ctrl_cmd(0xE20F); send_data_cmd(0x34);
			send_ctrl_cmd(0xE210); send_data_cmd(0x27);
			send_ctrl_cmd(0xE211); send_data_cmd(0x1F);
			send_ctrl_cmd(0xE212); send_data_cmd(0x25);
			send_ctrl_cmd(0xE213); send_data_cmd(0x1F);

			send_ctrl_cmd(0x3A00); send_data_cmd(0x66);
			//send_ctrl_cmd(0x3600); send_data_cmd(0x80);
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8012_rixin_NST397WV3922ANP_HSD_mcu18_wvga_lcm_drv =
    {
        .name		= "otm8012_rixin_NST397WV3922ANP_HSD_mcu18_wvga",
