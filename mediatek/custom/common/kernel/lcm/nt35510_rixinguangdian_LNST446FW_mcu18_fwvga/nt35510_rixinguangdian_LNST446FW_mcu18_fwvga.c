...
//#AVDD Set AVDD 5.2V
WriteCmd(0xB000);WriteDat(0x0c);  //0d
WriteCmd(0xB001);WriteDat(0x0c);
WriteCmd(0xB002);WriteDat(0x0c);

//#AVDD ratio
WriteCmd(0xB600);WriteDat(0x34);
WriteCmd(0xB601);WriteDat(0x34);
WriteCmd(0xB602);WriteDat(0x34);
 
//#AVEE  -5.2V
WriteCmd(0xB100);WriteDat(0x0c);//0d
WriteCmd(0xB101);WriteDat(0x0c);
WriteCmd(0xB102);WriteDat(0x0c);
//#AVEE ratio
WriteCmd(0xB700);WriteDat(0x35);
WriteCmd(0xB701);WriteDat(0x35);
WriteCmd(0xB702);WriteDat(0x35);

//#VCL  -2.5V
WriteCmd(0xB200);WriteDat(0x00);
WriteCmd(0xB201);WriteDat(0x00);
WriteCmd(0xB202);WriteDat(0x00);

//#VCL ratio
WriteCmd(0xB800);WriteDat(0x24);
WriteCmd(0xB801);WriteDat(0x24);
WriteCmd(0xB802);WriteDat(0x24);

//#VGH 15V  
WriteCmd(0xBF00);WriteDat(0x01);

WriteCmd(0xB300);WriteDat(0x08);
WriteCmd(0xB301);WriteDat(0x08);
WriteCmd(0xB302);WriteDat(0x08);

//#VGH ratio
WriteCmd(0xB900);WriteDat(0x37);//34  sanyi
WriteCmd(0xB901);WriteDat(0x37);
WriteCmd(0xB902);WriteDat(0x37);

//#VGLX ratio
WriteCmd(0xBA00);WriteDat(0x24);
WriteCmd(0xBA01);WriteDat(0x24);
WriteCmd(0xBA02);WriteDat(0x24);

//#VGMP/VGSP 4.7V/0V
WriteCmd(0xBC00);WriteDat(0x00);
WriteCmd(0xBC01);WriteDat(0xA0);
WriteCmd(0xBC02);WriteDat(0x00);

//#VGMN/VGSN -4.7V/0V
WriteCmd(0xBD00);WriteDat(0x00);
WriteCmd(0xBD01);WriteDat(0xA0);
WriteCmd(0xBD02);WriteDat(0x00);

//#VCOM 1.525V 
WriteCmd(0xBE00);WriteDat(0x00);
WriteCmd(0xBE01);WriteDat(0x9e);//89
...
//#Gate EQ control
WriteCmd(0xB700);WriteDat(0x70);
WriteCmd(0xB701);WriteDat(0x70);
...
WriteCmd(0xBC00);WriteDat(0x03);//00
WriteCmd(0xBC01);WriteDat(0x03);
WriteCmd(0xBC02);WriteDat(0x03);
...
WriteCmd(0xBD01);WriteDat(0x6c);
WriteCmd(0xBD02);WriteDat(0x1d);
WriteCmd(0xBD03);WriteDat(0x1d);
...
LCM_DRIVER nt35510_rixinguangdian_LNST446FW_mcu18_fwvga_lcm_drv =
    {
        .name			= "nt35510_rixinguangdian_LNST446FW_mcu18_fwvga",
