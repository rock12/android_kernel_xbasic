...
//#AVDD Set AVDD 5.2V
send_ctrl_cmd(0xB000);send_data_cmd(0x0D);//0x0D
send_ctrl_cmd(0xB001);send_data_cmd(0x0D);//0x0D
send_ctrl_cmd(0xB002);send_data_cmd(0x0D);//0x0D

//#AVDD ratio
send_ctrl_cmd(0xB600);send_data_cmd(0x34); //34
send_ctrl_cmd(0xB601);send_data_cmd(0x34);
send_ctrl_cmd(0xB602);send_data_cmd(0x34);
 
//#AVEE  -5.2V
send_ctrl_cmd(0xB100);send_data_cmd(0x0D);  //0x0D
send_ctrl_cmd(0xB101);send_data_cmd(0x0D);  //0x0D
send_ctrl_cmd(0xB102);send_data_cmd(0x0D);  //0x0D
...
//#Gate EQ control
send_ctrl_cmd(0xB700);send_data_cmd(0x74);
send_ctrl_cmd(0xB701);send_data_cmd(0x74);
...
send_ctrl_cmd(0xBC00);send_data_cmd(0x02);//02
...
send_ctrl_cmd(0xC901);send_data_cmd(0x82);
send_ctrl_cmd(0xC902);send_data_cmd(0x50); 
send_ctrl_cmd(0xC903);send_data_cmd(0x50);//28
send_ctrl_cmd(0xC904);send_data_cmd(0x50);//28

//#Timing control  Frame Rate
send_ctrl_cmd(0xBD00);send_data_cmd(0x01);
send_ctrl_cmd(0xBD01);send_data_cmd(0x90); //70 90
send_ctrl_cmd(0xBD02);send_data_cmd(0x1A);
send_ctrl_cmd(0xBD03);send_data_cmd(0x10);
...
//send_ctrl_cmd(0x4400);send_data_cmd(0x02);
//send_ctrl_cmd(0x4401);send_data_cmd(0xDC);
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dbi.parallel.read_latency   = 26;//18
    params->dbi.parallel.wait_period    = 8;
...
LCM_DRIVER nt35510_xyl_xyl45124_mcu_fwvga_lcm_drv =
    {
        .name			= "nt35510_xyl_xyl45124_mcu_fwvga",
