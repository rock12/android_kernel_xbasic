...
static struct LCM_setting_table lcm_initialization_setting[] = {
    ...
    {REGFLAG_DELAY, 10, {}},
	{0x00,	1,	{0xB4}},
	{0xC0,	1,	{0x10}},//0x50	//inversion point:0x00, 1+2:0x10, colume:0x50
    {0x00,	1,	{0x80}},
	{0xC1,	2,	{0x36,0x77}},
	{0x00,	1,	{0x89}},
	{0xC0,	1,	{0x01}},
	...
	{0x00,	1,	{0x90}},
	{0xC5,	3,	{0xd6,0x57,0x01}},
	{0x00,	1,	{0xb0}},
	{0xC5,	2,	{0x05,0xAc}},
	{0x00,	1,	{0x00}},
	{0xd8,	2,	{0xa7,0xa7}},//GVDD
	{0x00,	1,	{0x00}},
	{0xd9,	1,	{0x64}},//vcom
	{0x00,	1,	{0xa2}},
	...
	{0x00,	1,	{0x00}},
	{0xe1,	16,	{0x00,0x10,0x16,0x10,0x08,0x0d,0x09,0x07,0x05,0x06,0x11,0x08,0x0f,0x0d,0x08,0x03}},
	{0x00,	1,	{0x00}},
	{0xe2,	16,	{0x00,0x10,0x16,0x10,0x08,0x0d,0x09,0x07,0x05,0x06,0x11,0x08,0x0f,0x0d,0x08,0x03}},
	{0x00,	1,	{0xb1}},
	...
	{0x00,	1,	{0x80}},
	{0xC4,	1,	{0x9c}}, // source output levels during porch                         
	{0x00,	1,	{0x00}},
...
static unsigned int lcm_compare_id()
{
    ...
    Lcd_Log("mycat chuangxing lcd id: 0x%08x\n", id);
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm9608a_chuangxing_CH45L1190V0_LG_dsi_2_qhd_lcm_drv =
    {
        .name			= "otm9608a_chuangxing_CH45L1190V0_LG_dsi_2_qhd",
