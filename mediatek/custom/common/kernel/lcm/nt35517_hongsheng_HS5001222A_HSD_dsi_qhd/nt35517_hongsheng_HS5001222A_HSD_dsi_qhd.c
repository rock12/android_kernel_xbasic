...
/*
{0xF0,1,{0x55, 0xAA, 0x52, 0x08, 0x00}},
...
//Frame Rate
{0xBD,1,{0x01,0x4E,0x10,0x20,0x01}},

// Display Timing: Dual 8-phase 4-overlap
{0xC9,1,{0x61, 0x06, 0x0D, 0x17, 0x17, 0x00}},


//*************************************
// Select CMD2, Page 1
//*************************************
{0xF0,1,{0x55, 0xAA, 0x52, 0x08, 0x01}},


// AVDD: 5.5V
{0xB0,1,{0x0A, 0x0A, 0x0A}},

// AVEE: -5.5V
{0xB1,1,{0x0A, 0x0A, 0x0A}},

// VCL: -3.5V
{0xB2,1,{0x02, 0x02, 0x02}},

// VGH: 15.0V
{0xB3,1,{0x10, 0x10, 0x10}},

// VGLX: -10.0V
{0xB4,1,{0x06, 0x06, 0x06}},

// AVDD: 3xVDDB
{0xB6,1,{0x54, 0x54, 0x54}},

// AVEE: -2xVDDB
{0xB7,1,{0x24, 0x24, 0x24}},

// VCL: -2xVDDB    pump clock : Hsync
{0xB8,1,{0x34, 0x34, 0x34}},

// VGH: 2xAVDD-AVEE
{0xB9,1,{0x34, 0x34, 0x34}},

// VGLX: AVEE-AVDD
{0xBA,1,{0x14, 0x14, 0x14}},

// Set VGMP = 5.2V / VGSP = 0V
{0xBC,1,{0x00 , 0xB0  , 0x00}},

// Set VGMN = -5.2V / VGSN = 0V
{0xBD,1,{0x00, 0xB0, 0x00}},
...
LCM_DRIVER nt35517_hongsheng_HS5001222A_HSD_dsi_qhd_lcm_drv = 
{
	.name		= "nt35517_hongsheng_HS5001222A_HSD_dsi_qhd",
