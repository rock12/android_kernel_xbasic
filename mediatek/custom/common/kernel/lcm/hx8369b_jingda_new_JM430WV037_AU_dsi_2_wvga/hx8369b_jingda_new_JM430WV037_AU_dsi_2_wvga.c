...
static void init_lcm_registers(void)
{
  ...
  data_array[2]= 0x180F0F00; //18
  data_array[3]= 0x000A0C18; //18
  ...
  MDELAY(1); 
	...
	data_array[0]= 0x00033902; 
  data_array[1]= 0x00A0A0B6; //ADJUST FLICKER  6e
  dsi_set_cmdq(&data_array, 2, 1); 
  MDELAY(1);   

	data_array[0]= 0x00023902; 
  data_array[1]= 0x00006DCB; //00   02
  dsi_set_cmdq(&data_array, 2, 1); 
  MDELAY(1); 

	data_array[0]= 0x00023902; 
	data_array[1]= 0x00000ECC; //00   02
	dsi_set_cmdq(&data_array, 2, 1); 
	MDELAY(1); 

	data_array[0]= 0x00043902; 
  data_array[1]= 0x7AFF41C6; //00   02
  dsi_set_cmdq(&data_array, 2, 1); 
  MDELAY(1); 

	data_array[0]= 0x00023902; 
  data_array[1]= 0x000072EA; //00   02
  dsi_set_cmdq(&data_array, 2, 1); 
  MDELAY(1); 
  ...
  data_array[2]= 0x0009C434; //34c4 
  dsi_set_cmdq(&data_array, 3, 1); 
  MDELAY(1); 

	data_array[0]= 0x00023902; 
  data_array[1]= 0x000000C1; //00   02
  dsi_set_cmdq(&data_array, 2, 1); 
  MDELAY(1); 
  ...
  MDELAY(1); 
	...
	data_array[0]= 0x00023902; 
	data_array[1]= 0x0000C036; //00   02
	dsi_set_cmdq(&data_array, 2, 1); 
	MDELAY(1); 

	data_array[0]= 0x00023902; 
  data_array[1]= 0x0000773A; //00   02
  dsi_set_cmdq(&data_array, 2, 1); 
  MDELAY(1); 
...
LCM_DRIVER hx8369b_jingda_new_JM430WV037_AU_dsi_2_wvga_lcm_drv =
    {
        .name			= "hx8369b_jingda_new_JM430WV037_AU_dsi_2_wvga",
