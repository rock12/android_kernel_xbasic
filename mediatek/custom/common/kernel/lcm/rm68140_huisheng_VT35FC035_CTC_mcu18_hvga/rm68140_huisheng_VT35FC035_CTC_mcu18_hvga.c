...
{
	unsigned char i,n;
	Lcd_Log("mycat LCD rm68140_songrui_ST035HOM_FNP_mcu_hvga\n");	
    ...
    //************* Start Initial Sequence **********// 
     send_ctrl_cmd(0xC0); 
		send_data_cmd(0x16);    // P-Gamma level 0x0a
		send_data_cmd(0x16);    // N-Gamma level 0x0a
		 
		send_ctrl_cmd(0xC1);      // BT & VC Setting 
		send_data_cmd(0x45);   
		send_data_cmd(0x04);    // VCI1 = 2.5V 0x07
		...
		send_ctrl_cmd(0xC5); 
		send_data_cmd(0x00); 
		send_data_cmd(0x5F);     // VCM Setting 0x42
		send_data_cmd(0x80);     // VCM Register Enable 
		 
		send_ctrl_cmd(0xB1); 
		send_data_cmd(0xb0);     // Frame Rate Setting 
		send_data_cmd(0x11); 
		 
		send_ctrl_cmd(0xB4); 
		send_data_cmd(0x01);     // Frame Rate Setting  0x00
		...
		send_data_cmd(0x13); //(0x00)
		send_data_cmd(0x45);//(0x35);  
		send_data_cmd(0x13); //(0x33); 
		send_data_cmd(0x24);//(0x00);  
		send_data_cmd(0x00);//(0x00); 
		send_data_cmd(0x00); //(0x00);
		send_data_cmd(0x13); //(0x00);
		send_data_cmd(0x45); //(0x35);
		send_data_cmd(0x14); //(0x33);
		send_data_cmd(0x23);//(0x00); 
		send_data_cmd(0x00); //(0x00);
		send_data_cmd(0x00); //(0x00);
...
LCM_DRIVER rm68140_huisheng_VT35FC035_CTC_mcu18_hvga_lcm_drv =
    {
        .name			= "rm68140_huisheng_VT35FC035_CTC_mcu18_hvga",
