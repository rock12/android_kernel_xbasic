...
{0xBE,2,{0x00,0x88}},// 90-88-86     VCOM   flicker
{0xBF,1,{0x01}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.fbk_div =19;//12;//9;		// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)	
} 
...
LCM_DRIVER RM68171_QICAI_K40CM231613A1N_CMI_DSI_2_WVGA_VDO_lcm_drv = 
{
    .name			= "RM68171_QICAI_K40CM231613A1N_CMI_DSI_2_WVGA_VDO",
