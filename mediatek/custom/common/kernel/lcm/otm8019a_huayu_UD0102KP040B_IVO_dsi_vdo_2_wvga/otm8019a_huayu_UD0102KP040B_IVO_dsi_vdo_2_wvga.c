...
{0x00, 1 , {0x90}},
{0xC5,  2 ,{0xAE,0x36}},//c6 4E

{0x00, 1 , {0x00}},
{0xD8,  2 ,{0x7F,0x7F}},//57

{0x00, 1 , {0x00}},
{0xD9,  1 ,{0x5D}},//Vcom 60 59
...
{
	Lcd_Log("mycat lcm_initialization_setting[21].para_list[0]=0x%2x\n",lcm_initialization_setting[21].para_list[0]);
   lcm_init();
...
LCM_DRIVER otm8019a_huayu_UD0102KP040B_IVO_dsi_vdo_2_wvga_lcm_drv = 
{
    .name			= "otm8019a_huayu_UD0102KP040B_IVO_dsi_vdo_2_wvga",
