...
{
    Lcd_Log("mycat LCD rm68140_HF_135350000_A0_LT_mcu18_hvga\n");
	...
	send_data_cmd(0x00);        
	send_ctrl_cmd(0x36);
	send_data_cmd(0xC8);  // 0x08                                                           

	send_ctrl_cmd(0x3A);
	send_data_cmd(0x66);//55 16BIT 66 18BIT 77 24BIT
...
static unsigned int lcm_compare_id(void)
{
...
#ifdef BUILD_LK
    pmic_config_interface(0x0532,5,0x7,5);
    pmic_config_interface(0x050C,1,0x1,15);
#else
    hwPowerOn(MT6323_POWER_LDO_VGP2,VOL_2800,"LCM");
#endif
    ...
    Lcd_Log("mycat rm68140_HF_135350000_A0: id=0x%04x, get_lcd_id=%d\n", id, get_lcd_id());
    return ((0x6814 == id) && (0 == get_lcd_id())) ? 1 : 0;
}

LCM_DRIVER rm68140_HF_135350000_A0_LT_mcu18_hvga_lcm_drv =
{
    .name           = "rm68140_HF_135350000_A0_LT_mcu18_hvga",
