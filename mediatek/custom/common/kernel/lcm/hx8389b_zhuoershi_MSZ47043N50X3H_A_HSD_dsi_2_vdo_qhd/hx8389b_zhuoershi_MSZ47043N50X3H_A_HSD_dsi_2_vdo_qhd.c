...
static void RX_LCM_INIT(void)
{
		  ...
		  data_array[0]=0x00043902;//Enable external Command
			...
			*/
			...
			data_array[1]=0x00a800b6; //column 0xAC最好；dot inversion 0xB3最好。AA
			data_array[2]=0x000000a8; 
			dsi_set_cmdq(&data_array, 3, 1);
			MDELAY(1);//3000
...
static void lcm_init(void)
{
    ...
    MDELAY(150);//Must over 6 ms,SPEC request
		...
		lcm_compare_id();
#if defined(BUILD_LK)
	printf("wqcat hx8389b_zuoershi lcm init\n");
#endif

#ifndef BUILD_LK
	printk("wqcat hx8389b_zuoershi lcm init\n");
#endif
		RX_LCM_INIT();
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8389b_zhuoershi_MSZ47043N50X3H_A_HSD_dsi_2_vdo_qhd_lcm_drv = 
{
    .name			= "hx8389b_zhuoershi_MSZ47043N50X3H_A_HSD_dsi_2_vdo_qhd",
