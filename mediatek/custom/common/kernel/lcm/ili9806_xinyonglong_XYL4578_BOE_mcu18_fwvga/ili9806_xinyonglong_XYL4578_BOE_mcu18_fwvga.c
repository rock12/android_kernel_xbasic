...
send_data_cmd(0x15); //P2 
send_data_cmd(0x1F); //P3 
send_data_cmd(0x0F); //P4 
send_data_cmd(0x0F); //P5 
send_data_cmd(0x0B); //P6 
send_data_cmd(0xC8); //P7 
send_data_cmd(0x06); //P8 
send_data_cmd(0x07); //P9 
send_data_cmd(0x0A); //P10 
send_data_cmd(0x12); //P11 
send_data_cmd(0x13); //P12 
send_data_cmd(0x04); //P13 
send_data_cmd(0x06); //P14 
send_data_cmd(0x01); //P15 
send_data_cmd(0x00); //P16 

send_ctrl_cmd(0xE1); 
send_data_cmd(0x00); //P1 
send_data_cmd(0x12); //P2 
send_data_cmd(0x18); //P3 
send_data_cmd(0x0B); //P4 
send_data_cmd(0x0D); //P5 
send_data_cmd(0x0C); //P6 
send_data_cmd(0x73); //P7 
send_data_cmd(0x03); //P8 
send_data_cmd(0x0A); //P9 
send_data_cmd(0x0D); //P10 
send_data_cmd(0x0C); //P11 
send_data_cmd(0x0C); //P12 
send_data_cmd(0x12); //P13 
send_data_cmd(0x1B); //P14 
send_data_cmd(0x14); //P15 
send_data_cmd(0x00); //P16 
...
send_ctrl_cmd(0x3A); //Tearing Effect ON 
send_data_cmd(0x66);  //66=18bit   55=16bit
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dbi.parallel.read_setup     = 9; //6
    params->dbi.parallel.read_hold      = 3;  //1
    params->dbi.parallel.read_latency   = 30;//18
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_xinyonglong_XYL4578_BOE_mcu18_fwvga_lcm_drv = 
{
  .name			= "ili9806_xinyonglong_XYL4578_BOE_mcu18_fwvga",
