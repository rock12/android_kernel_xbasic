...
{
//if(get_lcd_id()==1)// ×¿ÏÔlcd CPT²£Á§
//	{
#if defined(BUILD_LK)
	printf("mycat LCD zhuoxian lcd +++000 \n");	
#endif
...
//	}
	...
	printf("mycat LCD unix lcd +++111 \n");	
		...
		send_data_cmd(0x01);
		send_data_cmd(0x01);
		send_data_cmd(0x03);//04
		send_data_cmd(0x00);
		send_data_cmd(0xFF);
		send_data_cmd(0xF2);
		send_data_cmd(0x01);
		send_data_cmd(0x00);
		send_data_cmd(0xC0);//40
		...
		send_ctrl_cmd(0xC1);
		send_data_cmd(0x17);
		send_data_cmd(0x80);//75
		send_data_cmd(0x8a);//67
		send_data_cmd(0x20);
		/*
		send_ctrl_cmd(0xE0);
		send_data_cmd(0x00);
...
#if defined(BUILD_LK)
  int ret;
	ret=pmic_config_interface((kal_uint8)(BANK0_LDO_VCAM_AF+LDO_CON1_OFFSET) , (kal_uint8)0x4, (kal_uint8)BANK_0_RG_LDO_VOSEL_MASK, (kal_uint8)BANK_0_RG_LDO_VOSEL_SHIFT);	//2.8v
	ret=pmic_config_interface((kal_uint8)(BANK0_LDO_VCAM_AF+LDO_CON1_OFFSET), (kal_uint8)(1),(kal_uint8)(BANK_0_LDO_EN_MASK),(kal_uint8)(BANK_0_LDO_EN_SHIFT));
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_zhuoxian_FD050FWV011S_mcu18_fwvga_lcm_drv = 
{
  .name			= "ili9806_zhuoxian_FD050FWV011S_mcu18_fwvga",
