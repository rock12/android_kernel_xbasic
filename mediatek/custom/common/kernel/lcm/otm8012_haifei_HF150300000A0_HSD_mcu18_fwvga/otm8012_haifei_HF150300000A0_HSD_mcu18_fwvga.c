...
static void init_lcm_registers(void)
{
	...
	#if defined(BUILD_LK)
		printf("mycat LCD otm8012_haifei_HF150300000A0_HSD_mcu18_fwvga\n");
	#endif
	...
	send_ctrl_cmd(0xC0A4);	send_data_cmd(0x15);	//有修改，原来为C0A3	
	...
	send_ctrl_cmd(0xC492);	send_data_cmd(0x08); // 竖线问题
	
	send_ctrl_cmd(0xC580);	send_data_cmd(0x50);
	
	send_ctrl_cmd(0xC582);	send_data_cmd(0xF0);
	
	send_ctrl_cmd(0xC590);	send_data_cmd(0x02);	//有修改，原来为0x03	
	...
	send_ctrl_cmd(0xD900);	send_data_cmd(0x39);
	
	
	send_ctrl_cmd(0xE100);	send_data_cmd(0x04);
	send_ctrl_cmd(0xE101);	send_data_cmd(0x06);
	send_ctrl_cmd(0xE102);	send_data_cmd(0x09);
	send_ctrl_cmd(0xE103);	send_data_cmd(0x13);
	send_ctrl_cmd(0xE104);	send_data_cmd(0x22);
	send_ctrl_cmd(0xE105);	send_data_cmd(0x36);
	send_ctrl_cmd(0xE106);	send_data_cmd(0x41);
	send_ctrl_cmd(0xE107);	send_data_cmd(0x77);
	send_ctrl_cmd(0xE108);	send_data_cmd(0x69);
	send_ctrl_cmd(0xE109);	send_data_cmd(0x81);
	send_ctrl_cmd(0xE10A);	send_data_cmd(0x84);
	send_ctrl_cmd(0xE10B);	send_data_cmd(0x72);
	send_ctrl_cmd(0xE10C);	send_data_cmd(0x8A);
	send_ctrl_cmd(0xE10D);	send_data_cmd(0x75);
	send_ctrl_cmd(0xE10E);	send_data_cmd(0x7A);
	send_ctrl_cmd(0xE10F);	send_data_cmd(0x73);
	send_ctrl_cmd(0xE110);	send_data_cmd(0x6B);
	send_ctrl_cmd(0xE111);	send_data_cmd(0x62);
	send_ctrl_cmd(0xE112);	send_data_cmd(0x56);
	send_ctrl_cmd(0xE113);	send_data_cmd(0x20);
	
	send_ctrl_cmd(0xE200);	send_data_cmd(0x04);
	send_ctrl_cmd(0xE201);	send_data_cmd(0x06);
	send_ctrl_cmd(0xE202);	send_data_cmd(0x09);
	send_ctrl_cmd(0xE203);	send_data_cmd(0x13);
	send_ctrl_cmd(0xE204);	send_data_cmd(0x22);
	send_ctrl_cmd(0xE205);	send_data_cmd(0x36);
	send_ctrl_cmd(0xE206);	send_data_cmd(0x41);
	send_ctrl_cmd(0xE207);	send_data_cmd(0x77);
	send_ctrl_cmd(0xE208);	send_data_cmd(0x69);
	send_ctrl_cmd(0xE209);	send_data_cmd(0x81);
	send_ctrl_cmd(0xE20A);	send_data_cmd(0x85);
	send_ctrl_cmd(0xE20B);	send_data_cmd(0x72);
	send_ctrl_cmd(0xE20C);	send_data_cmd(0x8A);
	send_ctrl_cmd(0xE20D);	send_data_cmd(0x75);
	send_ctrl_cmd(0xE20E);	send_data_cmd(0x7A);
	send_ctrl_cmd(0xE20F);	send_data_cmd(0x73);
	send_ctrl_cmd(0xE210);	send_data_cmd(0x6B);
	send_ctrl_cmd(0xE211);	send_data_cmd(0x62);
	send_ctrl_cmd(0xE212);	send_data_cmd(0x56);
	send_ctrl_cmd(0xE213);	send_data_cmd(0x20);
	
	send_ctrl_cmd(0X3500);	send_data_cmd(0X00);
	send_ctrl_cmd(0X3A00);	send_data_cmd(0X66);
	//后面是新加的内容，OTM8012A的代码必须添加
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8012_haifei_HF150300000A0_HSD_mcu18_fwvga_lcm_drv =
    {
        .name		= "otm8012_haifei_HF150300000A0_HSD_mcu18_fwvga",
