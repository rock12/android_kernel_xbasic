...
send_ctrl_cmd(0xB600);   send_data_cmd(0x34); // 0x34

send_ctrl_cmd(0xB601);   send_data_cmd(0x34); //0x34

send_ctrl_cmd(0xB602);   send_data_cmd(0x34); // 0x34
...
send_ctrl_cmd(0xB301);   send_data_cmd(0x05); //08

send_ctrl_cmd(0xB302);   send_data_cmd(0x05); //08 

//Control VGH booster voltage rang

send_ctrl_cmd(0xBF00);   send_data_cmd(0x01); //VGH:7~18V 
...
send_ctrl_cmd(0xBC01);   send_data_cmd(0xa3); //C8 =5.5V/90=4.8V

send_ctrl_cmd(0xBC02);   send_data_cmd(0x00); //01

//VGMN/VGSN=-4.5V/0V

send_ctrl_cmd(0xBD00);   send_data_cmd(0x00); //00

send_ctrl_cmd(0xBD01);   send_data_cmd(0xa3); //90
...
send_ctrl_cmd(0xBE01);   send_data_cmd(0x50); //HSD:64;Novatek:50=-1.0V;  send_data_cmd( 80
...
//send_ctrl_cmd(0x2C00); send_data_cmd(0x0006); //8BIT 6-6-6?
...
//send_ctrl_cmd(0xB100); send_data_cmd(0xCC); 
   ...
   // send_ctrl_cmd(0xB101);   send_data_cmd(0x00); // S1->S1440:00;S1440->S1:02
...
send_ctrl_cmd(0xB700);   send_data_cmd(0x00); //HSD:70;Nova:77  

send_ctrl_cmd(0xB701);   send_data_cmd(0x70); //HSD:70;Nova:77

//Source EQ control (Nova non-used)

send_ctrl_cmd(0xB800);   send_data_cmd(0x01); 

send_ctrl_cmd(0xB801);   send_data_cmd(0x05); //HSD:05;Nova:07

send_ctrl_cmd(0xB802);   send_data_cmd(0x05); //HSD:05;Nova:07

send_ctrl_cmd(0xB803);   send_data_cmd(0x05); //HSD:05;Nova:07

//Inversion mode: column

send_ctrl_cmd(0xBC00);   send_data_cmd(0x00); //00: column

send_ctrl_cmd(0xBC01);   send_data_cmd(0x00); //01:1dot
...
send_ctrl_cmd(0xBD02);   send_data_cmd(0x07); //HSD:06;Nova:1C

send_ctrl_cmd(0xBD03);   send_data_cmd(0x31); //HSD:04;Nova:1C
...
send_ctrl_cmd(0x4401);   send_data_cmd(0x1A);

send_ctrl_cmd(0x3A00);   send_data_cmd(0x66); //24bit=0x77,18bit=0x66
...
LCM_DRIVER nt35510_disipuli_dp0801_40wv_mcu_wvga_lcm_drv =
    {
        .name			= "nt35510_disipuli_dp0801_40wv_mcu_wvga",
