...
#ifndef BUILD_LK
    printk(KERN_CRIT "mycat nt35310_huarui_S1769: id=%04x, get_lcd_id=%d\n", id, get_lcd_id());
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER nt35310_huarui_S1769_tianma_mcu18_hvga_lcm_drv = 
{
    .name           = "nt35310_huarui_S1769_tianma_mcu18_hvga",
