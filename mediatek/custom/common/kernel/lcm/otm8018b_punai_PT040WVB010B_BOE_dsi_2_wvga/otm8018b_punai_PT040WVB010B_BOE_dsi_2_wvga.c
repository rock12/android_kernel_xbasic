...
{0x00, 1 , {0x90}},
{0xC5,  7 ,{0x96,0x34,0x01,0x03,0x33,0x34,0x23}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    */  
    ...
    params->dsi.fbk_div =16;//14 pyj		// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)   18
...
LCM_DRIVER otm8018b_punai_PT040WVB010B_BOE_dsi_2_wvga_lcm_drv = 
{
    .name			= "otm8018b_punai_PT040WVB010B_BOE_dsi_2_wvga",
