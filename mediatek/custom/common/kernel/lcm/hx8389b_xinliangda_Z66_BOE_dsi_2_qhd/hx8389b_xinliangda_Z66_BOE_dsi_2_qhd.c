...
//Set power option
   data_array[0] = 0x00043902;
	...
	data_array[3] = 0x3E360FB1;
	data_array[4] = 0x00422929;
	...
	data_array[3] = 0x1032CA13;
	data_array[4] = 0x480A1700;
	data_array[5] = 0x480A1302;//0x48001302
	data_array[6] = 0x0A504E14;
	...
	data_array[1] = 0x272318E0;
	data_array[2] = 0x323F3F36;
	data_array[3] = 0x0E0D0B48;
	data_array[4] = 0x14141413;
	data_array[5] = 0x2318140C;
	data_array[6] = 0x3F3F3627;
	data_array[7] = 0x0D0B4832;
	data_array[8] = 0x1414130E;
	data_array[9] = 0x00140C14;
	dsi_set_cmdq(&data_array,10, 1);
	MDELAY(5);

	data_array[0]=0x00023902;
	data_array[1]=0x00000Acc;   //0e,0a,02
	dsi_set_cmdq(&data_array, 2, 1);
	MDELAY(1);

	// Set VCOM 
	data_array[0] = 0x00053902;
	data_array[1] = 0x008B00B6;
	data_array[2] = 0x0000008B;
	dsi_set_cmdq(&data_array,3, 1);
	MDELAY(1);
...
/*	data_array[2] = 0x11105AE8;
	data_array[3] = 0x241c15D5;
	data_array[4] = 0x00423f3f;
	data_array[5] = 0x8020F73A;*/
	data_array[2] = 0x11109AE1;
	data_array[3] = 0x2C24F191;
	data_array[4] = 0x00422121;
	data_array[5] = 0x8020F73A;
	dsi_set_cmdq(&data_array,6, 1);
	MDELAY(25);
	...
	data_array[1] = 0x000C80B4;
	data_array[2] = 0x32011032;
	data_array[3] = 0x1032CA13;
	data_array[4] = 0x50011700;
	data_array[5] = 0x50011302;//0x48001302
	data_array[6] = 0x0AFFFF14;

	data_array[7] = 0x3C0A3C0A;
	data_array[8] = 0x0AFFFF14;
	...
	// Set Gamma
	data_array[0] = 0x00233902;
	data_array[1] = 0x080400E0;
	data_array[2] = 0x133f2321;
	data_array[3] = 0x0f0c0631;
	data_array[4] = 0x15131413;
	data_array[5] = 0x05001810;
	data_array[6] = 0x3F232009;
	data_array[7] = 0x0c043214;
	data_array[8] = 0x1214120E;
	data_array[9] = 0x00190f13;
	dsi_set_cmdq(&data_array,10, 1);
	MDELAY(5);

	data_array[0]=0x00023902;
	data_array[1]=0x000002cc;   //0e,0a,02
	dsi_set_cmdq(&data_array, 2, 1);
	MDELAY(1);

	// Set VCOM 
	data_array[0] = 0x00053902;
	data_array[1] = 0x007C00B6; //0x007E00B6   20140709
	data_array[2] = 0x0000007C;//0x00000081
	dsi_set_cmdq(&data_array,3, 1);
	MDELAY(1);
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8389b_xinliangda_Z66_BOE_dsi_2_qhd_lcm_drv = 
{
    .name			= "hx8389b_xinliangda_Z66_BOE_dsi_2_qhd",
