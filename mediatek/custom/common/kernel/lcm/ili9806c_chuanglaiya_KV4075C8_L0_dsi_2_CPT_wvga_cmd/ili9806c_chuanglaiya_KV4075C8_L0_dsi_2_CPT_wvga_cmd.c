...
{0xB4, 3, {0x02, 0x00, 0x00}}, // Display Inversion Control
...
{0xC1, 4, {0x37, 0x60, 0x60, 0x20}}, // Power Control 2

{0xE0, 16, {0x00, 0x00, 0x00, 0x0F, 0x10, 0x15, 0x07, 0x06, 0x05, 0x09, 0x07, 0x0F, 0x0F, 0x35, 0x31, 0x00}},  //  0x00,0x16,0x21

{0xE1, 16, {0x00, 0x00, 0x00, 0x0C, 0x0F, 0x10, 0x06, 0x07, 0x04, 0x08, 0x08, 0x0A, 0x0B, 0x24, 0x20, 0x00}},   //  0x00,0x16,0x19

{0x35, 1, {0x00}}, //Tearing Effect ON
#ifdef MTK6572M_LCM_PATCH_VIDEO
{0x44, 2, {0x01, 0x86}}, //Tearing Effect ON 22
#else
{0x44, 2, {0x01, 0x22}}, //Tearing Effect ON
#endif
{0x3A, 1, {0x77}},
...
static unsigned int lcm_compare_id(void)
{
    ...
    */
    ...
    Lcd_Log(" ili9806c_chuanglaiya_KV4075C8_L0_dsi_2_CPT_wvga_cmd %s, id=0x%x,id2=0x%x\n", __func__, id,id2);
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806c_chuanglaiya_KV4075C8_L0_dsi_2_CPT_wvga_cmd_lcm_drv = 
{
    .name			= "ili9806c_chuanglaiya_KV4075C8_L0_dsi_2_CPT_wvga_cmd",
