...
send_ctrl_cmd(0xC1);      // Power Control 2 
 send_data_cmd(0x17); 
 send_data_cmd(0x85); //75
 send_data_cmd(0x85); //75
 send_data_cmd(0x20); 
 
 send_ctrl_cmd(0xE0); 
 send_data_cmd(0x00);  //P1 
 send_data_cmd(0x07);  //P2 
 send_data_cmd(0x0C);  //P3 
 send_data_cmd(0x0B);  //P4 
 send_data_cmd(0x0E);  //P5 
 send_data_cmd(0x07);  //P6 
 send_data_cmd(0x05);  //P7 
 send_data_cmd(0x03);  //P8 
 send_data_cmd(0x08);  //P9 
 send_data_cmd(0x0C);  //P10 
 send_data_cmd(0x15);  //P11 
 send_data_cmd(0x12);  //P12 
 send_data_cmd(0x11);  //P13 
 send_data_cmd(0x1B);  //P14 
 send_data_cmd(0x15);  //P15 
 send_data_cmd(0x00);  //P16 
 
 send_ctrl_cmd(0xE1); 
 send_data_cmd(0x00);  //P1 
 send_data_cmd(0x08);  //P2 
 send_data_cmd(0x0E);  //P3 
 send_data_cmd(0x0B);  //P4 
 send_data_cmd(0x0D);  //P5 
 send_data_cmd(0x09);  //P6 
 send_data_cmd(0x06);  //P7 
 send_data_cmd(0x06);  //P8 
 send_data_cmd(0x07);  //P9 
 send_data_cmd(0x0A);  //P10 
 send_data_cmd(0x13);  //P11 
 send_data_cmd(0x0F);  //P12 
 send_data_cmd(0x0C);  //P13 
 send_data_cmd(0x0E);  //P14 
 send_data_cmd(0x03);  //P15 
 send_data_cmd(0x00);  //P16 
/*
send_ctrl_cmd(0xE0); 
 send_data_cmd(0x00);  //P1 
 send_data_cmd(0x02);  //P2 
 send_data_cmd(0x08);  //P3 
 send_data_cmd(0x0A);  //P4 
 send_data_cmd(0x0C);  //P5 
 send_data_cmd(0x09);  //P6 
 send_data_cmd(0x06);  //P7 
 send_data_cmd(0x05);  //P8 
 send_data_cmd(0x08);  //P9 
 send_data_cmd(0x0B);  //P10 
 send_data_cmd(0x0F);  //P11 
 send_data_cmd(0x0F);  //P12 
 send_data_cmd(0x0D);  //P13 
 send_data_cmd(0x1F);  //P14 
 send_data_cmd(0x18);  //P15 
 send_data_cmd(0x00);  //P16 
 
 send_ctrl_cmd(0xE1); 
 send_data_cmd(0x00);  //P1 
 send_data_cmd(0x05);  //P2 
 send_data_cmd(0x0A);  //P3 
 send_data_cmd(0x0D);  //P4 
 send_data_cmd(0x0E);  //P5 
 send_data_cmd(0x0A);  //P6 
 send_data_cmd(0x07);  //P7 
 send_data_cmd(0x05);  //P8 
 send_data_cmd(0x08);  //P9 
 send_data_cmd(0x0C);  //P10 
 send_data_cmd(0x0F);  //P11 
 send_data_cmd(0x10);  //P12 
 send_data_cmd(0x0C);  //P13 
 send_data_cmd(0x21);  //P14 
 send_data_cmd(0x1D);  //P15 
 send_data_cmd(0x00);  //P16 
	*/
			send_ctrl_cmd(0x35);
		send_data_cmd(0x00);
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_hengsheng_HS045PK_02A_CMI_mcu18_fwvga_lcm_drv = 
{
  .name			= "ili9806_hengsheng_HS045PK_02A_CMI_mcu18_fwvga",
