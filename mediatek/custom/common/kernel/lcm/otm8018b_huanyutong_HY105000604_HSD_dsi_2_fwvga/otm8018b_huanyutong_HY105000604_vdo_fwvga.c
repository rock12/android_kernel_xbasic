...
{0xc5,1,{0xa3}},
{0x00,1,{0x90}},
{0xc5,2,{0xd6,0x7D}},	//76 d6 79 7D

{0x00,1,{0x00}},
{0xd8,2,{0x6f,0x6f}},  //5.0V 97 67
{0x00,1,{0x00}},
{0xd9,1,{0x4A}},   //39 3D 51ап
...
{0x00, 1 , {0x00}},
{0xE1, 16 ,{0x08,0x09,0x0A,0x07,0x00,0x16,0x0F,0x0F,0x00,0x03,0x02,0x06,0x0E,0x27,0x24,0x1D}},

{0x00, 1 , {0x00}},
{0xE2, 16 ,{0x08,0x09,0x0A,0x06,0x00,0x16,0x0F,0x0F,0x00,0x04,0x02,0x06,0x0D,0x27,0x24,0x1D}},
...
{0x00, 1 , {0x90}},
{0xC0,  6 ,{0x00,0x55,0x00,0x00,0x00,0x03}},
...
{
	//lcm_initialization_setting[7].para_list[0]--;
	//lcm_compare_id();
	lcm_init();
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8018b_huanyutong_HY105000604_vdo_fwvga_lcm_drv = 
{
    .name			= "otm8018b_huanyutong_HY105000604_vdo_fwvga",
