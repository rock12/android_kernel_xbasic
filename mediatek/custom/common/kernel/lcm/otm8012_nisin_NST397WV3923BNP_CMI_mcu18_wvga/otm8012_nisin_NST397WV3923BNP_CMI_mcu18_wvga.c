...
static void init_lcm_registers(void)
{
    int i;
		...
		send_ctrl_cmd(0xC0B4); send_data_cmd(0x11); // 0x55
		...
		send_ctrl_cmd(0xD900); send_data_cmd(0x68); // 0x54
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8012_nisin_NST397WV3923BNP_CMI_mcu18_wvga_lcm_drv =
    {
        .name		= "otm8012_nisin_NST397WV3923BNP_CMI_mcu18_wvga",
