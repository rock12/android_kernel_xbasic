...
static void init_lcm_registers(void)
{
  ...
  send_ctrl_cmd(0xB9);  // SET password
	...
	send_ctrl_cmd(0xB2);  // SET Display  480x854
	send_data_cmd(0x00);
	send_data_cmd(0x10); //23 3-wire, 20 cpu
	send_data_cmd(0x05);
	send_data_cmd(0x0A);
	send_data_cmd(0x70);
	send_data_cmd(0x00);
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8369a_haifei_HF_14539_2059_A0_CMI_mcu18_fwvga_lcm_drv = 
{
    .name			= "hx8369a_haifei_HF_14539_2059_A0_CMI_mcu18_fwvga",
