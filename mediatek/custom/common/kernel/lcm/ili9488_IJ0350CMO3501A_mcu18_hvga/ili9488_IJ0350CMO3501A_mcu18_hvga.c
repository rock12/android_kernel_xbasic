...
{
    unsigned char i,n;
    Lcd_Log("mycat LCD ili9488_IJ0350CMO3501A_mcu18_hvga\n");    
...
send_data_cmd(0x18);  //Vreg1out 
send_data_cmd(0x17);  //Verg2out 
...
send_data_cmd(0x42);  //Source,Gate scan dieection 
...
static unsigned int lcm_compare_id(void)
{
    ...
    Lcd_Log("mycat ili9488_IJ0350CMO3501A ID %s, id = 0x%x\n", __func__, id);
    return ((LCM_ID == id) && (1 == get_lcd_id()))?1:0;
}

LCM_DRIVER ili9488_IJ0350CMO3501A_mcu18_hvga_lcm_drv =
    {
        .name            = "ili9488_IJ0350CMO3501A_mcu18_hvga",
