...
static void init_lcm_registers(void)
{
	...
	printf("mycat LCD huarui lcd +++000 \n");	
		...
		send_ctrl_cmd(0x3A);
		send_data_cmd(0x77);//55 16BIT 66 18BIT 77 24BIT
		...
		send_ctrl_cmd(0X36); // FW=00 ; BW=03 
		send_data_cmd(0x00); 
		
		send_ctrl_cmd(0X3A);  //55 16BIT 66 18BIT 77 24BIT
		send_data_cmd(0x66);
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_haifei_HF146391253B0_HSD_mcu18_fwvga_lcm_drv = 
{
  .name			= "ili9806_haifei_HF146391253B0_HSD_mcu18_fwvga",
