...
//======================
{0x00,1,{0x80}},
{0xC4,1,{0x30}},//source power of f pull-low

{0x00,1,{0x8A}},
{0xC4,1,{0x40}},  //source power of f pull-low
//====================
{0x00,1,{0x81}},
{0xC4,1,{0x83}},
...
static unsigned int lcm_compare_id(void)
{
   ...
   Lcd_Log("mycat 8018b %s, id = 0x%08x\n", __func__, id); 
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8018b_jingtai_JTD0450XXC0_CMI_dsi_vdo_2_fwvga_lcm_drv = 
{
    .name			= "otm8018b_jingtai_JTD0450XXC0_CMI_dsi_vdo_2_fwvga",
