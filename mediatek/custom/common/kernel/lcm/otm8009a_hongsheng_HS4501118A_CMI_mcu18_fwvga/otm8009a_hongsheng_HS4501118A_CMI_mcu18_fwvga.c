...
{
	int i;
  if (get_lcd_id())// 鸿盛	HS4501118A	　	OTM8009A	4.5	FWVGA	CMI ID=拉高
  {
  ...
  else// 华视	HS45VM07T2B	OTM8009A	4.5	FWVGA	CMI ID=拉低
  {
  		Lcd_Log("mycat init_lcm_registers huashi+++111 \r\n");	
		//8009+cmi4.5 
		  	send_ctrl_cmd(0xFF00); send_data_cmd(0x80);
		send_ctrl_cmd(0xFF01); send_data_cmd(0x09);
		send_ctrl_cmd(0xFF02); send_data_cmd(0x01);
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8009a_hongsheng_HS4501118A_CMI_mcu18_fwvga_lcm_drv = 
{
        .name		= "otm8009a_hongsheng_HS4501118A_CMI_mcu18_fwvga",
