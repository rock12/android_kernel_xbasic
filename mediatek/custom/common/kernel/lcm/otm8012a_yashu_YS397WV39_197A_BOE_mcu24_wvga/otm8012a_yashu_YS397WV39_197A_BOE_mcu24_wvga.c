...
send_ctrl_cmd(0xC591); send_data_cmd(0x0F);
send_ctrl_cmd(0xC0B4); send_data_cmd(0x50);
send_ctrl_cmd(0xC181); send_data_cmd(0x66);
send_ctrl_cmd(0xC1A1); send_data_cmd(0x08);

send_ctrl_cmd(0xD800); send_data_cmd(0x79);
send_ctrl_cmd(0xD801); send_data_cmd(0x79);

send_ctrl_cmd(0xD900); send_data_cmd(0x4E);
send_ctrl_cmd(0xC1A1); send_data_cmd(0x0E);

send_ctrl_cmd(0xC594); send_data_cmd(0x33);
send_ctrl_cmd(0xC595); send_data_cmd(0x33);
...
send_ctrl_cmd(0xCEa3); send_data_cmd(0x39);
...
send_ctrl_cmd(0xCEaa); send_data_cmd(0x3A);
...
send_ctrl_cmd(0xCEb3); send_data_cmd(0x3B);
...
send_ctrl_cmd(0xCEba); send_data_cmd(0x3C);
...
send_ctrl_cmd(0xCBE2); send_data_cmd(0x04);
send_ctrl_cmd(0xCBE3); send_data_cmd(0x04);
send_ctrl_cmd(0xCBE4); send_data_cmd(0x04);
...
send_ctrl_cmd(0xCCA5); send_data_cmd(0x25);
send_ctrl_cmd(0xCCA6); send_data_cmd(0x02);
send_ctrl_cmd(0xCCA7); send_data_cmd(0x0C);
send_ctrl_cmd(0xCCA8); send_data_cmd(0x0A);
...
send_ctrl_cmd(0xCCD5); send_data_cmd(0x26);
send_ctrl_cmd(0xCCD6); send_data_cmd(0x0B);
send_ctrl_cmd(0xCCD7); send_data_cmd(0x09);
send_ctrl_cmd(0xCCD8); send_data_cmd(0x01);
...
send_ctrl_cmd(0xC590); send_data_cmd(0x02);//03
send_ctrl_cmd(0xC591); send_data_cmd(0x76);//0f
send_ctrl_cmd(0xC0B4); send_data_cmd(0x50);
send_ctrl_cmd(0xC181); send_data_cmd(0x66);
send_ctrl_cmd(0xC1A1); send_data_cmd(0x08);
...
send_ctrl_cmd(0xD900); send_data_cmd(0x48);//0x4e
...
send_ctrl_cmd(0xE101); send_data_cmd(0x1C);
send_ctrl_cmd(0xE102); send_data_cmd(0x29);
send_ctrl_cmd(0xE103); send_data_cmd(0x37);
send_ctrl_cmd(0xE104); send_data_cmd(0x44);
send_ctrl_cmd(0xE105); send_data_cmd(0x54);
send_ctrl_cmd(0xE106); send_data_cmd(0x56);
send_ctrl_cmd(0xE107); send_data_cmd(0x81);
send_ctrl_cmd(0xE108); send_data_cmd(0x73);
send_ctrl_cmd(0xE109); send_data_cmd(0x8C);
send_ctrl_cmd(0xE10A); send_data_cmd(0x75);
send_ctrl_cmd(0xE10B); send_data_cmd(0x5F);
send_ctrl_cmd(0xE10C); send_data_cmd(0x70);
send_ctrl_cmd(0xE10D); send_data_cmd(0x4E);
send_ctrl_cmd(0xE10E); send_data_cmd(0x4C);
send_ctrl_cmd(0xE10F); send_data_cmd(0x3F);
send_ctrl_cmd(0xE110); send_data_cmd(0x33);
send_ctrl_cmd(0xE111); send_data_cmd(0x25);
send_ctrl_cmd(0xE112); send_data_cmd(0x18);
send_ctrl_cmd(0xE113); send_data_cmd(0x10);

send_ctrl_cmd(0xE200); send_data_cmd(0x09);
send_ctrl_cmd(0xE201); send_data_cmd(0x1C);
send_ctrl_cmd(0xE202); send_data_cmd(0x29);
send_ctrl_cmd(0xE203); send_data_cmd(0x37);
send_ctrl_cmd(0xE204); send_data_cmd(0x45);
send_ctrl_cmd(0xE205); send_data_cmd(0x54);
send_ctrl_cmd(0xE206); send_data_cmd(0x56);
send_ctrl_cmd(0xE207); send_data_cmd(0x82);
send_ctrl_cmd(0xE208); send_data_cmd(0x73);
send_ctrl_cmd(0xE209); send_data_cmd(0x8C);
send_ctrl_cmd(0xE20A); send_data_cmd(0x75);
send_ctrl_cmd(0xE20B); send_data_cmd(0x5F);
send_ctrl_cmd(0xE20C); send_data_cmd(0x70);
send_ctrl_cmd(0xE20D); send_data_cmd(0x4E);
send_ctrl_cmd(0xE20E); send_data_cmd(0x4B);
send_ctrl_cmd(0xE20F); send_data_cmd(0x3E);
send_ctrl_cmd(0xE210); send_data_cmd(0x34);
send_ctrl_cmd(0xE211); send_data_cmd(0x25);
send_ctrl_cmd(0xE212); send_data_cmd(0x18);
send_ctrl_cmd(0xE213); send_data_cmd(0x10);
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8012a_yashu_YS397WV39_197A_BOE_mcu24_wvga_lcm_drv =
    {
        .name		= "otm8012a_yashu_YS397WV39_197A_BOE_mcu24_wvga",
