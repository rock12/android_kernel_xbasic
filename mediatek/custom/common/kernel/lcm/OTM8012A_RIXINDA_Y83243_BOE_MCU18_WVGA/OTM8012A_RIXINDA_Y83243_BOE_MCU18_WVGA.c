...
send_cmd(0xC591); send_data(0x34);
...
send_cmd(0xD900); send_data(0x4a);
...
send_cmd(0xC590); send_data(0x03);

send_cmd(0xC0B4); send_data(0x11);
...
send_cmd(0xE100); send_data(0x0C);
send_cmd(0xE101); send_data(0x1d);
send_cmd(0xE102); send_data(0x28);
send_cmd(0xE103); send_data(0x36);
send_cmd(0xE104); send_data(0x44);
send_cmd(0xE105); send_data(0x53);
send_cmd(0xE106); send_data(0x55);
send_cmd(0xE107); send_data(0x80);
send_cmd(0xE108); send_data(0x70);
send_cmd(0xE109); send_data(0x8b);

send_cmd(0xE10A); send_data(0x79);
send_cmd(0xE10B); send_data(0x64);
send_cmd(0xE10C); send_data(0x76);
send_cmd(0xE10D); send_data(0x4f);
send_cmd(0xE10E); send_data(0x4b);
send_cmd(0xE10F); send_data(0x3b);
send_cmd(0xE110); send_data(0x2b);
send_cmd(0xE111); send_data(0x1c);
send_cmd(0xE112); send_data(0x0e);
send_cmd(0xE113); send_data(0x0a);


send_cmd(0xE200); send_data(0x0C);
send_cmd(0xE201); send_data(0x1c);
send_cmd(0xE202); send_data(0x29);
send_cmd(0xE203); send_data(0x36);
send_cmd(0xE204); send_data(0x44);
send_cmd(0xE205); send_data(0x53);
send_cmd(0xE206); send_data(0x55);
send_cmd(0xE207); send_data(0x80);
send_cmd(0xE208); send_data(0x70);
send_cmd(0xE209); send_data(0x8b);

send_cmd(0xE20A); send_data(0x79);
send_cmd(0xE20B); send_data(0x64);
send_cmd(0xE20C); send_data(0x76);
send_cmd(0xE20D); send_data(0x4f);
send_cmd(0xE20E); send_data(0x4b);
send_cmd(0xE20F); send_data(0x3c);
send_cmd(0xE210); send_data(0x2b);
send_cmd(0xE211); send_data(0x1c);
send_cmd(0xE212); send_data(0x0e);
send_cmd(0xE213); send_data(0x0a);
...
// ---------------------------------------------------------------------------
LCM_DRIVER OTM8012A_RIXINDA_Y83243_BOE_MCU18_WVGA_lcm_drv =
    {
        .name		= "OTM8012A_RIXINDA_Y83243_BOE_MCU18_WVGA",
