...
static unsigned int lcm_compare_id(void)
{
    ...
    return ((0x5517 == id) && (0 == get_lcd_id())) ? 1 : 0;
}
...
LCM_DRIVER nt35517_xingliangda_XLD0500940L1_25_LG_dsi_2_vdo_qhd_lcm_drv =
{
    .name           = "nt35517_xingliangda_XLD0500940L1_25_LG_dsi_2_vdo_qhd",
