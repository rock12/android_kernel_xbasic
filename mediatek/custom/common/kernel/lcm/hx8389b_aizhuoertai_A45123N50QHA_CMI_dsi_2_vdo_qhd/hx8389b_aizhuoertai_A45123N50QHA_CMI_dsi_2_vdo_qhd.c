...
static void RX_LCM_INIT(void)
{
	...
	data_array[3]=0x443cF1B1;//0x3E36F1B1
...
/*
	data_array[0]=0x00233902;
	data_array[1]=0x030200E0; 
	data_array[2]=0x163F1F0F; 
	data_array[3]=0x0F0C0838; 
	data_array[4]=0x12141613; 
	data_array[5]=0x02001C1D; 
	data_array[6]=0x3F1F0F03; 
	data_array[7]=0x0C083816; 
	data_array[8]=0x1416130F; 
	data_array[9]=0x001C1D12; 
	dsi_set_cmdq(&data_array, 10, 1);
  ...
  data_array[0]=0x00053902;
	data_array[1]=0x00A600B6;     //9E->9A
	data_array[2]=0x000000A6; 		//9E->9A
	
	//data_array[1]=65536*vcom+182;     //9E->9A
	//data_array[2]=vcom; 		//9E->9A
...
////#endif
		...
		params->dsi.vertical_sync_active				= 2;//9; //2
		params->dsi.vertical_backporch					= 10;//7; //14
		params->dsi.vertical_frontporch					= 13;//7; //9
...
static void lcm_resume(void)
{
	...
	//vcom += 2;
	//lcm_init();
	//printk("WANGDONG vcom id = 0x%02x", id);
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8389b_aizhuoertai_A45123N50QHA_CMI_dsi_2_vdo_qhd_lcm_drv = 
{
    .name			= "hx8389b_aizhuoertai_A45123N50QHA_CMI_dsi_2_vdo_qhd",
