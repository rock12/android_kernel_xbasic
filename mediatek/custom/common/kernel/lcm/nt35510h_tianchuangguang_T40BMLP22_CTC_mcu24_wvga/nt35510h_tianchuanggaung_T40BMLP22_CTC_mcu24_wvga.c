...
static void init_lcm_registers(void)
{
    ...
    printf("MYCAT LCD nt35510h_tianchuanggaung_T40BMLP22_CTC_mcu24_wvga");
#endif
	//LV2 Page 1 enable
	...
	//VGLX ratio
	send_ctrl_cmd(0xBA00); send_data_cmd(0x04);
	...
	send_ctrl_cmd(0xD203); send_data_cmd(0x01);
	send_ctrl_cmd(0xD204); send_data_cmd(0x00);
	send_ctrl_cmd(0xD205); send_data_cmd(0x18);
	send_ctrl_cmd(0xD206); send_data_cmd(0x00);
	send_ctrl_cmd(0xD207); send_data_cmd(0x43);
	send_ctrl_cmd(0xD208); send_data_cmd(0x00);
	send_ctrl_cmd(0xD209); send_data_cmd(0x77);
	send_ctrl_cmd(0xD20A); send_data_cmd(0x00);
	send_ctrl_cmd(0xD20B); send_data_cmd(0xC4);
	send_ctrl_cmd(0xD20C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD20D); send_data_cmd(0x08);
	send_ctrl_cmd(0xD20E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD20F); send_data_cmd(0x52);
	send_ctrl_cmd(0xD210); send_data_cmd(0x01);
	send_ctrl_cmd(0xD211); send_data_cmd(0x81);
	send_ctrl_cmd(0xD212); send_data_cmd(0x01);
	send_ctrl_cmd(0xD213); send_data_cmd(0xBD);
	send_ctrl_cmd(0xD214); send_data_cmd(0x01);
	send_ctrl_cmd(0xD215); send_data_cmd(0xE7);
	send_ctrl_cmd(0xD216); send_data_cmd(0x02);
	send_ctrl_cmd(0xD217); send_data_cmd(0x20);
	send_ctrl_cmd(0xD218); send_data_cmd(0x02);
	send_ctrl_cmd(0xD219); send_data_cmd(0x4A);
	send_ctrl_cmd(0xD21A); send_data_cmd(0x02);
	send_ctrl_cmd(0xD21B); send_data_cmd(0x4B);
	send_ctrl_cmd(0xD21C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD21D); send_data_cmd(0x70);
	send_ctrl_cmd(0xD21E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD21F); send_data_cmd(0x96);
	send_ctrl_cmd(0xD220); send_data_cmd(0x02);
	send_ctrl_cmd(0xD221); send_data_cmd(0xAA);
	send_ctrl_cmd(0xD222); send_data_cmd(0x02);
	send_ctrl_cmd(0xD223); send_data_cmd(0xC3);
	send_ctrl_cmd(0xD224); send_data_cmd(0x02);
	send_ctrl_cmd(0xD225); send_data_cmd(0xD2);
	send_ctrl_cmd(0xD226); send_data_cmd(0x02);
	send_ctrl_cmd(0xD227); send_data_cmd(0xE5);
	send_ctrl_cmd(0xD228); send_data_cmd(0x02);
	send_ctrl_cmd(0xD229); send_data_cmd(0xF1);
	send_ctrl_cmd(0xD22A); send_data_cmd(0x03);
	send_ctrl_cmd(0xD22B); send_data_cmd(0x02);
	send_ctrl_cmd(0xD22C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD22D); send_data_cmd(0x0F);
	send_ctrl_cmd(0xD22E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD22F); send_data_cmd(0x23);
	send_ctrl_cmd(0xD230); send_data_cmd(0x03);
	send_ctrl_cmd(0xD231); send_data_cmd(0x54);
	...
	send_ctrl_cmd(0xD303); send_data_cmd(0x01);
	send_ctrl_cmd(0xD304); send_data_cmd(0x00);
	send_ctrl_cmd(0xD305); send_data_cmd(0x18);
	send_ctrl_cmd(0xD306); send_data_cmd(0x00);
	send_ctrl_cmd(0xD307); send_data_cmd(0x43);
	send_ctrl_cmd(0xD308); send_data_cmd(0x00);
	send_ctrl_cmd(0xD309); send_data_cmd(0x77);
	send_ctrl_cmd(0xD30A); send_data_cmd(0x00);
	send_ctrl_cmd(0xD30B); send_data_cmd(0xC4);
	send_ctrl_cmd(0xD30C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD30D); send_data_cmd(0x08);
	send_ctrl_cmd(0xD30E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD30F); send_data_cmd(0x52);
	send_ctrl_cmd(0xD310); send_data_cmd(0x01);
	send_ctrl_cmd(0xD311); send_data_cmd(0x81);
	send_ctrl_cmd(0xD312); send_data_cmd(0x01);
	send_ctrl_cmd(0xD313); send_data_cmd(0xBD);
	send_ctrl_cmd(0xD314); send_data_cmd(0x01);
	send_ctrl_cmd(0xD315); send_data_cmd(0xE7);
	send_ctrl_cmd(0xD316); send_data_cmd(0x02);
	send_ctrl_cmd(0xD317); send_data_cmd(0x20);
	send_ctrl_cmd(0xD318); send_data_cmd(0x02);
	send_ctrl_cmd(0xD319); send_data_cmd(0x4A);
	send_ctrl_cmd(0xD31A); send_data_cmd(0x02);
	send_ctrl_cmd(0xD31B); send_data_cmd(0x4B);
	send_ctrl_cmd(0xD31C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD31D); send_data_cmd(0x70);
	send_ctrl_cmd(0xD31E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD31F); send_data_cmd(0x96);
	send_ctrl_cmd(0xD320); send_data_cmd(0x02);
	send_ctrl_cmd(0xD321); send_data_cmd(0xAA);
	send_ctrl_cmd(0xD322); send_data_cmd(0x02);
	send_ctrl_cmd(0xD323); send_data_cmd(0xC3);
	send_ctrl_cmd(0xD324); send_data_cmd(0x02);
	send_ctrl_cmd(0xD325); send_data_cmd(0xD2);
	send_ctrl_cmd(0xD326); send_data_cmd(0x02);
	send_ctrl_cmd(0xD327); send_data_cmd(0xE5);
	send_ctrl_cmd(0xD328); send_data_cmd(0x02);
	send_ctrl_cmd(0xD329); send_data_cmd(0xF1);
	send_ctrl_cmd(0xD32A); send_data_cmd(0x03);
	send_ctrl_cmd(0xD32B); send_data_cmd(0x02);
	send_ctrl_cmd(0xD32C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD32D); send_data_cmd(0x0F);
	send_ctrl_cmd(0xD32E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD32F); send_data_cmd(0x23);
	send_ctrl_cmd(0xD330); send_data_cmd(0x03);
	send_ctrl_cmd(0xD331); send_data_cmd(0x54);
	...
	send_ctrl_cmd(0xD403); send_data_cmd(0x01);
	send_ctrl_cmd(0xD404); send_data_cmd(0x00);
	send_ctrl_cmd(0xD405); send_data_cmd(0x18);
	send_ctrl_cmd(0xD406); send_data_cmd(0x00);
	send_ctrl_cmd(0xD407); send_data_cmd(0x43);
	send_ctrl_cmd(0xD408); send_data_cmd(0x00);
	send_ctrl_cmd(0xD409); send_data_cmd(0x77);
	send_ctrl_cmd(0xD40A); send_data_cmd(0x00);
	send_ctrl_cmd(0xD40B); send_data_cmd(0xC4);
	send_ctrl_cmd(0xD40C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD40D); send_data_cmd(0x08);
	send_ctrl_cmd(0xD40E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD40F); send_data_cmd(0x52);
	send_ctrl_cmd(0xD410); send_data_cmd(0x01);
	send_ctrl_cmd(0xD411); send_data_cmd(0x81);
	send_ctrl_cmd(0xD412); send_data_cmd(0x01);
	send_ctrl_cmd(0xD413); send_data_cmd(0xBD);
	send_ctrl_cmd(0xD414); send_data_cmd(0x01);
	send_ctrl_cmd(0xD415); send_data_cmd(0xE7);
	send_ctrl_cmd(0xD416); send_data_cmd(0x02);
	send_ctrl_cmd(0xD417); send_data_cmd(0x20);
	send_ctrl_cmd(0xD418); send_data_cmd(0x02);
	send_ctrl_cmd(0xD419); send_data_cmd(0x4A);
	send_ctrl_cmd(0xD41A); send_data_cmd(0x02);
	send_ctrl_cmd(0xD41B); send_data_cmd(0x4B);
	send_ctrl_cmd(0xD41C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD41D); send_data_cmd(0x70);
	send_ctrl_cmd(0xD41E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD41F); send_data_cmd(0x96);
	send_ctrl_cmd(0xD420); send_data_cmd(0x02);
	send_ctrl_cmd(0xD421); send_data_cmd(0xAA);
	send_ctrl_cmd(0xD422); send_data_cmd(0x02);
	send_ctrl_cmd(0xD423); send_data_cmd(0xC3);
	send_ctrl_cmd(0xD424); send_data_cmd(0x02);
	send_ctrl_cmd(0xD425); send_data_cmd(0xD2);
	send_ctrl_cmd(0xD426); send_data_cmd(0x02);
	send_ctrl_cmd(0xD427); send_data_cmd(0xE5);
	send_ctrl_cmd(0xD428); send_data_cmd(0x02);
	send_ctrl_cmd(0xD429); send_data_cmd(0xF1);
	send_ctrl_cmd(0xD42A); send_data_cmd(0x03);
	send_ctrl_cmd(0xD42B); send_data_cmd(0x02);
	send_ctrl_cmd(0xD42C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD42D); send_data_cmd(0x0F);
	send_ctrl_cmd(0xD42E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD42F); send_data_cmd(0x23);
	send_ctrl_cmd(0xD430); send_data_cmd(0x03);
	send_ctrl_cmd(0xD431); send_data_cmd(0x54);
	...
	send_ctrl_cmd(0xD503); send_data_cmd(0x01);
	send_ctrl_cmd(0xD504); send_data_cmd(0x00);
	send_ctrl_cmd(0xD505); send_data_cmd(0x18);
	send_ctrl_cmd(0xD506); send_data_cmd(0x00);
	send_ctrl_cmd(0xD507); send_data_cmd(0x43);
	send_ctrl_cmd(0xD508); send_data_cmd(0x00);
	send_ctrl_cmd(0xD509); send_data_cmd(0x77);
	send_ctrl_cmd(0xD50A); send_data_cmd(0x00);
	send_ctrl_cmd(0xD50B); send_data_cmd(0xC4);
	send_ctrl_cmd(0xD50C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD50D); send_data_cmd(0x08);
	send_ctrl_cmd(0xD50E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD50F); send_data_cmd(0x52);
	send_ctrl_cmd(0xD510); send_data_cmd(0x01);
	send_ctrl_cmd(0xD511); send_data_cmd(0x81);
	send_ctrl_cmd(0xD512); send_data_cmd(0x01);
	send_ctrl_cmd(0xD513); send_data_cmd(0xBD);
	send_ctrl_cmd(0xD514); send_data_cmd(0x01);
	send_ctrl_cmd(0xD515); send_data_cmd(0xE7);
	send_ctrl_cmd(0xD516); send_data_cmd(0x02);
	send_ctrl_cmd(0xD517); send_data_cmd(0x20);
	send_ctrl_cmd(0xD518); send_data_cmd(0x02);
	send_ctrl_cmd(0xD519); send_data_cmd(0x4A);
	send_ctrl_cmd(0xD51A); send_data_cmd(0x02);
	send_ctrl_cmd(0xD51B); send_data_cmd(0x4B);
	send_ctrl_cmd(0xD51C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD51D); send_data_cmd(0x70);
	send_ctrl_cmd(0xD51E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD51F); send_data_cmd(0x96);
	send_ctrl_cmd(0xD520); send_data_cmd(0x02);
	send_ctrl_cmd(0xD521); send_data_cmd(0xAA);
	send_ctrl_cmd(0xD522); send_data_cmd(0x02);
	send_ctrl_cmd(0xD523); send_data_cmd(0xC3);
	send_ctrl_cmd(0xD524); send_data_cmd(0x02);
	send_ctrl_cmd(0xD525); send_data_cmd(0xD2);
	send_ctrl_cmd(0xD526); send_data_cmd(0x02);
	send_ctrl_cmd(0xD527); send_data_cmd(0xE5);
	send_ctrl_cmd(0xD528); send_data_cmd(0x02);
	send_ctrl_cmd(0xD529); send_data_cmd(0xF1);
	send_ctrl_cmd(0xD52A); send_data_cmd(0x03);
	send_ctrl_cmd(0xD52B); send_data_cmd(0x02);
	send_ctrl_cmd(0xD52C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD52D); send_data_cmd(0x0F);
	send_ctrl_cmd(0xD52E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD52F); send_data_cmd(0x23);
	send_ctrl_cmd(0xD530); send_data_cmd(0x03);
	send_ctrl_cmd(0xD531); send_data_cmd(0x54);
	...
	send_ctrl_cmd(0xD603); send_data_cmd(0x01);
	send_ctrl_cmd(0xD604); send_data_cmd(0x00);
	send_ctrl_cmd(0xD605); send_data_cmd(0x18);
	send_ctrl_cmd(0xD606); send_data_cmd(0x00);
	send_ctrl_cmd(0xD607); send_data_cmd(0x43);
	send_ctrl_cmd(0xD608); send_data_cmd(0x00);
	send_ctrl_cmd(0xD609); send_data_cmd(0x77);
	send_ctrl_cmd(0xD60A); send_data_cmd(0x00);
	send_ctrl_cmd(0xD60B); send_data_cmd(0xC4);
	send_ctrl_cmd(0xD60C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD60D); send_data_cmd(0x08);
	send_ctrl_cmd(0xD60E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD60F); send_data_cmd(0x52);
	send_ctrl_cmd(0xD610); send_data_cmd(0x01);
	send_ctrl_cmd(0xD611); send_data_cmd(0x81);
	send_ctrl_cmd(0xD612); send_data_cmd(0x01);
	send_ctrl_cmd(0xD613); send_data_cmd(0xBD);
	send_ctrl_cmd(0xD614); send_data_cmd(0x01);
	send_ctrl_cmd(0xD615); send_data_cmd(0xE7);
	send_ctrl_cmd(0xD616); send_data_cmd(0x02);
	send_ctrl_cmd(0xD617); send_data_cmd(0x20);
	send_ctrl_cmd(0xD618); send_data_cmd(0x02);
	send_ctrl_cmd(0xD619); send_data_cmd(0x4A);
	send_ctrl_cmd(0xD61A); send_data_cmd(0x02);
	send_ctrl_cmd(0xD61B); send_data_cmd(0x4B);
	send_ctrl_cmd(0xD61C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD61D); send_data_cmd(0x70);
	send_ctrl_cmd(0xD61E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD61F); send_data_cmd(0x96);
	send_ctrl_cmd(0xD620); send_data_cmd(0x02);
	send_ctrl_cmd(0xD621); send_data_cmd(0xAA);
	send_ctrl_cmd(0xD622); send_data_cmd(0x02);
	send_ctrl_cmd(0xD623); send_data_cmd(0xC3);
	send_ctrl_cmd(0xD624); send_data_cmd(0x02);
	send_ctrl_cmd(0xD625); send_data_cmd(0xD2);
	send_ctrl_cmd(0xD626); send_data_cmd(0x02);
	send_ctrl_cmd(0xD627); send_data_cmd(0xE5);
	send_ctrl_cmd(0xD628); send_data_cmd(0x02);
	send_ctrl_cmd(0xD629); send_data_cmd(0xF1);
	send_ctrl_cmd(0xD62A); send_data_cmd(0x03);
	send_ctrl_cmd(0xD62B); send_data_cmd(0x02);
	send_ctrl_cmd(0xD62C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD62D); send_data_cmd(0x0F);
	send_ctrl_cmd(0xD62E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD62F); send_data_cmd(0x23);
	send_ctrl_cmd(0xD630); send_data_cmd(0x03);
	send_ctrl_cmd(0xD631); send_data_cmd(0x54);
	...
	send_ctrl_cmd(0xBD01); send_data_cmd(0x90);
	send_ctrl_cmd(0xBD02); send_data_cmd(0x1C);
	send_ctrl_cmd(0xBD03); send_data_cmd(0x1C);
	send_ctrl_cmd(0xBD04); send_data_cmd(0x00);
	//Timing control
	send_ctrl_cmd(0xCB00); send_data_cmd(0x02);
	send_ctrl_cmd(0xCB01); send_data_cmd(0x09);
	send_ctrl_cmd(0xCB02); send_data_cmd(0xBC);
	send_ctrl_cmd(0xCB03); send_data_cmd(0x02);
	send_ctrl_cmd(0xCB04); send_data_cmd(0x00);
	send_ctrl_cmd(0xCB05); send_data_cmd(0x80);
	send_ctrl_cmd(0xCB06); send_data_cmd(0x10);
	send_ctrl_cmd(0xCB07); send_data_cmd(0x0C);
	
	send_ctrl_cmd(0x3A00); send_data_cmd(0x66); //
	send_ctrl_cmd(0x3600); send_data_cmd(0x00); 	  //C0  00 D0
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dbi.parallel.wait_period    = 2;//4
...
static unsigned int lcm_compare_id(void)
{
    ...
    Lcd_Log("MYCAT Read NT35510H id  = %x\n",  id);
...
LCM_DRIVER nt35510h_tianchuangguang_T40BMLP22_CTC_mcu24_wvga_lcm_drv =
    {
        .name			= "nt35510h_tianchuangguang_T40BMLP22_CTC_mcu24_wvga",
