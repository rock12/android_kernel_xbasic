...
Lcd_Log("mycat READ ILI9806 LCD ID%s, id = 0x%x\n", __func__, id);
...
static void init_lcm_registers(void)
{
		...
		Lcd_Log("mycat LCD hansen lcd +++000 \n");	
		...
		send_data_cmd(0x0a); //P2
		send_data_cmd(0x16); //P3
		send_data_cmd(0x11); //P4
		send_data_cmd(0x12); //P5
		send_data_cmd(0x1A); //P6
		send_data_cmd(0x0B); //P7
		send_data_cmd(0x0a); //P8
		send_data_cmd(0x02); //P9
		send_data_cmd(0x07); //P10
		send_data_cmd(0x06); //P11
		send_data_cmd(0x0D); //P12
		send_data_cmd(0x0f); //P13
		send_data_cmd(0x2f); //P14
		send_data_cmd(0x21); //P15
		send_data_cmd(0x00); //P16
		
		send_ctrl_cmd(0xE1);
		send_data_cmd(0x00); //P1
		send_data_cmd(0x07); //P2
		send_data_cmd(0x10); //P3
		send_data_cmd(0x0f); //P4
		send_data_cmd(0x11); //P5
		send_data_cmd(0x15); //P6
		send_data_cmd(0x07); //P7
		send_data_cmd(0x05); //P8
		send_data_cmd(0x05); //P9
		send_data_cmd(0x0a); //P10
		send_data_cmd(0x08); //P11
		send_data_cmd(0x10); //P12
		send_data_cmd(0x0f); //P13
		send_data_cmd(0x26); //P14
		send_data_cmd(0x1b); //P15
		send_data_cmd(0x00); //P16
		
		send_ctrl_cmd(0x35); //Tearing Effect ON
		send_data_cmd(0x00);
		send_ctrl_cmd(0x44); //Tearing Effect ON
		send_data_cmd(0x01);
		send_data_cmd(0x00);
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dbi.io_driving_current      = LCM_DRIVING_CURRENT_6575_8MA; //8 pyj
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_hansen_HS40143WVNC39_CPT_mcu18_wvga_lcm_drv = 
{
  .name			= "ili9806_hansen_HS40143WVNC39_CPT_mcu18_wvga",
