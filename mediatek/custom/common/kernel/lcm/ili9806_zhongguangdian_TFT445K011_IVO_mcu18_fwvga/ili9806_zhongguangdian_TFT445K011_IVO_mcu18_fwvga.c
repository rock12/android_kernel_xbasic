...
static void init_lcm_registers(void)
{
...
#if defined(BUILD_UBOOT)
	printf("mycat LCD ili9806_zhongguangdian_TFT445K011_IVO_mcu18_fwvga \n");	
#endif

		//************* Start Initial Sequence **********// 
	send_ctrl_cmd(0XFF);    //EXTC command Password 
	send_data_cmd(0xFF); 
	send_data_cmd(0x98); 
	send_data_cmd(0x06); 
	...
	send_ctrl_cmd(0x35);        //Frame Rate Control 
	send_data_cmd(0x00);   
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_zhongguangdian_TFT445K011_IVO_mcu18_fwvga_lcm_drv = 
{
  .name			= "ili9806_zhongguangdian_TFT445K011_IVO_mcu18_fwvga",
