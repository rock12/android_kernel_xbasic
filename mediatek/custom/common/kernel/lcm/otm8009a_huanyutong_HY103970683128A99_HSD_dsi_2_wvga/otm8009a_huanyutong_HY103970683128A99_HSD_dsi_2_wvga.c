...
{0x44, 2 ,{0x01,0xC0}},// TE( Fmark ) Signal Output Position
#else
...
LCM_DRIVER otm8009a_huanyutong_HY103970683128A99_HSD_dsi_2_wvga_lcm_drv = 
{
    .name			= "otm8009a_huanyutong_HY103970683128A99_HSD_dsi_2_wvga",
