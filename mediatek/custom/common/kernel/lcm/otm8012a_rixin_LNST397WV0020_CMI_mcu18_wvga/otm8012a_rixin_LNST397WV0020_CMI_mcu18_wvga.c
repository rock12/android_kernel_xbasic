...
static void init_lcm_registers(void)
{
	...
	#if 1
    Lcd_Log("mycat LCD otm8009a truly or zhuoershi\n");	

//*****otm8012_cmo3.97***20130718****//
		...
		send_ctrl_cmd(0xC181); send_data_cmd(0x66);  //add
		...
		send_ctrl_cmd(0xC583); send_data_cmd(0x55);  //add
		...
		send_ctrl_cmd(0xD800); send_data_cmd(0x83);
		send_ctrl_cmd(0xD801); send_data_cmd(0x80);
		
		send_ctrl_cmd(0xD900); send_data_cmd(0x7a); // 0x54   0x68
...
send_ctrl_cmd(0xD800); send_data_cmd(0x83);
send_ctrl_cmd(0xD801); send_data_cmd(0x83);

send_ctrl_cmd(0xD900); send_data_cmd(0x5E);

send_ctrl_cmd(0xE100); send_data_cmd(0x0C);
send_ctrl_cmd(0xE101); send_data_cmd(0x1A);
send_ctrl_cmd(0xE102); send_data_cmd(0x25);
send_ctrl_cmd(0xE103); send_data_cmd(0x33);
send_ctrl_cmd(0xE104); send_data_cmd(0x41);
send_ctrl_cmd(0xE105); send_data_cmd(0x51);
send_ctrl_cmd(0xE106); send_data_cmd(0x53);
send_ctrl_cmd(0xE107); send_data_cmd(0x82);
send_ctrl_cmd(0xE108); send_data_cmd(0x74);
send_ctrl_cmd(0xE109); send_data_cmd(0x90);
send_ctrl_cmd(0xE10A); send_data_cmd(0x71);
send_ctrl_cmd(0xE10B); send_data_cmd(0x58);
send_ctrl_cmd(0xE10C); send_data_cmd(0x65);
send_ctrl_cmd(0xE10D); send_data_cmd(0x3A);
send_ctrl_cmd(0xE10E); send_data_cmd(0x37);
send_ctrl_cmd(0xE10F); send_data_cmd(0x2A);
send_ctrl_cmd(0xE110); send_data_cmd(0x1E);
send_ctrl_cmd(0xE111); send_data_cmd(0x19);
send_ctrl_cmd(0xE112); send_data_cmd(0x16);
send_ctrl_cmd(0xE113); send_data_cmd(0x13);

send_ctrl_cmd(0xE200); send_data_cmd(0x0C);
send_ctrl_cmd(0xE201); send_data_cmd(0x1A);
send_ctrl_cmd(0xE202); send_data_cmd(0x26);
send_ctrl_cmd(0xE203); send_data_cmd(0x33);
send_ctrl_cmd(0xE204); send_data_cmd(0x42);
send_ctrl_cmd(0xE205); send_data_cmd(0x51);
send_ctrl_cmd(0xE206); send_data_cmd(0x54);
send_ctrl_cmd(0xE207); send_data_cmd(0x82);
send_ctrl_cmd(0xE208); send_data_cmd(0x75);
send_ctrl_cmd(0xE209); send_data_cmd(0x90);
send_ctrl_cmd(0xE20A); send_data_cmd(0x71);
send_ctrl_cmd(0xE20B); send_data_cmd(0x58);
send_ctrl_cmd(0xE20C); send_data_cmd(0x65);
send_ctrl_cmd(0xE20D); send_data_cmd(0x3A);
send_ctrl_cmd(0xE20E); send_data_cmd(0x37);
send_ctrl_cmd(0xE20F); send_data_cmd(0x2A);
send_ctrl_cmd(0xE210); send_data_cmd(0x1E);
send_ctrl_cmd(0xE211); send_data_cmd(0x19);
send_ctrl_cmd(0xE212); send_data_cmd(0x16);
send_ctrl_cmd(0xE213); send_data_cmd(0x13);
...
static unsigned int lcm_compare_id(void)
{
    ...
    Lcd_Log("mycat READ OTM8012 LCD ID2%s, id = 0x%x\n", __func__, id);
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm8012a_rixin_LNST397WV0020_CMI_mcu18_wvga_lcm_drv =
    {
        .name		= "otm8012a_rixin_LNST397WV0020_CMI_mcu18_wvga",
