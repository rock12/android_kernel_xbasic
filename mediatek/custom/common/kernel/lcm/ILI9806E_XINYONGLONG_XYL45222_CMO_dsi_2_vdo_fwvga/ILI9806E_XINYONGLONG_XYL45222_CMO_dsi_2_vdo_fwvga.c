...
{0x31,1,{0x02}},                 // 2-dot Inversion{0x40,1,{0x11}},               // DDVDH/L BT 17 -10 5.94 -5.47 -2.3 1.6 43.4 21.88 0.17

{0x40,1,{0x11}},     

{0x41,1,{0x33}},                // DDVDH/L CLAMP// 33
{0x42,1,{0x03}},            //03
{0x43,1,{0x09}},

{0x44,1,{0x04}},

{0x50,1,{0x78}},                // VGMP 4.8  78
{0x51,1,{0x78}},                // VGMN 4.8   78
{0x52,1,{0x00}},      

{0x53,1,{0x6e}},  //wangdong88    
...
//		params->dbi.te_mode 			= LCM_DBI_TE_MODE_DISABLED; 
    	...
    	params->dsi.fbk_div =32;		//28 fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)		
}
...
//lcm_initialization_setting[13].para_list[0]+=1;
	lcm_init();
//	Lcd_Log("wangdong:0x02%x\n",lcm_initialization_setting[13].para_list[0]);
...
LCM_DRIVER ILI9806E_XINYONGLONG_XYL45222_CMO_dsi_2_vdo_fwvga_lcm_drv = 
{
    .name			= "ILI9806E_XINYONGLONG_XYL45222_CMO_dsi_2_vdo_fwvga",
