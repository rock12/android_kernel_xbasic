...
*/
	...
	data_array[2]=0x111050EB;
	data_array[3]=0x3027f2d0;  //0x332bf272   2a22f272
	data_array[4]=0x01422727; 
	...
	data_array[1]=0x009800b6; //98 9a
	data_array[2]=0x00000098; 
	dsi_set_cmdq(&data_array, 3, 1);
	MDELAY(1);//3000
/*
	data_array[0]=0x00053902;//Enable external Command
	data_array[1]=0x000000b6 | (vcom<<16); //98 9a
	data_array[2]=0x00000000 | vcom; 
	dsi_set_cmdq(&data_array, 3, 1);
	MDELAY(1);//3000
	vcom += 2;
*/
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8389b_zhuoershi_Z50244N50X2H_A_dsi_vdo_qhd_lcm_drv = 
{
    .name			= "hx8389b_zhuoershi_Z50244N50X2H_A_dsi_vdo_qhd",
