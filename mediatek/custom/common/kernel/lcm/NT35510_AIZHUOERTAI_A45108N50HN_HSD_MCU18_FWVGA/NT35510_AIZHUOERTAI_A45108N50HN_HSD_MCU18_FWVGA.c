...
//static int vcom = 0x60;
static void init_lcm_registers(void)

{
	#if defined(MTK6572M_LCM_PATCH)
	// LV2 Page 1 enable
	...
	send_ctrl_cmd(0xBE01);send_data_cmd(0x76);    //0x64
	...
	send_ctrl_cmd(0xB500);send_data_cmd(0x6B);  //0x6B 480*854 0x50 480*800
	...
	send_ctrl_cmd(0xBD01); send_data_cmd(0x68);
	send_ctrl_cmd(0xBD02); send_data_cmd(0x1E);
	send_ctrl_cmd(0xBD03); send_data_cmd(0x1D);
	...
	// VCOM
	send_ctrl_cmd(0xBE00);send_data_cmd(0x00);
	send_ctrl_cmd(0xBE01);send_data_cmd(0x80);    //0x64
	...
	//Frame rate
	send_ctrl_cmd(0xBD00); send_data_cmd(0x01);
	send_ctrl_cmd(0xBD01); send_data_cmd(0x6C);
	send_ctrl_cmd(0xBD02); send_data_cmd(0x1E);
	send_ctrl_cmd(0xBD03); send_data_cmd(0x1D);
	send_ctrl_cmd(0xBD04); send_data_cmd(0x00);
	// Timing control 4H w/ 4-delay
...
LCM_DRIVER NT35510_AIZHUOERTAI_A45108N50HN_HSD_MCU18_FWVGA_lcm_drv =
{

        .name	= "NT35510_AIZHUOERTAI_A45108N50HN_HSD_MCU18_FWVGA.",
