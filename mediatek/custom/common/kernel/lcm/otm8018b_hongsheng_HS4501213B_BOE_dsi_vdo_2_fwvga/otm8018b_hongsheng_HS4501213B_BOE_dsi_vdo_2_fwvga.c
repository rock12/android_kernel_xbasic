...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    */  
    ...
    params->dsi.fbk_div =15;//18		// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)		
...
LCM_DRIVER otm8018b_hongsheng_HS4501213B_BOE_dsi_vdo_2_fwvga_lcm_drv = 
{
    .name			= "otm8018b_hongsheng_HS4501213B_BOE_dsi_vdo_2_fwvga",
