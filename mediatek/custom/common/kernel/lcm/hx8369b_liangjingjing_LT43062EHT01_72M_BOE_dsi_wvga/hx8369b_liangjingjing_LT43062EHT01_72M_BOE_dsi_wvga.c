...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_backporch					= 18;//50;22
		params->dsi.vertical_frontporch					= 20;//50;20
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 
...
LCM_DRIVER hx8369b_liangjingjing_LT43062EHT01_72M_BOE_dsi_wvga_lcm_drv =
    {
        .name			= "hx8369b_liangjingjing_LT43062EHT01_72M_BOE_dsi_wvga",
