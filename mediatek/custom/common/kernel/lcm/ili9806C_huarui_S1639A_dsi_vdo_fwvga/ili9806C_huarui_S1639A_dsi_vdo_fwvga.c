...
static struct LCM_setting_table lcm_initialization_setting0[] = {
   ...
   */
	...
	{0xFF, 3,{0xFF,0x98,0x16}}, // EXTC Command Set enable regis

	{0xBA, 1,{0x60}}, // SPI Interface Setting 
	 
	{0XB0, 1,{0x01}}, // Interface Mode Control 
	
	{0xBC, 23,{0x01,0x0E,0x61,0xFF,0x01,0x01,0x0B,0x0F,0x6A,0x13,0x0F,0x6A,0x01,0x01,0x00,0x00,0x55,0x53,0x01,0x0D,0x0D,0x43,0x0B}},   // GIP 1 
	
	{0xBD, 8,{0x01,0x23,0x45,0x67,0x01,0x23,0x45,0x67}},  // GIP 2 
	
	{0xBE, 16,{0x02,0x22,0x11,0xBA,0xAB,0x66,0x00,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22}}, // GIP 3 
	...
	{0XC1, 4,{0x17,0x88,0x6C,0x10}}, // Power Control 2
	 
	{0XD8, 1,{0x50}}, // VGLO Selection
	
	{0XFC, 1,{0x08}}, // VGLO Selection 
	 
	{0XE0, 16,{0x80,0x8D,0x98,0XC0,0x0F,0x0C,0X08,0x06,0x07,0x0A,0x0F,0x0F,0x10,0x19,0x0C,0x00}}, // Positive Gamma Control
	
	{0XE1, 16,{0x80,0x90,0XD5,0xBA,0x0E,0x0B,0X06,0x04,0x07,0x0B,0x0D,0x0D,0x0A,0x17,0x14,0x00}}, // Negative Gamma Co
	 
	{0XD5, 8,{0x0A,0x09,0x0F,0x06,0xCB,0XA5,0x01,0x04}}, // Source Timing Adjust
	{0XF7, 1,{0x89}}, // Resolution 
	 
	{0XC7, 1,{0x49}}, // Vcom     0x46
	 
	{0X36, 1,{0x00}}, // 00=>FW ; 03=>BW   
  
	{0X21, 1, {0x00}}, //inversion
...
LCM_DRIVER ili9806C_huarui_S1639A_dsi_vdo_fwvga_lcm_drv = 
{
	.name			= "ili9806C_huarui_S1639A_dsi_vdo_fwvga",
