...
static void lcm_get_params(LCM_PARAMS *params)
{
  	...
  	params->dsi.fbk_div =13;//14		// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)		
...
LCM_DRIVER hx8357d_apex_A35406N00QH_A_CMI_dsi_cmd_hvga_lcm_drv = 
{
	.name								= "hx8357d_apex_A35406N00QH_A_CMI_dsi_cmd_hvga",
