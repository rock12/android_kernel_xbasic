...
{0x00,1,{0x00}},
{0xE1,16,{0x01,0x11,0x17,0x0F,0x07,0x11,0x0B,0x0A,0x04,0x07,0x0B,0x08,0x0E,0x15,0x11,0x06}},
////////////////////////////////// 255   251  247  239  231 203  175  147 , 108   80   52   24  16    8    4    0
{0x00,1,{0x00}},
{0xE2,16,{0x01,0x11,0x17,0x0E,0x07,0x11,0x0B,0x0A,0x04,0x07,0x0B,0x08,0x0E,0x15,0x11,0x06}},
...
{
//		lcm_initialization_setting[27].para_list[0]+=2;
//		Lcd_Log("mycat vcom = 0x%02x.....", lcm_initialization_setting[27].para_list[0]);
   lcm_init();
...
LCM_DRIVER otm8018b_zhongguangdian_CMI_dsi_vdo_2_fwvga_lcm_drv = 
{
    .name			= "otm8018b_zhongguangdian_CMI_dsi_vdo_2_fwvga",
