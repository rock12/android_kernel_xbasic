...
{0xC1,4,{0x17,0x8f,0x9d,0x20}}, 
 
  
 
{0xE0,16,{0x00,0x21,0x27,0x0c,0x0d,0x0a,0x08,0x07,0x05,0x0a,0x0f,0x0f,0x0e,0x17,0x11,0x00}},  
 
{0xE1,16,{0x00,0x21,0x27,0x0c,0x0d,0x0a,0x08,0x07,0x05,0x0a,0x0f,0x0f,0x0e,0x1b,0x11,0x00}},  
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.fbk_div =14;	//17	// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)		
...
static int get_lcd_id(void)
{
    ...
    MDELAY(1);
	Lcd_Log("MYCAT ILI9806 JX get_lcd_id=%d\n",mt_get_gpio_in(GPIO_LCD_ID_PIN));
...
static unsigned int lcm_compare_id(void)
{
    ...
    */
    ...
    Lcd_Log("MYCAT ILI9806 JX %s, id=0x%x,id2=0x%x\n", __func__, id,id2);
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_aizhuoertai_IPS_dsi_wvga_cmd_lcm_drv = 
{
    .name			= "ili9806_aizhuoertai_IPS_dsi_wvga_cmd",
