...
static void init_lcm_registers(void)
{
	...
	printf("mycat LCD unix lcd +++111 \n");	
		...
		send_ctrl_cmd(0xB1);
		send_data_cmd(0x00);
		send_data_cmd(0x12);//13
		send_data_cmd(0x19);//13
...
static void lcm_resume(void)
{
	...
	//lcm_init();
	send_ctrl_cmd(0x11); // Display off
	MDELAY(200);
	send_ctrl_cmd(0x29); // Sleep in
	MDELAY(50);
}
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_qijia_JX446003S0_CD_HSD_mcu18_fwvga_lcm_drv = 
{
  .name			= "ili9806_qijia_JX446003S0_CD_HSD_mcu18_fwvga",
