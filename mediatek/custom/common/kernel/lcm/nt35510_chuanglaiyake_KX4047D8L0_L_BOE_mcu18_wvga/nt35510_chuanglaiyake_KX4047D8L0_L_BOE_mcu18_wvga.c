...
static void init_lcm_registers(void)
{
    Lcd_Log("MYCAT LCD nt35510_tengsheng_43008fn_mcu_wvga");
	  ...
	  send_ctrl_cmd(0xF000); send_data_cmd(0x55);
		...
		send_ctrl_cmd(0x3600); send_data_cmd(0xD0);//00--normal,C0--Rotate 180
...
LCM_DRIVER nt35510_chuanglaiyake_KX4047D8L0_L_BOE_mcu18_wvga_lcm_drv =
    {
        .name			= "nt35510_chuanglaiyake_KX4047D8L0_L_BOE_mcu18_wvga",
