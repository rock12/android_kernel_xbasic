...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.fbk_div =32;	//17	// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)		
#else
		params->dsi.pll_div1=1;		//1 div1=0,1,2,3;div1_real=1,2,4,4
...
static unsigned int lcm_compare_id(void)
{
    ...
    */
    ...
    Lcd_Log("wqcat %s, id=0x%x,id2=0x%x\n", __func__, id,id2);
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806_CMS5106TRKSZ2_dsi_2_BOE_wvga_lcm_drv = 
{
    .name			= "ili9806_CMS5106TRKSZ2_dsi_2_BOE_wvga",
