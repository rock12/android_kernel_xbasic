 ...
 * Revision 1.6  2012/11/27 07:48:33  ouyangxian
 * mirror
 *
 * Revision 1.5  2012/11/12 08:55:07  maliejun
 * driver update
 *
 * Revision 1.4  2012/09/21 02:55:20  bianhuannan
 * no message
 *
 * Revision 1.3  2012/08/30 01:50:01  birdlibo
 * no message
 *
 * Revision 1.2  2012/07/18 04:07:15  maliejun
 * Editor: maliejun
 * Inspector:maliejun
...
void GC0309_Sensor_Init(void)
{
	...
	*/
...
#ifdef BIRD_GC0309_HV_MIRROR
	GC0309_write_cmos_sensor(0x14,0x13);	//mirror
#elif defined(BIRD_GC0309_H_MIRROR)
	GC0309_write_cmos_sensor(0x14,0x10);	//mirror
#else	
	GC0309_write_cmos_sensor(0x14,0x12);	//mirror
#endif		
	...
	GC0309_write_cmos_sensor(0x1f,0x17);  //17
	...
	//output sync_mode
	GC0309_write_cmos_sensor(0x26,0x06); //0x02
...
/**************** Mormo Update End *************************/	
    ...
    GC0309_GAMMA_Select(RGB_Gamma_m3);
}
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_UYVY;//SENSOR_OUTPUT_FORMAT_YVYU ,SENSOR_OUTPUT_FORMAT_UYVY;SENSOR_OUTPUT_FORMAT_VYUY
...
BOOL GC0309_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:  // +0 EV
		    	GC0309_write_cmos_sensor(0xb5, 0x08);
			GC0309_write_cmos_sensor(0xd3, 0x60);
			break;    
