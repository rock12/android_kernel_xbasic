 ...
 * Revision 1.1  2013/11/13 12:02:30  dongxiaocheng
 * Editor:dongxiaocheng
 * Inspector:dongxiaocheng
 * Reason:1360_H102ÏîÄ¿Ç°Éã
 * Reference:none
 *
...
void GC0313MIPI_Sensor_Init(void)
{
	...
	GC0313MIPI_write_cmos_sensor(0xb2 , 0x03);//07
	...
	GC0313MIPI_write_cmos_sensor(0xd1 , 0x22);//38
	GC0313MIPI_write_cmos_sensor(0xd2 , 0x22);//38
