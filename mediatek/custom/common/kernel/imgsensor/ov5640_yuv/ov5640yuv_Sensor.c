...
void OV5640YUV_Sensor_Dvp_Init(void)
{
    ...
    OV5640YUV_write_cmos_sensor(0x4051, 0x7f);
	  ...
	  //awb           
		...
		OV5640YUV_write_cmos_sensor(0x5302, 0x28); 
...
void OV5640YUV_set_720P_init(void)
{
    ...
    OV5640YUV_write_cmos_sensor(0x4051, 0x7f);
		...
		OV5640YUV_write_cmos_sensor(0x5307, 0x18);//28		 
...
void OV5640YUV_set_5M_init(void)
{
    ...
    OV5640YUV_write_cmos_sensor(0x4051, 0x8f);
		...
		OV5640YUV_write_cmos_sensor(0x5302, 0x1c);  
		OV5640YUV_write_cmos_sensor(0x5303, 0x08);  
...
tem =0;
	...
	OV5640YUV_Set_Mirror_Flip(IMAGE_NORMAL);
...
#define OV5640YUV_FLASH_BV_THRESHOLD 20     //´òÉÁãÐÖµ
static void OV5640YUV_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int NormBr;

    NormBr = OV5640YUV_read_cmos_sensor(0x56A1);
    printk("wqcat OV5640YUV_FlashTriggerCheck NormBr=%d\n",NormBr);
    if (NormBr > OV5640YUV_FLASH_BV_THRESHOLD){
...
//end
        ...
        case SENSOR_FEATURE_SET_AF_WINDOW:
            ...
            break;	
	         ...
	         OV5640YUV_FlashTriggerCheck(pFeatureData32);
