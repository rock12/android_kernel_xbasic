...
********************************************************************************/
char g_detectmainSensorNameStr[32] = {KDIMGSENSOR_NOSENSOR};
inline static int adopt_CAMERA_HW_CheckIsAlive(void)
{
...
#if defined(BIRD_1373EM_K9A)
    if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
    {
        if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_S5K5EAYX_YUV,g_invokeSensorNameStr)))
            {
            return -EIO;
        }
    }
#endif
#if defined(BIRD_13F45_502_CAM_POWERDOWN)

    if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
    {
        if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_OV5645_MIPI_YUV,g_invokeSensorNameStr)))
            {
            return -EIO;
        }
    }
...
#if defined(BIRD_1365E_V36_CAM_POWERDOWN)
	if (DUAL_CAMERA_MAIN_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC2035S_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
	...
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
		else if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC2035MIPI_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
#endif
#if defined(BIRD_SENSOR_POWERDOWN_13C43_Y05C)||defined(BIRD_SENSOR_POWERDOWN_GC2035_HM5065)
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC2035_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
...
#endif
    #ifdef BIRD_SENSOR_POWERDOWN_13E43_A6C
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC0328_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
	...
	#ifdef BIRD_SENSOR_POWERDOWN_13E45_L016
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
	...
	#if defined(BIRD_SENSOR_POWERDOWN_13E45_LT038T)
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
		...
		#if defined(BIRD_SENSOR_POWERDOWN_13C45_60)
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
	...
	#if defined(BIRD_13E27_B09W)||defined(BIRD_CAM_POWERDOWN_1365E_T02)
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_SP0A19_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
	...
	if (DUAL_CAMERA_MAIN_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_SP0A19S_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
	#endif
	#ifdef BIRD_SENSOR_POWERDOWN_13F45_502
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
		...
		#ifdef BIRD_SENSOR_POWERDOWN_13F39_FIRE
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
	...
	#endif
	#ifdef BIRD_SENSOR_POWERDOWN_13E45_JM55E
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
	...
	#ifdef BIRD_SENSOR_POWERDOWN_13F45_9500B
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
	...
	#ifdef BIRD_13C43_YT808
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC0329_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
	...
	if (DUAL_CAMERA_MAIN_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC0329S_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
...
#if defined(BIRD_CAM_POWERDOWN_1365E_T03)
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC0328_YUV,g_invokeSensorNameStr)))
        	{
	...
	if (DUAL_CAMERA_MAIN_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC0328S_YUV,g_invokeSensorNameStr)))
        	{
			return -EIO;
		}
	}
#endif
	#if defined(BIRD_13F43_P800AF) || defined(BIRD_13F43_JST_F43) || defined(BIRD_13F43_JST_F43D) 
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_HM5065_YUV,g_invokeSensorNameStr)))
        	{
...
#if defined(BIRD_CAM_POWERDOWN_1365F_E12_2P16)
/*
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC0329_YUV,g_invokeSensorNameStr)))
...
#ifdef BIRD_SENSOR_POWERDOWN_GC2035
	if (DUAL_CAMERA_SUB_SENSOR == g_invokeSocketIdx[0])
	{
		if (g_invokeSensorNameStr && (0 == strcmp(SENSOR_DRVNAME_GC2035_YUV,g_invokeSensorNameStr)))
        	{
		...
		for ( i = KDIMGSENSOR_INVOKE_DRIVER_0 ; i < KDIMGSENSOR_MAX_INVOKE_DRIVERS ; i++ ) {
			if(DUAL_CAMERA_NONE_SENSOR != g_invokeSocketIdx[i]){
		        ...
		        if (sensorID == 0) {    //not implement this feature ID
		        	...
		        	#if defined(BIRD_13E45_JM55E) || defined(BIRD_13E45_L016) || defined(BIRD_DUAL_MAIN_SENSOR)|| defined(BIRD_1360C_E360B)
								if (DUAL_CAMERA_MAIN_SENSOR == g_invokeSocketIdx[0])
								{
									memcpy((char*)g_detectmainSensorNameStr,(char*)(&g_invokeSensorNameStr[0]), 32);
								}
							#endif
...
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    //set I2C clock rate
    g_pstI2Cclient->timing = 100; //300;//200k  //modify by libo 20130620
    spin_unlock(&kdsensor_drv_lock);
