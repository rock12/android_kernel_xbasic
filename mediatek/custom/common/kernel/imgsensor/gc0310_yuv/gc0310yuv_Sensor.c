...
void GC0310_Sensor_Init(void)
{
	...
	GC0310_write_cmos_sensor(0xfe, 0xf0);
	GC0310_write_cmos_sensor(0xfe, 0x00);
	GC0310_write_cmos_sensor(0xfc, 0x16);
	GC0310_write_cmos_sensor(0xfc, 0x16);
	GC0310_write_cmos_sensor(0xf2, 0x07);
	GC0310_write_cmos_sensor(0xf3, 0x00);// output_disable
	GC0310_write_cmos_sensor(0xf7, 0x00);
	GC0310_write_cmos_sensor(0xf8, 0x00);
	GC0310_write_cmos_sensor(0xf9, 0x4f); 
	...
	GC0310_write_cmos_sensor(0x20, 0x89);
	...
	GC0310_write_cmos_sensor(0x33, 0x18);
	...
	GC0310_write_cmos_sensor(0x45, 0xaf);	
	...
	GC0310_write_cmos_sensor(0x06, 0xb6); 
	GC0310_write_cmos_sensor(0x07, 0x00);
	GC0310_write_cmos_sensor(0x08, 0x2a);
	...
	GC0310_write_cmos_sensor(0x2b, 0x06);   //exp level 2  6.67fps
...
BOOL GC0310_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			GC0310_write_cmos_sensor(0xfe, 0x00); 
			GC0310_write_cmos_sensor(0x05, 0x01); 	
			GC0310_write_cmos_sensor(0x06, 0xa1); 
			GC0310_write_cmos_sensor(0x07, 0x00);
			GC0310_write_cmos_sensor(0x08, 0x2a);
			
			GC0310_write_cmos_sensor(0xfe, 0x01);
			GC0310_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
			GC0310_write_cmos_sensor(0x26, 0x5a);   //anti-flicker step [7:0]
			
			GC0310_write_cmos_sensor(0x27, 0x02);   //exp level 0  20fps
			GC0310_write_cmos_sensor(0x28, 0x1c); 
			GC0310_write_cmos_sensor(0x29, 0x03);   //exp level 1  12.50fps
			GC0310_write_cmos_sensor(0x2a, 0x84); 
			GC0310_write_cmos_sensor(0x2b, 0x06);   //exp level 2  6.67fps
			GC0310_write_cmos_sensor(0x2c, 0x54); 
			GC0310_write_cmos_sensor(0x2d, 0x07);   //exp level 3  5.55fps
			GC0310_write_cmos_sensor(0x2e, 0x62); 
			GC0310_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
