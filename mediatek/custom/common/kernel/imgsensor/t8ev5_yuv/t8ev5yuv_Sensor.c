...
static void T8EV5YUV_Sensor_Init_setting(void)
{
	...
	T8EV5YUV_write_cmos_sensor(0x0141,0x01);//-/-/-/REGVD_SEL/-/-/AMON0_SEL[1:0]//zh modify for mipi phy power 20130723
	...
	T8EV5YUV_write_cmos_sensor(0x0304,0x38);//AGMIN[7:0]!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	T8EV5YUV_write_cmos_sensor(0x043B,0xC0);//;LSBLR[7:0] //D8
	T8EV5YUV_write_cmos_sensor(0x043C,0x6D);//;LSBLB[7:0]
	T8EV5YUV_write_cmos_sensor(0x043D,0xB5);//;LSBRG[7:0]  2nd right
	T8EV5YUV_write_cmos_sensor(0x043E,0xC6);//;LSBRR[7:0]//De
	T8EV5YUV_write_cmos_sensor(0x043F,0x52);//;LSBRB[7:0]
	T8EV5YUV_write_cmos_sensor(0x0440,0xD0);//;LSCUG[7:0] 2nd up  
	T8EV5YUV_write_cmos_sensor(0x0441,0xDF);//;LSCUR[7:0] //F7
	...
	T8EV5YUV_write_cmos_sensor(0x0447,0x09);//;LSDLR[7:0]
	T8EV5YUV_write_cmos_sensor(0x0448,0x63);//;LSDLB[7:0]
...
void T8EV5YUV_set_contrast(UINT16 iPara)
{
    ...
    switch(iPara)
    {
	    case ISP_CONTRAST_LOW:
	        T8EV5YUV_write_cmos_sensor(0x0249,0x87);
		break;
