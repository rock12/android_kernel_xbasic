...
static void T8EV5YUV_Sensor_Init_setting(int lines)
{
	...
	T8EV5YUV_write_cmos_sensor(0x0231,0xB5);//EXTR_LIM[7:0]
	...
	T8EV5YUV_write_cmos_sensor(0x024B,0x04);//-/-/-/-/BLK_CONT2[3:0]
...
static void T8EV5YUV_set_contrast(UINT16 iPara)
{
    ...
    switch(iPara)
    {
	    case ISP_CONTRAST_LOW:
	        T8EV5YUV_write_cmos_sensor(0x0249,0x86);
		break;
	    case ISP_CONTRAST_MIDDLE:
	        T8EV5YUV_write_cmos_sensor(0x0249,0x98);
		break;
   ...
   if(sceneMode==SCENE_MODE_HDR)
   {
	...
	if(Camco_mode == T8EV5_MODE_CAPTURE_5M)
	{
		 if((temp_val*H_PV/PCLK_PV)>=(H_CP*V_CP*AG_1X/PCLK_CP))//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		 {
			 ...
			 printk("T8EV5YUVCapture   111111111111111\n");
		 ...
		 else
		 {
			 ...
			 printk("T8EV5YUVCapture   22222222222222\n");
		 }
	}
