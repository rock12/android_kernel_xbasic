 ...
 *------------------------------------------------------------------------------
 * $Log: gc0311yuv_Sensor.c,v $
 * Revision 1.1  2013/10/25 02:22:57  wangdong
 * no message
 *
 * Revision 1.2  2013/09/16 03:48:45  shenqiaoqiao
 * Editor:shenqiaoqiao
 * Inspector:shenqiaoqiao
 * custom:
 * Reason: baoguang +-2
 * Reference:null
 *
 * Revision 1.1  2013/07/02 02:57:05  litianfeng
 * no message
 *
 *   
 *
...
void GC0311_Sensor_Init(void)
{
	...
	GC0311_write_cmos_sensor(0x03, 0x01);
	GC0311_write_cmos_sensor(0x04, 0x20);
	...
	GC0311_write_cmos_sensor(0x06, 0x2c); 
	GC0311_write_cmos_sensor(0x07, 0x00);
	GC0311_write_cmos_sensor(0x08, 0xb8);
	GC0311_SET_PAGE1;
	GC0311_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0311_write_cmos_sensor(0x2a, 0x60);   //anti-flicker step [7:0]

	GC0311_write_cmos_sensor(0x2b, 0x02);   //exp level 0  14.28fps
	GC0311_write_cmos_sensor(0x2c, 0xa0); 
	GC0311_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps
	GC0311_write_cmos_sensor(0x2e, 0x00); 
	GC0311_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps
	GC0311_write_cmos_sensor(0x30, 0xc0); 
	GC0311_write_cmos_sensor(0x31, 0x07);   //exp level 3  5.00fps
	GC0311_write_cmos_sensor(0x32, 0x80); 
	GC0311_write_cmos_sensor(0x33, 0x20);
	GC0311_SET_PAGE0;
 /////////////////20120703//////////////////////////
  ...
  /////////////////20120703//////////////////////////				
	...
	GC0311_write_cmos_sensor(0x44, 0xa0);
	...
	GC0311_write_cmos_sensor(0x82, 0x30);
	...
	/////////////YCP//////////////
	////////////////////////////
	GC0311_write_cmos_sensor(0xd1, 0x36);
	GC0311_write_cmos_sensor(0xd2, 0x36);
	...
	GC0311_write_cmos_sensor(0x12, 0x14);
	...
	GC0311_write_cmos_sensor(0x22, 0x40);
	...
	GC0311_write_cmos_sensor(0x52, 0x28);
	GC0311_write_cmos_sensor(0x53, 0x05);
	GC0311_write_cmos_sensor(0x54, 0x10);
	...
	GC0311_write_cmos_sensor(0x73, 0x71);
	...
	GC0311_write_cmos_sensor(0x81, 0x80);
	GC0311_write_cmos_sensor(0x82, 0x60);
	GC0311_write_cmos_sensor(0x83, 0xa0);
	...
	GC0311_write_cmos_sensor(0x44, 0xa2);
...
////////////////20120613 start//////////////////////////
	GC0311_write_cmos_sensor(0xfe, 0x01);
	GC0311_write_cmos_sensor(0x74, 0x13);
	GC0311_write_cmos_sensor(0x15, 0xfe);
	GC0311_write_cmos_sensor(0x21, 0xe0);
	...
	GC0311_write_cmos_sensor(0xd1, 0x2d);
	GC0311_write_cmos_sensor(0xd2, 0x2d);
	...
	GC0311_write_cmos_sensor(0xb5, 0x21);
	GC0311_write_cmos_sensor(0xb6, 0x21);
	GC0311_write_cmos_sensor(0xb7, 0xe4);
	GC0311_write_cmos_sensor(0xb8, 0xfb);

////////////////20120613 end//////////////////////////
    	GC0311GammaSelect(GC0311_RGB_Gamma_m4);//0:use default
}
...
BOOL GC0311_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0311_write_cmos_sensor(0x2f, 0x03);   //exp level 2  10.00fps
			GC0311_write_cmos_sensor(0x30, 0xc0); 
			GC0311_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
			GC0311_write_cmos_sensor(0x32, 0x40); 
			GC0311_SET_PAGE0;
			break;

		case AE_FLICKER_MODE_60HZ:
			GC0311_write_cmos_sensor(0x05, 0x02); 	
			GC0311_write_cmos_sensor(0x06, 0x4c); 
			GC0311_write_cmos_sensor(0x07, 0x00);
			GC0311_write_cmos_sensor(0x08, 0x88);
			
			GC0311_SET_PAGE1;
			GC0311_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0311_write_cmos_sensor(0x2a, 0x4e);   //anti-flicker step [7:0]
			
			GC0311_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0311_write_cmos_sensor(0x2c, 0x70); 
			GC0311_write_cmos_sensor(0x2d, 0x03);   //exp level 0  12.00fps
			GC0311_write_cmos_sensor(0x2e, 0x0c); 
			GC0311_write_cmos_sensor(0x2f, 0x03);   //exp level 0  10.00fps
			GC0311_write_cmos_sensor(0x30, 0xa8); 
			GC0311_write_cmos_sensor(0x31, 0x05);   //exp level 0  7.05fps
			GC0311_write_cmos_sensor(0x32, 0x2e); 
			GC0311_SET_PAGE0;
		break;
		default:
		return FALSE;
...
BOOL GC0311_set_param_exposure(UINT16 para)
{
	...
	{
		case AE_EV_COMP_n20:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0xc0);
		break;
		
		case AE_EV_COMP_n10:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0xe0);
		break;
		...
		case AE_EV_COMP_n03:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0xf0);
		break;				
		...
		case AE_EV_COMP_03:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0x10);
		break;
		
		case AE_EV_COMP_07:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0x20);
		break;
		...
		case AE_EV_COMP_20:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0x48);
		break;
		default:
		return FALSE;
	}
