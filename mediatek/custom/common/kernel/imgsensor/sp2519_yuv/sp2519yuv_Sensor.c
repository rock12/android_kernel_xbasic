...
void SP2519_Sensor_Init(void)
{
	...
	SP2519_write_cmos_sensor(0xeb,0x88);//80
	SP2519_write_cmos_sensor(0xec,0x88);//80
	...
	SP2519_write_cmos_sensor(0x10,0x80);//88
	SP2519_write_cmos_sensor(0x11,0x80);//88
	SP2519_write_cmos_sensor(0x12,0x80);//88
	SP2519_write_cmos_sensor(0x13,0x80);//8a
