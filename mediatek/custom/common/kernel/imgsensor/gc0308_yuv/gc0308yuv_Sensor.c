 ...
 *------------------------------------------------------------------------------
 * $Log: gc0308yuv_Sensor.c,v $
 * Revision 1.1  2013/09/03 05:41:44  lijunchao
 * Validate for GC0308
 *
 * Revision 1.3  2012/11/07 06:44:26  bianhuannan
 * no message
 *
 * Revision 1.2  2012/08/30 09:27:16  maliejun
 * green line
 *
 * Revision 1.1  2012/08/28 03:34:09  lichangying
 * Editor:lichangying
 * Inspector:lichangying
 * Reason:update for 12TX6_S9220C
 *
 * Revision 1.1  2012/08/06 08:20:18  maliejun
 * Editor: maliejun
 * Inspector:maliejun
 * Reason:[bug-null] driver update
 * Reference:none
 *
 * Revision 1.2  2012/07/18 03:54:16  maliejun
 * Editor: maliejun
 * Inspector:maliejun
 * Reason:[bug-null] gc fae zhangyanwei driver update
 * Reference:none
 *
...
void GC0308_Sensor_Init(void)
{
	...
	GC0308_write_cmos_sensor(0x14 , 0x13); //10
...
BOOL GC0308_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0308_write_cmos_sensor(0xe4  ,0x04);   //exp level 0  12.5fps
			GC0308_write_cmos_sensor(0xe5  ,0x60); 
			GC0308_write_cmos_sensor(0xe6  ,0x04);   //exp level 1  10fps
			GC0308_write_cmos_sensor(0xe7  ,0x60); 
			GC0308_write_cmos_sensor(0xe8  ,0x04);   //exp level 2  7.69fps
			GC0308_write_cmos_sensor(0xe9  ,0x60); 
			GC0308_write_cmos_sensor(0xea  ,0x06);   //exp level 3  5.00fps
			GC0308_write_cmos_sensor(0xeb  ,0x40); 
#else  //12M
			GC0308_write_cmos_sensor(0x01  ,0x32); 	
			GC0308_write_cmos_sensor(0x02  ,0x70); 
			GC0308_write_cmos_sensor(0x0f  ,0x01);

			GC0308_write_cmos_sensor(0xe2  ,0x00); 	//anti-flicker step [11:8]
			GC0308_write_cmos_sensor(0xe3  ,0x3c);   //anti-flicker step [7:0]

			GC0308_write_cmos_sensor(0xe4  ,0x02);   //exp level 0  12.5fps
			GC0308_write_cmos_sensor(0xe5  ,0x58); 
			GC0308_write_cmos_sensor(0xe6  ,0x02);   //exp level 1  10fps
			GC0308_write_cmos_sensor(0xe7  ,0x58); 
			GC0308_write_cmos_sensor(0xe8  ,0x02);   //exp level 2  7.69fps
			GC0308_write_cmos_sensor(0xe9  ,0x58); 
			GC0308_write_cmos_sensor(0xea  ,0x05);   //exp level 3  5.00fps
			GC0308_write_cmos_sensor(0xeb  ,0xdc);
#endif
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0308_write_cmos_sensor(0xe2  ,0x00); 	//anti-flicker step [11:8]
			GC0308_write_cmos_sensor(0xe3  ,0x32);   //anti-flicker step [7:0]
				
			GC0308_write_cmos_sensor(0xe4  ,0x02);   //exp level 0  12.00fps
			GC0308_write_cmos_sensor(0xe5  ,0x58); 
			GC0308_write_cmos_sensor(0xe6  ,0x02);   //exp level 1  10.00fps
			GC0308_write_cmos_sensor(0xe7  ,0x58); 
			GC0308_write_cmos_sensor(0xe8  ,0x02);   //exp level 2  7.50fps
			GC0308_write_cmos_sensor(0xe9  ,0x58); 
			GC0308_write_cmos_sensor(0xea  ,0x05);   //exp level 3  5.00fps
			GC0308_write_cmos_sensor(0xeb  ,0xd0);
#endif 
...
BOOL GC0308_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0308_write_cmos_sensor(0xd3, 0x58);
		break;
