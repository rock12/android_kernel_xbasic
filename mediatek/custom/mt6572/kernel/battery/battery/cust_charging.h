...
#define USB_CHARGER_CURRENT_CONFIGURED		CHARGE_CURRENT_600_00_MA//CHARGE_CURRENT_500_00_MA	// 500mA

#define USB_CHARGER_CURRENT					CHARGE_CURRENT_600_00_MA //500MA 

#if defined(BIRD_LITTLE_BATTERY_AC_500MA)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_600_00_MA  //500MA
#define NON_STD_AC_CHARGER_CURRENT			CHARGE_CURRENT_600_00_MA
#else

#if defined(MTK_FAN5405_SUPPORT)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1250_00_MA  //800MA
#define NON_STD_AC_CHARGER_CURRENT			CHARGE_CURRENT_1250_00_MA
#else
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_900_00_MA  //800MA
...
#if defined(BIRD_13F45_162C)||defined(BIRD_4_35V_BATTERY)
...
#define FAN5402_AC_CC_FIRST		CHARGE_CURRENT_550_00_MA
#define FAN5402_AC_CC_STEP		CHARGE_CURRENT_100_00_MA
#define FAN5402_VCDT_HV		450
#define FAN5402_VCDT_LV		400

extern int PMIC_IMM_GetOneChannelValue(int dwChannel, int deCount, int trimd);
extern 	kal_bool is_pmic_fan5405(void);
extern void BATTERY_SetFan5402Current(void);

extern void BATTERY_ResetFan5402DetectStatus(void);
extern kal_bool is_fan5402_ac_charge(void);
extern kal_bool is_fan5402_ac_charge_LV(void);
