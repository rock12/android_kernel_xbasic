...
{
//sunqi modify 131218 start
//#ifdef EN_CUSTOM_EXIF_INFO
//#define CUSTOM_EXIF_STRING_MAKE  "custom make"
//#define CUSTOM_EXIF_STRING_MODEL "custom model"
#if defined(BIRD_EXIF_STRING_MAKE)&&defined(BIRD_EXIF_STRING_MODEL)
#define CUSTOM_EXIF_STRING_MAKE BIRD_EXIF_STRING_MAKE
#define CUSTOM_EXIF_STRING_MODEL BIRD_EXIF_STRING_MODEL
//sunqi modify 131218 end
