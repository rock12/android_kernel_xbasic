        ...
        struct hw_device_t** device)
{
	...
	//charging led pulse when unread mms or missed call exists,chengting,@20140312,begin
	 #ifdef BIRD_CHARGE_LED_UNREAD_PULSE
	 	set_light = set_light_notifications;
	 #else
	 	return -EINVAL; // add by zhuyaozhong 20131112
	 #endif
	//charging led pulse when unread mms or missed call exists,chengting,@20140312,end
        //set_light = set_light_notifications;
    }
