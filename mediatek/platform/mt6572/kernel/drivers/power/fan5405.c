...
#if defined(BIRD_FAN540X_SUPPORT)
static struct i2c_board_info __initdata i2c_fan5402 = { I2C_BOARD_INFO("fan5405", (fan5402_SLAVE_ADDR_WRITE>>1))};
#endif
...
#if defined(BIRD_FAN540X_SUPPORT)
	i2c_register_board_info(1, &i2c_fan5402, 1);
#else	
    i2c_register_board_info(1, &i2c_fan5405, 1);
#endif
