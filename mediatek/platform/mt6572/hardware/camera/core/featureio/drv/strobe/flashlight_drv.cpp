...
//[ALPS01464328], add start by shenzhiwang, 20140321
    DRV_DBG("m_sensorDev = %d, e_CAMERA_MAIN_SENSOR = %d \n", m_sensorDev, e_CAMERA_MAIN_SENSOR); 
...
*/
//[ALPS01464328], add end by shenzhiwang, 20140321
}
