...
static int is_pmic_fan5405=false;
#endif
...
{
#if defined(BIRD_FAN540X_SUPPORT)
	U8 chip_slave_address;
	if(is_pmic_fan5405==true){
		chip_slave_address = fan5405_SLAVE_ADDR_WRITE;
	}else{
		chip_slave_address = fan5402_SLAVE_ADDR_WRITE;	
	}
#else
