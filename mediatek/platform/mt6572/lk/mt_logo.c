...
extern VBAT_TO_PERCENT Batt_VoltToPercent_Table[];

UINT32 BattVoltToPercentLogo(UINT16 dwVoltage)
{
    UINT32 m=0;
...
void SHOW_BAT_CheckBatteryStatus(void)
{
	int bat_vol,bat_volt_check_point;
	
	//BAT_GetVoltage();
	 bat_vol = get_bat_sense_volt(1);
	bat_volt_check_point = BattVoltToPercentLogo(bat_vol);
