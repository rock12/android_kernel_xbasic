...
#if 1
#include <cust_gpio_usage.h>
int charge_gpio_number   = GPIO_SWCHARGER_EN_PIN; 
int charge_gpio_off_mode = GPIO_SWCHARGER_EN_PIN_M_GPIO;
int charge_gpio_on_mode  = GPIO_SWCHARGER_EN_PIN_M_GPIO;
#else
int gpio_number   = 56; 
int gpio_off_mode = 0;
int gpio_on_mode  = 0;
#endif
int charge_gpio_off_dir  = GPIO_DIR_OUT;
int charge_gpio_off_out  = GPIO_OUT_ONE;
int charge_gpio_on_dir   = GPIO_DIR_OUT;
int charge_gpio_on_out   = GPIO_OUT_ZERO;
...
void pchr_turn_off_charging_fan5405 (void)
{
    ...
    mt_set_gpio_mode(charge_gpio_number,charge_gpio_off_mode);
    mt_set_gpio_dir(charge_gpio_number,charge_gpio_off_dir);
    mt_set_gpio_out(charge_gpio_number,charge_gpio_off_out);
...
void pchr_turn_on_charging_fan5405 (void)
{
    ...
    mt_set_gpio_mode(charge_gpio_number,charge_gpio_on_mode);
    mt_set_gpio_dir(charge_gpio_number,charge_gpio_on_dir);
    mt_set_gpio_out(charge_gpio_number,charge_gpio_on_out);
...
void batdrv_init(void)
{
    ...
    charge_gpio_off_dir  = cust_gpio_off_dir;
    charge_gpio_off_out  = cust_gpio_off_out;
    charge_gpio_on_mode  = cust_gpio_on_mode;
    charge_gpio_off_out   = cust_gpio_on_dir;
    charge_gpio_off_out   = cust_gpio_on_out;
    #endif
    printf("[LK][Charger IC] GPIO setting : %d,%d,%d,%d,%d,%d,%d\n",
    charge_gpio_number, charge_gpio_off_mode, charge_gpio_off_dir, charge_gpio_off_out, 
    charge_gpio_on_mode, charge_gpio_off_out, charge_gpio_off_out);
