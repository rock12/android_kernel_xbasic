...
#if 0// modified by maliejun 20130705
...
/* convert register to temperature */
sBaTTMP = BattThermistorConverTemp(TRes);
bm_print(BM_LOG_CRTI, "[BattVoltToTemp] caikuowei TRes=%d t\n",TRes);
return sBaTTMP;
}
#endif
...
{
		printk("mycat battery_meter fgauge_get_saddles g_Ntc_Pin3_BatteryType=%d \r\n",g_Ntc_Pin3_BatteryType);
		if(g_Ntc_Pin3_BatteryType)//4.35v
		{
    	return sizeof(battery_profile_t2_4_35V) / sizeof(BATTERY_PROFILE_STRUC);
    }
    else
    {
...
{
		printk("mycat battery_meter fgauge_get_saddles_r_table g_Ntc_Pin3_BatteryType=%d \r\n",g_Ntc_Pin3_BatteryType);
		if(g_Ntc_Pin3_BatteryType)//4.35v
		{
    	return sizeof(r_profile_t2_4_35V) / sizeof(R_PROFILE_STRUC);
    }
    else
    {
...
{
		printk("mycat battery_meter fgauge_get_profile g_Ntc_Pin3_BatteryType=%d \r\n",g_Ntc_Pin3_BatteryType);
    switch (temperature)
    {
        case TEMPERATURE_T0:
        		if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &battery_profile_t0_4_35V[0];
            }
            else
            {
        ...
        case TEMPERATURE_T1:
        		if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &battery_profile_t1_4_35V[0];
            }
            else
            {
        ...
        case TEMPERATURE_T2:
        		if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &battery_profile_t2_4_35V[0];
            }
            else
            {
        ...
        case TEMPERATURE_T3:
        		if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &battery_profile_t3_4_35V[0];
            }
            else
            {
        ...
        case TEMPERATURE_T:
        		if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &battery_profile_temperature_4_35V[0];
            }
            else
            {
...
{
		printk("mycat battery_meter fgauge_get_profile_r_table g_Ntc_Pin3_BatteryType=%d \r\n",g_Ntc_Pin3_BatteryType);
    switch (temperature)
    {
        case TEMPERATURE_T0:
        		if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &r_profile_t0_4_35V[0];
            }
            else
            {
        ...
        case TEMPERATURE_T:
        	if(g_Ntc_Pin3_BatteryType)//4.35v
        		{
            	return &r_profile_temperature_4_35V[0];
            }
            else
            {
