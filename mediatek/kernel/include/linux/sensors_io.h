...
/*-------------------bird add-------------------------------------------*/
#define GSENSOR_IOCTL_SET_CALIBRATION		_IO(GSENSOR, 0x0a)
...
#define MSENSOR_IOCTL_TEST_I2C		_IOR(MSENSOR, 0x53, int)
...
/*-------------------bird add-------------------------------------------*/
#define ALSPS_SET_PS_CALIBRATION						_IO(ALSPS, 0x0F)
#define ALSPS_PS_TEST						_IOR(ALSPS, 0x10, signed char)
